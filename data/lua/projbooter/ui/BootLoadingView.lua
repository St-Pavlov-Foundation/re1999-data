...
function var_0_0._setSwitch(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_0 = UnityEngine.Sprite.Create(arg_15_1, UnityEngine.Rect.New(0, 0, arg_15_1.width, arg_15_1.height), Vector2.zero)

	arg_15_0._imageBg2.sprite = var_15_0

	arg_15_0._aniTxt:Play("switch", 0, 0)
	arg_15_0._bgAnim:Play("switch", 0, 0)

	arg_15_0._txtDescribe2.text = arg_15_2.desc
	arg_15_0._txtTitle2.text = arg_15_2.title
