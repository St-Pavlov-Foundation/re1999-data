...
function var_0_0.getAllLangDownloadList(arg_14_0)
	...
	for iter_14_0, iter_14_1 in pairs(var_14_2) do
		...
		if var_14_0 then
			local var_14_5 = arg_14_0._optionalUpdateInst:GetLocalVersion(iter_14_0)

			var_14_4 = not string.nilorempty(var_14_5)
		else
			var_14_4 = tabletool.indexOf(var_14_1, iter_14_0)
		end

		if #iter_14_1.res > 0 and var_14_4 then
			local var_14_6 = {}
			...
			table.sort(var_14_6, var_0_0._sortByOrder)

			var_14_3[iter_14_0] = var_14_6
		end
	end
