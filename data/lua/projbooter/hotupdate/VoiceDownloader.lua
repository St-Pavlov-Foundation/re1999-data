...
function var_0_0._onDownloadPackFail(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4)
	logNormal("VoiceDownloader:_onDownloadPackFail, packName = " .. arg_9_1 .. " resUrl = " .. arg_9_2 .. " failError = " .. arg_9_3)

	if arg_9_3 == 5 then
		arg_9_0:_onNotEnoughDiskSpace(arg_9_1)
	else
		...
		if HotUpdateMgr.instance:isFailNeedAlert() then
			...
			local var_9_1 = {
				...
				content = arg_9_0:_getDownloadFailedTip(arg_9_3, arg_9_4),
				leftMsg = booterLang("exit"),
				leftCb = arg_9_0._quitGame,
				leftCbObj = arg_9_0,
				rightMsg = booterLang("retry"),
				rightCb = arg_9_0._retry,
				rightCbObj = arg_9_0
			}

			BootMsgBox.instance:show(var_9_1)
		else
	...
	var_9_2.step = "fail"
	var_9_2.spend_time = math.floor(Time.realtimeSinceStartup * 1000) - arg_9_0._downLoadStartTime
	var_9_2.result_msg = arg_9_0:_getDownloadFailedTip(arg_9_3, arg_9_4)
	var_9_2.download_voice_pack_list = arg_9_0._download_voice_pack_list
	var_9_2.update_amount = arg_9_0:_fixSizeMB(arg_9_0._totalSize - arg_9_0._downloadSize)

	SDKDataTrackMgr.instance:trackVoicePackDownloading(var_9_2)
end

function var_0_0._onNotEnoughDiskSpace(arg_10_0, arg_10_1)
	logNormal("VoiceDownloader:_onNotEnoughDiskSpace, packName = " .. arg_10_1)

	local var_10_0 = {
		title = booterLang("hotupdate"),
		content = booterLang("download_fail_no_enough_disk"),
		rightMsg = booterLang("exit"),
		rightCb = arg_10_0._quitGame,
		rightCbObj = arg_10_0
	}
...
function var_0_0._onPackUnZipFail(arg_11_0, arg_11_1, arg_11_2)
	if arg_11_1 then
		logNormal("VoiceDownloader:_onPackUnZipFail, packName = " .. arg_11_1 .. " failReason = " .. arg_11_2)

		local var_11_0 = {
			title = booterLang("hotupdate"),
			content = arg_11_0:_getUnzipFailedTip(arg_11_2),
			leftMsg = booterLang("exit"),
			leftCb = arg_11_0._quitGame,
			leftCbObj = arg_11_0,
			rightMsg = booterLang("retry"),
			rightCb = arg_11_0._retry,
			rightCbObj = arg_11_0
		}
...
function var_0_0._retry(arg_13_0)
	arg_13_0._optionalUpdateInst:RunNextStepAction()
end

function var_0_0._onUnzipProgress(arg_14_0, arg_14_1)
	logNormal("正在解压语音包，请稍后... progress = " .. arg_14_1)

	if tostring(arg_14_1) == "nan" then
		return
	end

	local var_14_0 = arg_14_0._downProgressS1 or ""
	local var_14_1 = arg_14_0._downProgressS2 or ""
	local var_14_2 = math.floor(100 * arg_14_1 + 0.5)
	local var_14_3

	if UnityEngine.Application.internetReachability == UnityEngine.NetworkReachability.ReachableViaLocalAreaNetwork then
		var_14_3 = string.format(booterLang("unziping_progress_wifi"), tostring(var_14_2), var_14_0, var_14_1)
	else
		var_14_3 = string.format(booterLang("unziping_progress"), tostring(var_14_2), var_14_0, var_14_1)
	end

	HotUpdateProgress.instance:setProgressUnzipVoice(arg_14_1, arg_14_0._nowPackSize, arg_14_0._downloadSuccSize, var_14_3)
end

function var_0_0.cancelDownload(arg_15_0)
	if arg_15_0._optionalUpdateInst then
		arg_15_0._optionalUpdateInst:StopDownload()

		arg_15_0._errorCode = nil
	end
end

function var_0_0._getDownloadFailedTip(arg_16_0, arg_16_1, arg_16_2)
	local var_16_0 = SLFramework.GameUpdate.FailError

	arg_16_1 = var_16_0.IntToEnum(arg_16_1)
	arg_16_0._errorCode = arg_16_1
	arg_16_2 = arg_16_2 or ""

	if arg_16_1 == var_16_0.DownloadErrer then
		return booterLang("download_fail_download_error")
	elseif arg_16_1 == var_16_0.NotFound then
		return booterLang("download_fail_not_found")
	elseif arg_16_1 == var_16_0.ServerPause then
		return booterLang("download_fail_server_pause")
	elseif arg_16_1 == var_16_0.TimeOut then
		return booterLang("download_fail_time_out")
	elseif arg_16_1 == var_16_0.NoEnoughDisk then
		return booterLang("download_fail_no_enough_disk")
	elseif arg_16_1 == var_16_0.MD5CheckError then
		return booterLang("download_fail_md5_check_error")
	else
		return booterLang("download_fail_other") .. tostring(arg_16_2)
	end
end

function var_0_0._getUnzipFailedTip(arg_17_0, arg_17_1)
	local var_17_0 = SLFramework.GameUpdate.UnzipStatus

	arg_17_1 = var_17_0.IntToEnum(arg_17_1)

	if arg_17_1 == var_17_0.Running then
		return booterLang("unpack_error_running")
	elseif arg_17_1 == var_17_0.Done then
		return booterLang("unpack_error_done")
	elseif arg_17_1 == var_17_0.FileNotFound then
		return booterLang("unpack_error_file_not_found")
	elseif arg_17_1 == var_17_0.NotEnoughSpace then
		return booterLang("unpack_error_not_enough_space")
	elseif arg_17_1 == var_17_0.ThreadAbort then
		return booterLang("unpack_error_thread_abort")
	elseif arg_17_1 == var_17_0.Exception then
...
function var_0_0._fixSizeStr(arg_18_0, arg_18_1)
	local var_18_0 = arg_18_1 / HotUpdateMgr.MB_SIZE
	local var_18_1 = "MB"

	if var_18_0 < 1 then
		var_18_0 = arg_18_1 / HotUpdateMgr.KB_SIZE
		var_18_1 = "KB"

		if var_18_0 < 0.01 then
			var_18_0 = 0.01
		end
	end

	local var_18_2 = var_18_0 - var_18_0 % 0.01

	return string.format("%.2f %s", var_18_2, var_18_1)
end

function var_0_0._fixSizeMB(arg_19_0, arg_19_1)
	local var_19_0 = arg_19_1 / HotUpdateMgr.MB_SIZE

	if var_19_0 < 0.001 then
		return 0.001
	end

	return var_19_0 - var_19_0 % 0.001
end
