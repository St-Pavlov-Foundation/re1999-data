...
function var_0_0._onHotUpdateDownloadFail(arg_36_0, arg_36_1, arg_36_2)
	if arg_36_1 == SLFramework.GameUpdate.FailError.MD5CheckError then
		arg_36_0:_checkSendFullPonitStat()
	end

	arg_36_0:inverseUseBackup()
	...
	arg_36_0:incFailCount()

	if arg_36_0:isFailNeedAlert() then
		arg_36_0:resetFailAlertCount()

		local var_36_1 = {
			title = booterLang("hotupdate"),
			content = arg_36_0:_getDownloadFailedTip(arg_36_1, arg_36_2),
			leftMsg = booterLang("exit"),
		...
		BootMsgBox.instance:show(var_36_1)
	else
		logNormal("HotUpdateMgr 静默重试下载！")
		arg_36_0._eventMgrInst:DoRetryAction()
		arg_36_0:showConnectTips()
	end
end

function var_0_0._onDownloadDiskFull(arg_37_0)
	local var_37_0 = {
		title = booterLang("hotupdate"),
...
function var_0_0._retryDownload(arg_38_0)
	...
	arg_38_0._eventMgrInst:DoRetryAction()
	arg_38_0:showConnectTips()
end
...
function var_0_0._getDownloadFailedTip(arg_39_0, arg_39_1, arg_39_2)
	...
	elseif arg_39_1 == var_39_0.MD5CheckError then
		SDKDataTrackMgr.instance:trackHotupdateFilesCheckEvent(SDKDataTrackMgr.Result.fail, arg_39_2)
...
function var_0_0._onHotUpdateDownloadSuccess(arg_40_0)
	...
	if arg_40_0._onDownloadSuccCb then
		arg_40_0._onDownloadSuccCb(arg_40_0._onDownloadSuccObj)
	end
end
...
function var_0_0._onDiskSpaceNotEnough(arg_42_0)
	...
	local var_42_0 = {
		...
		leftMsg = booterLang("exit"),
		leftCb = arg_42_0._quitGame,
		leftCbObj = arg_42_0
	}

	var_42_0.rightMsg = nil
...
function var_0_0._onUnzipFail(arg_44_0, arg_44_1)
	...
	local var_44_0 = {
		title = booterLang("hotupdate"),
		content = arg_44_0:_getUnzipFailedTip(arg_44_1),
		leftMsg = booterLang("exit"),
		leftCb = arg_44_0._quitGame,
		leftCbObj = arg_44_0,
		rightMsg = booterLang("retry"),
		rightCb = arg_44_0._retryUnzipFile,
		rightCbObj = arg_44_0
	}

	BootMsgBox.instance:show(var_44_0)
	SDKDataTrackMgr.instance:trackUnzipFinishEvent(SDKDataTrackMgr.Result.fail, var_44_0.content)
end

function var_0_0._retryUnzipFile(arg_45_0)
	logNormal("HotUpdateMgr:_retryUnzipFile, 重试解压资源包！")
	arg_45_0._eventMgrInst:DoRetryAction()
end

function var_0_0._getUnzipFailedTip(arg_46_0, arg_46_1)
	local var_46_0 = SLFramework.GameUpdate.UnzipStatus

	if arg_46_1 == var_46_0.Running then
		return booterLang("unpack_error_running")
	elseif arg_46_1 == var_46_0.Done then
		return booterLang("unpack_error_done")
	elseif arg_46_1 == var_46_0.FileNotFound then
		return booterLang("unpack_error_file_not_found")
	elseif arg_46_1 == var_46_0.NotEnoughSpace then
		return booterLang("unpack_error_not_enough_space")
	elseif arg_46_1 == var_46_0.ThreadAbort then
		return booterLang("unpack_error_thread_abort")
	elseif arg_46_1 == var_46_0.Exception then
...
function var_0_0.hasHotUpdate(arg_48_0)
	return arg_48_0._hasHotUpdate
end

function var_0_0._onHotUpdateComplete(arg_49_0)
	if arg_49_0._hasHotUpdate then
		arg_49_0:_onFinish()
	else
		arg_49_0:_showConfirmUpdateSize(0, 0, arg_49_0._onFinish)
	end
end
...
function var_0_0.statStartUpdate(arg_51_0)
	arg_51_0._statNextPoint = 0
	arg_51_0._statAllSize = 0
end

function var_0_0.statHotUpdate(arg_52_0, arg_52_1, arg_52_2)
	for iter_52_0 = arg_52_0._nowStatHotUpdatePerIndex, arg_52_0._statHotUpdatePerNum do
		local var_52_0 = arg_52_0._statHotUpdatePerList[iter_52_0]

		if arg_52_1 >= var_52_0[1] then
			SDKDataTrackMgr.instance:track(var_52_0[2])

			arg_52_0._nowStatHotUpdatePerIndex = iter_52_0 + 1
		else
			break
		end
	end

	if not arg_52_0._statNextPoint then
		return
	end

	arg_52_0._statAllSize = arg_52_2

	if arg_52_1 >= arg_52_0._statNextPoint then
		SDKDataTrackMgr.instance:track(SDKDataTrackMgr.EventName.HotUpdate, {
			[SDKDataTrackMgr.EventProperties.UpdateAmount] = arg_52_2,
			[SDKDataTrackMgr.EventProperties.UpdatePercentage] = tostring(arg_52_0._statNextPoint)
		})

		arg_52_0._statNextPoint = arg_52_0._statNextPoint + 0.5
	end
end

function var_0_0._checkSendFullPonitStat(arg_53_0)
	if arg_53_0._statNextPoint and arg_53_0._statNextPoint < 1.5 and arg_53_0._statAllSize and arg_53_0._statAllSize ~= 0 then
		arg_53_0._statNextPoint = 1

		arg_53_0:statHotUpdate(1, arg_53_0._statAllSize)
	end
end

function var_0_0._fixSizeStr(arg_54_0, arg_54_1)
	return var_0_0.fixSizeStr(arg_54_1)
end

function var_0_0._fixSizeMB(arg_55_0, arg_55_1)
	return var_0_0.fixSizeMB(arg_55_1)
end

var_0_0.MB_SIZE = 1048576
var_0_0.KB_SIZE = 1024

function var_0_0.fixSizeStr(arg_56_0)
	local var_56_0 = arg_56_0 / var_0_0.MB_SIZE
	local var_56_1 = "MB"

	if var_56_0 < 1 then
		var_56_0 = arg_56_0 / var_0_0.KB_SIZE
		var_56_1 = "KB"

		if var_56_0 < 0.01 then
			var_56_0 = 0.01
		end
	end

	local var_56_2 = var_56_0 - var_56_0 % 0.01

	return string.format("%.2f %s", var_56_2, var_56_1)
end

function var_0_0.fixSizeMB(arg_57_0)
	local var_57_0 = arg_57_0 / var_0_0.MB_SIZE

	if var_57_0 < 0.001 then
		return 0.001
	end

	return var_57_0 - var_57_0 % 0.001
end
