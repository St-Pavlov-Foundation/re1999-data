...
function var_0_0._getLangVersions(arg_7_0)
	...
	for iter_7_0 = 1, #var_7_3 do
		...
		local var_7_6 = var_7_5 ~= var_7_4
		local var_7_7 = var_7_0:GetLocalVersion(var_7_5)
		local var_7_8 = not string.nilorempty(var_7_7)
		local var_7_9 = not BootVoiceView.instance:isFirstDownloadDone()

		if var_7_6 and (var_7_8 or var_7_9) then
			table.insert(var_7_1, var_7_5)

			local var_7_10 = var_7_0.VoiceBranch

			if string.nilorempty(var_7_10) or not tonumber(var_7_10) then
				var_7_10 = 1

				logError("随包的语音分支错误：" .. var_7_0.VoiceBranch)
			end

			local var_7_11 = var_7_10 .. "." .. (string.nilorempty(var_7_7) and "0" or var_7_7)
