...
function var_0_0.startLoading(arg_13_0, arg_13_1, arg_13_2)
	...
	for iter_13_0, iter_13_1 in pairs(arg_13_0._allRes.prefabs) do
		arg_13_0._loadedCount = arg_13_0._loadedCount + 1

		loadAbAsset(iter_13_0, false, arg_13_0._onPrefabLoaded, arg_13_0)
	end

	for iter_13_2, iter_13_3 in pairs(arg_13_0._allRes.imgs) do
		arg_13_0._loadedCount = arg_13_0._loadedCount + 1

		loadAbAsset(iter_13_3.path, false, arg_13_0._onImgLoaded, arg_13_0)
	end
end

function var_0_0._onImgLoaded(arg_14_0, arg_14_1)
	if arg_14_1.IsLoadSuccess then
		arg_14_0._loadedCount = arg_14_0._loadedCount - 1

		local var_14_0 = arg_14_1:GetResource()

		arg_14_0._allRes.imgs[arg_14_1.ResPath].texture = var_14_0

		arg_14_0:_checkResLoadFinished()
	end
end

function var_0_0._onPrefabLoaded(arg_15_0, arg_15_1)
	if arg_15_1.IsLoadSuccess then
		if var_0_0.AdaptionBgViewPath == arg_15_1.ResPath then
			GameAdaptionBgMgr.instance:onAssetResLoaded(arg_15_1)
		end

		arg_15_0._loadedCount = arg_15_0._loadedCount - 1

		local var_15_0 = arg_15_1:GetResource()
		local var_15_1 = UnityEngine.GameObject.Instantiate(var_15_0)

		var_15_1:SetActive(false)

		local var_15_2 = arg_15_0._allRes.prefabs[arg_15_1.ResPath].layer or arg_15_0._topRoot

		var_15_1.transform:SetParent(var_15_2.transform, false)

		arg_15_0._allRes.prefabs[arg_15_1.ResPath].go = var_15_1

		arg_15_0:_checkResLoadFinished()
	end
end

function var_0_0._checkResLoadFinished(arg_16_0)
	if arg_16_0._loadedCount == 0 then
		logNormal("BootResMgr onloaded, 所有的启动UI资源都加载完成了！")

		if arg_16_0._loadedCb then
			arg_16_0._loadedCb(arg_16_0._cbObj)
		end
	end
end

function var_0_0.dispose(arg_17_0)
	if arg_17_0._disposed then
		return
	end
	...
	if arg_17_0._allRes then
		for iter_17_0, iter_17_1 in pairs(arg_17_0._allRes.prefabs) do
			UnityEngine.GameObject.Destroy(iter_17_1.go)
		end

		arg_17_0._allRes = nil
	end

	arg_17_0._disposed = true
end
