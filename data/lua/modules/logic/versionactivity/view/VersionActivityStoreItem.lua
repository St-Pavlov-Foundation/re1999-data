...
function slot0.onInitView(slot0, slot1)
	...
	slot0.txtTagFirstName = gohelper.findChildText(slot0.go, "tag/txt_tagNameFirst")
	slot0.txtTagRemainName = gohelper.findChildText(slot0.go, "tag/txt_tagNameRemain")
