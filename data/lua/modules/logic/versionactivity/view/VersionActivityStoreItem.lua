...
function var_0_0.onInitView(arg_1_0, arg_1_1)
	...
	arg_1_0.txtTagFirstName = gohelper.findChildText(arg_1_0.go, "tag/txt_tagNameFirst")
	arg_1_0.txtTagRemainName = gohelper.findChildText(arg_1_0.go, "tag/txt_tagNameRemain")
