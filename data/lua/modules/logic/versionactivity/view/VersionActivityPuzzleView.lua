...
function slot0.showGuide(slot0)
	...
	slot1 = uv0.AnswerAnchorPosDict[slot0.puzzleId]

	recthelper.setWidth(slot0.rectTransformAnswer, slot0:getAnswerWidth(1))
	recthelper.setAnchor(slot0.rectTransformAnswer, slot1.x, slot1.y)
...
function slot0.playGuideAnimation(slot0)
	...
	slot1 = uv0.AnswerAnchorPosDict[slot0.puzzleId]
	slot0.tweenId = ZProj.TweenHelper.DOAnchorPos(slot0.rectTransformFinger, slot1.x + uv0.FingerAnswerOffsetX, slot1.y + uv0.FingerAnswerOffsetY, 1.667, slot0.playGuideAnimation, slot0)
...
function slot0.changeDragItemAnchor(slot0, slot1)
	...
	slot4 = slot2.y
	slot3 = (slot2.x <= 0 or Mathf.Min(slot0.bgHalfWidth, slot3)) and Mathf.Max(-slot0.bgHalfWidth, slot3)
...
function slot0.getAnswerWidth(slot0, slot1)
	return slot0.maxAnswerLenList[slot1] * uv0.OneCharacterWidth
end
