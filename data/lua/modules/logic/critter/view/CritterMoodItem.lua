...
function slot0.removeEventListeners(slot0)
	slot0:removeEventCb(CritterController.instance, CritterEvent.CritterFeedFood, slot0._onMoodChange, slot0)
...
function slot0.refreshMood(slot0)
	...
	if slot0._isNOShowRestore ~= true and slot0._txtmoodRestore then
		slot10 = CritterHelper.getPreViewAttrValue(CritterEnum.AttributeType.MoodRestore, slot0.critterUid)
		slot0._txtmoodRestore.text = "+" .. CritterHelper.formatAttrValue(CritterEnum.AttributeType.MoodRestore, slot10)

		gohelper.setActive(slot0._txtmoodRestore, slot10 > 0)
		SLFramework.UGUI.GuiHelper.SetColor(slot0._txtmoodRestore, CritterHelper.getPatienceChangeValue(RoomBuildingEnum.BuildingType.Rest) < slot10 and "#D9A06F" or "#D4C399")
	end
end
