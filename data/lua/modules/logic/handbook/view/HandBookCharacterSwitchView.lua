...
function var_0_0._editableInitView(arg_12_0)
	...
	arg_12_0._simageswitchbg1:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz3")))
	arg_12_0._simageswitchbg2:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz1")))
	arg_12_0._simageswitchbg3:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz2")))
	arg_12_0._simageswitchbg4:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz4")))
	arg_12_0._simageswitchbg5:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz5")))
	arg_12_0._simageswitchbg6:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz6")))
end
