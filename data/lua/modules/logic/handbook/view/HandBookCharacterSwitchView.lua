...
function slot0._editableInitView(slot0)
	...
	slot0._simageswitchbg1:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz3")))
	slot0._simageswitchbg2:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz1")))
	slot0._simageswitchbg3:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz2")))
	slot0._simageswitchbg4:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz4")))
	slot0._simageswitchbg5:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz5")))
	slot0._simageswitchbg6:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(ResUrl.getHandbookCharacterImage("zz6")))
end
