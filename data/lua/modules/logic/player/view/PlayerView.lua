...
function var_0_0._initPlayerbassinfo(arg_21_0, arg_21_1)
	...
	arg_21_0._txtentryday.text = TimeUtil.timestampToString3(ServerTime.timeInLocal(arg_21_1.registerTime / 1000))
...
function var_0_0._initPlayerOtherinfo(arg_26_0, arg_26_1)
	...
	if var_26_1 then
		...
		if var_26_1 then
			arg_26_0._txtepisodeprogress.text = string.format("《%s %s》", DungeonController.getEpisodeName(var_26_1), var_26_1.name)
			arg_26_0._txtepisodeprogressen.text = var_26_1.name_En
		end
	end

	local var_26_2 = arg_26_1.level

	arg_26_0._txtlevel.text = var_26_2

	local var_26_3 = arg_26_1.exp
	local var_26_4 = 0

	if var_26_2 < CommonConfig.instance:getConstNum(ConstEnum.PlayerMaxLev) then
		var_26_4 = PlayerConfig.instance:getPlayerLevelCO(var_26_2 + 1).exp
	else
		var_26_4 = PlayerConfig.instance:getPlayerLevelCO(var_26_2).exp
		var_26_3 = var_26_4
	end

	arg_26_0._txtexp.text = var_26_3 .. "/" .. var_26_4

	arg_26_0._imageexp:SetValue(var_26_3 / var_26_4)
end
