...
function var_0_0.setPlayerPortrait(arg_12_0, arg_12_1)
	PlayerController.instance:dispatchEvent(PlayerEvent.SetPortrait, arg_12_1)

	arg_12_0._portrait = arg_12_1

	arg_12_0:_changePlayerbassinfo()
end

function var_0_0.setShowHeroUniqueIds(arg_13_0)
	PlayerController.instance:dispatchEvent(PlayerEvent.SetShowHero, arg_13_0._showHeros)
end

function var_0_0._changePlayerbassinfo(arg_14_0)
	local var_14_0 = arg_14_0:getPlayinfo()

	PlayerController.instance:dispatchEvent(PlayerEvent.PlayerbassinfoChange, var_14_0)
end

function var_0_0.getShowHeros(arg_15_0)
	return arg_15_0._showHeros
end

function var_0_0.getShowHeroUid(arg_16_0)
	local var_16_0 = {}

	for iter_16_0 = 1, #arg_16_0._showHeros do
		if arg_16_0._showHeros[iter_16_0] ~= 0 then
			local var_16_1 = HeroModel.instance:getByHeroId(arg_16_0._showHeros[iter_16_0].heroId).uid
...
function var_0_0.setShowHero(arg_17_0, arg_17_1, arg_17_2)
	if arg_17_2 ~= 0 then
		arg_17_0._showHeros[arg_17_1] = arg_17_0:_setSimpleinfo(arg_17_2)
	else
		arg_17_0._showHeros[arg_17_1] = 0
	end
end

function var_0_0._setSimpleinfo(arg_18_0, arg_18_1)
	local var_18_0 = HeroModel.instance:getByHeroId(arg_18_1)

	return {
		uid = var_18_0.uid,
		heroId = var_18_0.heroId,
		level = var_18_0.level,
		rank = var_18_0.rank,
		exSkillLevel = var_18_0.exSkillLevel,
		skin = var_18_0.skin
	}
end

function var_0_0.updateAssistRewardCountData(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
	arg_19_0._assistRewardCount = arg_19_1 or 0
	arg_19_0._hasReceiveAssistBonus = arg_19_2 or 0
...
function var_0_0.getAssistRewardCount(arg_20_0)
	return arg_20_0._assistRewardCount or 0
end

function var_0_0.isHasAssistReward(arg_21_0)
	local var_21_0 = false

	if arg_21_0:isGetAssistRewardReachingLimit() then
		return var_21_0
	end

	local var_21_1 = arg_21_0:getAssistRewardCount()

	return var_21_1 and var_21_1 > 0
end

function var_0_0.getMaxAssistRewardCount(arg_22_0)
	return CommonConfig.instance:getConstNum(ConstEnum.AssistRewardMaxNum) or 0
end

function var_0_0.getHasReceiveAssistBonus(arg_23_0)
	return arg_23_0._hasReceiveAssistBonus or 0
end

function var_0_0.isGetAssistRewardReachingLimit(arg_24_0)
	return arg_24_0:getMaxAssistRewardCount() <= arg_24_0:getHasReceiveAssistBonus()
end

function var_0_0.updateSimpleProperties(arg_25_0, arg_25_1)
	for iter_25_0, iter_25_1 in ipairs(arg_25_1) do
		arg_25_0:updateSimpleProperty(iter_25_1)
	end
end
...
function var_0_0._getSimplePropMo(arg_26_0, arg_26_1)
	local var_26_0 = arg_26_0._simpleProperties[arg_26_1]

	if not var_26_0 then
		var_26_0 = (var_0_1[arg_26_1] or SimplePropertyMO).New()
		arg_26_0._simpleProperties[arg_26_1] = var_26_0
	end

	return var_26_0
end

function var_0_0.updateSimpleProperty(arg_27_0, arg_27_1)
	arg_27_0._simpleProperties = arg_27_0._simpleProperties or {}

	arg_27_0:_getSimplePropMo(arg_27_1.id):init(arg_27_1)
end

function var_0_0.forceSetSimpleProperty(arg_28_0, arg_28_1, arg_28_2)
	local var_28_0 = arg_28_0._simpleProperties[arg_28_1]

	if var_28_0 then
		var_28_0.property = arg_28_2
	end
end

function var_0_0.getSimpleProperty(arg_29_0, arg_29_1)
	if arg_29_0._simpleProperties then
		local var_29_0 = arg_29_0._simpleProperties[arg_29_1]

		return var_29_0 and var_29_0.property
	end

	return nil
end

function var_0_0.getPropKeyValue(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	return arg_30_0:_getSimplePropMo(arg_30_1):getValue(arg_30_2, arg_30_3)
end

function var_0_0.setPropKeyValue(arg_31_0, arg_31_1, arg_31_2, arg_31_3)
	arg_31_0:_getSimplePropMo(arg_31_1):setValue(arg_31_2, arg_31_3)
end

function var_0_0.getPropKeyValueString(arg_32_0, arg_32_1)
	return arg_32_0:_getSimplePropMo(arg_32_1):getString()
end

function var_0_0.getMyUserId(arg_33_0)
	return arg_33_0._userId
end

function var_0_0.isPlayerSelf(arg_34_0, arg_34_1)
	local var_34_0 = true
	local var_34_1 = arg_34_0:getMyUserId()

	if var_34_1 and arg_34_1 then
		var_34_0 = arg_34_1 == var_34_1
	end

	return var_34_0
end

function var_0_0.logout(arg_35_0)
	return
end

function var_0_0.showWaterMark(arg_36_0)
	ViewMgr.instance:openView(ViewName.WaterMarkView, {
		userId = arg_36_0._userId
	})
end

function var_0_0.changeWaterMarkStatus(arg_37_0, arg_37_1)
	if not arg_37_0.waterMarkView then
		arg_37_0:showWaterMark()
	end

	if arg_37_1 then
		arg_37_0.waterMarkView:showWaterMark()
	else
		arg_37_0.waterMarkView:hideWaterMark()
	end
end

function var_0_0.getPreFeedBackTime(arg_38_0)
	return arg_38_0._preCommitFeedBackTime
end

function var_0_0.setPreFeedBackTime(arg_39_0)
	arg_39_0._preCommitFeedBackTime = Time.time
end

function var_0_0.setMainThumbnail(arg_40_0, arg_40_1)
	arg_40_0._mainThumbnail = arg_40_1
end

function var_0_0.GMSetMainThumbnail(arg_41_0)
	if isDebugBuild and PlayerPrefsHelper.getNumber(PlayerPrefsKey.GMToolViewOpenMainThumbnail, 0) == 1 then
		arg_41_0._mainThumbnail = false
