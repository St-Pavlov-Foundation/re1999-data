...
function slot0.onInitView(slot0)
	...
	slot0._txtevent = gohelper.findChildText(slot0.viewGO, "Content/#go_event/#go_item1/#txt_event")
...
function slot0.refreshResultContent(slot0, slot1, slot2)
	...
	gohelper.findChildText(slot1, "#txt_event").text = table.concat(slot2.contents, "\n")
