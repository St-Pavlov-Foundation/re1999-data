...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtdetaildec = gohelper.findChildText(arg_1_0.viewGO, "#go_detail/#txt_talentdec")
...
function var_0_0._refreshDetail(arg_16_0, arg_16_1, arg_16_2)
	...
	if not var_16_0 then
		...
		if var_16_2 then
			...
			arg_16_0._txtlocked2.text = GameUtil.getSubPlaceholderLuaLang(luaLang("rouge_talenttree_origin"), var_16_5)
		else
