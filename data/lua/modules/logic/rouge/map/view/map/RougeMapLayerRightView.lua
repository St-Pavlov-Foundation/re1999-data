...
function slot0.onInitView(slot0)
	...
	slot0._gopic = gohelper.findChild(slot0.viewGO, "#go_layer_right/#go_pic")
	slot0.simagelayerbg = gohelper.findChildSingleImage(slot0.viewGO, "#go_layer_right/#go_pic/#simage_picbg")
	slot0.simagelayerpic = gohelper.findChildSingleImage(slot0.viewGO, "#go_layer_right/#go_pic/#simage_pic")
