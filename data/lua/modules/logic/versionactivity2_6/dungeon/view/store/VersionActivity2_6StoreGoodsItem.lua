...
slot0 = class("VersionActivity2_6StoreGoodsItem", ListScrollCell)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.goodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.goodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_6Enum.ActivityId.DungeonStore, slot0.goodsCo.id)
...
function slot0.refreshRareBg(slot0)
	UISpriteSetMgr.instance:setV2a6MainActivitySprite(slot0.imageRare, "v2a6_store_quality_" .. slot0.rare)
