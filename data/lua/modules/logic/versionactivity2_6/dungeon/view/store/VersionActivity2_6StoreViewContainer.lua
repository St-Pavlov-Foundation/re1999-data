...
slot0 = class("VersionActivity2_6StoreViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivity2_6StoreGoodsItem
	...
	return {
		...
		LuaListScrollView.New(VersionActivity2_6StoreListModel.instance, slot1),
