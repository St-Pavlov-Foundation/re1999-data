...
local var_0_0 = class("VersionActivity2_6StoreTalk", BaseView)
...
function var_0_0._editableInitView(arg_6_0)
	...
	arg_6_0.actId = VersionActivity2_6Enum.ActivityId.DungeonStore
...
function var_0_0.onOpenFinish(arg_19_0)
	if arg_19_0.isFirstEnter then
		...
		local var_19_0 = PlayerModel.instance:getPlayerPrefsKey(PlayerPrefsKey.Version2_6PlayedStoreGroupIdKey)
...
function var_0_0.initGroupCo(arg_20_0)
	...
	local var_20_1 = PlayerModel.instance:getPlayerPrefsKey(PlayerPrefsKey.Version2_6PlayedStoreGroupIdKey)
	local var_20_2 = {}
