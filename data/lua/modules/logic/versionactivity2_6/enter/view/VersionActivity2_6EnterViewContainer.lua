...
slot0 = class("VersionActivity2_6EnterViewContainer", BaseViewContainer)
...
function slot0.buildTabViews(slot0, slot1)
	...
	elseif slot1 == 2 then
		slot2 = {
			[#slot2 + 1] = VersionActivity2_6DungeonEnterView.New(),
			[#slot2 + 1] = DiceHeroEnterView.New(),
			[#slot2 + 1] = V2a6_XugoujiEnterView.New(),
			[#slot2 + 1] = VersionActivity2_6RougeEnterView.New(),
			[#slot2 + 1] = V1a6_BossRush_EnterView.New(),
			[#slot2 + 1] = RoleStoryEnterView.New(),
			[#slot2 + 1] = V2a6_Season166EnterView.New(),
			[#slot2 + 1] = ActivityWeekWalkDeepShowView.New(),
			[#slot2 + 1] = TowerMainEntryView.New(),
			[#slot2 + 1] = ActivityWeekWalkHeartShowView.New()
		}
