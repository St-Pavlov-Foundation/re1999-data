...
local var_0_0 = class("VersionActivity2_6EnterViewContainer", BaseViewContainer)
...
function var_0_0.buildTabViews(arg_2_0, arg_2_1)
	...
	elseif arg_2_1 == 2 then
		...
		var_2_0[#var_2_0 + 1] = VersionActivity2_6DungeonEnterView.New()
		var_2_0[#var_2_0 + 1] = DiceHeroEnterView.New()
		var_2_0[#var_2_0 + 1] = V2a6_XugoujiEnterView.New()
		var_2_0[#var_2_0 + 1] = VersionActivity2_6RougeEnterView.New()
		var_2_0[#var_2_0 + 1] = V1a6_BossRush_EnterView.New()
		var_2_0[#var_2_0 + 1] = RoleStoryEnterView.New()
		var_2_0[#var_2_0 + 1] = V2a6_Season166EnterView.New()
