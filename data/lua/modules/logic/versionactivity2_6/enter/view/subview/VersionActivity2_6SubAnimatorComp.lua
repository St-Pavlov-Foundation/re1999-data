module("modules.logic.versionactivity2_6.enter.view.subview.VersionActivity2_6SubAnimatorComp", package.seeall)

slot0 = class("VersionActivity2_6SubAnimatorComp", VersionActivitySubAnimatorComp)
