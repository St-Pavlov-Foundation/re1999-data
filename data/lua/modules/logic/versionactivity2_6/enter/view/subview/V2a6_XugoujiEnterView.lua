...
slot0 = class("V2a6_XugoujiEnterView", VersionActivityEnterBaseSubView)

function slot0.onInitView(slot0)
	slot0._txtLimitTime = gohelper.findChildTextMesh(slot0.viewGO, "Right/image_LimitTimeBG/#txt_LimitTime")
...
function slot0._editableInitView(slot0)
	slot0.actCo = ActivityConfig.instance:getActivityCo(VersionActivity2_6Enum.ActivityId.Xugouji)
...
function slot0._refreshTime(slot0)
	if ActivityModel.instance:getActivityInfo()[VersionActivity2_6Enum.ActivityId.Xugouji] then
		...
		slot3 = ActivityHelper.getActivityStatus(VersionActivity2_6Enum.ActivityId.Xugouji) ~= ActivityEnum.ActivityStatus.Normal
