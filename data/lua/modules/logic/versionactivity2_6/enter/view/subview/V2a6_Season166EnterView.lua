module("modules.logic.versionactivity2_6.enter.view.subview.V2a6_Season166EnterView", package.seeall)

slot0 = class("V2a6_Season166EnterView", VersionActivityEnterBaseSubView)
...
function slot0.onOpen(slot0)
	...
	slot0.actId = VersionActivity2_6Enum.ActivityId.Season
