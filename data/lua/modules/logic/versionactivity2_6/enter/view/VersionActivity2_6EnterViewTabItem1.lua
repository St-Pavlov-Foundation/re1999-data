module("modules.logic.versionactivity2_6.enter.view.VersionActivity2_6EnterViewTabItem1", package.seeall)

slot0 = class("VersionActivity2_6EnterViewTabItem1", VersionActivity2_6EnterViewTabItemBase)
...
function slot0.afterSetData(slot0)
	...
	slot1 = VersionActivity2_6Enum.TabSetting
