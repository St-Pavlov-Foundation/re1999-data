...
slot0 = class("VersionActivity2_6EnterView", VersionActivityEnterBaseViewWithListNew)
slot1 = 2.1
...
function slot0._editableInitView(slot0)
	...
	slot0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.First, slot0._gotabitem1, VersionActivity2_6EnterViewTabItem1)
	slot0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.Second, slot0._gotabitem2, VersionActivity2_6EnterViewTabItem2)
...
function slot0._onTabScrollChange(slot0)
	for slot5, slot6 in ipairs(slot0.activityTabItemList) do
		if slot6:isShowRedDot() and slot0.viewPortHeight < -slot6:getAnchorY() + VersionActivity2_6Enum.RedDotOffsetY - recthelper.getAnchorY(slot0.rectTrContent) then
...
function slot0.refreshBtnVisible(slot0, slot1)
	gohelper.setActive(slot0.goReplayBtn, VersionActivity2_6EnterHelper.GetIsShowReplayBtn(slot0.curActId))
	gohelper.setActive(slot0.goAchievementBtn, VersionActivity2_6EnterHelper.GetIsShowAchievementBtn(slot0.curActId))
end
