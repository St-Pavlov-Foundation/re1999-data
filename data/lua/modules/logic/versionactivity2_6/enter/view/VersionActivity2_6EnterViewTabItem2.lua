...
slot0 = class("VersionActivity2_6EnterViewTabItem2", VersionActivity2_6EnterViewTabItemBase)
...
function slot0.childRefreshSelect(slot0, slot1)
	...
	slot2 = VersionActivity2_6Enum.TabSetting.unselect

	if slot0.isSelect then
		slot2 = VersionActivity2_6Enum.TabSetting.select
	end
