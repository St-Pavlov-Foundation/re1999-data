...
slot0 = class("DiceHeroTaskListModel", ListScrollModel)

function slot0.init(slot0)
	slot2 = {}
	slot3 = 0

	if TaskModel.instance:getAllUnlockTasks(TaskEnum.TaskType.DiceHero) ~= nil then
		for slot8, slot9 in ipairs(DiceHeroConfig.instance:getTaskList()) do
			slot10 = DiceHeroTaskMo.New()
