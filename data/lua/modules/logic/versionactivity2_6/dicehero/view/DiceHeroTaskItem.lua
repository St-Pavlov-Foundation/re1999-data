...
slot0 = class("DiceHeroTaskItem", ListScrollCellExtend)
...
function slot0._btnnotfinishbgOnClick(slot0)
	if slot0._taskMO.config.jumpId > 0 and GameFacade.jump(slot0._taskMO.config.jumpId) then
...
function slot0._editableAddEvents(slot0)
	DiceHeroController.instance:registerCallback(DiceHeroEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end

function slot0._editableRemoveEvents(slot0)
	DiceHeroController.instance:unregisterCallback(DiceHeroEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end

function slot0._onOneClickClaimReward(slot0)
	if slot0._taskMO and slot0._taskMO:alreadyGotReward() then
...
function slot0.onUpdateMO(slot0, slot1)
	...
	slot0:_refreshUI()
	slot0:_moveByRankDiff(DiceHeroTaskListModel.instance:getRankDiff(slot1))
end
...
slot0.prefabPath = "ui/viewres/versionactivity_2_6/dicehero/v2a6_dicehero_taskitem.prefab"
