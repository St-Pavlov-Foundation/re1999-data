...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(ActivityController.instance, ActivityEvent.RefreshActivityState, slot0.onActStateChange, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(ActivityController.instance, ActivityEvent.RefreshActivityState, slot0.onActStateChange, slot0)
...
function slot0.isShowRoot(slot0)
	if ActivityHelper.isOpen(VersionActivity2_6Enum.ActivityId.DiceHero) and OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.DiceHero) and slot0.chapterId == DungeonEnum.ChapterId.Main1_9 then
		return true
	end
end
