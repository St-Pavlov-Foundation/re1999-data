-- chunkname: @modules/logic/versionactivity3_2/enter/view/subview/VersionActivity3_2DungeonEnterView.lua

module("modules.logic.versionactivity3_2.enter.view.subview.VersionActivity3_2DungeonEnterView", package.seeall)

local VersionActivity3_2DungeonEnterView = class("VersionActivity3_2DungeonEnterView", VersionActivityFixedDungeonEnterView)

function VersionActivity3_2DungeonEnterView:onInitView()
...
function VersionActivity3_2DungeonEnterView:addEvents()
	VersionActivity3_2DungeonEnterView.super.addEvents(self)
...
function VersionActivity3_2DungeonEnterView:removeEvents()
	VersionActivity3_2DungeonEnterView.super.removeEvents(self)
...
function VersionActivity3_2DungeonEnterView:_editableInitView()
	VersionActivity3_2DungeonEnterView.super._editableInitView(self)
...
function VersionActivity3_2DungeonEnterView:onDestroyView()
	VersionActivity3_2DungeonEnterView.super.onDestroyView(self)
...
function VersionActivity3_2DungeonEnterView:onOpenFinish()
	self._videoPath = langVideoUrl(VersionActivity3_2Enum.EnterLoopVideoName)
...
function VersionActivity3_2DungeonEnterView:_setVideoAsLastSibling()
	local container = ViewMgr.instance:getContainer(ViewName.FullScreenVideoView)
...
function VersionActivity3_2DungeonEnterView:playLogoAnim(animName)
...
function VersionActivity3_2DungeonEnterView:refreshUI()
	VersionActivity3_2DungeonEnterView.super.refreshUI(self)
	self:refreshPaperCount()
end

function VersionActivity3_2DungeonEnterView:_onGetTaskBonus()
	CommandStationRpc.instance:sendGetCommandPostInfoRequest()
end

function VersionActivity3_2DungeonEnterView:refreshPaperCount()
	local finishCount = 0
	local totalCount = 0
...
return VersionActivity3_2DungeonEnterView
