...
function slot0._inOpenTime(slot0)
	...
	return slot0.isOffline == 0 and (string.nilorempty(slot0.onlineTime) and slot1 or TimeUtil.stringToTimestamp(slot0.onlineTime) - ServerTime.clientToServerOffset()) <= slot1 and slot1 <= (string.nilorempty(slot0.offlineTime) and slot1 or TimeUtil.stringToTimestamp(slot0.offlineTime) - ServerTime.clientToServerOffset())
end
...
function slot0.checkMonthCardLevelUpTagOpen()
	...
	return slot0 <= (string.nilorempty(CommonConfig.instance:getConstStr(ConstEnum.MonthCardLevelUpTime)) and slot0 or TimeUtil.stringToTimestamp(slot1) - ServerTime.clientToServerOffset())
end
