...
function var_0_0._inOpenTime(arg_2_0)
	...
	local var_2_1 = string.nilorempty(arg_2_0.onlineTime) and var_2_0 or TimeUtil.stringToTimestamp(arg_2_0.onlineTime) - ServerTime.clientToServerOffset()
	local var_2_2 = string.nilorempty(arg_2_0.offlineTime) and var_2_0 or TimeUtil.stringToTimestamp(arg_2_0.offlineTime) - ServerTime.clientToServerOffset()

	return arg_2_0.isOffline == 0 and var_2_1 <= var_2_0 and var_2_0 <= var_2_2
end
...
function var_0_0.checkMonthCardLevelUpTagOpen()
	...
	return var_6_0 <= (string.nilorempty(var_6_1) and var_6_0 or TimeUtil.stringToTimestamp(var_6_1) - ServerTime.clientToServerOffset())
end
