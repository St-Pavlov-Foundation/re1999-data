...
function var_0_0._updateActivityStore(arg_11_0)
	...
	gohelper.setActive(arg_11_0._goremain, false)
...
function var_0_0._refreshSkinDesc(arg_13_0, arg_13_1, arg_13_2)
	...
	if var_13_0 > 0 then
		...
		gohelper.setActive(arg_13_0._goremain, true)
...
function var_0_0.onClickIcon(arg_23_0)
	if not arg_23_0.skinCo then
		return
	end

	MaterialTipController.instance:showMaterialInfo(MaterialEnum.MaterialType.HeroSkin, arg_23_0.skinCo.id, false, nil, false)
end
...
function var_0_0.onDestroyView(arg_25_0)
	arg_25_0._simageleftbg:UnLoadImage()
	arg_25_0._simagerightbg:UnLoadImage()
	arg_25_0._simagedreesing:UnLoadImage()

	if arg_25_0._skinSpine then
		arg_25_0._skinSpine:doClear()

		arg_25_0._skinSpine = nil
	end

	if arg_25_0._skinSpine2 then
		arg_25_0._skinSpine2:doClear()

		arg_25_0._skinSpine2 = nil
	end
end
