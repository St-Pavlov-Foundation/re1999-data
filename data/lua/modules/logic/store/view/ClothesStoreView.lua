...
function var_0_0.refreshChargeInfo(arg_36_0, arg_36_1, arg_36_2)
	...
	local var_36_4 = StoreModel.instance:isSkinGoodsCanRepeatBuy(arg_36_1)
	local var_36_5 = arg_36_1:alreadyHas() and not var_36_4

	gohelper.setActive(arg_36_0.btnBuy, not var_36_5)
	gohelper.setActive(arg_36_0.goHasget, var_36_5)
	gohelper.setActive(arg_36_0.goSkinTips, var_36_4)

	if var_36_4 then
		gohelper.setActive(arg_36_0.goSkinTips, true)

		local var_36_6 = string.splitToNumber(arg_36_2.compensate, "#")
		local var_36_7 = luaLang("storeskinview_skintips")
		local var_36_8 = string.format("<sprite=2>%s", var_36_6[3])

		arg_36_0.txtPropNum.text = GameUtil.getSubPlaceholderLuaLangOneParam(var_36_7, var_36_8)
	end

	local var_36_9 = 0

	if not string.nilorempty(arg_36_1.config.deductionItem) then
		local var_36_10 = GameUtil.splitString2(arg_36_1.config.deductionItem, true)

		var_36_9 = ItemModel.instance:getItemCount(var_36_10[1][2])
		arg_36_0.txtCostDeduction.text = -var_36_10[2][1]
	end

	gohelper.setActive(arg_36_0.goCostDeduction, var_36_9 > 0)
end
