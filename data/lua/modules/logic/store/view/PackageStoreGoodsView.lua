...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtDailyReleaseDesc1 = gohelper.findChildText(arg_1_0._godailyrelease, "desc/txt")
	arg_1_0._txtDailyReleaseDesc2 = gohelper.findChildText(arg_1_0._godailyrelease, "desc/txt (1)")
...
function var_0_0.onOpen(arg_10_0)
	...
	gohelper.setActive(arg_10_0._goSecondGoodsName, arg_10_0._mo.config.id == var_0_1)
...
function var_0_0._refreshPriceArea(arg_11_0)
	...
	elseif arg_11_0._mo.isChargeGoods then
		arg_11_0._txtmaterialNum.text = string.format("%s<indent=33>%s", StoreModel.instance:getCostStr(var_11_0))
		arg_11_0._txtprice.text = string.format("%s<indent=33>%s", StoreModel.instance:getCostStr(arg_11_0._mo.config.originalCost))

		gohelper.setActive(arg_11_0._imagematerial.gameObject, false)
	else
		local var_11_1 = string.split(var_11_0, "|")
		local var_11_2 = var_11_1[arg_11_0._mo.buyCount + 1] or var_11_1[#var_11_1]
		local var_11_3 = string.splitToNumber(var_11_2, "#")

		arg_11_0._costType = var_11_3[1]
		arg_11_0._costId = var_11_3[2]
		arg_11_0._costQuantity = var_11_3[3]

		local var_11_4, var_11_5 = ItemModel.instance:getItemConfigAndIcon(arg_11_0._costType, arg_11_0._costId)
		local var_11_6 = var_11_4.icon
		local var_11_7 = string.format("%s_1", var_11_6)

		UISpriteSetMgr.instance:setCurrencyItemSprite(arg_11_0._imagematerial, var_11_7)
...
function var_0_0._updateNormal(arg_13_0)
	...
	local var_13_1 = gohelper.findChild(arg_13_0._gonormal, "info/remain/#go_rightbg")
	local var_13_2 = gohelper.findChildText(arg_13_0._gonormal, "info/remain/#go_rightbg/#txt_remaintime")

	if arg_13_0._mo.offlineTime > 0 then
		local var_13_3 = math.floor(arg_13_0._mo.offlineTime - ServerTime.now())

		gohelper.setActive(var_13_1, true)

		var_13_2.text = string.format("%s%s", TimeUtil.secondToRoughTime(var_13_3))
	else
		gohelper.setActive(var_13_1, false)
	end

	local var_13_4 = gohelper.findChild(arg_13_0._gonormal, "info/remain/#go_leftbg")
	local var_13_5 = gohelper.findChildText(arg_13_0._gonormal, "info/remain/#go_leftbg/#txt_remain")
	local var_13_6 = gohelper.findChild(arg_13_0._gonormal, "info/remain")

	arg_13_0:_updateNormalPackCommon(var_13_4, var_13_5, var_13_6)

	local var_13_7 = gohelper.findChild(arg_13_0._gonormal, "info/scroll/#scroll_product/product")
	local var_13_8 = gohelper.findChild(arg_13_0._gonormal, "info/scroll/#scroll_product/Viewport/Content")

	gohelper.setActive(var_13_7, false)
	arg_13_0:_updateNormalPackGoods(var_13_7, var_13_8)
end
...
function var_0_0._updateDetailDescNormalPack(arg_14_0)
	...
	local var_14_1 = gohelper.findChildText(arg_14_0._goDetailDescNormal, "info/remain/#go_rightbg/#txt_remaintime")
	local var_14_2 = gohelper.findChild(arg_14_0._goDetailDescNormal, "info/remain/#go_rightbg")

	if arg_14_0._mo.offlineTime > 0 then
		local var_14_3 = math.floor(arg_14_0._mo.offlineTime - ServerTime.now())

		gohelper.setActive(var_14_2, true)

		var_14_1.text = string.format("%s%s", TimeUtil.secondToRoughTime(var_14_3))
	else
		gohelper.setActive(var_14_2, false)
	end

	local var_14_4 = gohelper.findChild(arg_14_0._goDetailDescNormal, "info/remain")
	local var_14_5 = gohelper.findChild(arg_14_0._goDetailDescNormal, "info/remain/#go_leftbg")
	local var_14_6 = gohelper.findChildText(arg_14_0._goDetailDescNormal, "info/remain/#go_leftbg/#txt_remain")

	arg_14_0:_updateNormalPackCommon(var_14_5, var_14_6, var_14_4)

	local var_14_7 = gohelper.findChild(arg_14_0._goDetailDescNormal, "info/scroll/#scroll_product/product")
	local var_14_8 = gohelper.findChild(arg_14_0._goDetailDescNormal, "info/scroll/#scroll_product/Viewport/Content")

	gohelper.setActive(var_14_7, false)
	arg_14_0:_updateNormalPackGoods(var_14_7, var_14_8)

	local var_14_9 = gohelper.findChild(arg_14_0._goDetailDescNormal, "info/desc/info/txt")
	local var_14_10 = arg_14_0._mo.config.detailDesc
	local var_14_11 = string.split(var_14_10, "\n")

	gohelper.CreateObjList(nil, function(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
		gohelper.findChildText(arg_15_1, "").text = arg_15_2
	end, var_14_11, nil, var_14_9)
...
function var_0_0._updateDailyReleasePackage(arg_21_0, arg_21_1)
	...
	local var_21_0 = StoreConfig.instance:getDailyReleasePackageCfg(arg_21_0._mo.goodsId)
	local var_21_1 = var_21_0.days
	local var_21_2 = string.split(var_21_0.onceBonus, "|")
	local var_21_3 = string.splitToNumber(var_21_2[1], "#")
	local var_21_4 = var_21_3[1]
	local var_21_5 = var_21_3[2]
	local var_21_6 = var_21_3[3]
	...
	arg_21_0:_setIcon(arg_21_0._dailyReleasePackageIcon, var_21_4, var_21_5, var_21_6)

	if #var_21_2 > 1 then
		local var_21_7 = var_21_2[2]
		local var_21_8 = string.splitToNumber(var_21_7, "#")
		local var_21_9 = var_21_8[1]
		local var_21_10 = var_21_8[2]
		local var_21_11 = var_21_8[3]
		...
		arg_21_0:_setIcon(arg_21_0._dailyReleasePackageIcon2, var_21_9, var_21_10, var_21_11)
	end

	local var_21_12 = string.split(var_21_0.dailyBonus, "|")[1]
	local var_21_13 = string.splitToNumber(var_21_12, "#")
	local var_21_14 = var_21_13[1]
	local var_21_15 = var_21_13[2]
	local var_21_16 = var_21_13[3]
	...
	arg_21_0:_setIcon(arg_21_0._dailyReleasePackageDailyItemIcon1, var_21_14, var_21_15, var_21_16 * var_21_1)

	local var_21_17 = string.split(var_21_0.dailyBonus, "|")[2]
	local var_21_18 = string.splitToNumber(var_21_17, "#")
	local var_21_19 = var_21_18[1]
	local var_21_20 = var_21_18[2]
	local var_21_21 = var_21_18[3]
	...
	arg_21_0:_setIcon(arg_21_0._dailyReleasePackageDailyItemIcon2, var_21_19, var_21_20, var_21_21 * var_21_1)

	arg_21_0._txtDailyReleaseDesc1.text = var_21_0.desc1
	arg_21_0._txtDailyReleaseDesc2.text = var_21_0.desc2
end
