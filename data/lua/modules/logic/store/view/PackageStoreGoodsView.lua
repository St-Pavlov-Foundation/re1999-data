...
function var_0_0.onOpen(arg_9_0)
	...
	gohelper.setActive(arg_9_0._goSecondGoodsName, arg_9_0._mo.config.id == var_0_1)
...
function var_0_0._refreshPriceArea(arg_10_0)
	...
	elseif arg_10_0._mo.isChargeGoods then
		arg_10_0._txtmaterialNum.text = string.format("%s<indent=33>%s", StoreModel.instance:getCostStr(var_10_0))
		arg_10_0._txtprice.text = string.format("%s<indent=33>%s", StoreModel.instance:getCostStr(arg_10_0._mo.config.originalCost))

		gohelper.setActive(arg_10_0._imagematerial.gameObject, false)
	else
		local var_10_1 = string.split(var_10_0, "|")
		local var_10_2 = var_10_1[arg_10_0._mo.buyCount + 1] or var_10_1[#var_10_1]
		local var_10_3 = string.splitToNumber(var_10_2, "#")

		arg_10_0._costType = var_10_3[1]
		arg_10_0._costId = var_10_3[2]
		arg_10_0._costQuantity = var_10_3[3]

		local var_10_4, var_10_5 = ItemModel.instance:getItemConfigAndIcon(arg_10_0._costType, arg_10_0._costId)
		local var_10_6 = var_10_4.icon
		local var_10_7 = string.format("%s_1", var_10_6)

		UISpriteSetMgr.instance:setCurrencyItemSprite(arg_10_0._imagematerial, var_10_7)
...
function var_0_0._updateNormal(arg_12_0)
	...
	local var_12_1 = gohelper.findChild(arg_12_0._gonormal, "info/remain/#go_rightbg")
	local var_12_2 = gohelper.findChildText(arg_12_0._gonormal, "info/remain/#go_rightbg/#txt_remaintime")

	if arg_12_0._mo.offlineTime > 0 then
		local var_12_3 = math.floor(arg_12_0._mo.offlineTime - ServerTime.now())

		gohelper.setActive(var_12_1, true)

		var_12_2.text = string.format("%s%s", TimeUtil.secondToRoughTime(var_12_3))
	else
		gohelper.setActive(var_12_1, false)
	end

	local var_12_4 = gohelper.findChild(arg_12_0._gonormal, "info/remain/#go_leftbg")
	local var_12_5 = gohelper.findChildText(arg_12_0._gonormal, "info/remain/#go_leftbg/#txt_remain")
	local var_12_6 = gohelper.findChild(arg_12_0._gonormal, "info/remain")

	arg_12_0:_updateNormalPackCommon(var_12_4, var_12_5, var_12_6)

	local var_12_7 = gohelper.findChild(arg_12_0._gonormal, "info/scroll/#scroll_product/product")
	local var_12_8 = gohelper.findChild(arg_12_0._gonormal, "info/scroll/#scroll_product/Viewport/Content")

	gohelper.setActive(var_12_7, false)
	arg_12_0:_updateNormalPackGoods(var_12_7, var_12_8)
end
...
function var_0_0._updateDetailDescNormalPack(arg_13_0)
	...
	local var_13_1 = gohelper.findChildText(arg_13_0._goDetailDescNormal, "info/remain/#go_rightbg/#txt_remaintime")
	local var_13_2 = gohelper.findChild(arg_13_0._goDetailDescNormal, "info/remain/#go_rightbg")
	...
	if arg_13_0._mo.offlineTime > 0 then
		...
		var_13_1.text = string.format("%s%s", TimeUtil.secondToRoughTime(var_13_3))
	else
		gohelper.setActive(var_13_2, false)
	end

	local var_13_4 = gohelper.findChild(arg_13_0._goDetailDescNormal, "info/remain")
	local var_13_5 = gohelper.findChild(arg_13_0._goDetailDescNormal, "info/remain/#go_leftbg")
	local var_13_6 = gohelper.findChildText(arg_13_0._goDetailDescNormal, "info/remain/#go_leftbg/#txt_remain")

	arg_13_0:_updateNormalPackCommon(var_13_5, var_13_6, var_13_4)

	local var_13_7 = gohelper.findChild(arg_13_0._goDetailDescNormal, "info/scroll/#scroll_product/product")
	local var_13_8 = gohelper.findChild(arg_13_0._goDetailDescNormal, "info/scroll/#scroll_product/Viewport/Content")

	gohelper.setActive(var_13_7, false)
	arg_13_0:_updateNormalPackGoods(var_13_7, var_13_8)

	local var_13_9 = gohelper.findChild(arg_13_0._goDetailDescNormal, "info/desc/info/txt")
	local var_13_10 = arg_13_0._mo.config.detailDesc
	local var_13_11 = string.split(var_13_10, "\n")

	gohelper.CreateObjList(nil, function(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
		gohelper.findChildText(arg_14_1, "").text = arg_14_2
	end, var_13_11, nil, var_13_9)
...
function var_0_0._updateDailyReleasePackage(arg_20_0, arg_20_1)
	...
	local var_20_0 = StoreConfig.instance:getDailyReleasePackageCfg(arg_20_0._mo.goodsId)
	local var_20_1 = var_20_0.days
	local var_20_2 = string.split(var_20_0.onceBonus, "|")
	local var_20_3 = string.splitToNumber(var_20_2[1], "#")
	local var_20_4 = var_20_3[1]
	local var_20_5 = var_20_3[2]
	local var_20_6 = var_20_3[3]
	...
	arg_20_0:_setIcon(arg_20_0._dailyReleasePackageIcon, var_20_4, var_20_5, var_20_6)

	if #var_20_2 > 1 then
		local var_20_7 = var_20_2[2]
		local var_20_8 = string.splitToNumber(var_20_7, "#")
		local var_20_9 = var_20_8[1]
		local var_20_10 = var_20_8[2]
		local var_20_11 = var_20_8[3]
		...
		arg_20_0:_setIcon(arg_20_0._dailyReleasePackageIcon2, var_20_9, var_20_10, var_20_11)
	end

	local var_20_12 = string.split(var_20_0.dailyBonus, "|")[1]
	local var_20_13 = string.splitToNumber(var_20_12, "#")
	local var_20_14 = var_20_13[1]
	local var_20_15 = var_20_13[2]
	...
	arg_20_0:_setIcon(arg_20_0._dailyReleasePackageDailyItemIcon1, var_20_14, var_20_15, var_20_16 * var_20_1)

	local var_20_17 = string.split(var_20_0.dailyBonus, "|")[2]
	local var_20_18 = string.splitToNumber(var_20_17, "#")
	local var_20_19 = var_20_18[1]
	local var_20_20 = var_20_18[2]
	local var_20_21 = var_20_18[3]
	...
	arg_20_0:_setIcon(arg_20_0._dailyReleasePackageDailyItemIcon2, var_20_19, var_20_20, var_20_21 * var_20_1)

	arg_20_0._txtDailyReleaseDesc1.text = var_20_0.desc1
	arg_20_0._txtDailyReleaseDesc2.text = var_20_0.desc2
end
