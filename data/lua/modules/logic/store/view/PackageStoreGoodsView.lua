...
function slot0.onInitView(slot0)
	...
	slot0._txtDailyReleaseDesc1 = gohelper.findChildText(slot0._godailyrelease, "desc/txt")
	slot0._txtDailyReleaseDesc2 = gohelper.findChildText(slot0._godailyrelease, "desc/txt (1)")
...
function slot0.onOpen(slot0)
	...
	gohelper.setActive(slot0._goSecondGoodsName, slot0._mo.config.id == uv3)
...
function slot0._refreshPriceArea(slot0)
	...
	elseif slot0._mo.isChargeGoods then
		slot0._txtmaterialNum.text = string.format("%s<indent=33>%s", StoreModel.instance:getCostStr(slot1))
		slot0._txtprice.text = string.format("%s<indent=33>%s", StoreModel.instance:getCostStr(slot0._mo.config.originalCost))
