-- chunkname: @modules/logic/store/view/decorate/DecorateStoreGoodsViewContainer.lua

module("modules.logic.store.view.decorate.DecorateStoreGoodsViewContainer", package.seeall)
