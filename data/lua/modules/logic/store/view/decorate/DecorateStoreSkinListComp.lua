-- chunkname: @modules/logic/store/view/decorate/DecorateStoreSkinListComp.lua

module("modules.logic.store.view.decorate.DecorateStoreSkinListComp", package.seeall)
