-- chunkname: @modules/logic/store/view/decorate/DecorateStoreGoodsBuyViewContainer.lua

module("modules.logic.store.view.decorate.DecorateStoreGoodsBuyViewContainer", package.seeall)
