-- chunkname: @modules/logic/store/view/decorate/DecorateStoreGoodsBuyView.lua

module("modules.logic.store.view.decorate.DecorateStoreGoodsBuyView", package.seeall)
