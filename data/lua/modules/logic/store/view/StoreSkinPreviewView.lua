...
function slot0.onInitView(slot0)
	...
	slot0._btnshowDetail = gohelper.findChildButtonWithAudio(slot0.viewGO, "desc/#btn_showDetail")
...
function slot0._btnvideoOnClick(slot0)
	...
	WebViewController.instance:openWebView(WebViewController.instance:getVideoUrl(slot0.skinCo.characterId), false, nil, , 0, nil, 0, 0, nil, true)
end
