...
function slot0._refreshTabsItem(slot0)
	...
	for slot7 = 1, #slot1 do
		slot0:_refreshSecondTabs(slot7, slot1[slot7])
		gohelper.setActive(slot0._categoryItemContainer[slot7].go, true)
	...
	for slot7 = #slot1 + 1, #slot0._categoryItemContainer do
		...
		gohelper.destroy(slot0._categoryItemContainer[slot7].go)

		slot0._categoryItemContainer[slot7] = nil
	end

	slot4 = -300 * (slot0._nowIndex - 5) - 50
	...
	elseif slot4 < slot6 then
		recthelper.setAnchorX(slot0._categorycontentTrans, slot4)
	end
