...
function var_0_0._refreshTabsItem(arg_21_0)
	...
	for iter_21_2 = 1, #var_21_0 do
		local var_21_3 = var_21_0[iter_21_2]

		table.insert(arg_21_0._tabIdList, var_21_3.id)
		arg_21_0:_refreshSecondTabs(iter_21_2, var_21_3)
	...
	local var_21_4 = -300 * (arg_21_0._nowIndex - 5) - 50
	local var_21_5 = -300 * (arg_21_0._nowIndex - 1)
	local var_21_6 = recthelper.getAnchorX(arg_21_0._categorycontentTrans)

	if var_21_6 < var_21_5 then
		recthelper.setAnchorX(arg_21_0._categorycontentTrans, var_21_5)
	elseif var_21_4 < var_21_6 then
		recthelper.setAnchorX(arg_21_0._categorycontentTrans, var_21_4)
	end
