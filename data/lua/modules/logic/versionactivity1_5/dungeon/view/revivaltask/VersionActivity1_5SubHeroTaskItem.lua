...
function slot0.refreshFinishedUI(slot0)
	...
	slot0._txtdes.text = GameUtil.getBriefName(slot0.config.desc .. slot0.config.descSuffix, VersionActivity1_5DungeonEnum.HeroTaskDescShowCount, VersionActivity1_5DungeonEnum.Suffix)
