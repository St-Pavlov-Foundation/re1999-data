...
function var_0_0.refreshFinishedUI(arg_10_0)
	...
	arg_10_0._txtdes.text = GameUtil.getBriefName(arg_10_0.config.desc .. arg_10_0.config.descSuffix, VersionActivity1_5DungeonEnum.HeroTaskDescShowCount, VersionActivity1_5DungeonEnum.Suffix)
