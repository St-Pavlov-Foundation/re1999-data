...
function var_0_0.refreshCostTime(arg_23_0)
	...
	local var_23_8 = string.format("%s%s%s%s%s%s%s", luaLang("dispatch_cost_time"), var_23_4, luaLang("time_hour"), var_23_6, luaLang("time_minute"), var_23_7, luaLang("time_second"))
