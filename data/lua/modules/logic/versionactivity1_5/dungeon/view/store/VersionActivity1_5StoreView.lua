...
local var_0_0 = class("VersionActivity1_5StoreView", BaseView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0._simagebg:LoadImage("singlebg/v1a5_enterview_singlebg/v1a5_store_fullbg.png")
	gohelper.setActive(arg_4_0._gostoreItem, false)

	arg_4_0.actId = VersionActivity1_5Enum.ActivityId.DungeonStore
...
function var_0_0.refreshStoreContent(arg_8_0)
	local var_8_0 = ActivityStoreConfig.instance:getActivityStoreGroupDict(VersionActivity1_5Enum.ActivityId.DungeonStore)
	local var_8_1
	...
	for iter_8_0 = 1, #var_8_0 do
		...
		if not var_8_2 then
			var_8_2 = VersionActivity1_5StoreItem.New()
...
function var_0_0.refreshTime(arg_11_0)
	local var_11_0 = ActivityModel.instance:getActivityInfo()[VersionActivity1_5Enum.ActivityId.DungeonStore]:getRealEndTimeStamp() - ServerTime.now()
	...
	if var_11_1 >= 1 then
		arg_11_0._txttime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_11_1, luaLang("time_day"), var_11_3, luaLang("time_hour2")))

		return
	end

	if var_11_3 >= 1 then
		arg_11_0._txttime.text = string.format(luaLang("remain"), var_11_3 .. luaLang("time_hour2"))

		return
	end

	local var_11_4 = var_11_2 % TimeUtil.OneHourSecond
	local var_11_5 = Mathf.Floor(var_11_4 / TimeUtil.OneMinuteSecond)

	if var_11_5 >= 1 then
		arg_11_0._txttime.text = string.format(luaLang("remain"), var_11_5 .. luaLang("time_minute2"))

		return
	end

	arg_11_0._txttime.text = string.format(luaLang("remain"), "<1" .. luaLang("time_minute2"))
end
