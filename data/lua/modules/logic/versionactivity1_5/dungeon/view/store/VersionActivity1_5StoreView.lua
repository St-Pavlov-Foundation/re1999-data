...
slot0 = class("VersionActivity1_5StoreView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage("singlebg/v1a5_enterview_singlebg/v1a5_store_fullbg.png")
	gohelper.setActive(slot0._gostoreItem, false)

	slot0.actId = VersionActivity1_5Enum.ActivityId.DungeonStore
...
function slot0.refreshStoreContent(slot0)
	...
	for slot6 = 1, #ActivityStoreConfig.instance:getActivityStoreGroupDict(VersionActivity1_5Enum.ActivityId.DungeonStore) do
		if not slot0.storeItemList[slot6] then
			slot2 = VersionActivity1_5StoreItem.New()
...
function slot0.refreshTime(slot0)
	slot2 = ActivityModel.instance:getActivityInfo()[VersionActivity1_5Enum.ActivityId.DungeonStore]:getRealEndTimeStamp() - ServerTime.now()
