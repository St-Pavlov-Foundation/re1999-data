...
local var_0_0 = class("VersionActivity1_5DungeonMapLevelView", BaseView)
...
function var_0_0.initLocalEpisodeMode(arg_27_0)
	arg_27_0.unlockedEpisodeModeDict = arg_27_0:loadDict(VersionActivity1_5EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode))
	arg_27_0.lastEpisodeSelectModeDict = arg_27_0:loadDict(VersionActivity1_5EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode))
end
...
function var_0_0.refreshEye(arg_29_0)
	...
	local var_29_0 = arg_29_0.originEpisodeConfig.chapterId == VersionActivity1_5DungeonEnum.DungeonChapterId.LeiMiTeBeiHard
...
function var_0_0._editableInitView(arg_30_0)
	...
	arg_30_0._simageactivitynormalbg:LoadImage(ResUrl.getV1a5DungeonSingleBg("v1a5_dungeon_bg_storypanel"))
	arg_30_0._simageactivityhardbg:LoadImage(ResUrl.getV1a5DungeonSingleBg("v1a5_dungeon_bg_hardpanel"))
...
function var_0_0.getEpisodeIndex(arg_32_0)
	return VersionActivity1_5DungeonController.instance:getEpisodeIndex(arg_32_0.originEpisodeId)
end

function var_0_0.markSelectEpisode(arg_33_0)
	if arg_33_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_5Dungeon or arg_33_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Boss then
...
function var_0_0.setImage(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
	if arg_51_2 then
		...
		local var_51_1 = VersionActivity1_5DungeonEnum.EpisodeStarType[var_51_0.chapterId]

		UISpriteSetMgr.instance:setV1a5DungeonSprite(arg_51_1, var_51_1)
	else
		local var_51_2 = DungeonConfig.instance:getEpisodeCO(arg_51_3)
		local var_51_3 = VersionActivity1_5DungeonEnum.EpisodeStarEmptyType[var_51_2.chapterId]

		UISpriteSetMgr.instance:setV1a5DungeonSprite(arg_51_1, var_51_3)
	end
end
...
function var_0_0.saveEpisodeUnlockMode(arg_57_0)
	PlayerPrefsHelper.setString(arg_57_0:getKey(VersionActivity1_5EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode)), cjson.encode(arg_57_0.unlockedEpisodeModeDict))
end

function var_0_0.saveEpisodeLastSelectMode(arg_58_0)
	PlayerPrefsHelper.setString(arg_58_0:getKey(VersionActivity1_5EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode)), cjson.encode(arg_58_0.lastEpisodeSelectModeDict))
end
