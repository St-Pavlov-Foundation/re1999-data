...
function var_0_0._refreshRemainTime(arg_5_0)
	local var_5_0 = ActivityModel.instance:getActivityInfo()[VersionActivity1_5Enum.ActivityId.PeaceUlu]:getRealEndTimeStamp() - ServerTime.now()
	local var_5_1 = Mathf.Floor(var_5_0 / TimeUtil.OneDaySecond)
	local var_5_2 = var_5_0 % TimeUtil.OneDaySecond
	local var_5_3 = Mathf.Floor(var_5_2 / TimeUtil.OneHourSecond)

	if var_5_1 >= 1 then
		arg_5_0._txtremaintime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_5_1, luaLang("time_day"), var_5_3, luaLang("time_hour2")))

		return
	end

	if var_5_3 >= 1 then
		arg_5_0._txtremaintime.text = string.format(luaLang("remain"), var_5_3 .. luaLang("time_hour2"))

		return
	end

	local var_5_4 = var_5_2 % TimeUtil.OneHourSecond
	local var_5_5 = Mathf.Floor(var_5_4 / TimeUtil.OneMinuteSecond)

	if var_5_5 >= 1 then
		arg_5_0._txtremaintime.text = string.format(luaLang("remain"), var_5_5 .. luaLang("time_minute2"))

		return
	end

	arg_5_0._txtremaintime.text = string.format(luaLang("remain"), "<1" .. luaLang("time_minute2"))
end
...
function var_0_0._refreshSchedule(arg_12_0)
	...
	local var_12_3 = 40
	local var_12_4 = (268 - var_12_3) * var_12_2 - 174
