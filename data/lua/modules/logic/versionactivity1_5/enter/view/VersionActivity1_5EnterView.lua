...
function var_0_0.refreshRemainTime(arg_24_0)
	...
	local var_24_1 = Mathf.Floor(var_24_0 / TimeUtil.OneDaySecond)
	local var_24_2 = var_24_0 % TimeUtil.OneDaySecond
	local var_24_3 = Mathf.Floor(var_24_2 / TimeUtil.OneHourSecond)

	arg_24_0._txtremaintime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_24_1, luaLang("time_day"), var_24_3, luaLang("time_hour2")))
end
