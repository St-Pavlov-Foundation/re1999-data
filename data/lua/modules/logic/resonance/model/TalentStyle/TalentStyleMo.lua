...
function var_0_0.getStyleTag(arg_6_0)
	...
	if string.nilorempty(arg_6_0._tagStr) then
		local var_6_0 = arg_6_0._styleCo.tag
		...
		if not string.nilorempty(var_6_0) then
			...
			for iter_6_0, iter_6_1 in ipairs(var_6_1) do
				local var_6_2 = lua_character_attribute.configDict[iter_6_1]
				local var_6_3 = var_6_2 and var_6_2.name or luaLang("talent_style_special_tag_" .. iter_6_1)

				if string.nilorempty(arg_6_0._tagStr) then
					arg_6_0._tagStr = var_6_3
				else
					arg_6_0._tagStr = string.format("%s    %s", arg_6_0._tagStr, var_6_3)
				end
			end
		end
	end
