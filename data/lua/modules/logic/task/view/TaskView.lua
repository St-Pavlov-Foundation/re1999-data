...
function var_0_0._onFrame(arg_11_0, arg_11_1)
	PostProcessingMgr.instance:setBlurWeight(arg_11_1)
end

function var_0_0.getInitTaskType()
	local var_12_0 = ActivityModel.instance:isActOnLine(ActivityEnum.Activity.NoviceTask)
	local var_12_1 = var_12_0 and TaskEnum.TaskType.Novice or TaskEnum.TaskType.Daily

	if var_12_0 and #TaskModel.instance:getAllRewardUnreceivedTasks(TaskEnum.TaskType.Novice) > 0 then
		var_12_1 = TaskEnum.TaskType.Novice
	elseif #TaskModel.instance:getAllRewardUnreceivedTasks(TaskEnum.TaskType.Daily) > 0 and not TaskModel.instance:isAllRewardGet(TaskEnum.TaskType.Daily) then
		var_12_1 = TaskEnum.TaskType.Daily
	elseif #TaskModel.instance:getAllRewardUnreceivedTasks(TaskEnum.TaskType.Weekly) > 0 and not TaskModel.instance:isAllRewardGet(TaskEnum.TaskType.Weekly) then
		var_12_1 = TaskEnum.TaskType.Weekly
	elseif var_12_0 and not TaskModel.instance:isTypeAllTaskFinished(TaskEnum.TaskType.Novice) then
		var_12_1 = TaskEnum.TaskType.Novice
	elseif not TaskModel.instance:isTypeAllTaskFinished(TaskEnum.TaskType.Daily) and not TaskModel.instance:isAllRewardGet(TaskEnum.TaskType.Daily) then
		var_12_1 = TaskEnum.TaskType.Daily
	elseif not TaskModel.instance:isTypeAllTaskFinished(TaskEnum.TaskType.Weekly) and not TaskModel.instance:isAllRewardGet(TaskEnum.TaskType.Weekly) then
...
function var_0_0.onOpenFinish(arg_14_0)
	gohelper.setActive(arg_14_0._gocontainer, true)
	arg_14_0:_refreshTop()
	arg_14_0:_changeTask()
end

function var_0_0._refreshTop(arg_15_0)
	local var_15_0 = ActivityModel.instance:isActOnLine(ActivityEnum.Activity.NoviceTask)

	gohelper.setActive(arg_15_0._gonovice, var_15_0)
	gohelper.setActive(arg_15_0._goline1, var_15_0 and arg_15_0._taskType == TaskEnum.TaskType.Weekly)

	if var_15_0 then
		gohelper.setActive(arg_15_0._gonoviceunchoose, arg_15_0._taskType ~= TaskEnum.TaskType.Novice)
		gohelper.setActive(arg_15_0._gonovicechoose, arg_15_0._taskType == TaskEnum.TaskType.Novice)
	end

	gohelper.setActive(arg_15_0._goline2, arg_15_0._taskType == TaskEnum.TaskType.Novice)
	gohelper.setActive(arg_15_0._godayunchoose, arg_15_0._taskType ~= TaskEnum.TaskType.Daily)
	gohelper.setActive(arg_15_0._godaychoose, arg_15_0._taskType == TaskEnum.TaskType.Daily)
	gohelper.setActive(arg_15_0._goweekunchoose, arg_15_0._taskType ~= TaskEnum.TaskType.Weekly)
	gohelper.setActive(arg_15_0._goweekchoose, arg_15_0._taskType == TaskEnum.TaskType.Weekly)
	gohelper.setActive(arg_15_0._golineicon, arg_15_0._taskType == TaskEnum.TaskType.Daily or arg_15_0._taskType == TaskEnum.TaskType.Weekly)
end

function var_0_0._changeTask(arg_16_0)
	local var_16_0 = TaskModel.instance:getRefreshCount()

	TaskModel.instance:setRefreshCount(var_16_0 + 1)

	if arg_16_0._taskType == TaskEnum.TaskType.Novice then
		arg_16_0.viewContainer:switchTab(1)
	elseif arg_16_0._taskType == TaskEnum.TaskType.Daily then
		arg_16_0.viewContainer:switchTab(2)
	elseif arg_16_0._taskType == TaskEnum.TaskType.Weekly then
		arg_16_0.viewContainer:switchTab(3)
	end
end

function var_0_0.onClose(arg_17_0)
	arg_17_0:removeEventCb(TaskController.instance, TaskEvent.SetTaskList, arg_17_0._changeTask, arg_17_0)
	arg_17_0:removeEventCb(ActivityController.instance, ActivityEvent.RefreshActivityState, arg_17_0._refreshView, arg_17_0)

	if arg_17_0._blurTweenId then
		PostProcessingMgr.instance:setBlurWeight(1)
		ZProj.TweenHelper.KillById(arg_17_0._blurTweenId)
	end
end
