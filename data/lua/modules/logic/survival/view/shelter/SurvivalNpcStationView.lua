...
function var_0_0._sendSelectNpc(arg_6_0)
	UIBlockHelper.instance:startBlock("SurvivalNpcStationView_SendSelect")

	local var_6_0 = SurvivalShelterNpcMonsterListModel.instance:getSelectList()

	SurvivalWeekRpc.instance:sendSurvivalIntrudeExterminateRequest(var_6_0, arg_6_0._relayClose, arg_6_0)
end

function var_0_0._relayClose(arg_7_0)
	UIBlockHelper.instance:endBlock("SurvivalNpcStationView_SendSelect")
	arg_7_0:closeThis()
end
