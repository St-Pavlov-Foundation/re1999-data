...
function var_0_0._btnFightOnClick(arg_8_0)
	if arg_8_0._fight == nil then
		return
	end

	if not arg_8_0._fight:canFight() then
		local var_8_0 = SurvivalShelterModel.instance:getWeekInfo()
		local var_8_1 = arg_8_0._fight.endTime - var_8_0.day

		GameFacade.showToast(ToastEnum.SurvivalBossDotOpen, var_8_1)
...
function var_0_0._refreshState(arg_18_0)
	...
	local var_18_0 = arg_18_0._fight:canFight()
