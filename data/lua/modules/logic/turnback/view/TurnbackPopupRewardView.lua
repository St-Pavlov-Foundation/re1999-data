...
function TurnbackPopupRewardView:setSubModuleItemContent(showInPopupCount)
	self._subModuleContentLayout.startAxis = showInPopupCount > 3 and UnityEngine.UI.GridLayoutGroup.Axis.Horizontal or UnityEngine.UI.GridLayoutGroup.Axis.Vertical
