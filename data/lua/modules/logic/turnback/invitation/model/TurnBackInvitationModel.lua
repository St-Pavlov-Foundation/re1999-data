...
function var_0_0.getLoginUrl(arg_10_0)
	...
	local var_10_1 = TurnBackInvitationConfig.instance:getUrlByChannelId(var_10_0)

	if var_10_1 == nil then
		logError(string.format("TurnBackInvitationModel getUrl Fail channelId: %s", var_10_0))
