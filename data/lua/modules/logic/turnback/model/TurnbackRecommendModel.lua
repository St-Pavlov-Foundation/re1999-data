...
function var_0_0.checkRecommendIsInTime(arg_5_0, arg_5_1)
	...
	if var_5_4 then
		var_5_2 = TimeUtil.stringToTimestamp(arg_5_1.onlineTime) + ServerTime.clientToServerOffset()
	end

	local var_5_5 = not string.nilorempty(arg_5_1.offlineTime)

	if var_5_5 then
		var_5_3 = TimeUtil.stringToTimestamp(arg_5_1.offlineTime) + ServerTime.clientToServerOffset()
	end

	local var_5_6 = not string.nilorempty(arg_5_1.constTime)

	if var_5_6 then
		var_5_1 = TimeUtil.stringToTimestamp(arg_5_1.constTime) + ServerTime.clientToServerOffset()
	end
