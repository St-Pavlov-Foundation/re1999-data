-- chunkname: @modules/logic/versionactivity2_3/dungeon/view/map/VersionActivity2_3DungeonMapInteractView.lua

module("modules.logic.versionactivity2_3.dungeon.view.map.VersionActivity2_3DungeonMapInteractView", package.seeall)

local VersionActivity2_3DungeonMapInteractView = class("VersionActivity2_3DungeonMapInteractView", BaseView)

function VersionActivity2_3DungeonMapInteractView:onInitView(go)
...
function VersionActivity2_3DungeonMapInteractView:initNoneContainer()
...
function VersionActivity2_3DungeonMapInteractView:initFightContainer()
...
function VersionActivity2_3DungeonMapInteractView:initDialogueContainer()
...
function VersionActivity2_3DungeonMapInteractView:initTalkContainer()
...
function VersionActivity2_3DungeonMapInteractView:addEvents()
	...
	self:addEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_3DungeonMapInteractView:removeEvents()
	...
	self:removeEventCb(VersionActivity2_3DungeonController.instance, VersionActivity2_3DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_3DungeonMapInteractView:_editableInitView()
	self._handleTypeMap = {
...
function VersionActivity2_3DungeonMapInteractView:showInteractUI(mapElement)
	if self._show then
		return
	end
	...
	VersionActivity2_3DungeonModel.instance:setShowInteractView(true)
...
function VersionActivity2_3DungeonMapInteractView:onRecheck(elementCo)
	if self._show then
		return
	end
...
function VersionActivity2_3DungeonMapInteractView:show()
	if self._show then
		return
	end
...
function VersionActivity2_3DungeonMapInteractView:hide()
	if not self._show then
		return
	end

	VersionActivity2_3DungeonModel.instance:setShowInteractView(nil)
	...
	VersionActivity2_3DungeonController.instance:dispatchEvent(VersionActivity2_3DungeonEvent.OnHideInteractUI)
end

function VersionActivity2_3DungeonMapInteractView:refreshUI()
...
function VersionActivity2_3DungeonMapInteractView:refreshRewards()
...
function VersionActivity2_3DungeonMapInteractView:createRewardItem()
...
function VersionActivity2_3DungeonMapInteractView:refreshNoneUI()
...
function VersionActivity2_3DungeonMapInteractView:setFinishText()
...
function VersionActivity2_3DungeonMapInteractView:refreshFightUI()
...
function VersionActivity2_3DungeonMapInteractView:refreshDialogueUI()
...
function VersionActivity2_3DungeonMapInteractView:refreshTalkUI()
	self._sectionStack = {}
...
function VersionActivity2_3DungeonMapInteractView:_playSection(sectionId, dialogIndex)
	self:_setSectionData(sectionId, dialogIndex)
	self:_playNextDialog()
end

function VersionActivity2_3DungeonMapInteractView:_setSectionData(sectionId, dialogIndex)
...
function VersionActivity2_3DungeonMapInteractView:_playNextDialog()
...
function VersionActivity2_3DungeonMapInteractView:_showDialog(type, text, speaker, audio)
...
function VersionActivity2_3DungeonMapInteractView:setIsChat(isChat)
	gohelper.setActive(self._godesc, not isChat)
	gohelper.setActive(self._gochat, isChat)
end

function VersionActivity2_3DungeonMapInteractView:_addDialogOption(index, sectionId, text)
...
function VersionActivity2_3DungeonMapInteractView:_onOptionClick(param)
...
function VersionActivity2_3DungeonMapInteractView:_refreshDialogBtnState(showOption, hasNext)
...
function VersionActivity2_3DungeonMapInteractView:onClickRoot()
	self:hide()
...
function VersionActivity2_3DungeonMapInteractView:_btncloseOnClick()
	self:hide()
...
function VersionActivity2_3DungeonMapInteractView:_onClickNoneBtn()
	self:hide()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
	self:finishElement()
end

function VersionActivity2_3DungeonMapInteractView:_onClickFightBtn()
	self:hide()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
	...
	VersionActivity2_3DungeonModel.instance:setLastEpisodeId(self.activityDungeonMo.episodeId)
	DungeonFightController.instance:enterFight(config.chapterId, episodeId)
end

function VersionActivity2_3DungeonMapInteractView:_onClickEnterDialogueBtn()
	if self.isFinish and not self._isRecheck then
		self:hide()
		self:finishElement()
...
function VersionActivity2_3DungeonMapInteractView:finishElement(dialogIds)
...
function VersionActivity2_3DungeonMapInteractView:refreshElement()
	return
end

function VersionActivity2_3DungeonMapInteractView:_btnnextOnClick()
	self:_playNextSectionOrDialog()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
end

function VersionActivity2_3DungeonMapInteractView:_playNextSectionOrDialog()
	if #self._sectionList >= self._dialogIndex then
		self:_playNextDialog()
...
function VersionActivity2_3DungeonMapInteractView:_btnfinishtalkOnClick()
	self:hide()
...
function VersionActivity2_3DungeonMapInteractView:onDialogueInfoChange(dialogueId)
	if dialogueId == self.dialogueId then
		self:refreshDialogueUI()
	end
end

function VersionActivity2_3DungeonMapInteractView:onCloseViewFinishCall(viewName)
	if viewName == ViewName.DialogueView and self.isFinish then
		self:refreshUI()
	end
end

function VersionActivity2_3DungeonMapInteractView:beforeJump()
	self:hide()
end

function VersionActivity2_3DungeonMapInteractView:onClose()
	return
end

function VersionActivity2_3DungeonMapInteractView:onDestroyView()
	self.rootClick:RemoveClickListener()
end

return VersionActivity2_3DungeonMapInteractView
