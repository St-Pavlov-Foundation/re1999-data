...
slot0 = class("VersionActivity2_3DungeonMapEpisodeItem", BaseChildView)
...
function slot0.onClick(slot0)
	...
	if ViewMgr.instance:getContainer(ViewName.VersionActivity2_3DungeonMapLevelView) then
...
function slot0._showEye(slot0)
	...
	slot2 = slot0._config.chapterId == VersionActivity2_3DungeonEnum.DungeonChapterId.Hard
...
function slot0.getMapAllElementList(slot0)
	return VersionActivity2_3DungeonModel.instance:getElementCoList(slot0._map.id)
end

function slot0._showAllElementTipView(slot0)
	if not slot0._map or slot0._config.chapterId == VersionActivity2_3DungeonEnum.DungeonChapterId.Hard then
	...
	slot1, slot2 = VersionActivity2_3DungeonModel.instance:getElementCoListWithFinish(slot0._map.id)
...
function slot0.refresh(slot0, slot1, slot2)
	...
	slot0._map = VersionActivity2_3DungeonConfig.instance:getEpisodeMapConfig(slot0._config.id)
...
function slot0.setImage(slot0, slot1, slot2, slot3)
	slot5 = VersionActivity2_3DungeonEnum.EpisodeStarType[DungeonConfig.instance:getEpisodeCO(slot3).chapterId]
