...
slot0 = class("WeekwalkHeart_PanelViewPatFaceWork", PatFaceWorkBase)
...
function slot0.checkCanPat(slot0)
	...
	if ActivityHelper.getActivityStatus(slot0:_actId(), true) == ActivityEnum.ActivityStatus.Normal and TaskModel.instance:getTaskById(uv0.SigninId) and slot3.finishCount <= 0 then
		slot2 = true
	end
