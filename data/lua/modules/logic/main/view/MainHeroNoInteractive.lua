...
function var_0_0._checkSpecialIdle(arg_10_0)
	...
	if #ViewMgr.instance:getOpenViewNameList() - (ViewMgr.instance:isOpen(ViewName.ToastView) and 1 or 0) - (ViewMgr.instance:isOpen(ViewName.WaterMarkView) and 1 or 0) > 1 then
		return
	end
