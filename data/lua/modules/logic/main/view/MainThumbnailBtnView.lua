...
function var_0_0._btnzhoubianOnClick(arg_9_0)
	...
	if GameUtil.openDeepLink(var_9_0, var_9_1) then
		return
	end

	GameUtil.openURL(var_9_0)
end
...
function var_0_0._refreshBtns(arg_33_0)
	...
	gohelper.setActive(arg_33_0._btnplayercard.gameObject, var_33_0 and OpenModel.instance:isFuncBtnShow(OpenEnum.UnlockFunc.PlayerCard))
