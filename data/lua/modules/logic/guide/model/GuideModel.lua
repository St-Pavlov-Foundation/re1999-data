...
function var_0_0.isGuideRunning(arg_21_0, arg_21_1)
	local var_21_0 = arg_21_0:getById(arg_21_1)

	if var_21_0 and not var_21_0.isFinish then
		return true
	end
...
function var_0_0.isGuideFinish(arg_22_0, arg_22_1)
	local var_22_0 = arg_22_0:getById(arg_22_1)

	if var_22_0 and var_22_0.isFinish then
		return true
	end
...
function var_0_0.isStepFinish(arg_23_0, arg_23_1, arg_23_2)
	if arg_23_0:isGuideFinish(arg_23_1) then
		return true
	end

	local var_23_0 = arg_23_0:getById(arg_23_1)

	if var_23_0 and arg_23_2 < var_23_0.currStepId then
		return true
	end
...
function var_0_0.setLockGuide(arg_24_0, arg_24_1, arg_24_2)
	if arg_24_0._lockGuideId and not arg_24_0:isGuideFinish(arg_24_0._lockGuideId) and not arg_24_2 then
		logNormal(string.format("<color=#FFA500>setLockGuide old:%s new:%s</color>", arg_24_0._lockGuideId, arg_24_1))

		return
	end

	arg_24_0._lockGuideId = arg_24_1

	logNormal(string.format("<color=#FFA500>setLockGuide guideId:%s</color>", arg_24_0._lockGuideId))
end

function var_0_0.getLockGuideId(arg_25_0)
	if arg_25_0._lockGuideId and arg_25_0:isGuideFinish(arg_25_0._lockGuideId) then
		arg_25_0._lockGuideId = nil
	end

	return arg_25_0._lockGuideId
end

function var_0_0.gmStartGuide(arg_26_0, arg_26_1, arg_26_2)
	arg_26_0._gmStartGuideId = arg_26_1
	arg_26_0._gmStartGuideStep = arg_26_2
end

function var_0_0.setGMGuideStep(arg_27_0, arg_27_1)
	if not arg_27_1 or arg_27_1.guideId ~= arg_27_0._gmStartGuideId or not arg_27_0._gmStartGuideStep then
		return
	end

	arg_27_1.stepId = arg_27_0._gmStartGuideStep
	arg_27_0._gmStartGuideStep = nil

	logNormal(string.format("<color=#FF0000>setGMGuideStep guideId:%d step:%d</color>", arg_27_1.guideId, arg_27_1.stepId))
end

function var_0_0.isGMStartGuide(arg_28_0, arg_28_1)
	return arg_28_1 == arg_28_0._gmStartGuideId
end

function var_0_0.setNextStepGOPath(arg_29_0, arg_29_1, arg_29_2, arg_29_3)
	local var_29_0 = GuideConfig.instance:getNextStepId(arg_29_1, arg_29_2)

	if var_29_0 then
		arg_29_0._fixNextStepGOPathDict[arg_29_1] = arg_29_0._fixNextStepGOPathDict[arg_29_1] or {}
		arg_29_0._fixNextStepGOPathDict[arg_29_1][var_29_0] = arg_29_3
	end
end

function var_0_0.getStepGOPath(arg_30_0, arg_30_1, arg_30_2)
	if arg_30_0._fixNextStepGOPathDict[arg_30_1] then
		local var_30_0 = arg_30_0._fixNextStepGOPathDict[arg_30_1][arg_30_2]
	...
	local var_30_1 = GuideConfig.instance:getStepCO(arg_30_1, arg_30_2)

	return var_30_1 and var_30_1.goPath
end

function var_0_0.getGuideParam(arg_31_0)
	return arg_31_0._guideParam
end
