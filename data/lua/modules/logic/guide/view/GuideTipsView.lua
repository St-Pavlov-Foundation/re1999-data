...
function slot0.onInitView(slot0)
	...
	slot0._noIconGO = gohelper.findChild(slot0.viewGO, "tips/noIcon")
	slot0._hasIconBg = gohelper.findChildSingleImage(slot0.viewGO, "tips/hasIcon/imgBg")
...
function slot0._updateUI(slot0)
	...
	slot0._hasIconBg:LoadImage(ResUrl.getFightBattleDialogBg("duihuak_002"))
