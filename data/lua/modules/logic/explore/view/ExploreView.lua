...
function slot0.checkMove(slot0)
	...
	slot1 = PCInputController.instance
	slot2, slot3, slot4, slot5 = slot1:getThirdMoveKey()
	slot6 = ExploreEnum.RoleMoveDir.None

	if slot1:getKeyPress(slot2) then
		slot6 = ExploreEnum.RoleMoveDir.Up
	elseif slot1:getKeyPress(slot3) then
		slot6 = ExploreEnum.RoleMoveDir.Left
	elseif slot1:getKeyPress(slot4) then
		slot6 = ExploreEnum.RoleMoveDir.Down
	elseif slot1:getKeyPress(slot5) then
		slot6 = ExploreEnum.RoleMoveDir.Right
	end

	if slot6 ~= ExploreEnum.RoleMoveDir.None and slot0._isTop == false then
		slot6 = ExploreEnum.RoleMoveDir.None
	end

	ExploreController.instance:dispatchEvent(ExploreEvent.UpdateMoveDir, slot6)
end
