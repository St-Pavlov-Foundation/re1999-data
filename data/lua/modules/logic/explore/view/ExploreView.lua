...
function var_0_0.checkMove(arg_23_0)
	...
	local var_23_0 = PCInputController.instance
	local var_23_1, var_23_2, var_23_3, var_23_4 = var_23_0:getThirdMoveKey()
	local var_23_5 = ExploreEnum.RoleMoveDir.None

	if var_23_0:getKeyPress(var_23_1) then
		var_23_5 = ExploreEnum.RoleMoveDir.Up
	elseif var_23_0:getKeyPress(var_23_2) then
		var_23_5 = ExploreEnum.RoleMoveDir.Left
	elseif var_23_0:getKeyPress(var_23_3) then
		var_23_5 = ExploreEnum.RoleMoveDir.Down
	elseif var_23_0:getKeyPress(var_23_4) then
		var_23_5 = ExploreEnum.RoleMoveDir.Right
	end

	if var_23_5 ~= ExploreEnum.RoleMoveDir.None and arg_23_0._isTop == false then
		var_23_5 = ExploreEnum.RoleMoveDir.None
	end

	ExploreController.instance:dispatchEvent(ExploreEvent.UpdateMoveDir, var_23_5)
end
