...
function var_0_0.isOverseas(arg_25_0)
	if arg_25_0.__isOverseas == nil then
		local var_25_0 = SDKMgr.instance:getGameId()

		if tostring(var_25_0) == "50001" then
			arg_25_0.__isOverseas = false
		else
			arg_25_0.__isOverseas = true
		end
	end

	return arg_25_0.__isOverseas
end
