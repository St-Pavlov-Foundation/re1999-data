...
function slot0._refreshView(slot0)
	...
	slot0._simageicon:LoadImage((not (lua_weekwalk_rule.configDict[slot1].isCn == 1) or ResUrl.getWeekWalkIconLangPath(slot2.icon)) and ResUrl.getWeekWalkBg("rule/" .. slot2.icon .. ".png"))
