...
function var_0_0._refreshView(arg_8_0)
	...
	local var_8_2 = var_8_1.isCn == 1
	local var_8_3

	if var_8_2 then
		var_8_3 = ResUrl.getWeekWalkIconLangPath(var_8_1.icon)
	else
		var_8_3 = ResUrl.getWeekWalkBg("rule/" .. var_8_1.icon .. ".png")
	end

	arg_8_0._simageicon:LoadImage(var_8_3)

	local var_8_4 = var_8_1.additionRule

	if string.nilorempty(var_8_4) then
		return
	end
	...
	for iter_8_0, iter_8_1 in ipairs(var_8_5) do
		local var_8_6 = iter_8_1[1]
		local var_8_7 = iter_8_1[2]
		local var_8_8 = lua_rule.configDict[var_8_7]

		if var_8_8 then
			arg_8_0:_setRuleDescItem(var_8_8, var_8_6)
		end
