...
function var_0_0.onOpen(arg_14_0)
	...
	if var_14_10 then
		var_14_11 = ResUrl.getWeekWalkIconLangPath(var_14_9.icon)
	else
		var_14_11 = ResUrl.getWeekWalkBg("rule/" .. var_14_9.icon .. ".png")
	end

	arg_14_0._simageruledescicon:LoadImage(var_14_11)

	local var_14_12 = var_14_9.additionRule

	if string.nilorempty(var_14_12) then
		return
	end

	local var_14_13 = GameUtil.splitString2(var_14_12, true, "|", "#")

	arg_14_0._ruleList = var_14_13

	for iter_14_0, iter_14_1 in ipairs(var_14_13) do
		local var_14_14 = iter_14_1[1]
		local var_14_15 = iter_14_1[2]
		local var_14_16 = lua_rule.configDict[var_14_15]

		arg_14_0:_setRuleDescItem(var_14_16, var_14_14)
