...
function var_0_0.getLoginUrl(arg_10_0)
	...
	local var_10_1 = serverType == GameChannelConfig.ServerType.OutRelease or serverType == GameChannelConfig.ServerType.OutPreview
	local var_10_2

	if var_10_1 then
		var_10_2 = Activity201Config.instance:getUrlByChannelId(var_10_0)
	else
		var_10_2 = Activity201Config.instance:getTestUrlByChannelId(var_10_0)
	end

	if var_10_0 == TurnbackEnum.ChannelType.eFun then
		return arg_10_0:getEFunLoginUrl(var_10_2)
	elseif var_10_0 == TurnbackEnum.ChannelType.KO then
		return arg_10_0:getKOLoginUrl(var_10_2)
	else
		return arg_10_0:getGlobalLoginUrl(var_10_2)
	end
end
