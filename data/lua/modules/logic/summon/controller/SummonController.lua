...
function var_0_0.simpleEnterSummonScene(arg_78_0, arg_78_1, arg_78_2)
	GameUtil.onDestroyViewMember(arg_78_0, "_simpleFlow")

	arg_78_0._simpleFlow = VirtualSummonBehaviorFlow.New()

	arg_78_0._simpleFlow:start(arg_78_1, arg_78_2)
end
