...
function var_0_0.simpleEnterSummonScene(arg_77_0, arg_77_1, arg_77_2)
	GameUtil.onDestroyViewMember(arg_77_0, "_simpleFlow")

	arg_77_0._simpleFlow = VirtualSummonBehaviorFlow.New()

	arg_77_0._simpleFlow:start(arg_77_1, arg_77_2)
end
