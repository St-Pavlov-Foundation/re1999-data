...
function var_0_0.refreshPropUpAD(arg_9_0)
	...
	elseif var_9_4 then
		var_9_6 = luaLang("summonpooldetail_up_probability_StrongCustomOnePick")
		var_9_1.txtProbabilityLabel.text = GameUtil.getSubPlaceholderLuaLangTwoParam(var_9_6, var_9_5, var_9_2)
	else
		var_9_1.txtProbabilityLabel.text = string.format(var_9_6, var_9_5)
		var_9_1.txtProbability.text = var_9_2 .. "%"
	end
end
