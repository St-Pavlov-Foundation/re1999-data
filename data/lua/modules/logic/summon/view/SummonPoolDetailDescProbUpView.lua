...
function var_0_0.addProbUpItemByRare(arg_10_0, arg_10_1)
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_0) do
		...
		if arg_10_0._poolType == SummonEnum.Type.MultiProbUp4 and arg_10_1 == var_0_2 then
			var_10_1.txtProbability.text = tostring(SummonEnum.MultiProbUp4ShowRate) .. "%"
			var_10_1.txtProbabilityLabel.text = string.format(luaLang("summon_multiup4_rule_title"), arg_10_1 + 1)
		else
			var_10_1.txtProbability.text = CommonConfig.instance:getConstNum(ConstEnum.SummonSSRUpProb) / 10 .. "%"
			var_10_1.txtProbabilityLabel.text = string.format(luaLang("p_summonpooldetail_up_probability"), arg_10_1 + 1)
		end
	end
end
