...
function var_0_0._refreshEquipItem(arg_14_0, arg_14_1, arg_14_2)
	...
	gohelper.setActive(arg_14_1.txtnameen, true)

	local var_14_0 = arg_14_2.equipId
	local var_14_1 = EquipConfig.instance:getEquipCo(var_14_0)

	arg_14_1.txtname.text = var_14_1.name
	arg_14_1.txtnameen.text = var_14_1.name_en

	UISpriteSetMgr.instance:setSummonSprite(arg_14_1.imagerare, "pingzhi_" .. tostring(CharacterEnum.Color[var_14_1.rare]))
	UISpriteSetMgr.instance:setSummonSprite(arg_14_1.equiprare, "equiprare_" .. tostring(CharacterEnum.Color[var_14_1.rare]))
	gohelper.setActive(arg_14_1.imagecareer.gameObject, false)
	gohelper.setActive(arg_14_1.simageicon.gameObject, false)
	arg_14_1.simageequipicon:LoadImage(ResUrl.getSummonEquipGetIcon(var_14_1.icon), var_0_1, arg_14_1)
	EquipHelper.loadEquipCareerNewIcon(var_14_1, arg_14_1.imageequipcareer, 1, "lssx")
	arg_14_0:_refreshEffect(var_14_1.rare, arg_14_1)
...
function var_0_0._refreshHeroItem(arg_15_0, arg_15_1, arg_15_2)
	...
	gohelper.setActive(arg_15_1.txtnameen, true)

	local var_15_0 = arg_15_2.heroId
	local var_15_1 = HeroConfig.instance:getHeroCO(var_15_0)
	local var_15_2 = SkinConfig.instance:getSkinCo(var_15_1.skinId)

	gohelper.setActive(arg_15_1.equiprare.gameObject, false)
	gohelper.setActive(arg_15_1.simageequipicon.gameObject, false)

	arg_15_1.txtname.text = var_15_1.name
	arg_15_1.txtnameen.text = var_15_1.nameEng

	UISpriteSetMgr.instance:setSummonSprite(arg_15_1.imagerare, "pingzhi_" .. tostring(CharacterEnum.Color[var_15_1.rare]))
	UISpriteSetMgr.instance:setCommonSprite(arg_15_1.imagecareer, "lssx_" .. tostring(var_15_1.career))
	arg_15_1.simageicon:LoadImage(ResUrl.getHeadIconMiddle(var_15_2.retangleIcon))
	...
	arg_15_0:_refreshEffect(var_15_1.rare, arg_15_1)
