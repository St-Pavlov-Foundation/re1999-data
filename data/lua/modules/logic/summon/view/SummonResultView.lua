...
function var_0_0._refreshEquipItem(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_0 = arg_15_2.equipId
	local var_15_1 = EquipConfig.instance:getEquipCo(var_15_0)

	arg_15_1.txtname.text = var_15_1.name
	arg_15_1.txtnameen.text = var_15_1.name_en

	UISpriteSetMgr.instance:setSummonSprite(arg_15_1.imagerare, "pingzhi_" .. tostring(CharacterEnum.Color[var_15_1.rare]))
	UISpriteSetMgr.instance:setSummonSprite(arg_15_1.equiprare, "equiprare_" .. tostring(CharacterEnum.Color[var_15_1.rare]))
	gohelper.setActive(arg_15_1.imagecareer.gameObject, false)
	gohelper.setActive(arg_15_1.simageicon.gameObject, false)
	arg_15_1.simageequipicon:LoadImage(ResUrl.getSummonEquipGetIcon(var_15_1.icon), var_0_1, arg_15_1)
	EquipHelper.loadEquipCareerNewIcon(var_15_1, arg_15_1.imageequipcareer, 1, "lssx")
...
function var_0_0._refreshHeroItem(arg_16_0, arg_16_1, arg_16_2)
	...
	gohelper.setActive(arg_16_1.txtnameen, true)

	local var_16_0 = arg_16_2.heroId
	local var_16_1 = HeroConfig.instance:getHeroCO(var_16_0)
	local var_16_2 = SkinConfig.instance:getSkinCo(var_16_1.skinId)

	gohelper.setActive(arg_16_1.equiprare.gameObject, false)
	gohelper.setActive(arg_16_1.simageequipicon.gameObject, false)

	arg_16_1.txtname.text = var_16_1.name
	arg_16_1.txtnameen.text = var_16_1.nameEng

	UISpriteSetMgr.instance:setSummonSprite(arg_16_1.imagerare, "pingzhi_" .. tostring(CharacterEnum.Color[var_16_1.rare]))
	UISpriteSetMgr.instance:setCommonSprite(arg_16_1.imagecareer, "lssx_" .. tostring(var_16_1.career))
	arg_16_1.simageicon:LoadImage(ResUrl.getHeadIconMiddle(var_16_2.retangleIcon))
	...
	arg_16_0:_refreshEffect(var_16_1.rare, arg_16_1)
