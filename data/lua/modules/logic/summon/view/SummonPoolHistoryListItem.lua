...
function var_0_0._refreshItem(arg_5_0)
	if arg_5_0._mo then
		...
		arg_5_0._pooltype.text = arg_5_0._mo.poolName
		...
		local var_5_2 = SummonEnum.HistoryColor[var_5_1] or SummonEnum.HistoryColor[1]

		if arg_5_0._colorStr ~= var_5_2 then
			arg_5_0._colorStr = var_5_2

			SLFramework.UGUI.GuiHelper.SetColor(arg_5_0._name, var_5_2)

			if var_5_1 >= 4 then
				SLFramework.UGUI.GuiHelper.SetColor(arg_5_0._imgstar, var_5_2)
			end
		end
	end
