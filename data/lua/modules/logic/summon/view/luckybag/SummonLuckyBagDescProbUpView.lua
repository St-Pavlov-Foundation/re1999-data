...
function slot0.addProbUpItemByLuckyBagId(slot0, slot1, slot2)
	...
	for slot7, slot8 in ipairs(slot3) do
		...
		slot9.txtProbabilityLabel.text = string.format(luaLang("summonpooldetail_luckybag_prop"), SummonConfig.instance:getLuckyBag(slot0._poolId, slot2).name)
		slot9.txtProbability.text = luaLang("summonpooldetail_luckybag_prop2")
	end
end
