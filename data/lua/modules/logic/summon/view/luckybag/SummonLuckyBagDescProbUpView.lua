...
function var_0_0.addProbUpItemByLuckyBagId(arg_12_0, arg_12_1, arg_12_2)
	...
	for iter_12_0, iter_12_1 in ipairs(var_12_0) do
		...
		var_12_1.txtProbabilityLabel.text = string.format(luaLang("summonpooldetail_luckybag_prop"), var_12_2.name)
		var_12_1.txtProbability.text = luaLang("summonpooldetail_luckybag_prop2")
	end
end
