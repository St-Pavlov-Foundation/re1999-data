...
function var_0_0._btnsummon10OnClick(arg_11_0)
	...
	if var_11_6 then
		...
		var_11_5.cost_quantity = var_11_10
		var_11_5.miss_quantity = var_11_9
	end

	SummonMainController.instance:openSummonConfirmView(var_11_5)
end
