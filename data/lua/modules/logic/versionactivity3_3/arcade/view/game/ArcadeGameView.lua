...
function ArcadeGameView:onInitView()
	...
	self._btnLeft = gohelper.findChildButton(self.viewGO, "Left/#go_joyPoint/#go_joystick/#go_background/btn_left")
	self._btnRight = gohelper.findChildButton(self.viewGO, "Left/#go_joyPoint/#go_joystick/#go_background/btn_right")
	self._btnUp = gohelper.findChildButton(self.viewGO, "Left/#go_joyPoint/#go_joystick/#go_background/btn_up")
	self._btnDown = gohelper.findChildButton(self.viewGO, "Left/#go_joyPoint/#go_joystick/#go_background/btn_down")
...
function ArcadeGameView:addEvents()
	...
	self._btnLeft:AddClickListener(self._btnDirectionOnClick, self, ArcadeEnum.Direction.Left)
	self._btnRight:AddClickListener(self._btnDirectionOnClick, self, ArcadeEnum.Direction.Right)
	self._btnUp:AddClickListener(self._btnDirectionOnClick, self, ArcadeEnum.Direction.Up)
	self._btnDown:AddClickListener(self._btnDirectionOnClick, self, ArcadeEnum.Direction.Down)
...
function ArcadeGameView:refreshEventTip(isPlay)
	...
	if eventEntityType and eventEntityUid then
		...
		self:_closeTipView()
		ArcadeController.instance:dispatchEvent(ArcadeEvent.TriggerGuideOnShowEventTip)
	else
		self._showingEventEntityType = nil
		self._showingEventEntityUid = nil
