...
function ArcadeHallView:_editableAddEvents()
	...
	self:addEventCb(ArcadeController.instance, ArcadeEvent.OnGainReward, self._refreshTaskReddot, self)
...
function ArcadeHallView:_editableRemoveEvents()
	...
	self:removeEventCb(ArcadeController.instance, ArcadeEvent.OnGainReward, self._refreshTaskReddot, self)
