...
function slot0._build(slot0)
	...
	if slot0._videoName == "xuzhangkaichangpv" and BootNativeUtil.isWindows() then
		slot2, slot3 = BootNativeUtil.getDisplayResolution()

		if slot3 >= 2160 then
			slot0._videoName = "xuzhangkaichangpv_4k"
		elseif slot3 >= 1440 then
			slot0._videoName = "xuzhangkaichangpv_2k"
		end
	end
