...
function slot0.onInitView(slot0)
	...
	slot0._goblackbottom = gohelper.findChild(slot0.viewGO, "#go_contentroot/#go_conversation/blackBottom")
	...
	slot0._gospine = gohelper.findChild(slot0.viewGO, "#go_contentroot/#go_conversation/#go_spine")
	slot0._gonamebg = gohelper.findChild(slot0.viewGO, "#go_contentroot/#go_conversation/#go_spine/#go_namebg")
	slot0._gospineobj = gohelper.findChild(slot0.viewGO, "#go_contentroot/#go_conversation/#go_spine/mask/#go_spineobj")
	slot0._goname = gohelper.findChild(slot0.viewGO, "#go_contentroot/#go_conversation/#go_name")
	slot0._txtnamecn1 = gohelper.findChildText(slot0.viewGO, "#go_contentroot/#go_conversation/#go_name/namelayout/#txt_namecn1")
	slot0._txtnamecn2 = gohelper.findChildText(slot0.viewGO, "#go_contentroot/#go_conversation/#go_name/namelayout/#txt_namecn2")
...
function slot0._updateStep(slot0, slot1)
	if not StoryModel.instance:isNormalStep() and not slot0._skip then
		return
	end
...
function slot0._showConversationItem(slot0, slot1)
	...
	gohelper.setActive(slot0._txtnameen.gameObject, slot0._stepCo.conversation.nameEnShow)
...
function slot0._playDialog(slot0)
	...
	slot0._dialogItem:hideDialog()
	slot0._dialogItem:playDialog(slot0._diatxt, slot0._stepCo, slot0._conFinished, slot0)
end
...
function slot0._clearItems(slot0)
	...
	for slot4, slot5 in pairs(slot0._videos) do
		slot5:onDestroy()
	end
