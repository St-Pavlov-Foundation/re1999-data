module("modules.logic.story.view.StoryActivityChapterOpen2_7", package.seeall)

slot0 = class("StoryActivityChapterOpen2_7", StoryActivityChapterBase)

function slot0.onCtor(slot0)
	slot0.assetPath = "ui/viewres/story/v2a7/storyactivitychapteropen.prefab"
end
...
function slot0.getVideoName(slot0, slot1)
	return slot1 == 1 and "2_7_opening_1"
end

function slot0.getLangResBg(slot0, slot1)
	return string.format("singlebg_lang/txt_v2a7_storyactivityopenclose/%s.png", slot1)
end
