...
function var_0_0.hasConfigNotExist(arg_59_0)
	local var_59_0 = StoryStepModel.instance:getStepList()

	if not var_59_0 or not next(var_59_0) then
		logError("剧情step数据异常,请检查数据！")

		return true
	end

	local var_59_1 = StoryGroupModel.instance:getGroupList()
...
function var_0_0.needWaitStoryFinish(arg_60_0)
	return arg_60_0._needWait
end

function var_0_0.setNeedWaitStoryFinish(arg_61_0, arg_61_1)
	arg_61_0._needWait = arg_61_1
end

function var_0_0.setReplaceHero(arg_62_0, arg_62_1, arg_62_2)
	if not arg_62_0._replaceHeroList then
		arg_62_0._replaceHeroList = {}
	end

	local var_62_0 = {
		initHero = arg_62_1,
		replaceHeroPath = arg_62_2
	}

	table.insert(arg_62_0._replaceHeroList, var_62_0)
end

function var_0_0.getReplaceHeroPath(arg_63_0, arg_63_1)
	if not arg_63_0._replaceHeroList then
		return
	end

	for iter_63_0, iter_63_1 in pairs(arg_63_0._replaceHeroList) do
		if arg_63_1 == iter_63_1.initHero then
			return iter_63_1.replaceHeroPath
		end
	end
end

function var_0_0.isDirectSkipStory(arg_64_0, arg_64_1)
	if math.floor(arg_64_1 / 100) == 8008 then
		return arg_64_1 % 100 > 4
	end
