...
function var_0_0.hasConfigNotExist(arg_55_0)
	local var_55_0 = StoryStepModel.instance:getStepList()

	if not var_55_0 or not next(var_55_0) then
		logError("剧情step数据异常,请检查数据！")

		return true
	end

	local var_55_1 = StoryGroupModel.instance:getGroupList()

	if not var_55_1 or not next(var_55_1) then
...
function var_0_0.needWaitStoryFinish(arg_56_0)
	return arg_56_0._needWait
end

function var_0_0.setNeedWaitStoryFinish(arg_57_0, arg_57_1)
	arg_57_0._needWait = arg_57_1
end

function var_0_0.setReplaceHero(arg_58_0, arg_58_1, arg_58_2)
	if not arg_58_0._replaceHeroList then
		arg_58_0._replaceHeroList = {}
	end

	local var_58_0 = {
		initHero = arg_58_1,
		replaceHeroPath = arg_58_2
	}

	table.insert(arg_58_0._replaceHeroList, var_58_0)
end

function var_0_0.getReplaceHeroPath(arg_59_0, arg_59_1)
	if not arg_59_0._replaceHeroList then
		return
	end

	for iter_59_0, iter_59_1 in pairs(arg_59_0._replaceHeroList) do
		if arg_59_1 == iter_59_1.initHero then
			return iter_59_1.replaceHeroPath
		end
	end
end

function var_0_0.isDirectSkipStory(arg_60_0, arg_60_1)
	if math.floor(arg_60_1 / 100) == 8008 then
		return arg_60_1 % 100 > 4
	end
