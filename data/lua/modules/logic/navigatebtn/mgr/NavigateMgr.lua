...
function var_0_0._onEscapeBtnClick(arg_10_0)
	...
	local var_10_0 = ViewMgr.instance:getUIRoot()
	local var_10_1 = ViewMgr.instance:getOpenViewNameList()
	local var_10_2 = var_0_0.sortOpenViewNameList(var_10_1)

	for iter_10_0, iter_10_1 in ipairs(var_10_2) do
		local var_10_3 = ViewMgr.instance:getSetting(iter_10_1)

		if var_10_3.layer == "TOP" and not var_0_2[iter_10_1] then
			return
		end

		if var_10_3.layer == "GUIDE" then
			return
		end
	end

	for iter_10_2 = #var_10_2, 1, -1 do
		local var_10_4 = var_10_2[iter_10_2]
		local var_10_5 = ViewMgr.instance:getSetting(var_10_4)
		local var_10_6 = ViewMgr.instance:getContainer(var_10_4)

		if var_10_4 == ViewName.MainView then
			if GameSceneMgr.instance:getCurSceneType() == SceneType.Main then
				SDKController.instance:openSDKExitView()
			end

			return
		elseif not var_0_1[var_10_4] then
			local var_10_7 = var_10_6 and var_10_6.viewGO

			if (var_10_7 and var_10_7.transform.parent.parent) == var_10_0.transform then
				arg_10_0:_dispatchEscape(var_10_4)
...
function var_0_0._onSpaceBtnClick(arg_13_0)
	...
	for iter_13_0, iter_13_1 in ipairs(var_13_2) do
		...
		if var_13_3.layer == "TOP" and iter_13_1 ~= ViewName.GMToolView2 then
			return
		end
	...
	for iter_13_2 = #var_13_2, 1, -1 do
		...
		if var_13_4 ~= ViewName.ToastView and var_13_4 ~= ViewName.StorySceneView then
