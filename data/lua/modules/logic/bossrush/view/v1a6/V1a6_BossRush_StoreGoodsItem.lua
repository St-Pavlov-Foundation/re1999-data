-- chunkname: @modules/logic/bossrush/view/v1a6/V1a6_BossRush_StoreGoodsItem.lua

module("modules.logic.bossrush.view.v1a6.V1a6_BossRush_StoreGoodsItem", package.seeall)

local V1a6_BossRush_StoreGoodsItem = class("V1a6_BossRush_StoreGoodsItem", UserDataDispose)

function V1a6_BossRush_StoreGoodsItem:onInitView(go)
	self:__onInit()
...
function V1a6_BossRush_StoreGoodsItem:onClick()
...
function V1a6_BossRush_StoreGoodsItem:refreshRemainBuyCount()
...
function V1a6_BossRush_StoreGoodsItem:refreshTag()
...
function V1a6_BossRush_StoreGoodsItem:getItemTypeIdQuantity(coStr)
	local attribute = string.splitToNumber(coStr, "#")

	return attribute[1], attribute[2], attribute[3]
end

function V1a6_BossRush_StoreGoodsItem:hide()
	gohelper.setActive(self.go, false)
end

function V1a6_BossRush_StoreGoodsItem:onDestroy()
...
function V1a6_BossRush_StoreGoodsItem:updateNewData(newTagData)
	local _isNew = newTagData and newTagData.isNew

	gohelper.setActive(self.reddot, _isNew)
end

function V1a6_BossRush_StoreGoodsItem:clearNewTag()
	V1a6_BossRush_StoreModel.instance:onClickGoodsItem(self._mo.belongStoreId, self._mo.goodsId)
	gohelper.setActive(self.reddot, false)
end

return V1a6_BossRush_StoreGoodsItem
