...
function var_0_0._onClickTest2(arg_33_0)
	logError("test2")
	System.GC.Collect(2, System.GCCollectionMode.Forced, true, true)
end

function var_0_0._onVisualToggleValueChange(arg_34_0, arg_34_1, arg_34_2)
	if not arg_34_0.isOpenFinish then
		return
	end

	GMController.instance:setVisualInteractive(arg_34_2)
...
function var_0_0._onClickChangeActivityBtn(arg_35_0)
	local var_35_0 = arg_35_0.activityIdList[arg_35_0.selectActivityIndex or 1]

	if arg_35_0.activityAll[var_35_0] then
		for iter_35_0, iter_35_1 in pairs(arg_35_0.activityAll[var_35_0]) do
			arg_35_0:_changeActivityInfo(iter_35_1)
		end

		return
	end

	arg_35_0:_changeActivityInfo(var_35_0)
end

function var_0_0._changeActivityInfo(arg_36_0, arg_36_1)
	local var_36_0 = arg_36_0.statusList[arg_36_0.selectStatusIndex or 1]
	local var_36_1 = ActivityModel.instance:getActivityInfo()[arg_36_1]

	if ActivityHelper.getActivityStatus(arg_36_1) == var_36_0 then
		return
	end

	local var_36_2 = ServerTime.now() * 1000
	local var_36_3 = TimeUtil.maxDateTimeStamp * 1000

	var_36_1.config = arg_36_0:copyConfig(var_36_1.config)

	if var_36_0 == ActivityEnum.ActivityStatus.Normal then
		var_36_1.startTime = var_36_2 - 1
		var_36_1.endTime = var_36_3
		var_36_1.config.openId = 0
		var_36_1.online = true
	elseif var_36_0 == ActivityEnum.ActivityStatus.NotOpen then
		var_36_1.startTime = var_36_3
	elseif var_36_0 == ActivityEnum.ActivityStatus.Expired then
		var_36_1.startTime = var_36_2 - 1
		var_36_1.endTime = var_36_1.startTime
	elseif var_36_0 == ActivityEnum.ActivityStatus.NotUnlock then
		var_36_1.startTime = var_36_2 - 1
		var_36_1.endTime = var_36_3
		var_36_1.config.openId = arg_36_1
		OpenModel.instance._unlocks[arg_36_1] = false
	elseif var_36_0 == ActivityEnum.ActivityStatus.NotOnLine then
		var_36_1.startTime = var_36_2 - 1
		var_36_1.endTime = var_36_3
		var_36_1.config.openId = 0
		var_36_1.online = false
	end

	ActivityController.instance:dispatchEvent(ActivityEvent.RefreshActivityState, arg_36_1)
end

function var_0_0.copyConfig(arg_37_0, arg_37_1)
	local var_37_0 = {}
	local var_37_1 = {
		logoName = 9,
		name = 3,
	...
	for iter_37_0, iter_37_1 in pairs(var_37_1) do
		var_37_0[iter_37_0] = arg_37_1[iter_37_0]
	end

	return var_37_0
end

function var_0_0._onClickResetActivityBtn(arg_38_0)
	ActivityRpc.instance:sendGetActivityInfosRequest()
end

function var_0_0._onActivityDropValueChange(arg_39_0, arg_39_1)
	arg_39_0.selectActivityIndex = arg_39_1 + 1
end

function var_0_0._onActivityStatusDropValueChange(arg_40_0, arg_40_1)
	arg_40_0.selectStatusIndex = arg_40_1 + 1
end

function var_0_0._onClickResetActivityUnlockAim(arg_41_0)
...
function var_0_0._onClickEnterActivity(arg_42_0)
	local var_42_0 = arg_42_0.activityIdList[arg_42_0.selectActivityIndex or 1]
	local var_42_1 = arg_42_0._activityEnterFuncMap[var_42_0]

	if not var_42_1 then
		return
	end

	local var_42_2 = arg_42_0._activityEnterFuncParamsMap[var_42_0]

	var_42_1(var_42_2.obj, var_42_2.params)
end

function var_0_0.initActivityEnterFunc(arg_43_0)
	arg_43_0._activityEnterFuncMap = {
		[11304] = Activity1_3ChessController.openMapView,
		[12204] = LoperaController.openLoperaMainView
	}
	arg_43_0._activityEnterFuncParamsMap = {
		[11304] = {
			params = 1,
...
function var_0_0._onClickOnekeyFightSucc(arg_44_0)
	arg_44_0:closeThis()
	GMRpc.instance:sendGMRequest("set fight 1")
end

function var_0_0._onClickEnterDialogue(arg_45_0)
	local var_45_0 = arg_45_0._inputDialogue:GetText()
	local var_45_1 = tonumber(var_45_0)

	if not var_45_1 then
		return
	end

	if lua_tip_dialog.configDict[var_45_1] then
		TipDialogController.instance:openTipDialogView(var_45_1)

		return
	end

	if not DialogueConfig.instance:getDialogueCo(var_45_1) then
		GameFacade.showToastString("对话id不存在，请检查配置")
	end

	DialogueController.instance:enterDialogue(var_45_1)
end

function var_0_0._onClickStartEditV1a5HoleBtn(arg_46_0)
	local var_46_0 = ViewMgr.instance:getContainer(ViewName.VersionActivity1_5DungeonMapView)
	...
	if not var_46_0:isOpenFinish() then
		ToastController.instance:showToastWithString("请等待1.5副本界面打开完成")

		return
	end

	arg_46_0.holeEditView = EditorV1a5DungeonHoleView.start(var_46_0)
