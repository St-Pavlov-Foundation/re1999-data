...
function var_0_0._updateSpeedText(arg_32_0)
	...
	arg_32_0._txtSpeed.text = string.format("Speed x%.2f", var_32_0)
end
...
function var_0_0._onSpeedChange(arg_34_0, arg_34_1, arg_34_2)
	...
	arg_34_0._txtSpeed.text = string.format("Speed x%.2f", arg_34_2)
...
function var_0_0._onSkinGetValueChanged(arg_82_0, arg_82_1)
	if not arg_82_0.haveHeroList then
		return
	end
	...
	local var_82_0 = string.split(arg_82_0.haveHeroList[arg_82_1 + 1], "#")[2]

	if not var_82_0 then
		logError("not found : " .. arg_82_0.haveHeroList[arg_82_1 + 1])
	end

	local var_82_1 = {
		heroId = tonumber(var_82_0)
	}

	var_82_1.newRank = 3
	var_82_1.isRank = true

	PopupController.instance:addPopupView(PopupEnum.PriorityType.GainCharacterView, ViewName.CharacterGetView, var_82_1)
end

function var_0_0._onHeroFaithSelectChanged(arg_83_0, arg_83_1)
	...
	arg_83_0.selectHeroFaithId = tonumber(var_83_0)
end

function var_0_0._onHeroLevelSelectChanged(arg_84_0, arg_84_1)
	...
	arg_84_0.selectHeroLevelId = tonumber(var_84_0)
end

function var_0_0._onClickHeroFaithOk(arg_85_0)
	if arg_85_0.selectHeroFaithId == 0 then
		return
	end

	GameFacade.showToast(ToastEnum.GMTool5, arg_85_0.selectHeroFaithId)
	GMRpc.instance:sendGMRequest(string.format("add material %d#%d#%d", 6, arg_85_0.selectHeroFaithId, HeroConfig.instance.maxFaith))
end

function var_0_0._onClickHeroLevelOk(arg_86_0)
	if arg_86_0.selectHeroLevelId == 0 then
		return
	end

	local var_86_0 = arg_86_0._inpHeroLevel:GetText()

	GameFacade.showToast(ToastEnum.GMToolFastAddHero, string.format(" 等级%d 洞悉%d 共鸣%d 塑造%d", var_86_0, 100, 100, 2))
	GMRpc.instance:sendGMRequest(string.format("add heroAttr %d#%d#%d#%d#%d", arg_86_0.selectHeroLevelId, var_86_0, 100, 100, 2))
end

function var_0_0._initWeatherSelect(arg_87_0)
	arg_87_0.weatherReportIdList = {}

	for iter_87_0, iter_87_1 in ipairs(lua_weather_report.configList) do
		local var_87_0 = BGMSwitchProgress.WeatherLight[iter_87_1.lightMode]
		local var_87_1 = BGMSwitchProgress.WeatherEffect[iter_87_1.effect]
		local var_87_2 = string.format("%d %s-%s", iter_87_1.id, var_87_0, var_87_1)

		table.insert(arg_87_0.weatherReportIdList, var_87_2)
	end

	arg_87_0._dropWeather:ClearOptions()
	arg_87_0._dropWeather:AddOptions(arg_87_0.weatherReportIdList)

	if WeatherController.instance._curReport then
		arg_87_0._dropWeather:SetValue(WeatherController.instance._curReport.id - 1)
	end

	arg_87_0._dropWeather:AddOnValueChanged(arg_87_0._onWeatherChange, arg_87_0)
end

function var_0_0._onWeatherChange(arg_88_0, arg_88_1)
	WeatherController.instance:setReportId(arg_88_1 + 1)
end

function var_0_0._onClickGetAllHeroBtn(arg_89_0)
...
function var_0_0._onClickDeleteAllHeroInfoBtn(arg_91_0)
...
function var_0_0._refreshGMBtnText(arg_94_0)
	if not arg_94_0.showGMBtn then
		arg_94_0.showGMBtn = PlayerPrefsHelper.getNumber(PlayerPrefsKey.GMToolViewShowGMBtn, 1)
	end

	if arg_94_0.showGMBtn == 1 then
		arg_94_0._txtGM.text = "隐藏GM按钮"
	else
		arg_94_0._txtGM.text = "显示GM按钮"
	end
end

function var_0_0._onClickHideGMBtn(arg_95_0)
	arg_95_0.showGMBtn = arg_95_0.showGMBtn == 1 and 0 or 1

	arg_95_0:_refreshGMBtnText()
	PlayerPrefsHelper.setNumber(PlayerPrefsKey.GMToolViewShowGMBtn, arg_95_0.showGMBtn)
	MainController.instance:dispatchEvent(MainEvent.OnChangeGMBtnStatus)
end

function var_0_0._onClickUnLockAllEpisode(arg_96_0)
	GMRpc.instance:sendGMRequest("set dungeon all")
end

function var_0_0._onClickOpenHuaRongViewBtn(arg_97_0)
	ViewMgr.instance:openView(ViewName.DungeonHuaRongView)
end

function var_0_0._onClickOpenSeasonViewBtn(arg_98_0)
	local var_98_0 = FeiLinShiDuoConfig.instance:getGameEpisode(1251301)
	local var_98_1 = {
		mapId = FeiLinShiDuoEnum.TestMapId,
		gameConfig = var_98_0
	}

	FeiLinShiDuoGameController.instance:openGameView(var_98_1)
end

function var_0_0._onEarToggleValueChange(arg_99_0)
	if not arg_99_0.initDone then
		return
	end

	local var_99_0 = SDKMgr.instance:isEarphoneContact()

	arg_99_0._toggleEar.isOn = var_99_0
end

function var_0_0._onClickShowHero(arg_100_0)
	if not ViewMgr.instance:isOpen(ViewName.MainView) then
		return
	end

	arg_100_0.showHero = not arg_100_0.showHero

	arg_100_0:_showHero()
end

function var_0_0._showHero(arg_101_0)
	if not ViewMgr.instance:isOpen(ViewName.MainView) then
		return
	end

	if not arg_101_0.heroNodes then
		local var_101_0 = ViewMgr.instance:getContainer(ViewName.MainView)

		arg_101_0.heroNodes = {}

		table.insert(arg_101_0.heroNodes, gohelper.findChild(var_101_0.viewGO, "#go_spine_scale"))
		table.insert(arg_101_0.heroNodes, gohelper.findChild(var_101_0.viewGO, "#go_lightspinecontrol"))
	end

	for iter_101_0, iter_101_1 in pairs(arg_101_0.heroNodes) do
		gohelper.setActive(iter_101_1, arg_101_0.showHero)
	end

	arg_101_0._txtshowHero.text = arg_101_0.showHero and "隐藏主界面角色" or "显示主界面角色"

	PlayerPrefsHelper.setNumber(PlayerPrefsKey.ShowHeroKey, arg_101_0.showHero and 1 or 0)
end

function var_0_0._onClickShowUI(arg_102_0)
	if not ViewMgr.instance:isOpen(ViewName.MainView) then
		return
	end

	arg_102_0.showUI = not arg_102_0.showUI

	arg_102_0:_showUI()
end

function var_0_0._showUI(arg_103_0)
	if not ViewMgr.instance:isOpen(ViewName.MainView) then
		return
	end

	if not arg_103_0.uiNodes then
		arg_103_0.uiNodes = {}

		table.insert(arg_103_0.uiNodes, arg_103_0:getIDCanvasNode())

		local var_103_0 = ViewMgr.instance:getContainer(ViewName.MainView)

		table.insert(arg_103_0.uiNodes, gohelper.findChild(var_103_0.viewGO, "left"))
		table.insert(arg_103_0.uiNodes, gohelper.findChild(var_103_0.viewGO, "left_top"))
		table.insert(arg_103_0.uiNodes, gohelper.findChild(var_103_0.viewGO, "#go_righttop"))
		table.insert(arg_103_0.uiNodes, gohelper.findChild(var_103_0.viewGO, "right"))
		table.insert(arg_103_0.uiNodes, gohelper.findChild(var_103_0.viewGO, "bottom"))
	end

	for iter_103_0, iter_103_1 in pairs(arg_103_0.uiNodes) do
		gohelper.setActive(iter_103_1, arg_103_0.showUI)
	end

	arg_103_0._txtshowUI.text = arg_103_0.showUI and "隐藏主界面UI" or "显示主界面UI"

	PlayerPrefsHelper.setNumber(PlayerPrefsKey.ShowUIKey, arg_103_0.showUI and 1 or 0)

	arg_103_0.showID = arg_103_0.showUI

	arg_103_0:_showID()
end

function var_0_0._onClickShowID(arg_104_0)
	arg_104_0.showID = not arg_104_0.showID

	arg_104_0:_showID()
end

function var_0_0._showID(arg_105_0)
	gohelper.setActive(arg_105_0:getIDCanvasNode(), arg_105_0.showID)

	arg_105_0._txtshowId.text = arg_105_0.showID and "隐藏左下角ID" or "显示左下角ID"

	PlayerPrefsHelper.setNumber(PlayerPrefsKey.ShowIDKey, arg_105_0.showID and 1 or 0)
end

function var_0_0._onClickWaterMark(arg_106_0)
	arg_106_0.showWaterMark = not arg_106_0.showWaterMark

	arg_106_0:_showWaterMark()
end

function var_0_0._showWaterMark(arg_107_0)
	local var_107_0 = ViewMgr.instance:getContainer(ViewName.WaterMarkView)

	if var_107_0 then
		if arg_107_0.showWaterMark then
			var_107_0.waterMarkView:showWaterMark()
		else
			var_107_0.waterMarkView:hideWaterMark()
		end

		arg_107_0._txtwatermark.text = arg_107_0.showWaterMark and "隐藏水印" or "显示水印"
	end
end

function var_0_0.getIDCanvasNode(arg_108_0)
	if not arg_108_0.goIDRoot then
		arg_108_0.goIDRoot = gohelper.find("IDCanvas")
	end

	if not arg_108_0.goIDPopup then
		arg_108_0.goIDPopup = gohelper.findChild(arg_108_0.goIDRoot, "POPUP")
	end

	return arg_108_0.goIDPopup
end

function var_0_0._onBtnCopyTalentData(arg_109_0)
	CharacterController.instance:dispatchEvent(CharacterEvent.CopyTalentData)
end

function var_0_0._onBtnPrintAllEntityBuff(arg_110_0)
	logError("打印角色的当前buffid~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")

	local var_110_0 = FightHelper.getAllEntitys()

	for iter_110_0, iter_110_1 in ipairs(var_110_0) do
		local var_110_1 = iter_110_1:getMO()

		logError("角色id或者怪物id: " .. var_110_1.modelId)

		local var_110_2 = var_110_1:getBuffList()

		for iter_110_2, iter_110_3 in ipairs(var_110_2) do
			logError("携带buffid: " .. iter_110_3.buffId)
		end
	end
end

function var_0_0._onClickBtnFastAddHero(arg_111_0)
	arg_111_0:closeThis()
	ViewMgr.instance:openView(ViewName.GMToolFastAddHeroView)
end

function var_0_0._OnBtnReplaceSummonHeroClick(arg_112_0)
	local var_112_0 = arg_112_0._inpHeroList:GetText()

	if string.nilorempty(var_112_0) then
		return
	end

	local var_112_1 = string.splitToNumber(var_112_0, ";")
	local var_112_2 = {}
	local var_112_3
	...
	for iter_112_0, iter_112_1 in ipairs(var_112_1) do
		...
		table.insert(var_112_2, var_112_4)
	end

	local var_112_5 = SummonController.summonSuccess

	function SummonController.summonSuccess(arg_113_0, arg_113_1)
		var_112_5(arg_113_0, var_112_2)
	end
end

function var_0_0._testJavaCrash(arg_114_0)
	CrashSightAgent.TestJavaCrash()
end

function var_0_0._testOcCrash(arg_115_0)
	CrashSightAgent.TestOcCrash()
end

function var_0_0._testNativeCrash(arg_116_0)
	CrashSightAgent.TestNativeCrash()
end

function var_0_0._onClickEnterView(arg_117_0)
	local var_117_0 = arg_117_0._inpViewName:GetText()

	if string.nilorempty(var_117_0) then
		GameFacade.showToastString("请输入界面名字")
	elseif ViewName[var_117_0] then
		arg_117_0:closeThis()
		ViewMgr.instance:openView(ViewName[var_117_0])
		PlayerPrefsHelper.setString(PlayerPrefsKey.GMToolViewOpenView, var_117_0)
	else
		GameFacade.showToastString(string.format("界面%s不存在", var_117_0))
	end
end
