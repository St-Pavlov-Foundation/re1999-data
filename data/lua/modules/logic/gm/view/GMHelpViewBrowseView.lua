...
function var_0_0._onClickTab(arg_8_0, arg_8_1)
	GMHelpViewBrowseModel.instance:setListByTabMode(arg_8_1)
end
...
function var_0_0.removeEvents(arg_9_0)
	...
	for iter_9_0, iter_9_1 in ipairs(arg_9_0._tabBtnList) do
		iter_9_1:RemoveClickListener()
	end
end
...
function var_0_0.onOpen(arg_11_0)
	...
	arg_11_0:_onClickTab(GMHelpViewBrowseModel.tabModeEnum.helpView)
end
