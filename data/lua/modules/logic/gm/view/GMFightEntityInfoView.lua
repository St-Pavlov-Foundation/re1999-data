...
function var_0_0._onSelectHero(arg_6_0, arg_6_1)
	...
	local var_6_5 = FightEnum.TeamType.MySide
	local var_6_6 = FightDataHelper.getBloodPool(var_6_5)
	local var_6_7 = arg_6_0._entityMO.id == FightEntityScene.MySideId and var_6_6

	if var_6_7 then
		arg_6_0.bloodPool_input:SetText(var_6_6.value)

		arg_6_0.bloodPool_max.text = "/" .. tostring(var_6_6.max)
	end

	gohelper.setActive(arg_6_0.bloodPool_go, var_6_7)

	local var_6_8 = FightHelper.getSurvivalEntityHealth(arg_6_1.id)
	local var_6_9 = var_6_8 ~= nil

	gohelper.setActive(arg_6_0.health_go, var_6_9)

	if var_6_9 then
		arg_6_0.health_input:SetText(var_6_8)
	...
	if not arg_6_1:isMonster() or not lua_monster.configDict[arg_6_1.modelId] then
		local var_6_10 = lua_character.configDict[arg_6_1.modelId]
	end

	local var_6_11 = FightConfig.instance:getSkinCO(arg_6_1.originSkin)

	if arg_6_1:isCharacter() then
		local var_6_12 = ResUrl.getHeadIconSmall(var_6_11.retangleIcon)

		arg_6_0._icon:LoadImage(var_6_12)
	elseif arg_6_1:isMonster() then
		gohelper.getSingleImage(arg_6_0._imgIcon.gameObject):LoadImage(ResUrl.monsterHeadIcon(var_6_11.headIcon))

		arg_6_0._imgIcon.enabled = true
	end

	local var_6_13 = arg_6_1:getCareer()

	if var_6_13 ~= 0 then
		UISpriteSetMgr.instance:setEnemyInfoSprite(arg_6_0._imgCareer, "sxy_" .. tostring(var_6_13))
	end
end
...
function var_0_0._onEndEditBloodPool(arg_13_0, arg_13_1)
	...
	local var_13_1 = FightEnum.TeamType.MySide
	local var_13_2 = FightDataHelper.getBloodPool(var_13_1)
	local var_13_3 = var_13_2.max
	local var_13_4 = math.min(math.max(0, var_13_0), var_13_3)

	var_13_2.value = var_13_4

	GMRpc.instance:sendGMRequest(string.format("setBloodPoolValue %d", var_13_4))
	FightController.instance:dispatchEvent(FightEvent.BloodPool_ValueChange, var_13_1)
end

function var_0_0._onEndEditHealth(arg_14_0, arg_14_1)
