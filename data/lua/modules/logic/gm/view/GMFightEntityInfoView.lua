...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0.alert_input = gohelper.findChildTextMeshInputField(arg_1_0.viewGO, "info/Scroll View/Viewport/Content/power/alert/input")
	arg_1_0.alert_max = gohelper.findChildText(arg_1_0.viewGO, "info/Scroll View/Viewport/Content/power/alert/max")
	arg_1_0.alert_go = gohelper.findChild(arg_1_0.viewGO, "info/Scroll View/Viewport/Content/power/alert")
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0.alert_input:AddOnEndEdit(arg_2_0._onEndEditAlert, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0.alert_input:RemoveOnEndEdit()
...
function var_0_0._onSelectHero(arg_6_0, arg_6_1)
	...
	local var_6_2 = arg_6_1:getPowerInfo(FightEnum.PowerType.Alert)

	if var_6_2 then
		arg_6_0.alert_input:SetText(tostring(var_6_2.num))

		arg_6_0.alert_max.text = "/" .. tostring(var_6_2.max)
	end

	gohelper.setActive(arg_6_0.alert_go, var_6_2)

	local var_6_3 = arg_6_1:getPowerInfo(FightEnum.PowerType.Stress)

	if var_6_3 then
		arg_6_0.stress_input:SetText(tostring(var_6_3.num))

		arg_6_0.stress_max.text = "/" .. tostring(var_6_3.max)
	end

	gohelper.setActive(arg_6_0.stress_go, arg_6_1:hasStress())

	if var_6_0 then
		local var_6_4 = arg_6_1:getPowerInfo(FightEnum.PowerType.AssistBoss)

		arg_6_0.assistBoss_input:SetText(tostring(var_6_4.num))

		arg_6_0.assistBoss_max.text = "/" .. tostring(var_6_4.max)
	end

	gohelper.setActive(arg_6_0.assistBoss_go, var_6_0)

	local var_6_5 = arg_6_1:isASFDEmitter()
...
function var_0_0._onEndEditAlert(arg_10_0, arg_10_1)
	local var_10_0 = GMFightEntityModel.instance.entityMO
	local var_10_1 = var_10_0:getPowerInfo(FightEnum.PowerType.Alert)

	if not var_10_1 then
		return
	end

	local var_10_2 = tonumber(arg_10_1)

	if var_10_2 then
		local var_10_3 = var_10_1 and var_10_1.num or 0
		local var_10_4 = var_10_1 and var_10_1.max or 0
		local var_10_5 = Mathf.Clamp(var_10_2, 0, var_10_4)

		if var_10_2 ~= var_10_5 then
			arg_10_0.alert_input:SetTextWithoutNotify(tostring(var_10_5))
		end

		var_10_1.num = var_10_5

		local var_10_6 = FightLocalDataMgr.instance:getEntityById(var_10_0.id)

		if var_10_6 then
			local var_10_7 = var_10_6:getPowerInfo(FightEnum.PowerType.Alert)
		...
		FightController.instance:dispatchEvent(FightEvent.PowerChange, var_10_0.id, FightEnum.PowerType.Alert, var_10_3, var_10_5)
		GMRpc.instance:sendGMRequest(string.format("fightChangePower %s %s %d", var_10_0.id, FightEnum.PowerType.Alert, var_10_5))
	end
end

function var_0_0._onEndEditStress(arg_11_0, arg_11_1)
	local var_11_0 = GMFightEntityModel.instance.entityMO

	if not var_11_0:hasStress() then
		return
	end
	...
	if var_11_1 then
		local var_11_2 = var_11_0:getPowerInfo(FightEnum.PowerType.Stress)
		...
		if var_11_1 ~= var_11_5 then
			arg_11_0.stress_input:SetTextWithoutNotify(tostring(var_11_5))
		end
		...
		if var_11_6 then
			local var_11_7 = var_11_6:getPowerInfo(FightEnum.PowerType.Stress)
		...
		FightController.instance:dispatchEvent(FightEvent.PowerChange, var_11_0.id, FightEnum.PowerType.Stress, var_11_3, var_11_5)
		GMRpc.instance:sendGMRequest(string.format("fightChangePower %s %s %d", var_11_0.id, FightEnum.PowerType.Stress, var_11_5))
	end
end

function var_0_0._onEndEditAssistBoss(arg_12_0, arg_12_1)
	local var_12_0 = GMFightEntityModel.instance.entityMO

	if not var_12_0:isAssistBoss() then
		return
	end
	...
	if var_12_1 then
		local var_12_2 = var_12_0:getPowerInfo(FightEnum.PowerType.AssistBoss)
		local var_12_3 = var_12_2 and var_12_2.num or 0
		local var_12_4 = var_12_2 and var_12_2.max or 0
		local var_12_5 = Mathf.Clamp(var_12_1, 0, var_12_4)

		if var_12_1 ~= var_12_5 then
			arg_12_0.assistBoss_input:SetTextWithoutNotify(tostring(var_12_5))
		end

		var_12_2.num = var_12_5

		local var_12_6 = FightLocalDataMgr.instance:getEntityById(var_12_0.id)

		if var_12_6 then
			local var_12_7 = var_12_6:getPowerInfo(FightEnum.PowerType.AssistBoss)

			if var_12_7 then
				var_12_7.num = var_12_5
			end
		end

		FightController.instance:dispatchEvent(FightEvent.PowerChange, var_12_0.id, FightEnum.PowerType.AssistBoss, var_12_3, var_12_5)
		GMRpc.instance:sendGMRequest(string.format("fightChangePower %s %s %d", var_12_0.id, FightEnum.PowerType.AssistBoss, var_12_5))
	end
end

function var_0_0._onEndEditEmitterEnergy(arg_13_0, arg_13_1)
	local var_13_0 = GMFightEntityModel.instance.entityMO

	if not var_13_0:isASFDEmitter() then
		return
	end

	local var_13_1 = tonumber(arg_13_1)
