...
function var_0_0.getSubPlaceholderLuaLang(arg_2_0, arg_2_1)
	...
	if arg_2_1 and #arg_2_1 > 0 then
		for iter_2_0, iter_2_1 in pairs(arg_2_1) do
			if type(iter_2_1) == "number" then
				arg_2_0 = string.gsub(arg_2_0, "▩" .. iter_2_0 .. "%%d", string.format("%d", iter_2_1))
			else
				iter_2_1 = var_0_1(iter_2_1)
			end

			arg_2_0 = string.gsub(arg_2_0, "▩" .. iter_2_0 .. "%%s", iter_2_1)
		end

		if var_0_0.instance:checkHasCache(arg_2_0) == false then
			var_0_0.instance._inUseDic[arg_2_0] = {}

			for iter_2_2, iter_2_3 in pairs(var_2_0) do
				for iter_2_4, iter_2_5 in pairs(arg_2_1) do
					if type(iter_2_5) == "number" then
						iter_2_3 = string.gsub(iter_2_3, "▩" .. iter_2_4 .. "%%d", string.format("%d", iter_2_5))
					else
						iter_2_5 = var_0_1(iter_2_5)
					end

					iter_2_3 = string.gsub(arg_2_0, "▩" .. iter_2_4 .. "%%s", iter_2_5)
				end

				var_0_0.instance._inUseDic[arg_2_0][iter_2_2] = iter_2_3
			end
