...
function var_0_0._setTitleInfo(arg_36_0)
	...
	local var_36_1 = os.date("%w", var_36_0)
...
function var_0_0._showMonthRewardInfo(arg_52_0, arg_52_1)
	...
	arg_52_0["_txtmonthrewardcount" .. arg_52_1].text = string.format("%s%s", luaLang("multiple"), var_52_0.reward[3])
...
function var_0_0._setMonthViewRewardTips(arg_53_0)
	...
	arg_53_0._txtdaycount.text = var_53_0

	local var_53_1 = SignInConfig.instance:getSignMonthRewards()

	for iter_53_0 = 1, 3 do
		arg_53_0:_showMonthRewardInfo(iter_53_0)
	end

	local var_53_2 = SignInModel.instance:isSignTotalRewardGet(1)
	local var_53_3 = SignInModel.instance:getTotalSignDays() >= tonumber(SignInConfig.instance:getSignMonthReward(1).signinaddup)

	gohelper.setActive(arg_53_0._gorewardmark1, not var_53_2 and var_53_3)
	gohelper.setActive(arg_53_0._gogetmonthbg1, var_53_3)
	...
	local var_53_4 = SignInModel.instance:isSignTotalRewardGet(2)
	local var_53_5 = SignInModel.instance:getTotalSignDays() >= tonumber(SignInConfig.instance:getSignMonthReward(2).signinaddup)

	gohelper.setActive(arg_53_0._gorewardmark2, not var_53_4 and var_53_5)
	gohelper.setActive(arg_53_0._gogetmonthbg2, var_53_5)
	...
	local var_53_6 = SignInModel.instance:isSignTotalRewardGet(3)
	local var_53_7 = SignInModel.instance:getTotalSignDays() >= tonumber(SignInConfig.instance:getSignMonthReward(3).signinaddup)

	gohelper.setActive(arg_53_0._gorewardmark3, not var_53_6 and var_53_7)
	gohelper.setActive(arg_53_0._gogetmonthbg3, var_53_7)
	...
	local var_53_8 = SignInModel.instance:getSignTargetDate()

	arg_53_0:_setGoldRewards(var_53_8)

	arg_53_0._curDayRewards = string.splitToNumber(SignInConfig.instance:getSignRewards(var_53_8[3]).signinBonus, "#")

	local var_53_9, var_53_10 = ItemModel.instance:getItemConfigAndIcon(arg_53_0._curDayRewards[1], arg_53_0._curDayRewards[2], true)
	...
	arg_53_0._simagenormaldayrewardicon:LoadImage(var_53_10)
	arg_53_0._simagemonthcarddayrewardicon:LoadImage(var_53_10)

	if tonumber(arg_53_0._curDayRewards[1]) == MaterialEnum.MaterialType.Equip then
		arg_53_0._simagenormaldayrewardicon:LoadImage(ResUrl.getPropItemIcon(var_53_9.icon))
		arg_53_0._simagemonthcarddayrewardicon:LoadImage(ResUrl.getPropItemIcon(var_53_9.icon))
	end

	local var_53_11 = SignInModel.instance:getValidMonthCard(var_53_8[1], var_53_8[2], var_53_8[3])

	gohelper.setActive(arg_53_0._gomonthcard, var_53_11)
	gohelper.setActive(arg_53_0._gonormal, not var_53_11)

	if var_53_11 then
		local var_53_12 = string.split(StoreConfig.instance:getMonthCardConfig(var_53_11).dailyBonus, "|")

		arg_53_0._curmonthCardRewards = string.splitToNumber(var_53_12[1], "#")
		arg_53_0._curmonthCardPower = string.splitToNumber(var_53_12[2], "#")
		...
		local var_53_13, var_53_14 = ItemModel.instance:getItemConfigAndIcon(arg_53_0._curmonthCardRewards[1], arg_53_0._curmonthCardRewards[2], true)

		arg_53_0._simagemonthcardicon:LoadImage(var_53_14)

		local var_53_15, var_53_16 = ItemModel.instance:getItemConfigAndIcon(arg_53_0._curmonthCardPower[1], arg_53_0._curmonthCardPower[2], true)

		arg_53_0._simagemonthcardpowericon:LoadImage(var_53_16)
		gohelper.setActive(arg_53_0._gopowerlimittime, false)

		if var_53_15.expireTime then
			gohelper.setActive(arg_53_0._gopowerlimittime, true)
		end

		local var_53_17 = StoreModel.instance:getMonthCardInfo()

		if var_53_17 then
			local var_53_18 = var_53_17:getRemainDay()

			if var_53_18 > 0 then
				gohelper.setActive(arg_53_0._golimittime.gameObject, true)

				if var_53_18 <= StoreEnum.MonthCardStatus.NotEnoughThreeDay then
				...
				arg_53_0._txtlimittime.text = formatLuaLang("remain_day", var_53_18)
			else
				gohelper.setActive(arg_53_0._golimittime.gameObject, false)
			end
		end

		local var_53_19 = arg_53_0._curDate.year == arg_53_0._targetDate[1] and arg_53_0._curDate.month == arg_53_0._targetDate[2] and arg_53_0._curDate.day == arg_53_0._targetDate[3] and not arg_53_0._rewardGetState

		gohelper.setActive(arg_53_0._gomonthcardget, var_53_19)
		gohelper.setActive(arg_53_0._gomonthcarddayget, var_53_19)
		gohelper.setActive(arg_53_0._gomonthcarddayget_gold, var_53_19)
		gohelper.setActive(arg_53_0._gomonthcardnoget, not var_53_19)
		gohelper.setActive(arg_53_0._gomonthcardpowernoget, not var_53_19)
		gohelper.setActive(arg_53_0._gomonthcarddaynoget, not var_53_19)
		gohelper.setActive(arg_53_0._gomonthcarddaynoget_gold, not var_53_19)
	end
end
