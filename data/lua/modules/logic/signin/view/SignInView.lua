...
function var_0_0._setTitleInfo(arg_40_0)
	...
	local var_40_1 = os.date("%w", var_40_0)
...
function var_0_0._setMonthViewRewardTips(arg_52_0)
	...
	arg_52_0._txtdaycount.text = var_52_0

	local var_52_1 = SignInConfig.instance:getSignMonthRewards()

	for iter_52_0 = 1, 3 do
		arg_52_0:_showMonthRewardInfo(iter_52_0)
	end

	local var_52_2 = SignInModel.instance:isSignTotalRewardGet(1)
	local var_52_3 = SignInModel.instance:getTotalSignDays() >= tonumber(SignInConfig.instance:getSignMonthReward(1).signinaddup)

	gohelper.setActive(arg_52_0._gorewardmark1, not var_52_2 and var_52_3)
	gohelper.setActive(arg_52_0._gogetmonthbg1, var_52_3)
	...
	local var_52_4 = SignInModel.instance:isSignTotalRewardGet(2)
	local var_52_5 = SignInModel.instance:getTotalSignDays() >= tonumber(SignInConfig.instance:getSignMonthReward(2).signinaddup)

	gohelper.setActive(arg_52_0._gorewardmark2, not var_52_4 and var_52_5)
	gohelper.setActive(arg_52_0._gogetmonthbg2, var_52_5)
	...
	local var_52_6 = SignInModel.instance:isSignTotalRewardGet(3)
	local var_52_7 = SignInModel.instance:getTotalSignDays() >= tonumber(SignInConfig.instance:getSignMonthReward(3).signinaddup)

	gohelper.setActive(arg_52_0._gorewardmark3, not var_52_6 and var_52_7)
	gohelper.setActive(arg_52_0._gogetmonthbg3, var_52_7)
	...
	local var_52_8 = SignInModel.instance:getSignTargetDate()

	arg_52_0:_setGoldRewards(var_52_8)

	arg_52_0._curDayRewards = string.splitToNumber(SignInConfig.instance:getSignRewards(var_52_8[3]).signinBonus, "#")

	local var_52_9, var_52_10 = ItemModel.instance:getItemConfigAndIcon(arg_52_0._curDayRewards[1], arg_52_0._curDayRewards[2], true)
	...
	arg_52_0._simagenormaldayrewardicon:LoadImage(var_52_10)
	arg_52_0._simagemonthcarddayrewardicon:LoadImage(var_52_10)

	if tonumber(arg_52_0._curDayRewards[1]) == MaterialEnum.MaterialType.Equip then
		arg_52_0._simagenormaldayrewardicon:LoadImage(ResUrl.getPropItemIcon(var_52_9.icon))
		arg_52_0._simagemonthcarddayrewardicon:LoadImage(ResUrl.getPropItemIcon(var_52_9.icon))
	end

	local var_52_11 = SignInModel.instance:getValidMonthCard(var_52_8[1], var_52_8[2], var_52_8[3])

	gohelper.setActive(arg_52_0._gomonthcard, var_52_11)
	gohelper.setActive(arg_52_0._gonormal, not var_52_11)

	if var_52_11 then
		local var_52_12 = string.split(StoreConfig.instance:getMonthCardConfig(var_52_11).dailyBonus, "|")

		arg_52_0._curmonthCardRewards = string.splitToNumber(var_52_12[1], "#")
		arg_52_0._curmonthCardPower = string.splitToNumber(var_52_12[2], "#")
		...
		local var_52_13, var_52_14 = ItemModel.instance:getItemConfigAndIcon(arg_52_0._curmonthCardRewards[1], arg_52_0._curmonthCardRewards[2], true)

		arg_52_0._simagemonthcardicon:LoadImage(var_52_14)

		local var_52_15, var_52_16 = ItemModel.instance:getItemConfigAndIcon(arg_52_0._curmonthCardPower[1], arg_52_0._curmonthCardPower[2], true)

		arg_52_0._simagemonthcardpowericon:LoadImage(var_52_16)
		gohelper.setActive(arg_52_0._gopowerlimittime, false)

		if var_52_15.expireTime then
			gohelper.setActive(arg_52_0._gopowerlimittime, true)
		end

		local var_52_17 = StoreModel.instance:getMonthCardInfo()

		if var_52_17 then
			local var_52_18 = var_52_17:getRemainDay()

			if var_52_18 > 0 then
				gohelper.setActive(arg_52_0._golimittime.gameObject, true)

				if var_52_18 <= StoreEnum.MonthCardStatus.NotEnoughThreeDay then
				...
				arg_52_0._txtlimittime.text = formatLuaLang("remain_day", var_52_18)
			else
				gohelper.setActive(arg_52_0._golimittime.gameObject, false)
			end
		end

		local var_52_19 = arg_52_0._curDate.year == arg_52_0._targetDate[1] and arg_52_0._curDate.month == arg_52_0._targetDate[2] and arg_52_0._curDate.day == arg_52_0._targetDate[3] and not arg_52_0._rewardGetState

		gohelper.setActive(arg_52_0._gomonthcardget, var_52_19)
		gohelper.setActive(arg_52_0._gomonthcarddayget, var_52_19)
		gohelper.setActive(arg_52_0._gomonthcarddayget_gold, var_52_19)
		gohelper.setActive(arg_52_0._gomonthcardnoget, not var_52_19)
		gohelper.setActive(arg_52_0._gomonthcardpowernoget, not var_52_19)
		gohelper.setActive(arg_52_0._gomonthcarddaynoget, not var_52_19)
		gohelper.setActive(arg_52_0._gomonthcarddaynoget_gold, not var_52_19)
	end
end
...
function var_0_0._showMonthRewardInfo(arg_54_0, arg_54_1)
	...
	arg_54_0["_txtrewardcount" .. arg_54_1].text = string.format("%s%s", luaLang("multiple"), var_54_0.reward[3])
...
function var_0_0._refreshFestivalDecoration(arg_67_0)
	...
	gohelper.setActive(arg_67_0._gofestivaldecorationbg, var_67_0)
