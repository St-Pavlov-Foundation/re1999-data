...
function var_0_0._refreshChapterInfo(arg_14_0, arg_14_1)
	...
	if var_14_3 >= 2 then
		...
		local var_14_6 = GameUtil.utf8sub(var_14_2, 2, var_14_3 - 2)
		local var_14_7 = GameUtil.utf8sub(var_14_2, var_14_3, 1)

		var_14_4 = string.format("<size=86>%s</size>%s<size=86>%s</size>", var_14_5, var_14_6, var_14_7)
	else
	...
	local var_14_8, var_14_9, var_14_10, var_14_11, var_14_12, var_14_13 = ExploreSimpleModel.instance:getChapterCoinCount(var_14_0.id)
	local var_14_14 = ExploreSimpleModel.instance:isChapterCoinFull(var_14_0.id)
	local var_14_15 = var_14_8 == var_14_11
	local var_14_16 = var_14_9 == var_14_12
	local var_14_17 = var_14_10 == var_14_13

	for iter_14_0 = 1, 3 do
		UISpriteSetMgr.instance:setExploreSprite(arg_14_0._chapterProcess[iter_14_0].bg, var_14_14 and "dungeon_secretroom_img_full" or "dungeon_secretroom_img_unfull")
	end

	gohelper.setActive(arg_14_0._chapterProcess[1].dark, not var_14_17)
	gohelper.setActive(arg_14_0._chapterProcess[1].light, var_14_17)
	gohelper.setActive(arg_14_0._chapterProcess[2].dark, not var_14_16)
	gohelper.setActive(arg_14_0._chapterProcess[2].light, var_14_16)
	gohelper.setActive(arg_14_0._chapterProcess[3].dark, not var_14_15)
	gohelper.setActive(arg_14_0._chapterProcess[3].light, var_14_15)

	arg_14_0._txtrewarddesc.text = var_14_14 and luaLang("explore_collect_full") or luaLang("explore_collect")

	local var_14_18 = ExploreSimpleModel.instance:getChapterMo(arg_14_0._chapterCo.id)
	local var_14_19 = var_14_18 and tabletool.len(var_14_18.archiveIds) or 0
	local var_14_20 = ExploreConfig.instance:getArchiveTotalCount(arg_14_0._chapterCo.id)

	arg_14_0._txtfullbooknum.text = var_14_19 .. "/" .. var_14_20
	arg_14_0._txtunfullbooknum.text = var_14_19 .. "/" .. var_14_20

	gohelper.setActive(arg_14_0._gofullbooknum, var_14_20 <= var_14_19)
	gohelper.setActive(arg_14_0._gounfullbooknum, var_14_19 < var_14_20)

	arg_14_0._chapterProcess[1].progress.text = string.format("%d/%d", var_14_10, var_14_13)
	arg_14_0._chapterProcess[2].progress.text = string.format("%d/%d", var_14_9, var_14_12)
	arg_14_0._chapterProcess[3].progress.text = string.format("%d/%d", var_14_8, var_14_11)

	arg_14_0:_hideUnlockEffect()

	local var_14_21 = false

	if var_14_15 and not ExploreSimpleModel.instance:getCollectFullIsShow(var_14_0.id, ExploreEnum.CoinType.Bonus) then
	...
	if var_14_16 and not ExploreSimpleModel.instance:getCollectFullIsShow(var_14_0.id, ExploreEnum.CoinType.GoldCoin) then
	...
	if var_14_17 and not ExploreSimpleModel.instance:getCollectFullIsShow(var_14_0.id, ExploreEnum.CoinType.PurpleCoin) then
