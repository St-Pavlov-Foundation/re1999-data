...
function slot0._refreshChapterInfo(slot0, slot1)
	...
	slot6 = nil
	slot0._txtlevelname.text = (GameUtil.utf8len(slot2.name) < 2 or string.format("<size=86>%s</size>%s<size=86>%s</size>", GameUtil.utf8sub(slot4, 1, 1), GameUtil.utf8sub(slot4, 2, slot5 - 2), GameUtil.utf8sub(slot4, slot5, 1))) and "<size=86>" .. slot4
