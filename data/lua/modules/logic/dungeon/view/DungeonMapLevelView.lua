...
function slot0.onInitView(slot0)
	...
	slot1._txttitle3 = gohelper.findChildText(slot0.viewGO, "anim/right/title/#txt_title3")
	slot1._txtchapterindex = gohelper.findChildText(slot0.viewGO, "anim/right/title/#txt_title3/#txt_chapterindex")
...
function slot0.onStoryStatus(slot0)
	...
	recthelper.setAnchorY(slot0._txtdesc.transform, slot8 and 56.6 or 129.1)
...
function slot0.setTitleDesc(slot0)
	...
	if GameUtil.utf8len(slot1.name) >= 2 then
		slot4 = string.format("<size=80>%s</size>", GameUtil.utf8sub(slot1.name, 2, GameUtil.utf8len(slot1.name) - 1))
	end

	slot0._txttitle1.text = slot3 .. slot4
