...
function var_0_0._showProgress2(arg_20_0)
	...
	arg_20_0._txtcurprogress2.text = string.format("【%s】", var_20_3.battleName)
	arg_20_0._txtscenetype2.text = string.format("%s%s", var_20_3.typeName, var_20_3.name)
...
function var_0_0._showProgress(arg_22_0)
	...
	arg_22_0._txtcurprogress.text = string.format("【%s】", var_22_3.battleName)
	arg_22_0._txtscenetype.text = string.format("%s%s", var_22_3.typeName, var_22_3.name)
