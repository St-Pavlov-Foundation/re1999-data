...
function var_0_0._showProgress2(arg_16_0)
	...
	arg_16_0._txtcurprogress2.text = string.format("【%s】", var_16_3.battleName)
	arg_16_0._txtscenetype2.text = string.format("%s%s", var_16_3.typeName, var_16_3.name)
...
function var_0_0._showProgress(arg_18_0)
	...
	arg_18_0._txtcurprogress.text = string.format("【%s】", var_18_3.battleName)
	arg_18_0._txtscenetype.text = string.format("%s%s", var_18_3.typeName, var_18_3.name)
