-- chunkname: @modules/logic/dungeon/view/DungeonMapInteractiveItem110.lua

module("modules.logic.dungeon.view.DungeonMapInteractiveItem110", package.seeall)

local DungeonMapInteractiveItem110 = class("DungeonMapInteractiveItem110", BaseView)

function DungeonMapInteractiveItem110:onInitView()
	...
	self._goop110 = gohelper.findChild(self.viewGO, "rotate/#go_op110")
	self._txt110 = gohelper.findChildText(self.viewGO, "rotate/#go_op110/#go_versionactivity_puzzle/#txt_puzzle")
	self._btn110 = gohelper.findChildButtonWithAudio(self.viewGO, "rotate/#go_op110/#go_versionactivity_puzzle/#btn_puzzle")
	self._goop110finish = gohelper.findChild(self.viewGO, "rotate/#go_op110/#go_versionactivity_puzzle_finish")
	self._btn110puzzlefinish = gohelper.findChildButtonWithAudio(self.viewGO, "rotate/#go_op110/#go_versionactivity_puzzle_finish/#btn_puzzle_finish")
...
function DungeonMapInteractiveItem110:addEvents()
	...
	self._btn110:AddClickListener(self._btn110JumpGameOnClick, self)
	self._btn110puzzlefinish:AddClickListener(self._btn101PuzzleGameFinishOnClick, self)
end

function DungeonMapInteractiveItem110:removeEvents()
	...
	self._btn110:RemoveClickListener()
	self._btn110puzzlefinish:RemoveClickListener()
end

function DungeonMapInteractiveItem110:_btnfightuiuseOnClick()
	self:_btnfightOnClick()
end

function DungeonMapInteractiveItem110:_btnsubmitOnClick()
...
function DungeonMapInteractiveItem110:_closeMapInteractiveItem()
	self:_onHide()
end

function DungeonMapInteractiveItem110:_btnfinishtalkOnClick()
	self:_onHide()
...
function DungeonMapInteractiveItem110:_btndodialogOnClick()
	self:_onHide()
...
function DungeonMapInteractiveItem110:_onPlayDialogFinished()
	local dialogId = tonumber(self._config.param)
	local isFinish = DialogueModel.instance:isFinishDialogue(dialogId)
...
function DungeonMapInteractiveItem110:_btnunfinishtaskOnClick()
	self:_onHide()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
end
...
function DungeonMapInteractiveItem110:_btnnextOnClick()
	if self._playScrollAnim then
		return
	end
...
function DungeonMapInteractiveItem110:_btnpuzzlequestionOnClick()
...
function DungeonMapInteractiveItem110:_btnpuzzlepipeOnClick()
...
function DungeonMapInteractiveItem110:_btn102okOnClick()
	self:_onHide()
...
function DungeonMapInteractiveItem110:_btnpuzzlechangecolorOnClick()
...
function DungeonMapInteractiveItem110:_btnmazedrawOnClick()
...
function DungeonMapInteractiveItem110:_btnputcubegameOnClick()
...
function DungeonMapInteractiveItem110:_btn101PuzzleGameOnClick()
	self:_onHide()
...
function DungeonMapInteractiveItem110:_btn110JumpGameOnClick()
	self:_onHide()

	local storyId = tonumber(self._config.param)

	storyId = storyId and storyId or 101009

	local hasLocalProgress = DungeonJumpGameController.instance:HasLocalProgress()

	if not storyId or hasLocalProgress then
		self:_enterJumpGameView()
	...
	StoryController.instance:playStory(storyId, param, self._enterJumpGameView, self)
end

function DungeonMapInteractiveItem110:_enterJumpGameView()
...
function DungeonMapInteractiveItem110:_btntalkitemOnClick()
	return
end

function DungeonMapInteractiveItem110:_editableInitView()
...
function DungeonMapInteractiveItem110:_loadBgImage()
	return
end

function DungeonMapInteractiveItem110:_onScreenResize()
...
function DungeonMapInteractiveItem110:_hidePlaceholderText()
	gohelper.setActive(self._goplaceholdertext, false)
end

function DungeonMapInteractiveItem110:_onInputAnswerEndEdit()
	gohelper.setActive(self._goplaceholdertext, true)
end

function DungeonMapInteractiveItem110:_playAnim(go, name)
	local animator = go:GetComponent(typeof(UnityEngine.Animator))

	animator:Play(name)
end

function DungeonMapInteractiveItem110:_playBtnsQuitAnim()
	...
	for _, value in pairs(DungeonEnum.ChapterId) do
		local go = self["_goop" .. value]
...
function DungeonMapInteractiveItem110:_onShow()
	if self._show then
		return
	end
...
function DungeonMapInteractiveItem110:_showCloseBtn()
	gohelper.setActive(self._btnclose.gameObject, true)
end

function DungeonMapInteractiveItem110:_onOutAnimationFinished()
	gohelper.setActive(self.viewGO, false)
	UIBlockMgr.instance:endBlock("dungeonmap_interactive_out")
	gohelper.destroy(self.viewGO)
end

function DungeonMapInteractiveItem110:_asynHide(viewName)
...
function DungeonMapInteractiveItem110:_onHide()
	if not self._show then
		return
	end
...
function DungeonMapInteractiveItem110:_onViewClose(viewName)
	if viewName == self._waitCloseViewName then
		self:_cancelAsynHide()
	end
end

function DungeonMapInteractiveItem110:_onClickElement()
	self:_cancelAsynHide()
end

function DungeonMapInteractiveItem110:_cancelAsynHide()
...
function DungeonMapInteractiveItem110:init(go)
	self.viewGO = go
...
function DungeonMapInteractiveItem110:_editableAddEvents()
	...
	self._handleTypeMap[DungeonEnum.ElementType.JumpGame] = self._showJumpGame
end

function DungeonMapInteractiveItem110:_showElementTitle()
...
function DungeonMapInteractiveItem110:_refreshType()
...
function DungeonMapInteractiveItem110:_OnClickElement(mapElement)
...
function DungeonMapInteractiveItem110:_showRewards()
...
function DungeonMapInteractiveItem110:_openRewardView(rewardList)
	AudioMgr.instance:trigger(AudioEnum.UI.Play_UI_Copies)
	DungeonController.instance:openDungeonElementRewardView(rewardList)
end

function DungeonMapInteractiveItem110:_playQuestion()
	self._txtinfo.text = self._config.desc
end

function DungeonMapInteractiveItem110:_showFight()
	local episodeId = tonumber(self._config.param)
...
function DungeonMapInteractiveItem110:_addToMapView()
...
function DungeonMapInteractiveItem110:_showTask()
	self._txtinfo.text = self._config.desc
...
function DungeonMapInteractiveItem110:_showPuzzleQuestion()
...
function DungeonMapInteractiveItem110:_showPuzzlePipeGame()
	local isClear = DungeonMapModel.instance:hasMapPuzzleStatus(self._config.id)
...
function DungeonMapInteractiveItem110:_showPuzzleChangeColor()
	local isClear
end

function DungeonMapInteractiveItem110:_showPuzzleMazeDraw()
	local isClear = DungeonMapModel.instance:hasMapPuzzleStatus(self._config.id)
...
function DungeonMapInteractiveItem110:_showPutCubeGame()
	return
end

function DungeonMapInteractiveItem110:_showOuijaGame()
	local isClear = DungeonMapModel.instance:hasMapPuzzleStatus(self._config.id)
...
function DungeonMapInteractiveItem110:_showPuzzleGame()
...
function DungeonMapInteractiveItem110:_showEnterDialog()
	self._txtinfo.text = self._config.desc
	self._txtdodialog.text = self._config.acceptText
end

function DungeonMapInteractiveItem110:_showJumpGame()
	self._txt110.text = self._config.acceptText
	self._txtinfo.text = self._config.desc

	self._goop110:SetActive(true)
	self._goop110finish:SetActive(false)
end

function DungeonMapInteractiveItem110:_showSpStory()
...
function DungeonMapInteractiveItem110:_directlyComplete()
	self._txtdoit.text = self._config.acceptText
	self._txtinfo.text = self._config.desc
end

function DungeonMapInteractiveItem110:_playNextSectionOrDialog()
	self:_clearDialog()
...
function DungeonMapInteractiveItem110:_playStory()
	self:_clearDialog()
...
function DungeonMapInteractiveItem110:_playSection(sectionId, dialogIndex)
	self:_setSectionData(sectionId, dialogIndex)
	self:_playNextDialog()
end

function DungeonMapInteractiveItem110:_setSectionData(sectionId, dialogIndex)
...
function DungeonMapInteractiveItem110:_playNextDialog()
...
function DungeonMapInteractiveItem110:_refreshDialogBtnState(showOption, hasNext)
...
function DungeonMapInteractiveItem110:_addDialogOption(index, sectionId, text)
...
function DungeonMapInteractiveItem110:_onOptionClick(param)
	if self._playScrollAnim then
		return
	end
...
function DungeonMapInteractiveItem110:_showDialog(type, text, speaker, audio)
...
function DungeonMapInteractiveItem110:_clearDialog()
	self._dialogItemList = self:getUserDataTb_()
...
function DungeonMapInteractiveItem110:_delayScroll()
...
function DungeonMapInteractiveItem110:_scrollEnd(scrollGo)
...
function DungeonMapInteractiveItem110:_onDissolveStart()
...
function DungeonMapInteractiveItem110:_onDissolveFinish()
	self:_playAudio()
...
function DungeonMapInteractiveItem110:_playAudio()
...
function DungeonMapInteractiveItem110:_onAudioStop(audioId)
	gohelper.setActive(self._audioIcon, false)
end

function DungeonMapInteractiveItem110:setBtnClosePosZ(posZ)
...
function DungeonMapInteractiveItem110:setScale(scale)
	transformhelper.setLocalScale(self.viewGO.transform, scale, scale, scale)
end

function DungeonMapInteractiveItem110:_clearScroll()
	self._showOption = false
	self._dissolveInfo = nil
	self._playScrollAnim = false
...
function DungeonMapInteractiveItem110:_editableRemoveEvents()
	for k, v in pairs(self._optionBtnList) do
...
function DungeonMapInteractiveItem110:onDestroy()
