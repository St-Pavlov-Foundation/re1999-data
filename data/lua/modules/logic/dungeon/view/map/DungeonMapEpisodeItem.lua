...
function var_0_0.onUpdateParam(arg_11_0)
	...
	local var_11_0 = arg_11_0._config.chainEpisode

	if var_11_0 ~= 0 then
		gohelper.setActive(arg_11_0._goflag, not DungeonModel.instance:hasPassLevelAndStory(var_11_0))
	else
		gohelper.setActive(arg_11_0._goflag, not DungeonModel.instance:hasPassLevelAndStory(arg_11_0._config.id))
	end

	local var_11_1 = DungeonConfig.instance:getChapterCO(arg_11_0._config.chapterId)

	arg_11_0:_updateLock()
	arg_11_0:_showMap()

	local var_11_2 = arg_11_0:refreshLockTip()
	local var_11_3 = DungeonModel.instance:chapterListIsResType(var_11_1.type)

	arg_11_0._isResourceTypeLock = var_11_3 and var_11_2

	arg_11_0:_refreshUI(var_11_3, var_11_2)
	arg_11_0:showStatus()
	arg_11_0:_showAllElementTipView()
	arg_11_0:refreshV1a7Fall()

	if DungeonModel.isBattleEpisode(arg_11_0._config) and var_11_1.type == DungeonEnum.ChapterType.Normal then
		local var_11_4 = string.splitToNumber(arg_11_0._config.icon, "#")
		...
		if var_11_5 and var_11_6 then
			...
			var_11_9, var_11_8 = ItemModel.instance:getItemConfigAndIcon(var_11_5, var_11_6)
		end

		gohelper.setActive(arg_11_0._gofallbg, true)
		arg_11_0:setFallIconPos(GameUtil.utf8len(arg_11_0._config.name))

		if not string.nilorempty(var_11_8) then
			arg_11_0._simagefall:LoadImage(var_11_8)
		end
	end
