...
function var_0_0._showTaskList(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_2 = var_7_1 and DungeonModel.instance:chapterIsLock(var_7_1.id) and DungeonModel.instance:chapterIsPass(var_7_0)

	gohelper.setActive(arg_7_0._gotasklist, not var_7_2)
	gohelper.setActive(arg_7_0._gounlocktip, var_7_2)

	if var_7_2 then
		arg_7_0._txtunlocktitle.text = formatLuaLang("dungeonmapview_unlocktitle", var_7_1.name)

		local var_7_3, var_7_4 = DungeonMapModel.instance:getTotalRewardPointProgress(var_7_0)
		local var_7_5 = {
			var_7_3,
			var_7_4
		}

		arg_7_0._txtunlockprogress.text = GameUtil.getSubPlaceholderLuaLang(luaLang("dungeonmapview_unlockprogress"), var_7_5)
