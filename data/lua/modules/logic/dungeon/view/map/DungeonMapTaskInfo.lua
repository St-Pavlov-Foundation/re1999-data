...
function slot0._showTaskList(slot0, slot1, slot2)
	slot6 = DungeonConfig.instance:getUnlockChapterConfig(DungeonConfig.instance:getEpisodeCO(slot1).chapterId) and DungeonModel.instance:chapterIsLock(slot5.id) and DungeonModel.instance:chapterIsPass(slot4)

	gohelper.setActive(slot0._gotasklist, not slot6)
	gohelper.setActive(slot0._gounlocktip, slot6)

	if slot6 then
		slot0._txtunlocktitle.text = formatLuaLang("dungeonmapview_unlocktitle", slot5.name)
		slot7, slot8 = DungeonMapModel.instance:getTotalRewardPointProgress(slot4)
