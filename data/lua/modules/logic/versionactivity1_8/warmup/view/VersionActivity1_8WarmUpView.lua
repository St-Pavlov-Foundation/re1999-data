...
local var_0_0 = class("VersionActivity1_8WarmUpView", BaseView)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtWrongChannel = gohelper.findChildText(arg_1_0.viewGO, "Right/TaskPanel/#go_WrongChannel/txt_WrongChannel")
...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(Activity125Controller.instance, Activity125Event.OnClickFile, arg_2_0._refreshWrongChannel, arg_2_0)
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(Activity125Controller.instance, Activity125Event.OnClickFile, arg_3_0._refreshWrongChannel, arg_3_0)
...
function var_0_0.onOpen(arg_6_0)
	...
	arg_6_0._actId = ActivityEnum.Activity.Activity1_8WarmUp
...
function var_0_0._refreshData(arg_10_0)
	...
	Activity125Model.instance:setHasCheckEpisode(arg_10_0._actId, var_10_0)
...
function var_0_0._initEpisodeList(arg_13_0)
	...
	for iter_13_0 = 1, var_13_0 do
		...
		local var_13_6 = Activity125Model.instance:isEpisodeFinished(arg_13_0._actId, iter_13_0)
		local var_13_7 = Activity125Model.instance:checkLocalIsPlay(arg_13_0._actId, iter_13_0)
		local var_13_8 = Activity125Model.instance:isFirstCheckEpisode(arg_13_0._actId, iter_13_0)
		local var_13_9 = not var_13_5 and var_13_8 or not var_13_6 and var_13_7

		gohelper.setActive(var_13_2.goRed, var_13_9)
	end
	...
	local var_13_10 = math.max(recthelper.getWidth(arg_13_0._goTaskContent.transform) - recthelper.getWidth(arg_13_0._goTaskScroll.transform), 0)
	local var_13_11 = (var_13_1 - 1) * 166

	recthelper.setAnchorX(arg_13_0._goTaskContent.transform, -math.min(var_13_11, var_13_10))
end
...
function var_0_0._taskItemOnClick(arg_14_0, arg_14_1)
	...
	if not var_14_1 then
		GameFacade.showToast(ToastEnum.V1A8WarmupEpisodeNotOpen, var_14_2)
...
function var_0_0._playEpisodeDesc(arg_21_0, arg_21_1, arg_21_2, arg_21_3)
	...
	local var_21_0 = AudioParam.New()

	var_21_0.loopNum = 999

	AudioEffectMgr.instance:playAudio(AudioEnum.Warmup1_8.play_caption, var_21_0)
...
function var_0_0.onDestroyView(arg_26_0)
	TaskDispatcher.cancelTask(arg_26_0._showLeftTime, arg_26_0)
...
function var_0_0._refreshWrongChannel(arg_27_0)
	local var_27_0 = arg_27_0:getCurSelectedEpisode()
	local var_27_1 = PlayerPrefsHelper.getNumber(PlayerPrefsKey.Act1_8WarmUpClickFile .. PlayerModel.instance:getMyUserId(), 0)

	if var_27_0 == 1 and var_27_1 == 0 then
		arg_27_0._txtWrongChannel.text = luaLang("justreport_firsttips")
	else
		arg_27_0._txtWrongChannel.text = luaLang("justreport_secondtips")
	end
end
