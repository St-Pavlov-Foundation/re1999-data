...
slot0 = class("ActWeilaLevelView", BaseView)
...
function slot0.addEvents(slot0)
	...
	slot0._animEvent:AddEventListener(ActWeilaEnum.AnimEvt.OnStoryOpenEnd, slot0._onStoryOpenEnd, slot0)
	slot0._animEvent:AddEventListener(ActWeilaEnum.AnimEvt.OnFightOpenEnd, slot0._onFightOpenEnd, slot0)
	slot0._animEvent:AddEventListener(ActWeilaEnum.AnimEvt.OnGoStoryEnd, slot0._onGoStoryEnd, slot0)
end
...
function slot0._editableInitView(slot0)
	slot0.actId = VersionActivity1_8Enum.ActivityId.Weila
...
function slot0.onOpen(slot0)
	slot0:addEventCb(ActWeilaController.instance, ActWeilaEvent.StoryItemClick, slot0.OnStoryItemClick, slot0)
	slot0:addEventCb(ActWeilaController.instance, ActWeilaEvent.FightItemClick, slot0.OnFightItemClick, slot0)
	slot0:addEventCb(ActWeilaController.instance, ActWeilaEvent.TabSwitch, slot0.OnTabSwitch, slot0)
...
function slot0._checkFirstEnter(slot0)
	if not slot0.storyItemList[2]:isUnlock() and PlayerPrefsHelper.getNumber("ActWeilaFirstEnter", 0) == 0 then
...
function slot0._initStageItems(slot0)
	...
	for slot7 = 1, #RoleActivityConfig.instance:getStoryLevelList(slot0.actId) do
		slot0.storyItemList[slot7] = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], gohelper.findChild(slot0._gostoryStages, "stage" .. slot7)), WeilaStoryItem, slot0)
	...
	for slot8 = 1, #RoleActivityConfig.instance:getBattleLevelList(slot0.actId) / 2 do
		slot0.fightItemList[slot8] = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[2], gohelper.findChild(slot0._gofightStages, "stage" .. slot8)), WeilaFightItem, slot0)
...
function slot0._playStoryFinishAnim(slot0)
	if ActWeilaModel.instance:getNewFinishStoryLvl() then
...
function slot0._playFightFinishAnim(slot0)
	if ActWeilaModel.instance:getNewFinishFightLvl() then
		ActWeilaModel.instance:updateData()
