...
slot0 = class("VersionActivity1_8DungeonMapLevelView", BaseView)
slot1 = 0.4
slot2 = 2.7
...
function slot0.startBattle(slot0)
	...
	if slot0.isSpecialEpisode then
		...
		VersionActivity1_8DungeonController.instance:savePlayerPrefs(VersionActivity1_8DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode, cjson.encode(slot0.lastEpisodeSelectModeDict))
	end
...
function slot0.initLocalEpisodeMode(slot0)
	slot0.unlockedEpisodeModeDict = VersionActivity1_8DungeonController.instance:loadDictFromStr(VersionActivity1_8DungeonController.instance:getPlayerPrefs(VersionActivity1_8DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode, ""))
	slot0.lastEpisodeSelectModeDict = VersionActivity1_8DungeonController.instance:loadDictFromStr(VersionActivity1_8DungeonController.instance:getPlayerPrefs(VersionActivity1_8DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode, ""))
end
...
function slot0.initViewParam(slot0)
	...
	slot0.index = VersionActivity1_8DungeonConfig.instance:getEpisodeIndex(slot0.originEpisodeId)
...
function slot0.markSelectEpisode(slot0)
	if slot0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_8Dungeon then
...
function slot0.refreshEpisodeTextInfo(slot0)
	slot2 = nil
	slot2 = (DungeonConfig.instance:getChapterCO(slot0.showEpisodeCo.chapterId).id ~= VersionActivity1_8DungeonEnum.DungeonChapterId.Story or slot0.showEpisodeCo) and VersionActivity1_8DungeonConfig.instance:getStoryEpisodeCo(slot0.showEpisodeCo.id)
...
function slot0.setStarImage(slot0, slot1, slot2, slot3)
	if slot2 then
		UISpriteSetMgr.instance:setV1a8DungeonSprite(slot1, VersionActivity1_8DungeonEnum.EpisodeStarType[DungeonConfig.instance:getEpisodeCO(slot3).chapterId].light)
	else
...
function slot0.refreshEye(slot0)
	...
	slot2 = slot0.originEpisodeConfig.chapterId == VersionActivity1_8DungeonEnum.DungeonChapterId.Hard
...
function slot0.onModeUnlockAnimationPlayDone(slot0)
	...
	VersionActivity1_8DungeonController.instance:savePlayerPrefs(VersionActivity1_8DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode, cjson.encode(slot0.unlockedEpisodeModeDict))
