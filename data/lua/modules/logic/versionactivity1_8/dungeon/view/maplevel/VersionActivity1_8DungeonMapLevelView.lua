...
function VersionActivity1_8DungeonMapLevelView:refreshEpisodeTextInfo()
	...
	if chapterCo.id == VersionActivity1_8DungeonEnum.DungeonChapterId.Story then
		targetConfig = self.showEpisodeCo
	else
		targetConfig = VersionActivity1_8DungeonConfig.instance:getStoryEpisodeCo(self.showEpisodeCo.id)
	end
