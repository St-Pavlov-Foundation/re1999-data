...
local var_0_0 = class("V1a8_WeilaEnterView", BaseView)
...
function var_0_0._btnEnterOnClick(arg_4_0)
	...
	if string.nilorempty(var_4_0) then
		...
		local var_4_4 = PlayerPrefsKey.EnterRoleActivity .. "#" .. tostring(VersionActivity1_8Enum.ActivityId.Weila) .. "#" .. tostring(var_4_3)
...
function var_0_0._editableInitView(arg_7_0)
	arg_7_0.actId = VersionActivity1_8Enum.ActivityId.Weila
