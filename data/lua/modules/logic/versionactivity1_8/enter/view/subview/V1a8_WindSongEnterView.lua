...
local var_0_0 = class("V1a8_WindSongEnterView", BaseView)
...
function var_0_0._btnEnterOnClick(arg_4_0)
	...
	if string.nilorempty(var_4_0) then
		...
		local var_4_4 = PlayerPrefsKey.EnterRoleActivity .. "#" .. tostring(VersionActivity1_8Enum.ActivityId.WindSong) .. "#" .. tostring(var_4_3)
...
function var_0_0._editableInitView(arg_7_0)
	arg_7_0.actId = VersionActivity1_8Enum.ActivityId.WindSong
...
function var_0_0._freshLockStatus(arg_11_0)
	local var_11_0 = ActivityHelper.getActivityStatus(arg_11_0.actId)

	gohelper.setActive(arg_11_0._btnEnter, var_11_0 ~= ActivityEnum.ActivityStatus.NotUnlock)
	gohelper.setActive(arg_11_0._btnLocked, var_11_0 == ActivityEnum.ActivityStatus.NotUnlock)
end
