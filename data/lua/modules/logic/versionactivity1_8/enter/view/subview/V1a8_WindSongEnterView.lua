...
slot0 = class("V1a8_WindSongEnterView", BaseView)
...
function slot0._btnEnterOnClick(slot0)
	...
	elseif OpenModel.instance:isFunctionUnlock(tonumber(string.split(slot1, "=")[2])) or PlayerPrefsHelper.getNumber(PlayerPrefsKey.EnterRoleActivity .. "#" .. tostring(VersionActivity1_8Enum.ActivityId.WindSong) .. "#" .. tostring(PlayerModel.instance:getPlayinfo().userId), 0) == 1 then
		ActWindSongController.instance:enterActivity()
	else
