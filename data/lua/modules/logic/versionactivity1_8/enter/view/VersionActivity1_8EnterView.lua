...
local var_0_0 = class("VersionActivity1_8EnterView", VersionActivityEnterBaseViewWithListNew)
local var_0_1 = 2.1
...
function var_0_0._editableInitView(arg_1_0)
	...
	arg_1_0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.First, arg_1_0._gotabitem1, VersionActivity1_8EnterViewTabItem1)
	arg_1_0:setTabLevelSetting(VersionActivityEnterViewEnum.ActLevel.Second, arg_1_0._gotabitem2, VersionActivity1_8EnterViewTabItem2)
...
function var_0_0._onTabScrollChange(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_0.activityTabItemList) do
		if iter_6_1:isShowRedDot() and -iter_6_1:getAnchorY() + VersionActivity1_8Enum.RedDotOffsetY - var_6_0 > arg_6_0.viewPortHeight then
...
function var_0_0.playVideo(arg_7_0)
	...
	if arg_7_0.viewParam.playVideo then
		...
		VideoController.instance:openFullScreenVideoView(VersionActivity1_8Enum.EnterAnimVideoPath, nil, var_0_1)
...
function var_0_0.refreshBtnVisible(arg_10_0, arg_10_1)
	local var_10_0 = VersionActivity1_8EnterHelper.GetIsShowReplayBtn(arg_10_0.curActId)
	local var_10_1 = VersionActivity1_8EnterHelper.GetIsShowAchievementBtn(arg_10_0.curActId)
