...
function var_0_0._btnplaylOnClick(arg_7_0)
	...
	var_0_2(var_7_0, var_0_9 .. "?" .. var_0_1("timestamp=%s", ServerTime.now() * 1000))
	var_0_2(var_7_0, var_0_1("gameId=%s", SDKMgr.instance:getGameId()))
	var_0_2(var_7_0, var_0_1("gameRoleId=%s", PlayerModel.instance:getMyUserId()))
	var_0_2(var_7_0, var_0_1("channelUserId=%s", LoginModel.instance.channelUserId))
	var_0_2(var_7_0, var_0_1("deviceModel=%s", WebViewController.instance:urlEncode(UnityEngine.SystemInfo.deviceModel)))
	var_0_2(var_7_0, var_0_1("deviceId=%s", SDKMgr.instance:getDeviceInfo().deviceId))
	var_0_2(var_7_0, var_0_1("os=%s", WebViewController.instance:urlEncode(UnityEngine.SystemInfo.operatingSystem)))
	var_0_2(var_7_0, var_0_1("token=%s", SDKMgr.instance:getGameSdkToken()))
	var_0_2(var_7_0, var_0_1("channelId=%s", SDKMgr.instance:getChannelId()))
	var_0_2(var_7_0, var_0_1("isEmulator=%s", SDKMgr.instance:isEmulator() and 1 or 0))

	local var_7_1 = var_0_3(var_7_0, "&")

	logNormal(var_7_1)
	WebViewController.instance:openWebView(var_7_1, false, arg_7_0._onWebViewCb, arg_7_0)
end
...
function var_0_0._refreshActive_btnplay(arg_49_0)
	local var_49_0 = CommonConfig.instance:getConstStr(ConstEnum.V2a4_WarmUp_btnplay_openTs)

	if string.nilorempty(var_49_0) then
		gohelper.setActive(arg_49_0._btnplayGo, true)

		return
	end

	local var_49_1 = ServerTime.now() >= TimeUtil.stringToTimestamp(var_49_0)

	gohelper.setActive(arg_49_0._btnplayGo, var_49_1)
end
