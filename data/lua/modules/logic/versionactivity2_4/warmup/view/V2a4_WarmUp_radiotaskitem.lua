...
slot0 = class("V2a4_WarmUp_radiotaskitem", RougeSimpleItemBase)
...
function slot0.setData(slot0, slot1)
	...
	gohelper.setActive(slot0._goreddot, not not slot0:_isEpisodeReallyOpen(slot2) and not slot0:_getRLOC(slot2))
end
