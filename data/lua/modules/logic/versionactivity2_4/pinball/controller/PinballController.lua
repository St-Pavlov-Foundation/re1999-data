...
function var_0_0.removeBuilding(arg_7_0, arg_7_1)
	...
	for iter_7_3, iter_7_4 in pairs(var_7_1) do
		...
		if var_7_5 then
			table.insert(var_7_4, string.format("%s+%s", var_7_5.name, iter_7_4))
		end
	end

	arg_7_0._tempIndex = arg_7_1

	GameFacade.showMessageBox(MessageBoxIdDefine.PinballRemoveBuilding, MsgBoxEnum.BoxType.Yes_No, arg_7_0._realRemoveBuilding, nil, nil, arg_7_0, nil, nil, table.concat(var_7_4, " "))
end
