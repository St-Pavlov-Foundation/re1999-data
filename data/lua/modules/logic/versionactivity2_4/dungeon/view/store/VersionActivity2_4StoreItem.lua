module("modules.logic.versionactivity2_4.dungeon.view.store.VersionActivity2_4StoreItem", package.seeall)

slot0 = class("VersionActivity2_4StoreItem", UserDataDispose)
slot1 = 424
slot2 = 382.32
slot3 = 300

function slot4(slot0, slot1)
	slot2 = VersionActivity2_1Enum.ActivityId.DungeonStore
...
function slot0.refreshGoods(slot0)
	...
	for slot5, slot6 in ipairs(slot0.groupGoodsCoList) do
		if not slot0.goodsItemList[slot5] then
			slot1 = VersionActivity2_4StoreGoodsItem.New()
