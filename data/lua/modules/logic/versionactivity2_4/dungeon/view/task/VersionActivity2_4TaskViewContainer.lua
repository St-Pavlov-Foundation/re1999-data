...
slot0 = class("VersionActivity2_4TaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivity2_4TaskItem
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity2_4TaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
