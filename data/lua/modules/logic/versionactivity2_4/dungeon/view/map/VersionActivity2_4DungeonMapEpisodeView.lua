...
function VersionActivity2_4DungeonMapEpisodeView:addEvents()
	...
	self:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, self.hideUI, self)
	self:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_4DungeonMapEpisodeView:removeEvents()
	...
	self:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, self.hideUI, self)
	self:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnHideInteractUI, self.showUI, self)
