...
slot0 = class("VersionActivity2_4DungeonMapViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot0.mapScene = VersionActivity2_4DungeonMapScene.New()
	slot0.mapSceneElements = VersionActivity2_4DungeonMapSceneElements.New()
	slot0.mapView = VersionActivity2_4DungeonMapView.New()
	slot0.mapEpisodeView = VersionActivity2_4DungeonMapEpisodeView.New()
	slot0.interactView = VersionActivity2_4DungeonMapInteractView.New()
...
function slot0.onContainerInit(slot0)
	slot0.versionActivityDungeonBaseMo = VersionActivity2_4DungeonMo.New()
	slot5 = slot0.viewParam.chapterId

	slot0.versionActivityDungeonBaseMo:init(VersionActivity2_4Enum.ActivityId.Dungeon, slot5, slot0.viewParam.episodeId)
	slot0.versionActivityDungeonBaseMo:setLayoutClass(VersionActivity2_4DungeonMapChapterLayout)

	slot4 = VersionActivity2_4DungeonMapEpisodeItem
	...
	VersionActivity2_4DungeonModel.instance:setDungeonBaseMo(slot0.versionActivityDungeonBaseMo)
