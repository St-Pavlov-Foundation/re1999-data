-- chunkname: @modules/logic/versionactivity2_4/dungeon/view/map/VersionActivity2_4DungeonMapInteractView.lua

module("modules.logic.versionactivity2_4.dungeon.view.map.VersionActivity2_4DungeonMapInteractView", package.seeall)

local VersionActivity2_4DungeonMapInteractView = class("VersionActivity2_4DungeonMapInteractView", BaseView)

function VersionActivity2_4DungeonMapInteractView:onInitView(go)
...
function VersionActivity2_4DungeonMapInteractView:initNoneContainer()
...
function VersionActivity2_4DungeonMapInteractView:initFightContainer()
...
function VersionActivity2_4DungeonMapInteractView:initDialogueContainer()
...
function VersionActivity2_4DungeonMapInteractView:initTalkContainer()
...
function VersionActivity2_4DungeonMapInteractView:addEvents()
	...
	self:addEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_4DungeonMapInteractView:removeEvents()
	...
	self:removeEventCb(VersionActivity2_4DungeonController.instance, VersionActivity2_4DungeonEvent.OnClickElement, self.showInteractUI, self)
...
function VersionActivity2_4DungeonMapInteractView:_editableInitView()
	self._handleTypeMap = {
...
function VersionActivity2_4DungeonMapInteractView:showInteractUI(mapElement)
	if self._show then
		return
	end
...
function VersionActivity2_4DungeonMapInteractView:show()
	if self._show then
		return
	end
...
function VersionActivity2_4DungeonMapInteractView:hide()
	if not self._show then
		return
	end

	VersionActivity2_4DungeonModel.instance:setShowInteractView(nil)
	...
	VersionActivity2_4DungeonController.instance:dispatchEvent(VersionActivity2_4DungeonEvent.OnHideInteractUI)
end

function VersionActivity2_4DungeonMapInteractView:refreshUI()
...
function VersionActivity2_4DungeonMapInteractView:refreshRewards()
...
function VersionActivity2_4DungeonMapInteractView:createRewardItem()
...
function VersionActivity2_4DungeonMapInteractView:refreshNoneUI()
...
function VersionActivity2_4DungeonMapInteractView:setFinishText()
...
function VersionActivity2_4DungeonMapInteractView:refreshFightUI()
...
function VersionActivity2_4DungeonMapInteractView:refreshDialogueUI()
...
function VersionActivity2_4DungeonMapInteractView:refreshTalkUI()
	self._sectionStack = {}
...
function VersionActivity2_4DungeonMapInteractView:_playSection(sectionId, dialogIndex)
	self:_setSectionData(sectionId, dialogIndex)
	self:_playNextDialog()
end

function VersionActivity2_4DungeonMapInteractView:_setSectionData(sectionId, dialogIndex)
...
function VersionActivity2_4DungeonMapInteractView:_playNextDialog()
...
function VersionActivity2_4DungeonMapInteractView:_showDialog(type, text, speaker, audio)
...
function VersionActivity2_4DungeonMapInteractView:setIsChat(isChat)
	gohelper.setActive(self._godesc, not isChat)
	gohelper.setActive(self._gochat, isChat)
end

function VersionActivity2_4DungeonMapInteractView:_addDialogOption(index, sectionId, text)
...
function VersionActivity2_4DungeonMapInteractView:_onOptionClick(param)
...
function VersionActivity2_4DungeonMapInteractView:_refreshDialogBtnState(showOption, hasNext)
...
function VersionActivity2_4DungeonMapInteractView:_onClickFightBtn()
	self:hide()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
	...
	VersionActivity2_4DungeonModel.instance:setLastEpisodeId(self.activityDungeonMo.episodeId)
...
function VersionActivity2_4DungeonMapInteractView:_btnnextOnClick()
	self:_playNextSectionOrDialog()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
end

function VersionActivity2_4DungeonMapInteractView:_playNextSectionOrDialog()
	if #self._sectionList >= self._dialogIndex then
		self:_playNextDialog()
...
function VersionActivity2_4DungeonMapInteractView:_btnfinishtalkOnClick()
	self:hide()
...
function VersionActivity2_4DungeonMapInteractView:onDialogueInfoChange(dialogueId)
	if dialogueId == self.dialogueId then
		self:refreshDialogueUI()
	end
end

function VersionActivity2_4DungeonMapInteractView:onCloseViewFinishCall(viewName)
	if viewName == ViewName.DialogueView and self.isFinish then
		self:refreshUI()
	end
end

function VersionActivity2_4DungeonMapInteractView:beforeJump()
	self:hide()
end

function VersionActivity2_4DungeonMapInteractView:onClose()
	return
end

function VersionActivity2_4DungeonMapInteractView:onDestroyView()
	self.rootClick:RemoveClickListener()
end

return VersionActivity2_4DungeonMapInteractView
