-- chunkname: @modules/logic/versionactivity2_4/dungeon/view/map/scene/VersionActivity2_4DungeonMapScene.lua

module("modules.logic.versionactivity2_4.dungeon.view.map.scene.VersionActivity2_4DungeonMapScene", package.seeall)

local VersionActivity2_4DungeonMapScene = class("VersionActivity2_4DungeonMapScene", BaseView)

function VersionActivity2_4DungeonMapScene:onInitView()
...
function VersionActivity2_4DungeonMapScene:addEvents()
...
function VersionActivity2_4DungeonMapScene:removeEvents()
...
function VersionActivity2_4DungeonMapScene:_onOpenView(viewName)
...
function VersionActivity2_4DungeonMapScene:_onCloseView(viewName)
	if viewName == ViewName.StoryView then
		self:loadMap()
	end
end

function VersionActivity2_4DungeonMapScene:_onScreenResize()
	if self._sceneGo then
		local camera = CameraMgr.instance:getMainCamera()
		local scale = GameUtil.getAdapterScale()

		camera.orthographicSize = VersionActivity2_4DungeonEnum.DungeonMapCameraSize * scale

		self:_initScene()
	end
end

function VersionActivity2_4DungeonMapScene:onModeChange()
	self:refreshMap()
end

function VersionActivity2_4DungeonMapScene:onActivityDungeonMoChange()
	local needTween = VersionActivity2_4DungeonModel.instance:getMapNeedTweenState()

	self:refreshMap(needTween)
end

function VersionActivity2_4DungeonMapScene:onClickElement(elementComp)
...
function VersionActivity2_4DungeonMapScene:focusElementByCo(elementCo)
...
function VersionActivity2_4DungeonMapScene:onFocusElement(elementId, isForce)
...
function VersionActivity2_4DungeonMapScene:changeToElementEpisode(elementId)
...
function VersionActivity2_4DungeonMapScene:manualClickElement(elementId)
	local elementComp = self.mapSceneElementsView:getElementComp(elementId)
...
function VersionActivity2_4DungeonMapScene:_onDragBegin(param, pointerEventData)
...
function VersionActivity2_4DungeonMapScene:_onDrag(param, pointerEventData)
...
function VersionActivity2_4DungeonMapScene:_onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
end

function VersionActivity2_4DungeonMapScene:getDragWorldPos(pointerEventData)
...
function VersionActivity2_4DungeonMapScene:_editableInitView()
...
function VersionActivity2_4DungeonMapScene:_initMapRootNode()
	self._sceneRoot = UnityEngine.GameObject.New(VersionActivity2_4DungeonEnum.SceneRootName)
...
function VersionActivity2_4DungeonMapScene:onUpdateParam()
	self:refreshMap()
end

function VersionActivity2_4DungeonMapScene:onOpen()
	MainCameraMgr.instance:addView(self.viewName, self._initCamera, nil, self)
	self:refreshMap()
end

function VersionActivity2_4DungeonMapScene:_initCamera()
	local camera = CameraMgr.instance:getMainCamera()
...
function VersionActivity2_4DungeonMapScene:refreshMap(needTween, mapCfg)
	self._mapCfg = mapCfg or VersionActivity2_4DungeonConfig.instance:getEpisodeMapConfig(self.activityDungeonMo.episodeId)
...
function VersionActivity2_4DungeonMapScene:_initElements()
	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnInitElements)
end

function VersionActivity2_4DungeonMapScene:loadMap()
...
function VersionActivity2_4DungeonMapScene:buildLoadRes(allResPath, mapCfg)
...
function VersionActivity2_4DungeonMapScene:_loadSceneFinish()
...
function VersionActivity2_4DungeonMapScene:_initScene()
	...
	local cameraSizeRate = VersionActivity2_4DungeonEnum.DungeonMapCameraSize / uiCameraSize
...
function VersionActivity2_4DungeonMapScene:_setMapPos()
...
function VersionActivity2_4DungeonMapScene:_addMapLight()
...
function VersionActivity2_4DungeonMapScene:_addMapAudio()
...
function VersionActivity2_4DungeonMapScene:_focusUnfinishStoryElement()
	local elementCo = VersionActivity2_4DungeonModel.instance:checkAndGetUnfinishStoryElementCo(self._mapCfg.id)

	if elementCo then
		VersionActivity2_4DungeonController.instance:dispatchEvent(VersionActivity2_4DungeonEvent.FocusElement, elementCo.id)
	end
end

function VersionActivity2_4DungeonMapScene:tweenSetScenePos(targetPos, srcPos)
...
function VersionActivity2_4DungeonMapScene:getTargetPos(targetPos)
...
function VersionActivity2_4DungeonMapScene:tweenFrameCallback(value)
...
function VersionActivity2_4DungeonMapScene:tweenFinishCallback()
	self._tempVector:Set(self._tweenTargetPosX, self._tweenTargetPosY, 0)
	self:directSetScenePos(self._tempVector)
end

function VersionActivity2_4DungeonMapScene:directSetScenePos(targetPos)
	...
	VersionActivity2_4DungeonController.instance:dispatchEvent(VersionActivity2_4DungeonEvent.OnMapPosChanged, self._scenePos, self.needTween)
	self:_updateElementArrow()
end

function VersionActivity2_4DungeonMapScene:_updateElementArrow()
	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnUpdateElementArrow)
end

function VersionActivity2_4DungeonMapScene:setVisible(isVisible)
...
function VersionActivity2_4DungeonMapScene:getSceneGo()
	return self._sceneGo
end

function VersionActivity2_4DungeonMapScene:onClose()
	self:killTween()
	self:_resetCamera()
end

function VersionActivity2_4DungeonMapScene:killTween()
	if self.tweenId then
		ZProj.TweenHelper.KillById(self.tweenId)
	end
end

function VersionActivity2_4DungeonMapScene:_resetCamera()
	local camera = CameraMgr.instance:getMainCamera()
...
function VersionActivity2_4DungeonMapScene:disposeOldMap()
...
function VersionActivity2_4DungeonMapScene:_disposeScene()
	self._oldScenePos = self._scenePos
...
return VersionActivity2_4DungeonMapScene
