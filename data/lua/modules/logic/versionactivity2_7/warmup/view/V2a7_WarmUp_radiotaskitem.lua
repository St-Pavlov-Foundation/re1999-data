module("modules.logic.versionactivity2_7.warmup.view.V2a7_WarmUp_radiotaskitem", package.seeall)

slot0 = class("V2a7_WarmUp_radiotaskitem", RougeSimpleItemBase)
...
function slot0._checkIfOpenAndToast(slot0)
	...
	if not slot0:_isEpisodeReallyOpen(slot2) then
