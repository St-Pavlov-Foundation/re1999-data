...
slot0 = class("V2a7_LengZhou6EnterView", VersionActivityEnterBaseSubView)
...
function slot0.onInitView(slot0)
	...
	slot0._simageTitleeff = gohelper.findChildSingleImage(slot0.viewGO, "Right/#simage_Title/#simage_Title_eff")
	...
	slot0._btnTrial = gohelper.findChildButtonWithAudio(slot0.viewGO, "Right/#go_Try/#btn_Trial")
...
function slot0._btnEnterOnClick(slot0)
	LengZhou6Controller.instance:enterLevelView(slot0.actId)
end
...
function slot0.onOpen(slot0)
	RedDotController.instance:addRedDot(slot0._goreddot, RedDotEnum.DotNode.V2a7LengZhou6)
