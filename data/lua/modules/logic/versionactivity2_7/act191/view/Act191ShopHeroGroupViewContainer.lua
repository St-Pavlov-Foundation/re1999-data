module("modules.logic.versionactivity2_7.act191.view.Act191ShopHeroGroupViewContainer", package.seeall)

slot0 = class("Act191ShopHeroGroupViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot1 = {}
	slot0.groupView = Act191ShopHeroGroupView.New()
