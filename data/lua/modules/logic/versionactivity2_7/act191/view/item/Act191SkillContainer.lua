...
slot0 = class("Act191SkillContainer", LuaCompBase)
...
function slot0._refreshSkillUI(slot0)
	if slot0._roleId then
		for slot5, slot6 in pairs(Activity191Config.instance:getHeroSkillIdDic(slot0._roleId, true)) do
...
function slot0._onSkillCardClick(slot0, slot1)
	if slot0._roleId then
		ViewMgr.instance:openView(ViewName.SkillTipView, {
			super = slot1 == 3,
			skillIdList = Activity191Config.instance:getHeroSkillIdDic(slot0._roleId)[slot1],
