...
local var_0_0 = class("Act191SkillDescComp", LuaCompBase)
...
function var_0_0._replaceSkillTag(arg_4_0, arg_4_1, arg_4_2)
	...
	if var_4_3 == 0 then
		var_4_4 = Activity191Config.instance:getHeroPassiveSkillIdList(arg_4_0._config.id)[1]
	else
		var_4_4 = Activity191Config.instance:getHeroSkillIdDic(arg_4_0._config.id, true)[var_4_3]
	end

	if not var_4_4 then
		logError("没找到当前角色的技能：heroId:" .. arg_4_0._config.id .. "  skillindex:" .. var_4_3)
...
function var_0_0._onHyperLinkClick(arg_16_0, arg_16_1, arg_16_2)
	...
	elseif var_16_0 == 0 then
		...
		var_16_1.id = arg_16_0._config.id
		...
		ViewMgr.instance:openView(ViewName.Act191CharacterTipView, var_16_1)
	else
		local var_16_2 = {}
		local var_16_3 = Activity191Config.instance:getHeroSkillIdDic(arg_16_0._config.id)

		var_16_2.super = var_16_0 == 3
		var_16_2.skillIdList = var_16_3[var_16_0]
		var_16_2.monsterName = arg_16_0._config.name
		var_16_2.heroId = arg_16_0._config.roleId
