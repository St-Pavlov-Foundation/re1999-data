...
slot0 = class("Act191StoreGoodsItem", UserDataDispose)
...
function slot0.updateInfo(slot0, slot1)
	...
	slot2, slot3, slot4 = VersionActivity2_1EnterHelper.getItemTypeIdQuantity(slot0.storeGoodsCo.product)
	...
	UISpriteSetMgr.instance:setAct174Sprite(slot0.imageRare, "act174_store_quality_" .. slot7)
	...
	slot0.costItemType, slot0.costItemId, slot0.costItemQuantity = VersionActivity2_1EnterHelper.getItemTypeIdQuantity(slot0.storeGoodsCo.cost)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivity2_7Enum.ActivityId.Act191Store, slot0.storeGoodsCo.id)
