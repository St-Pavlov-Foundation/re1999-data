module("modules.logic.versionactivity2_7.newinsight.view.ActivityInsightShowView_2_7", package.seeall)

slot0 = class("ActivityInsightShowView_2_7", BaseView)
...
function slot0._editableInitView(slot0)
	...
	for slot4 = 1, 3 do
		slot5 = ActivityInsightShowTaskItem_2_7.New()
