module("modules.logic.versionactivity2_7.newinsight.view.ActivityInsightShowTaskItem_2_7", package.seeall)

slot0 = class("ActivityInsightShowTaskItem_2_7", LuaCompBase)
