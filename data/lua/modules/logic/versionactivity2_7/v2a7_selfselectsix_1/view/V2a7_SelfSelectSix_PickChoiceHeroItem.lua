...
slot0 = class("V2a7_SelfSelectSix_PickChoiceHeroItem", LuaCompBase)
slot1 = {
	0.2,
	0.4,
	0.6,
...
function slot0.onClickSelf(slot0)
	logNormal("V2a7_SelfSelectSix_PickChoiceHeroItem onClickChoice id = " .. tostring(slot0._mo.id))
	V2a7_SelfSelectSix_PickChoiceController.instance:setSelect(slot0._mo.id)
end
...
function slot0.refreshUI(slot0)
	if not HeroConfig.instance:getHeroCO(slot0._mo.id) then
		logError("V2a7_SelfSelectSix_PickChoiceHeroItem.onUpdateMO error, heroConfig is nil, id:" .. tostring(slot0._mo.id))
...
function slot0.refreshBaseInfo(slot0, slot1)
	if not SkinConfig.instance:getSkinCo(slot1.skinId) then
		logError("V2a7_SelfSelectSix_PickChoiceHeroItem.onUpdateMO error, skinCfg is nil, id:" .. tostring(slot1.skinId))
...
function slot0.refreshSelect(slot0)
	gohelper.setActive(slot0._goSelected, V2a7_SelfSelectSix_PickChoiceListModel.instance:isHeroIdSelected(slot0._mo.id))
end
