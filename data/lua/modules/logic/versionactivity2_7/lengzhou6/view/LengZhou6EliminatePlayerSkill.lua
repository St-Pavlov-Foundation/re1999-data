...
slot0 = class("LengZhou6EliminatePlayerSkill", ListScrollCellExtend)
...
function slot0.isInRect(slot0, slot1)
	...
	slot7, slot8 = UnityEngine.RectTransformUtility.ScreenPointToLocalPointInRectangle(slot0._rectMaskHoleTr, slot1.position, CameraMgr.instance:getUICamera(), uv1)
