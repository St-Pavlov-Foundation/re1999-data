...
slot0 = class("LengZhou6TaskItem", ListScrollCellExtend)
...
function slot0._btngetallOnClick(slot0)
	LengZhou6Controller.instance:dispatchEvent(LengZhou6Event.OneClickClaimReward, slot0._mo.activityId)
	UIBlockHelper.instance:startBlock(LengZhou6Enum.BlockKey.OneClickClaimReward, 0.5)
...
function slot0._editableAddEvents(slot0)
	LengZhou6Controller.instance:registerCallback(LengZhou6Event.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end

function slot0._editableRemoveEvents(slot0)
	LengZhou6Controller.instance:unregisterCallback(LengZhou6Event.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end
...
function slot0._refreshUI(slot0)
	...
	slot1 = slot0._mo.id ~= LengZhou6Enum.TaskMOAllFinishId
...
function slot0._moveByRankDiff(slot0)
	if not LengZhou6TaskListModel.instance:getRankDiff(slot0._mo) or slot1 == 0 then
		return
	end
