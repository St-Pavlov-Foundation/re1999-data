-- chunkname: @modules/logic/versionactivity3_5/common/VersionActivity3_5CanJumpFunc.lua

module("modules.logic.versionactivity3_5.common.VersionActivity3_5CanJumpFunc", package.seeall)

local VersionActivity3_5CanJumpFunc = class("VersionActivity3_5CanJumpFunc")

function VersionActivity3_5CanJumpFunc:canJumpTo13502(jumpParamArray)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity3_5Enum.ActivityId.EnterView)

	if status ~= ActivityEnum.ActivityStatus.Normal then
		return false, toastId, toastParamList
	end

	local actId = VersionActivity3_5Enum.ActivityId.Dungeon
...
function VersionActivity3_5CanJumpFunc:canJumpTo13440(paramsList)
	local status, toastId, toastParamList = ActivityHelper.getActivityStatusAndToast(VersionActivity3_5Enum.ActivityId.ReactivityStore)
...
return VersionActivity3_5CanJumpFunc
