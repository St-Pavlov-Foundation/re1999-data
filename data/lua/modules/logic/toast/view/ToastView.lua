...
function var_0_0._refreshAllItemsAnimation(arg_13_0)
	...
	for iter_13_0, iter_13_1 in ipairs(arg_13_0._usingList) do
		local var_13_1 = (1 - iter_13_0) * arg_13_0._itemHeight

		if iter_13_0 == #arg_13_0._usingList then
			recthelper.setAnchorY(iter_13_1.tr, var_13_1)
		else
			iter_13_1:upAnimation(var_13_1)
		end
	end
end
