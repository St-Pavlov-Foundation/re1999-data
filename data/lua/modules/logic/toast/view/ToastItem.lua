...
function var_0_0.setToastType(arg_12_0, arg_12_1)
	if arg_12_1 == var_0_0.ToastType.Normal then
		gohelper.setActive(arg_12_0._gonormal, true)
		gohelper.setActive(arg_12_0._goachievement, false)
		gohelper.setActive(arg_12_0._goseason166, false)
	elseif arg_12_1 == var_0_0.ToastType.Achievement then
		gohelper.setActive(arg_12_0._gonormal, false)
		gohelper.setActive(arg_12_0._goachievement, true)
		gohelper.setActive(arg_12_0._goseason166, false)
	elseif arg_12_1 == var_0_0.ToastType.Season166 then
		gohelper.setActive(arg_12_0._gonormal, false)
		gohelper.setActive(arg_12_0._goachievement, false)
		gohelper.setActive(arg_12_0._goseason166, true)
	end
end

function var_0_0.getToastRootByType(arg_13_0, arg_13_1)
	if arg_13_1 == var_0_0.ToastType.Normal then
		return arg_13_0._gonormal
	elseif arg_13_1 == var_0_0.ToastType.Achievement then
		return arg_13_0._goachievement
	elseif arg_13_1 == var_0_0.ToastType.Season166 then
		return arg_13_0._goseason166
	end
end

function var_0_0.getTip(arg_14_0)
	local var_14_0 = ""

	if arg_14_0.msg.extra and #arg_14_0.msg.extra > 0 then
		var_14_0 = GameUtil.getSubPlaceholderLuaLang(arg_14_0.msg.co.tips, arg_14_0.msg.extra)
	else
		var_14_0 = arg_14_0.msg.co.tips
	end
