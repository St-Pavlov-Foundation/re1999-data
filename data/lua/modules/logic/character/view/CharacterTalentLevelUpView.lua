...
function slot0.onOpen(slot0)
	...
	if not slot0.next_config then
		slot0._txttalentresult.text = string.format("%s<size=18>LV</size>.%s", slot1, HeroResonanceConfig.instance:getTalentConfig(slot0.hero_id, slot0.hero_mo_data.talent + 1) and slot0.hero_mo_data.talent or "max")
	else
		for slot6 = 1, 3 do
