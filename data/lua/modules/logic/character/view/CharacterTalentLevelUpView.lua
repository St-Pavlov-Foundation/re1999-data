...
function var_0_0.onOpen(arg_13_0)
	...
	if not arg_13_0.next_config then
		arg_13_0._txttalentresult.text = string.format("%s<size=18>LV</size>.%s", var_13_0, HeroResonanceConfig.instance:getTalentConfig(arg_13_0.hero_id, arg_13_0.hero_mo_data.talent + 1) and arg_13_0.hero_mo_data.talent or "max")
	else
