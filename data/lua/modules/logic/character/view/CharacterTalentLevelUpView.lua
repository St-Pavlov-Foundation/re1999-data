...
function var_0_0.onOpen(arg_12_0)
	...
	if not arg_12_0.next_config then
		arg_12_0._txttalentresult.text = string.format("%s<size=18>LV</size>.%s", var_12_0, HeroResonanceConfig.instance:getTalentConfig(arg_12_0.hero_id, arg_12_0.hero_mo_data.talent + 1) and arg_12_0.hero_mo_data.talent or "max")
	else
