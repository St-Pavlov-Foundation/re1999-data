...
function slot0.onInitView(slot0)
	...
	slot0._btnequiplv = gohelper.findChildButtonWithAudio(slot0.viewGO, "#go_equipsort/#btn_equiplv")
	slot0._btnequiprare = gohelper.findChildButtonWithAudio(slot0.viewGO, "#go_equipsort/#btn_equiprare")
	slot0._btnequiptime = gohelper.findChildButtonWithAudio(slot0.viewGO, "#go_equipsort/#btn_equiptime")
