...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._btnequiplv = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_equipsort/#btn_equiplv")
	arg_1_0._btnequiprare = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_equipsort/#btn_equiprare")
	arg_1_0._btnequiptime = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_equipsort/#btn_equiptime")
