...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtmedium = gohelper.findChildText(arg_1_0.viewGO, "content/intro/introduce2/#txt_medium")
	arg_1_0._txtinspiration = gohelper.findChildText(arg_1_0.viewGO, "content/intro/introduce2/#txt_inspiration")
	arg_1_0._txtaroma = gohelper.findChildText(arg_1_0.viewGO, "content/intro/introduce2/#txt_aroma")
	arg_1_0._txtsize = gohelper.findChildText(arg_1_0.viewGO, "content/intro/introduce2/#txt_size")
	arg_1_0._imagefetter = gohelper.findChildImage(arg_1_0.viewGO, "content/fetter/#image_fetter")
	arg_1_0._txtfetter = gohelper.findChildText(arg_1_0.viewGO, "content/fetter/#txt_fetter")
...
function var_0_0._getFormatStr(arg_24_0, arg_24_1)
	...
	return string.format("<size=94>%s</size><space=-22><voffset=-0.05em> %s", var_24_0, var_24_1)
end
