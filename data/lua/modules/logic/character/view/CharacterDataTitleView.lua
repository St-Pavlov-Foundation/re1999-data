...
function slot0.onInitView(slot0)
	...
	slot0._txtmedium = gohelper.findChildText(slot0.viewGO, "content/intro/introduce2/#txt_medium")
	slot0._txtinspiration = gohelper.findChildText(slot0.viewGO, "content/intro/introduce2/#txt_inspiration")
	slot0._txtaroma = gohelper.findChildText(slot0.viewGO, "content/intro/introduce2/#txt_aroma")
	slot0._txtsize = gohelper.findChildText(slot0.viewGO, "content/intro/introduce2/#txt_size")
	slot0._imagefetter = gohelper.findChildImage(slot0.viewGO, "content/fetter/#image_fetter")
	slot0._txtfetter = gohelper.findChildText(slot0.viewGO, "content/fetter/#txt_fetter")
...
function slot0._getTitleStr(slot0, slot1)
	...
	if #string.split(slot1, string.find(string.gsub(slot1, "\n", ""), "：") and "：" or ": ") > 1 then
		return slot3[2]
	else
		return slot1
	end
...
function slot0._getFormatStr(slot0, slot1)
	...
	return string.format("<size=94>%s</size><space=-22><voffset=-0.05em> %s", slot2, slot3)
end
