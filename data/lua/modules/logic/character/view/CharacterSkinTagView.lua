...
function slot0._btnplayOnClick(slot0)
	WebViewController.instance:openWebView(WebViewController.instance:getVideoUrl(slot0._skinCo.characterId, slot0._skinCo.id), false, slot0.OnWebViewBack, slot0)
end
