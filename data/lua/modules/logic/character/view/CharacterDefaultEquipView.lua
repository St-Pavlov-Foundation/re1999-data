...
function var_0_0._editableInitView(arg_5_0)
	arg_5_0.goaddicon = gohelper.findChild(arg_5_0.goequipcontainer, "#go_addIcon")
	arg_5_0.simageequipicon = gohelper.findChildSingleImage(arg_5_0.goequipcontainer, "#simage_equipicon")
