...
function slot0._editableInitView(slot0)
	slot0.goaddicon = gohelper.findChild(slot0.goequipcontainer, "#go_addIcon")
	slot0.simageequipicon = gohelper.findChildSingleImage(slot0.goequipcontainer, "#simage_equipicon")
