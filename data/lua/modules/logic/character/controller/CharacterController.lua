...
function var_0_0.showCharacterGetToast(arg_37_0, arg_37_1, arg_37_2)
	...
	for iter_37_2, iter_37_3 in ipairs(var_37_1) do
		local var_37_9 = string.format("%s%s\n%s%s%s", iter_37_3.desc, var_37_0.name, iter_37_3.config.name, luaLang("multiple"), iter_37_3.quantity)

		GameFacade.showToastWithIcon(ToastEnum.IconId, iter_37_3.icon, var_37_9)
	end
end
