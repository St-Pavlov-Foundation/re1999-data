...
function slot0.showCharacterGetToast(slot0, slot1, slot2)
	...
	for slot9, slot10 in ipairs(slot4) do
		GameFacade.showToastWithIcon(ToastEnum.IconId, slot10.icon, string.format("%s%s\n%s%s%s", slot10.desc, slot3.name, slot10.config.name, luaLang("multiple"), slot10.quantity))
	end
end
