...
function var_0_0.showCharacterGetToast(arg_34_0, arg_34_1, arg_34_2)
	...
	for iter_34_2, iter_34_3 in ipairs(var_34_1) do
		local var_34_9 = string.format("%s%s\n%s%s%s", iter_34_3.desc, var_34_0.name, iter_34_3.config.name, luaLang("multiple"), iter_34_3.quantity)

		GameFacade.showToastWithIcon(ToastEnum.IconId, iter_34_3.icon, var_34_9)
	end
end
