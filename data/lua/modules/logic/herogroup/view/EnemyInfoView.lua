...
local var_0_0 = class("EnemyInfoView", BaseViewExtended)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txthp = gohelper.findChildText(arg_1_0.viewGO, "enemyinfo/hpbar/txt_hp/image_HPFrame/#txt_hp")
	...
	arg_1_0._multiHpRoot = gohelper.findChild(arg_1_0.viewGO, "enemyinfo/hpbar/txt_hp/image_HPFrame/image_HPBG")
	arg_1_0._multiHpItem = gohelper.findChild(arg_1_0.viewGO, "enemyinfo/hpbar/txt_hp/image_HPFrame/image_HPBG/image_HpItem")
...
function var_0_0._refreshEnemyItem(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	...
	local var_7_0 = lua_monster_group.configDict[tonumber(arg_7_2[arg_7_1])]
	local var_7_1 = {}
	local var_7_2 = string.nilorempty(var_7_0.monster)
	local var_7_3 = string.nilorempty(var_7_0.spMonster)

	if var_7_2 and var_7_3 then
		return
	end

	local var_7_4 = var_7_2 and {} or string.split(var_7_0.monster, "#")
	local var_7_5 = var_7_3 and {} or string.split(var_7_0.spMonster, "#")
	...
	for iter_7_2 = 1, #var_7_4 do
		local var_7_6 = tonumber(var_7_4[iter_7_2])
		local var_7_7 = arg_7_3.enemyItemGOs[iter_7_2]

		if not var_7_7 then
			local var_7_8 = gohelper.cloneInPlace(arg_7_3.goenemyitem, "item" .. iter_7_2)

			var_7_7 = arg_7_0:_initEnemyItem(var_7_8, var_7_6, arg_7_1)

			table.insert(arg_7_3.enemyItemGOs, var_7_7)
		end

		var_7_7.monsterId = var_7_6

		local var_7_9 = lua_monster.configDict[var_7_6]
		local var_7_10 = FightConfig.instance:getSkinCO(var_7_9.skinId)

		arg_7_0:_setEnemyItem(var_7_7, var_7_9, var_7_10, arg_7_1, iter_7_2)
		gohelper.setActive(var_7_7.go, true)
		gohelper.setActive(var_7_7.bosstag, false)
		gohelper.setActive(var_7_7.bosstag, FightHelper.isBossId(var_7_0.bossId, var_7_6))

		arg_7_0._enemyItemIndex = arg_7_0._enemyItemIndex + 1
	end

	for iter_7_3 = #var_7_4 + 1, #arg_7_3.enemyItemGOs do
...
function var_0_0._refreshInfo(arg_12_0, arg_12_1)
	if arg_12_1.index ~= arg_12_0.selectMonsterIndex then
		...
		arg_12_0._txtlevel.text = HeroConfig.instance:getLevelDisplayVariant(var_12_2.level)
		...
		if arg_12_0.viewParam.showHpQuestionMark then
			arg_12_0._txthp.text = "????"
		else
			arg_12_0._txthp.text = CharacterDataConfig.instance:getMonsterHp(var_12_0)
		end
		...
		arg_12_0:_detectBossMultiHp(var_12_2)
	end
end

function var_0_0._getBossId(arg_13_0, arg_13_1)
	local var_13_0 = FightModel.instance:getSelectMonsterGroupId(arg_13_1)
...
function var_0_0._refreshPassiveSkill(arg_17_0, arg_17_1, arg_17_2)
	...
	if var_17_0 and #var_17_0 > 0 then
		...
		for iter_17_0 = 1, #var_17_0 do
			...
			local var_17_6 = FightConfig.instance:getSkillEffectDesc(nil, var_17_5)
...
function var_0_0._detectBossMultiHp(arg_28_0, arg_28_1)
	local var_28_0 = lua_monster_template.configDict[arg_28_1.template]
	local var_28_1 = #FightConfig.instance:getMultiHpListByMonsterId(arg_28_1.id)

	gohelper.setActive(arg_28_0._multiHpRoot, var_28_1 > 1)

	if var_28_1 > 1 then
		arg_28_0:com_createObjList(nil, var_28_1, arg_28_0._multiHpRoot, arg_28_0._multiHpItem)
	end
end

function var_0_0.onClose(arg_29_0)
	arg_29_0:removeEventCb(HeroGroupController.instance, HeroGroupEvent.OnClickEnemyItem, arg_29_0._refreshInfo, arg_29_0)
end

function var_0_0.onDestroyView(arg_30_0)
	arg_30_0._simagerightbg:UnLoadImage()

	arg_30_0._simagerightbg = nil

	if arg_30_0._enemyGroupItemGOs then
		for iter_30_0 = 1, #arg_30_0._enemyGroupItemGOs do
			if arg_30_0._enemyGroupItemGOs[iter_30_0].enemyItemGOs then
				for iter_30_1 = 1, #arg_30_0._enemyGroupItemGOs[iter_30_0].enemyItemGOs do
					local var_30_0 = arg_30_0._enemyGroupItemGOs[iter_30_0].enemyItemGOs[iter_30_1]

					var_30_0.btn:RemoveClickListener()
					HeroGroupController.instance:unregisterCallback(HeroGroupEvent.OnClickEnemyItem, var_30_0.onClickEnemyItem, var_30_0)
				end
			end
		end
	end

	if arg_30_0._skillGOs then
		for iter_30_2 = 1, #arg_30_0._skillGOs do
			local var_30_1 = arg_30_0._skillGOs[iter_30_2]

			var_30_1.tag:UnLoadImage()
			var_30_1.icon:UnLoadImage()
			var_30_1.btn:RemoveClickListener()
		end
	end

	for iter_30_3, iter_30_4 in ipairs(arg_30_0._superItemList) do
		iter_30_4.btn:RemoveClickListener()
	end
