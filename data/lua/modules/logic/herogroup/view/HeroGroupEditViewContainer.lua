-- chunkname: @modules/logic/herogroup/view/HeroGroupEditViewContainer.lua

module("modules.logic.herogroup.view.HeroGroupEditViewContainer", package.seeall)

local HeroGroupEditViewContainer = class("HeroGroupEditViewContainer", BaseViewContainer)

function HeroGroupEditViewContainer:buildViews()
...
function HeroGroupEditViewContainer:buildTabViews(tabContainerId)
...
function HeroGroupEditViewContainer:onContainerOpenFinish()
	self._navigateButtonView:resetOnCloseViewAudio(AudioEnum.HeroGroupUI.Play_UI_Team_Close)
end

function HeroGroupEditViewContainer:_overrideClose()
...
function HeroGroupEditViewContainer:_setHomeBtnVisible(isVisible)
...
return HeroGroupEditViewContainer
