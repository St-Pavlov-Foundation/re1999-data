...
local var_0_0 = class("HeroGroupEditView", BaseView)
...
function var_0_0._btnconfirmOnClick(arg_9_0)
	...
	if arg_9_0._heroMO then
		...
		if arg_9_0._heroMO:isTrial() and not HeroSingleGroupModel.instance:isInGroup(arg_9_0._heroMO.uid) and (var_9_4:isEmpty() or not var_9_4.trial) and HeroGroupEditListModel.instance:isTrialLimit() then
...
function var_0_0._btnquickeditOnClick(arg_18_0)
	...
	if arg_18_0._isShowQuickEdit then
		...
		local var_18_0 = HeroGroupQuickEditListModel.instance:getById(arg_18_0._originalHeroUid)

		if var_18_0 then
			local var_18_1 = HeroGroupQuickEditListModel.instance:getIndex(var_18_0)

			HeroGroupQuickEditListModel.instance:selectCell(var_18_1, true)
		end
	else
		...
		if var_18_2 ~= "0" then
			local var_18_3 = HeroGroupEditListModel.instance:getById(var_18_2)
			local var_18_4 = HeroGroupEditListModel.instance:getIndex(var_18_3)

			HeroGroupEditListModel.instance:selectCell(var_18_4, true)
		end
...
function var_0_0._saveQuickGroupInfo(arg_34_0)
	if HeroGroupQuickEditListModel.instance:getIsDirty() then
		local var_34_0 = HeroGroupQuickEditListModel.instance:getHeroUids()
...
function var_0_0._onGroupModify(arg_39_0)
	if arg_39_0._isShowQuickEdit then
		...
		if arg_39_0._originalHeroUid ~= var_39_0 then
			...
			HeroGroupEditListModel.instance:setParam(var_39_0, arg_39_0._adventure)
			arg_39_0:_onHeroItemClick(nil)
			HeroGroupEditListModel.instance:cancelAllSelected()

			local var_39_1 = HeroGroupEditListModel.instance:getById(var_39_0)
			local var_39_2 = HeroGroupEditListModel.instance:getIndex(var_39_1)

			HeroGroupEditListModel.instance:selectCell(var_39_2, true)
		end
