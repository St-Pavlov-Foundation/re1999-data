...
function slot0.onScenePrepared(slot0, slot1, slot2)
	...
	FightController.instance:registerCallback(FightEvent.UpgradeMagicCircile, slot0._onUpgradeMagicCircile, slot0)
...
function slot0._onSkillPlayStart(slot0, slot1, slot2, slot3)
	if slot1:getMO() and FightCardDataHelper.isBigSkill(slot2) and slot0._loopEffect then
...
function slot0._onUpgradeMagicCircile(slot0, slot1)
	slot0:clearLastLoopEffect()

	slot0._config = slot0:_getConfig(slot1.magicCircleId)
...
function slot0.onSceneClose(slot0, slot1, slot2)
	...
	FightController.instance:unregisterCallback(FightEvent.UpgradeMagicCircile, slot0._onUpgradeMagicCircile, slot0)
