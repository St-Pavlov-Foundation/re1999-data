-- chunkname: @modules/logic/scene/shelter/comp/SurvivalShelterSceneGraphicsComp.lua

module("modules.logic.scene.shelter.comp.SurvivalShelterSceneGraphicsComp", package.seeall)

local SurvivalShelterSceneGraphicsComp = class("SurvivalShelterSceneGraphicsComp", BaseSceneComp)

function SurvivalShelterSceneGraphicsComp:onInit()
...
function SurvivalShelterSceneGraphicsComp:onScenePrepared(sceneId, levelId)
	return
end

function SurvivalShelterSceneGraphicsComp:setPPValue(key, value)
...
function SurvivalShelterSceneGraphicsComp:init()
...
function SurvivalShelterSceneGraphicsComp:onSceneClose()
...
function SurvivalShelterSceneGraphicsComp:_refreshGraphics()
	local camera = CameraMgr.instance:getMainCamera()
...
return SurvivalShelterSceneGraphicsComp
