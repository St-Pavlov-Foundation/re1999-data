...
function var_0_0.refreshSkillDesc(arg_6_0)
	...
	arg_6_0._txtSkillDesc.text = AutoChessHelper.buildSkillDesc(var_6_0) .. var_6_1
end
...
function var_0_0.refreshSkillDesc2(arg_10_0, arg_10_1)
	...
	arg_10_0._txtSkillDesc.text = AutoChessHelper.buildSkillDesc(var_10_0) .. var_10_1 .. var_10_2
end
