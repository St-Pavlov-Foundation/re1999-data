...
function var_0_0.refreshSkillDesc(arg_4_0)
	...
	arg_4_0._txtSkillDesc.text = AutoChessHelper.buildSkillDesc(var_4_0) .. var_4_1
end
...
function var_0_0.refreshSkillDesc2(arg_9_0, arg_9_1)
	...
	arg_9_0._txtSkillDesc.text = AutoChessHelper.buildSkillDesc(var_9_0) .. var_9_1 .. var_9_2
end
