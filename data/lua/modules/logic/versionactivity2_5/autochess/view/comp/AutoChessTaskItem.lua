module("modules.logic.versionactivity2_5.autochess.view.comp.AutoChessTaskItem", package.seeall)

slot0 = class("AutoChessTaskItem", ListScrollCellExtend)
...
function slot0._btngetallOnClick(slot0)
	AutoChessController.instance:dispatchEvent(AutoChessEvent.OneClickClaimReward, slot0._taskMo.activityId)
	UIBlockHelper.instance:startBlock("AutoChessTaskItem_finishAnim", 0.5)
...
function slot0._editableAddEvents(slot0)
	slot0:addEventCb(AutoChessController.instance, AutoChessEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end

function slot0._editableRemoveEvents(slot0)
	slot0:removeEventCb(AutoChessController.instance, AutoChessEvent.OneClickClaimReward, slot0._onOneClickClaimReward, slot0)
end
...
function slot0.onUpdateMO(slot0, slot1)
	...
	slot0:_refreshUI()
	slot0:_moveByRankDiff(AutoChessTaskListModel.instance:getRankDiff(slot1))
end
...
slot0.prefabPath = "ui/viewres/versionactivity_2_5/autochess/item/autochesstaskitem.prefab"
