...
function slot0._getOrCreateGroupItem(slot0, slot1, slot2)
	if not slot0._groupItemTab[slot1] then
		slot0._groupItemTab[slot1] = MonoHelper.addLuaComOnceToGo(gohelper.cloneInPlace(slot0._gogroupitem, "groupitem_" .. slot1), Act183Enum.GroupCategoryClsType[slot2])
	end
...
function slot0._getOrCreeateEpisodeItem(slot0, slot1)
	if not (slot0._episodeItemTab and slot0._episodeItemTab[slot1:getConfig().order]) then
		slot0._episodeItemTab[slot3] = Act183BaseEpisodeItem.Get(slot0.viewGO, slot1)
	end
