...
function slot0.Get(slot0, slot1)
	...
	return MonoHelper.addLuaComOnceToGo(gohelper.clone(slot6.getItemTemplateGo(slot0, slot6.getItemTemplatePath()), gohelper.findChild(slot0, slot6.getItemParentPath(slot4)), "item_" .. slot4), slot6)
end
