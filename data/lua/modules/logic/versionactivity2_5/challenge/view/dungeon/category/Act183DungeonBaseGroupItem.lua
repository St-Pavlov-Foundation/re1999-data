...
function slot0.refreshGroupTaskProgress(slot0)
	slot2, slot3 = Act183Helper.getGroupEpisodeTaskProgress(Act183Model.instance:getActivityId(), slot0._groupId)

	gohelper.setActive(slot0._gofinished, slot2 <= slot3)
end
