...
function slot0._refreshMainGroupEpisodeItem(slot0, slot1, slot2)
	...
	if slot4 then
		slot8, slot9 = Act183Helper.getGroupEpisodeTaskProgress(slot0._actId, slot2:getGroupId())
...
function slot0._refreshDailyGroupItem(slot0, slot1, slot2, slot3)
	...
	if slot6 then
		...
		slot8, slot9 = Act183Helper.getGroupEpisodeTaskProgress(slot0._actId, slot4)
		slot7 = slot8 <= slot9
