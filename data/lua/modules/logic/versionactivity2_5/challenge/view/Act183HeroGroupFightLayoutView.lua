module("modules.logic.versionactivity2_5.challenge.view.Act183HeroGroupFightLayoutView", package.seeall)

slot0 = class("Act183HeroGroupFightLayoutView", BaseView)
