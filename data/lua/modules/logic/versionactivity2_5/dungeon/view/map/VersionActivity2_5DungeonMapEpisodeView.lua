...
function VersionActivity2_5DungeonMapEpisodeView:addEvents()
	...
	self:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.hideUI, self)
	self:addEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_5DungeonMapEpisodeView:removeEvents()
	...
	self:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnClickElement, self.hideUI, self)
	self:removeEventCb(VersionActivity2_5DungeonController.instance, VersionActivity2_5DungeonEvent.OnHideInteractUI, self.showUI, self)
