-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/map/VersionActivity2_5DungeonMapEpisodeItem.lua

module("modules.logic.versionactivity2_5.dungeon.view.map.VersionActivity2_5DungeonMapEpisodeItem", package.seeall)

local VersionActivity2_5DungeonMapEpisodeItem = class("VersionActivity2_5DungeonMapEpisodeItem", BaseChildView)

function VersionActivity2_5DungeonMapEpisodeItem:onInitView()
...
function VersionActivity2_5DungeonMapEpisodeItem:addEvents()
...
function VersionActivity2_5DungeonMapEpisodeItem:removeEvents()
...
function VersionActivity2_5DungeonMapEpisodeItem:onClick()
	if self.isLock then
	...
	local viewContainer = ViewMgr.instance:getContainer(ViewName.VersionActivity2_5DungeonMapLevelView)
...
function VersionActivity2_5DungeonMapEpisodeItem:_editableInitView()
...
function VersionActivity2_5DungeonMapEpisodeItem:_showEye()
	...
	local isHard = self._config.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Hard

	gohelper.setActive(self._gonormaleye, not isHard)
	gohelper.setActive(self._gohardeye, isHard)
end

function VersionActivity2_5DungeonMapEpisodeItem:initViewParam()
	self._contentTransform = self.viewParam[1]
	self._layout = self.viewParam[2]
	self._mapSceneView = self.viewContainer.mapScene
end

function VersionActivity2_5DungeonMapEpisodeItem:onUpdateParam()
	self:initViewParam()
	self:_showAllElementTipView()
end

function VersionActivity2_5DungeonMapEpisodeItem:onOpen()
	self:initViewParam()
end

function VersionActivity2_5DungeonMapEpisodeItem:getMapAllElementList()
	local normalElementCoList = VersionActivity2_5DungeonModel.instance:getElementCoList(self._map.id)

	return normalElementCoList
end

function VersionActivity2_5DungeonMapEpisodeItem:_showAllElementTipView()
	if not self._map or self._config.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Hard then
	...
	local finishElementCoList, mapAllElementList = VersionActivity2_5DungeonModel.instance:getElementCoListWithFinish(self._map.id)
...
function VersionActivity2_5DungeonMapEpisodeItem:_hideAllElementTip()
	gohelper.setActive(self._gotipcontent, false)
end

function VersionActivity2_5DungeonMapEpisodeItem:refresh(config, dungeonMo)
	self._config = config
	...
	self._map = VersionActivity2_5DungeonConfig.instance:getEpisodeMapConfig(self._config.id)
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshUI()
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshLock()
	self.isLock = self:checkLock()

	gohelper.setActive(self.goLock, self:checkLock())
end

function VersionActivity2_5DungeonMapEpisodeItem:initElementIdList()
...
function VersionActivity2_5DungeonMapEpisodeItem:clearElementIdList()
	self.elementIdList = nil
end

function VersionActivity2_5DungeonMapEpisodeItem:checkLock()
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshStar()
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshFlag()
	gohelper.setActive(self._goflag, false)
end

function VersionActivity2_5DungeonMapEpisodeItem:refreshUnlockContent()
	if self.pass then
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshHardModeStar()
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshStoryModeStar()
	local starItem
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshEpisodeStar(starItem, episodeId)
...
function VersionActivity2_5DungeonMapEpisodeItem:refreshFocusStatus()
	gohelper.setActive(self.goSelected, self._config.id == self.activityDungeonMo.episodeId)
end

function VersionActivity2_5DungeonMapEpisodeItem:beginShowRewardView()
	self.beginReward = true
end

function VersionActivity2_5DungeonMapEpisodeItem:endShowRewardView()
...
function VersionActivity2_5DungeonMapEpisodeItem:calculatePosInContent()
	...
	self._maxWidth = math.max(halfWidth * 2, VersionActivity2_5DungeonEnum.EpisodeItemMinWidth) + 30
...
function VersionActivity2_5DungeonMapEpisodeItem:setImage(image, light, episodeId)
	local episodeConfig = DungeonConfig.instance:getEpisodeCO(episodeId)
	local starType = VersionActivity2_5DungeonEnum.EpisodeStarType[episodeConfig.chapterId]
...
function VersionActivity2_5DungeonMapEpisodeItem:getMaxWidth()
	return self._maxWidth
end

function VersionActivity2_5DungeonMapEpisodeItem:updateSelectStatus(selectedItem, ignoreAni)
...
function VersionActivity2_5DungeonMapEpisodeItem:onRemoveElement(elementId)
...
function VersionActivity2_5DungeonMapEpisodeItem:playUnLockAnimation()
	local animator = self.goLock:GetComponent(typeof(UnityEngine.Animator))

	animator.enabled = true
end

function VersionActivity2_5DungeonMapEpisodeItem:playAnimation(animationName)
...
function VersionActivity2_5DungeonMapEpisodeItem:getEpisodeId()
	return self._config and self._config.id
end

function VersionActivity2_5DungeonMapEpisodeItem:createStarItem(goStar)
...
function VersionActivity2_5DungeonMapEpisodeItem:onClose()
	TaskDispatcher.cancelTask(self._hideAllElementTip, self)
end

function VersionActivity2_5DungeonMapEpisodeItem:onDestroyView()
	self.goClick:RemoveClickListener()
end

return VersionActivity2_5DungeonMapEpisodeItem
