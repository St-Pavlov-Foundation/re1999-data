...
slot0 = class("VersionActivity2_5DungeonMapLevelView", BaseView)
slot1 = 0.4
slot2 = 2.7
...
function slot0.startBattle(slot0)
	...
	if slot0.isSpecialEpisode then
		...
		VersionActivity2_5DungeonController.instance:savePlayerPrefs(VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode, cjson.encode(slot0.lastEpisodeSelectModeDict))
	end
...
function slot0.initLocalEpisodeMode(slot0)
	slot0.unlockedEpisodeModeDict = VersionActivity2_5DungeonController.instance:loadDictFromStr(VersionActivity2_5DungeonController.instance:getPlayerPrefs(VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode, ""))
	slot0.lastEpisodeSelectModeDict = VersionActivity2_5DungeonController.instance:loadDictFromStr(VersionActivity2_5DungeonController.instance:getPlayerPrefs(VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode, ""))
end
...
function slot0.initViewParam(slot0)
	...
	slot0.index = VersionActivity2_5DungeonConfig.instance:getEpisodeIndex(slot0.originEpisodeId)
...
function slot0.refreshEpisodeTextInfo(slot0)
	slot2 = nil
	slot2 = (DungeonConfig.instance:getChapterCO(slot0.showEpisodeCo.chapterId).id ~= VersionActivity2_5DungeonEnum.DungeonChapterId.Story or slot0.showEpisodeCo) and VersionActivity2_5DungeonConfig.instance:getStoryEpisodeCo(slot0.showEpisodeCo.id)
...
function slot0.setStarImage(slot0, slot1, slot2, slot3)
	if slot2 then
		UISpriteSetMgr.instance:setV2a3DungeonSprite(slot1, VersionActivity2_5DungeonEnum.EpisodeStarType[DungeonConfig.instance:getEpisodeCO(slot3).chapterId].light)
	else
...
function slot0.refreshEye(slot0)
	...
	slot2 = slot0.originEpisodeConfig.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Hard
...
function slot0.onModeUnlockAnimationPlayDone(slot0)
	...
	VersionActivity2_5DungeonController.instance:savePlayerPrefs(VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode, cjson.encode(slot0.unlockedEpisodeModeDict))
