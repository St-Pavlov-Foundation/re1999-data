-- chunkname: @modules/logic/versionactivity2_5/dungeon/view/maplevel/VersionActivity2_5DungeonMapLevelView.lua

module("modules.logic.versionactivity2_5.dungeon.view.maplevel.VersionActivity2_5DungeonMapLevelView", package.seeall)

local VersionActivity2_5DungeonMapLevelView = class("VersionActivity2_5DungeonMapLevelView", BaseView)
local OPEN_ANIM_TIME = 0.4
local UNLOCK_ANIM_TIME = 2.7

function VersionActivity2_5DungeonMapLevelView:onInitView()
...
function VersionActivity2_5DungeonMapLevelView:addEvents()
...
function VersionActivity2_5DungeonMapLevelView:removeEvents()
...
function VersionActivity2_5DungeonMapLevelView:_onCurrencyChange(changeIds)
...
function VersionActivity2_5DungeonMapLevelView:_btnleftarrowOnClick()
...
function VersionActivity2_5DungeonMapLevelView:_btnrightarrowOnClick()
	local isHardMode = self.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard
...
function VersionActivity2_5DungeonMapLevelView:refreshUIByMode(mode)
...
function VersionActivity2_5DungeonMapLevelView:_btnactivityrewardOnClick()
	DungeonController.instance:openDungeonRewardView(self.showEpisodeCo)
end

function VersionActivity2_5DungeonMapLevelView:_btnnormalStartOnClick()
...
function VersionActivity2_5DungeonMapLevelView:_btnhardStartOnClick()
	self:startBattle()
end

function VersionActivity2_5DungeonMapLevelView:startBattle()
	...
	if self.isSpecialEpisode then
		...
		local prefsKey = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
		local strLastSelectMode = cjson.encode(self.lastEpisodeSelectModeDict)

		VersionActivity2_5DungeonController.instance:savePlayerPrefs(prefsKey, strLastSelectMode)
	end
...
function VersionActivity2_5DungeonMapLevelView:_playSkipMainStory()
	DungeonRpc.instance:sendStartDungeonRequest(self.showEpisodeCo.chapterId, self.showEpisodeCo.id)
	self:onStoryFinished()
end

function VersionActivity2_5DungeonMapLevelView:_playMainStory()
	DungeonRpc.instance:sendStartDungeonRequest(self.showEpisodeCo.chapterId, self.showEpisodeCo.id)
...
function VersionActivity2_5DungeonMapLevelView:onStoryFinished()
...
function VersionActivity2_5DungeonMapLevelView:_playStoryAndEnterFight(storyId)
...
function VersionActivity2_5DungeonMapLevelView:_enterFight()
	DungeonFightController.instance:enterFight(self.showEpisodeCo.chapterId, self.showEpisodeCo.id, 1)
end

function VersionActivity2_5DungeonMapLevelView:playAfterStory(storyId)
	local param = {}
...
function VersionActivity2_5DungeonMapLevelView:_btnlockStartOnClick()
	local preModeName = self:getPreModeName()

	GameFacade.showToast(ToastEnum.VersionActivityCanFight, preModeName)
end

function VersionActivity2_5DungeonMapLevelView:getPreModeName()
...
function VersionActivity2_5DungeonMapLevelView:_btnreplayStoryOnClick()
...
function VersionActivity2_5DungeonMapLevelView:_editableInitView()
	self.rewardItems = {}
...
function VersionActivity2_5DungeonMapLevelView:initLocalEpisodeMode()
	local unlockModePrefsKey = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local strLastUnlockModeValue = VersionActivity2_5DungeonController.instance:getPlayerPrefs(unlockModePrefsKey, "")

	self.unlockedEpisodeModeDict = VersionActivity2_5DungeonController.instance:loadDictFromStr(strLastUnlockModeValue)

	local lastSelectModePrefsKey = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
	local strLastSelectModeValue = VersionActivity2_5DungeonController.instance:getPlayerPrefs(lastSelectModePrefsKey, "")

	self.lastEpisodeSelectModeDict = VersionActivity2_5DungeonController.instance:loadDictFromStr(strLastSelectModeValue)
end

function VersionActivity2_5DungeonMapLevelView:onUpdateParam()
	self:onOpen()
	self.animator:Play(UIAnimationName.Open, 0, 0)
end

function VersionActivity2_5DungeonMapLevelView:onOpen()
...
function VersionActivity2_5DungeonMapLevelView:initViewParam()
	...
	self.index = VersionActivity2_5DungeonConfig.instance:getEpisodeIndex(self.originEpisodeId)
...
function VersionActivity2_5DungeonMapLevelView:initMode()
...
function VersionActivity2_5DungeonMapLevelView:checkNeedPlayModeUnLockAnimation()
...
function VersionActivity2_5DungeonMapLevelView:markSelectEpisode()
...
function VersionActivity2_5DungeonMapLevelView:refreshStoryIdList()
...
function VersionActivity2_5DungeonMapLevelView:refreshBg()
...
function VersionActivity2_5DungeonMapLevelView:refreshUI()
...
function VersionActivity2_5DungeonMapLevelView:refreshModeCanFight()
...
function VersionActivity2_5DungeonMapLevelView:refreshEpisodeTextInfo()
	local chapterCo = DungeonConfig.instance:getChapterCO(self.showEpisodeCo.chapterId)
	local targetConfig

	if chapterCo.id == VersionActivity2_5DungeonEnum.DungeonChapterId.Story then
		targetConfig = self.showEpisodeCo
	else
		targetConfig = VersionActivity2_5DungeonConfig.instance:getStoryEpisodeCo(self.showEpisodeCo.id)
	end
...
function VersionActivity2_5DungeonMapLevelView:buildEpisodeName(episodeCo)
...
function VersionActivity2_5DungeonMapLevelView:buildColorText(text, color)
	return string.format("<color=%s>%s</color>", color, text)
end

function VersionActivity2_5DungeonMapLevelView:refreshStar()
...
function VersionActivity2_5DungeonMapLevelView:setStarImage(image, light, episodeId)
	local episodeConfig = DungeonConfig.instance:getEpisodeCO(episodeId)
	local starTypeData = VersionActivity2_5DungeonEnum.EpisodeStarType[episodeConfig.chapterId]
...
function VersionActivity2_5DungeonMapLevelView:refreshMode()
...
function VersionActivity2_5DungeonMapLevelView:refreshArrow()
...
function VersionActivity2_5DungeonMapLevelView:refreshReward()
	local rewardList = {}
...
function VersionActivity2_5DungeonMapLevelView:refreshStartBtn()
	self:refreshCostPower()
...
function VersionActivity2_5DungeonMapLevelView:refreshCostPower()
	local cost = 0
...
function VersionActivity2_5DungeonMapLevelView:refreshEye()
	...
	local isHard = self.originEpisodeConfig.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Hard

	gohelper.setActive(self._gonormaleye, not isHard)
	gohelper.setActive(self._gohardeye, isHard)
end

function VersionActivity2_5DungeonMapLevelView:playModeUnlockAnimation()
	if not self.needPlayUnlockModeAnimation then
		return
	end
...
function VersionActivity2_5DungeonMapLevelView:_playModeUnLockAnimation(animationName)
	self.lockTypeAnimator.enabled = true
...
function VersionActivity2_5DungeonMapLevelView:onModeUnlockAnimationPlayDone()
	self:_playModeUnLockAnimation(UIAnimationName.Idle)

	self.unlockedEpisodeModeDict[tostring(self.specialEpisodeId)] = self.mode

	local prefsKey = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local strLastUnlockMode = cjson.encode(self.unlockedEpisodeModeDict)

	VersionActivity2_5DungeonController.instance:savePlayerPrefs(prefsKey, strLastUnlockMode)
...
function VersionActivity2_5DungeonMapLevelView:onClose()
...
function VersionActivity2_5DungeonMapLevelView:onDestroyView()
	self.rewardItems = nil

	self._simagepower:UnLoadImage()
end

return VersionActivity2_5DungeonMapLevelView
