...
function var_0_0.startBattle(arg_11_0)
	...
	if arg_11_0.isSpecialEpisode then
		...
		local var_11_0 = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
		local var_11_1 = cjson.encode(arg_11_0.lastEpisodeSelectModeDict)

		VersionActivity2_5DungeonController.instance:savePlayerPrefs(var_11_0, var_11_1)
	end
...
function var_0_0.initLocalEpisodeMode(arg_23_0)
	local var_23_0 = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local var_23_1 = VersionActivity2_5DungeonController.instance:getPlayerPrefs(var_23_0, "")

	arg_23_0.unlockedEpisodeModeDict = VersionActivity2_5DungeonController.instance:loadDictFromStr(var_23_1)

	local var_23_2 = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
	local var_23_3 = VersionActivity2_5DungeonController.instance:getPlayerPrefs(var_23_2, "")

	arg_23_0.lastEpisodeSelectModeDict = VersionActivity2_5DungeonController.instance:loadDictFromStr(var_23_3)
end
...
function var_0_0.initViewParam(arg_26_0)
	...
	arg_26_0.index = VersionActivity2_5DungeonConfig.instance:getEpisodeIndex(arg_26_0.originEpisodeId)
...
function var_0_0.refreshEpisodeTextInfo(arg_34_0)
	...
	if var_34_0.id == VersionActivity2_5DungeonEnum.DungeonChapterId.Story then
		var_34_1 = arg_34_0.showEpisodeCo
	else
		var_34_1 = VersionActivity2_5DungeonConfig.instance:getStoryEpisodeCo(arg_34_0.showEpisodeCo.id)
	end
	...
	local var_34_4 = lua_battle.configDict[arg_34_0.showEpisodeCo.battleId]
	local var_34_5 = lua_battle.configDict[arg_34_0.showEpisodeCo.firstBattleId]
	local var_34_6 = var_34_5 and not string.nilorempty(var_34_5.balance)
	local var_34_7 = var_34_4 and not string.nilorempty(var_34_4.balance)
	local var_34_8 = DungeonModel.instance:hasPassLevel(arg_34_0.showEpisodeCo.id)

	gohelper.setActive(arg_34_0._gorecommend, var_34_3 > 0)

	if (var_34_6 or var_34_7) and not var_34_8 then
		arg_34_0._txtrecommendlv.text = "---"
...
function var_0_0.setStarImage(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	local var_38_1 = VersionActivity2_5DungeonEnum.EpisodeStarType[var_38_0.chapterId]
...
function var_0_0.refreshEye(arg_44_0)
	...
	local var_44_0 = arg_44_0.originEpisodeConfig.chapterId == VersionActivity2_5DungeonEnum.DungeonChapterId.Hard
...
function var_0_0.onModeUnlockAnimationPlayDone(arg_47_0)
	...
	local var_47_0 = VersionActivity2_5DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local var_47_1 = cjson.encode(arg_47_0.unlockedEpisodeModeDict)

	VersionActivity2_5DungeonController.instance:savePlayerPrefs(var_47_0, var_47_1)
