...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtcollectProcess = gohelper.findChildText(arg_1_0.viewGO, "root/right/collect/#go_collectProcess/#txt_collectProcess")
	...
	for iter_40_0 = 1, arg_40_0._allClueCount do
		...
		if var_40_0 then
			...
			while var_40_4 do
				...
				if var_40_10 then
					...
					if var_40_13 then
						...
						if var_40_17 <= var_40_16 then
							...
							if var_40_25.x < var_40_21.x then
								recthelper.setWidth(var_40_15, var_40_18 - var_40_22)

								for iter_40_1 = var_40_17, var_40_24 do
									local var_40_26 = var_40_9.textInfo.characterInfo[iter_40_1]
									local var_40_27 = var_40_9.textInfo.characterInfo[iter_40_1 + 1]

									if var_40_26 and var_40_27 and var_40_26.baseLine - var_40_27.baseLine > 1 then
										local var_40_28 = gohelper.cloneInPlace(var_40_13)

										table.insert(var_40_14, var_40_28)

										local var_40_29 = var_40_28.transform

										var_40_21 = var_40_27.bottomLeft

										local var_40_30 = var_40_21.x + var_40_18 / 2
										local var_40_31 = var_40_27.baseLine - var_40_19 / 2 - 10

										recthelper.setAnchorX(var_40_29, var_40_30)
										recthelper.setAnchorY(var_40_29, var_40_31)
										recthelper.setWidth(var_40_29, var_40_25.x - var_40_27.bottomLeft.x)
									end
								end
							else
				...
				var_40_4, var_40_32 = string.find(var_40_1, var_40_2)
			end
		end
	end

	if GuideModel.instance:isGuideFinish(var_0_1) and arg_40_0.bonusFinished then
		local var_40_33 = string.splitToNumber(arg_40_0._selectConfig.clueIds, "|")

		for iter_40_2, iter_40_3 in ipairs(var_40_33) do
			if lua_activity121_clue.configDict[iter_40_3][arg_40_0._activityId].storyTag == 1 then
				local var_40_34 = arg_40_0._gocollectNote.transform:GetChild(iter_40_2 - 1).gameObject
				local var_40_35 = gohelper.findChild(var_40_34, "go_storytag")

				gohelper.setActive(var_40_35, true)
			end
		end
	end
end
