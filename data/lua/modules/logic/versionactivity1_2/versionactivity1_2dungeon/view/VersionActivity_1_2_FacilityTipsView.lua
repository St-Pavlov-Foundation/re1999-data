...
function slot0._onItemShow(slot0, slot1, slot2, slot3)
	...
	if slot2.buildingType == 2 then
		slot0:com_createObjList(slot0._showType2DesItem, string.split(slot2.configType, "|"), gohelper.findChild(slot1, "tips"), gohelper.findChildText(slot1, "tips/txt_info").gameObject)
	else
