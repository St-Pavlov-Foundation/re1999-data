...
function var_0_0._getDefaultFocusEpisode(arg_10_0, arg_10_1)
	local var_10_0 = DungeonConfig.instance:getChapterEpisodeCOList(arg_10_1)
	local var_10_1 = true
	local var_10_2

	for iter_10_0, iter_10_1 in ipairs(var_10_0) do
		if not DungeonModel.instance:hasPassLevel(iter_10_1.id) then
			var_10_1 = false
		end

		if DungeonModel.instance:isUnlock(iter_10_1) and DungeonModel.instance:isFinishElementList(iter_10_1) then
			var_10_2 = iter_10_1.id
		end
	end

	if var_10_1 then
		local var_10_3 = VersionActivity1_2DungeonMapEpisodeBaseView.getlastBattleEpisodeId(arg_10_1)
	...
	return var_10_2 or var_10_0[1].id
end

function var_0_0.getNowEpisodeId(arg_11_0)
	local var_11_0 = DungeonConfig.instance:getChapterEpisodeCOList(VersionActivity1_2DungeonEnum.DungeonChapterId.Activity1_2DungeonNormal1)
	local var_11_1 = var_11_0[1].id

	for iter_11_0, iter_11_1 in ipairs(var_11_0) do
		if DungeonModel.instance:isUnlock(iter_11_1) and DungeonModel.instance:isFinishElementList(iter_11_1) then
			var_11_1 = iter_11_1.id
		end
	end
