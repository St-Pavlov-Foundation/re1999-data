...
function var_0_0.refreshUI(arg_11_0)
	...
	if arg_11_0.isWin then
		...
		arg_11_0._simageSuccTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.Success))
	else
		...
		if var_11_0 and var_11_0:isDelete() then
			arg_11_0._simageFailTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.FightFail))
		elseif YaXianGameModel.instance:isRoundUseUp() then
			arg_11_0._simageFailTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.RoundUseUp))
		else
			arg_11_0._simageFailTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.FightFail))
		end
	end
...
function var_0_0.onDestroyView(arg_17_0)
	...
	arg_17_0._simageSuccTitle:UnLoadImage()
	arg_17_0._simageFailTitle:UnLoadImage()
