...
function slot0.refreshUI(slot0)
	...
	if slot0.isWin then
		...
		slot0._simageSuccTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.Success))
	else
		...
		if YaXianGameController.instance:getPlayerInteractItem() and slot1:isDelete() then
			slot0._simageFailTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.FightFail))
		elseif YaXianGameModel.instance:isRoundUseUp() then
			slot0._simageFailTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.RoundUseUp))
		else
			slot0._simageFailTitle:LoadImage(ResUrl.gettxt_versionactivitychessIcon(YaXianGameEnum.ResultSimageName.FightFail))
		end
	end
...
function slot0.onDestroyView(slot0)
	...
	slot0._simageSuccTitle:UnLoadImage()
