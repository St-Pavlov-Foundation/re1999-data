...
function slot0._editableInitView(slot0)
	...
	slot1.scrollGOPath = "#go_attr/#go_attrdetail/#scroll"
	slot1.prefabType = ScrollEnum.ScrollPrefabFromView
	slot1.prefabUrl = "#go_attr/#go_attrdetail/#scroll/item"
	slot1.cellClass = Activity114FeaturesItem
	slot1.scrollDir = ScrollEnum.ScrollDirV
	slot1.lineCount = 1
	slot1.cellWidth = 276
	slot1.cellHeight = 48
	slot1.cellSpaceH = 0
	slot1.cellSpaceV = 20.73
	slot1.startSpace = 0
	slot1.frameUpdateMs = 100
	slot0._scrollView = LuaListScrollView.New(Activity114FeaturesModel.instance, slot1)
...
function slot0.setFeatureItem(slot0, slot1, slot2)
	gohelper.findChildTextMesh(slot1, "title/#txt_name").text = slot2.features
	gohelper.findChildTextMesh(slot1, "#txt_des").text = slot2.desc

	gohelper.setActive(gohelper.findChild(slot1, "title/#go_inherit"), slot2.inheritable == 1)
	UISpriteSetMgr.instance:setVersionActivitywhitehouseSprite(gohelper.findChildImage(slot1, "title/#icon_feature"), slot2.inheritable == 1 and "img_shuxing1" or "img_shuxing2")
end
