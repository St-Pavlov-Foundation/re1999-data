...
function var_0_0._editableInitView(arg_5_0)
	...
	local var_5_3 = ListScrollParam.New()

	var_5_3.scrollGOPath = "#go_attr/#go_attrdetail/#scroll"
	var_5_3.prefabType = ScrollEnum.ScrollPrefabFromView
	var_5_3.prefabUrl = "#go_attr/#go_attrdetail/#scroll/item"
	var_5_3.cellClass = Activity114FeaturesItem
	var_5_3.scrollDir = ScrollEnum.ScrollDirV
	var_5_3.lineCount = 1
	var_5_3.cellWidth = 276
	var_5_3.cellHeight = 48
	var_5_3.cellSpaceH = 0
	var_5_3.cellSpaceV = 20.73
	var_5_3.startSpace = 0
	var_5_3.frameUpdateMs = 100
	arg_5_0._scrollView = LuaListScrollView.New(Activity114FeaturesModel.instance, var_5_3)
...
function var_0_0.setFeatureItem(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_1 = gohelper.findChildTextMesh(arg_10_1, "title/#txt_name")
	local var_10_2 = gohelper.findChildTextMesh(arg_10_1, "#txt_des")
