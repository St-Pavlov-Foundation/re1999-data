...
function slot0.init(slot0, slot1)
	...
	slot0._imgSelect = gohelper.findChildSingleImage(slot1, "#go_selected/#btn_select")
	...
	slot0._goUnSelectAnim = slot0._gounselect:GetComponent(typeof(UnityEngine.Animator))
...
function slot0.updateData(slot0, slot1, slot2, slot3, slot4)
	...
	recthelper.setWidth(slot0._txtunselectdesc.transform, slot1 == Activity114Enum.EventContentType.Check_Once and 300 or 500)
	recthelper.setWidth(slot0._txtselectdesc.transform, slot1 == Activity114Enum.EventContentType.Check_Once and 340 or 700)
	...
	slot0._imgSelect:LoadImage(ResUrl.getAct114Image("btn_xuanze_" .. slot5))
end
