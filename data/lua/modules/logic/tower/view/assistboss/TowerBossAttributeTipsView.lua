...
function slot0.refreshAttr(slot0)
	for slot8 = 1, math.max(#TowerConfig.instance:getHeroGroupAddAttr(slot0.bossId, 0, slot0.bossMo and slot0.bossMo.trialLevel > 0 and slot0.bossMo.trialLevel or slot0.bossMo and slot0.bossMo.level or 1), #slot0.items) do
