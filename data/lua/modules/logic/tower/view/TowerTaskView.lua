...
function slot0.refreshRemainTime(slot0)
	for slot4, slot5 in ipairs(slot0.towerItemList) do
		...
		slot8, slot9 = TimeUtil.secondToRoughTime2(slot7, true)
		slot5.towerItemUI.txtTime.text = slot7 > 0 and string.format("%s%s", slot8, slot9) or ""
	end

	slot5, slot6 = TimeUtil.secondToRoughTime2(TowerModel.instance:getTowerOpenInfo(TowerTaskModel.instance.curSelectTowerType, TowerTaskModel.instance.curSelectToweId, TowerEnum.TowerStatus.Open) and slot3.nextTime / 1000 - ServerTime.now() or 0, true)
