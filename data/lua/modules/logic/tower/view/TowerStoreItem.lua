...
slot0 = class("TowerStoreItem", UserDataDispose)
...
function slot0.onInitView(slot0, slot1)
	...
	slot0._btnTips = gohelper.findChildButtonWithAudio(slot0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#btn_Tips")
	slot0._goTips = gohelper.findChild(slot0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#go_Tips")
	slot0._txtTimeTips = gohelper.findChildText(slot0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#go_Tips/image_Tips/#txt_TimeTips")
	slot0._btnclosetip = gohelper.findChildButtonWithAudio(slot0.go, "tag1/#go_Time/image_TipsBG/#txt_Time/#go_Tips/#btn_closetip")
...
function slot0.refreshTag(slot0)
	...
	slot0.txtTagName.text, slot3 = TowerStoreModel.instance:getStoreGroupName(TowerStoreModel.instance:getStore()[slot0.groupId])
...
function slot0.refreshGoods(slot0)
	...
	for slot5, slot6 in pairs(slot1) do
		...
		slot7:updateNewData(TowerStoreModel.instance:getStoreGoodsNewData(slot0.groupGoodsMoList.id, slot6.goodsId))
	end
