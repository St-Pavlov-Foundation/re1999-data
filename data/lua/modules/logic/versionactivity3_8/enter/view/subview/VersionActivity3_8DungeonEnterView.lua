-- chunkname: @modules/logic/versionactivity3_8/enter/view/subview/VersionActivity3_8DungeonEnterView.lua

module("modules.logic.versionactivity3_8.enter.view.subview.VersionActivity3_8DungeonEnterView", package.seeall)
...
function VersionActivity3_8DungeonEnterView:removeEvents()
	VersionActivity3_8DungeonEnterView.super.removeEvents(self)
...
function VersionActivity3_8DungeonEnterView:onDestroyView()
	VersionActivity3_8DungeonEnterView.super.onDestroyView(self)
...
function VersionActivity3_8DungeonEnterView:_btnBoardOnClick()
	CommandStationController.instance:openCommandStationPaperView()
end

function VersionActivity3_8DungeonEnterView:onOpenFinish()
	self._videoPath = VersionActivity3_8Enum.EnterLoopVideoName
...
function VersionActivity3_8DungeonEnterView:_onVideoStart()
	TaskDispatcher.cancelTask(self._onVideoStart, self)
...
function VersionActivity3_8DungeonEnterView:onPlayVideoDone()
...
function VersionActivity3_8DungeonEnterView:_setVideoAsLastSibling()
	local container = ViewMgr.instance:getContainer(ViewName.FullScreenVideoView)
...
function VersionActivity3_8DungeonEnterView:playLogoAnim(animName)
...
function VersionActivity3_8DungeonEnterView:refreshUI()
	VersionActivity3_8DungeonEnterView.super.refreshUI(self)
	self:refreshPaperCount()
end

function VersionActivity3_8DungeonEnterView:_onGetTaskBonus()
	CommandStationRpc.instance:sendGetCommandPostInfoRequest()
end

function VersionActivity3_8DungeonEnterView:refreshPaperCount()
	local finishCount = 0
	local totalCount = 0
...
return VersionActivity3_8DungeonEnterView
