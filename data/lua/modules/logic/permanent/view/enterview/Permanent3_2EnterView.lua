-- chunkname: @modules/logic/permanent/view/enterview/Permanent3_2EnterView.lua

module("modules.logic.permanent.view.enterview.Permanent3_2EnterView", package.seeall)

local Permanent3_2EnterView = class("Permanent3_2EnterView", BaseView)

function Permanent3_2EnterView:onInitView()
	...
	self._goReddot2 = gohelper.findChild(self.viewGO, "Left/EntranceRole2/#go_Reddot1")
	...
	self._goDungeonReddot = gohelper.findChild(self.viewGO, "Right/EntranceDungeon/#go_reddot")
...
function Permanent3_2EnterView:addEvents()
...
function Permanent3_2EnterView:_btnEntranceRole1OnClick()
...
function Permanent3_2EnterView:_btnEntranceRole2OnClick()
...
function Permanent3_2EnterView:_btnPlayOnClick()
	local param = {}
...
function Permanent3_2EnterView:_btnAchievementOnClick()
...
function Permanent3_2EnterView:_btnEntranceDungeonOnClick()
	VersionActivityFixedDungeonController.instance:openVersionActivityReactivityDungeonMapView(3, 2)
end

function Permanent3_2EnterView:_editableInitView()
	self.actCfg = ActivityConfig.instance:getActivityCo(VersionActivity3_2Enum.ActivityId.EnterView)

	gohelper.setActive(self._btnAchievement.gameObject, false)

	self._gobg = gohelper.findChild(self.viewGO, "#simage_FullBG")
	self._videoComp = VersionActivityVideoComp.get(self._gobg, self)
end

function Permanent3_2EnterView:onOpen()
	local act1MO = ActivityConfig.instance:getActivityCo(VersionActivity3_2Enum.ActivityId.HuiDiaoLan)
	local act2MO = ActivityConfig.instance:getActivityCo(VersionActivity3_2Enum.ActivityId.BeiLiEr)
	...
	local actMO = ActivityConfig.instance:getActivityCo(VersionActivity3_2Enum.ActivityId.Dungeon)

	if actMO.redDotId ~= 0 then
		RedDotController.instance:addRedDot(self._goDungeonReddot, actMO.redDotId)
	end
end

function Permanent3_2EnterView:onOpenFinish()
	self._videoPath = VersionActivity3_2Enum.EnterLoopVideoName

	self._videoComp:play(self._videoPath, true)
end

function Permanent3_2EnterView:onClose()
	PermanentModel.instance:undateActivityInfo(self.actCfg.id)
end

function Permanent3_2EnterView:onDestroyView()
	self._videoComp:destroy()
end

return Permanent3_2EnterView
