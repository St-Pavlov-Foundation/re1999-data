-- chunkname: @modules/logic/permanent/view/enterview/Permanent1_1EnterView.lua

module("modules.logic.permanent.view.enterview.Permanent1_1EnterView", package.seeall)

local Permanent1_1EnterView = class("Permanent1_1EnterView", BaseView)

function Permanent1_1EnterView:onInitView()
...
function Permanent1_1EnterView:addEvents()
...
function Permanent1_1EnterView:removeEvents()
...
function Permanent1_1EnterView:_btnEntranceRole1OnClick()
	local activityCO = ActivityConfig.instance:getActivityCo(VersionActivityEnum.ActivityId.Act108)
	...
	if string.nilorempty(condition) then
		...
		local key = PlayerPrefsKey.EnterRoleActivity .. "#" .. tostring(VersionActivityEnum.ActivityId.Act108) .. "#" .. tostring(userid)
...
function Permanent1_1EnterView:_btnEntranceRole2OnClick()
	Activity109ChessController.instance:openEntry(VersionActivityEnum.ActivityId.Act109)
end

function Permanent1_1EnterView:_btnPlayOnClick()
	local param = {}
...
function Permanent1_1EnterView:_btnEntranceDungeonOnClick()
	VersionActivityDungeonController.instance:openVersionActivityDungeonMapView()
end

function Permanent1_1EnterView:_editableInitView()
	self.actCfg = ActivityConfig.instance:getActivityCo(VersionActivityEnum.ActivityId.Act105)
end

function Permanent1_1EnterView:onOpen()
	local act1MO = ActivityConfig.instance:getActivityCo(VersionActivityEnum.ActivityId.Act108)
	local act2MO = ActivityConfig.instance:getActivityCo(VersionActivityEnum.ActivityId.Act109)
	local act3MO = ActivityConfig.instance:getActivityCo(VersionActivityEnum.ActivityId.Act113)
...
function Permanent1_1EnterView:onClose()
	PermanentModel.instance:undateActivityInfo(self.actCfg.id)
end

return Permanent1_1EnterView
