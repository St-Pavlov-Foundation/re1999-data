...
NecrologistStoryEvent.OnChangeTime = GameUtil.getEventId()
NecrologistStoryEvent.OnChangePlace = GameUtil.getEventId()
NecrologistStoryEvent.OnChangePic = GameUtil.getEventId()
NecrologistStoryEvent.OnStoryItemClickNext = GameUtil.getEventId()
NecrologistStoryEvent.OnSelectOption = GameUtil.getEventId()
...
NecrologistStoryEvent.V3A4_PutItem = GameUtil.getEventId()
NecrologistStoryEvent.V3A4_OnDataUpdate = GameUtil.getEventId()
NecrologistStoryEvent.V3A4_StartGame = GameUtil.getEventId()
NecrologistStoryEvent.V3A5_UpdateCoin = GameUtil.getEventId()
NecrologistStoryEvent.V3A5_PlayGameAnim = GameUtil.getEventId()
NecrologistStoryEvent.V3A5_GameAnimFinished = GameUtil.getEventId()
