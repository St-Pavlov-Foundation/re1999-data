-- chunkname: @modules/logic/activitywelfare/subview/newinsight/ActivityInsightShowView_2_4.lua

module("modules.logic.activitywelfare.subview.newinsight.ActivityInsightShowView_2_4", package.seeall)
