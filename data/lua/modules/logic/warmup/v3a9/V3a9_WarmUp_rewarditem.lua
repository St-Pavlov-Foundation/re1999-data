-- chunkname: @modules/logic/warmup/v3a9/V3a9_WarmUp_rewarditem.lua

module("modules.logic.warmup.v3a9.V3a9_WarmUp_rewarditem", package.seeall)

local V3a9_WarmUp_rewarditem = class("V3a9_WarmUp_rewarditem", RougeSimpleItemBase)

function V3a9_WarmUp_rewarditem:onInitView()
	if self._editableInitView then
		self:_editableInitView()
	end
end

function V3a9_WarmUp_rewarditem:addEvents()
	return
end

function V3a9_WarmUp_rewarditem:removeEvents()
	return
end

function V3a9_WarmUp_rewarditem:ctor(ctorParam)
	V3a9_WarmUp_rewarditem.super.ctor(self, ctorParam)
end

function V3a9_WarmUp_rewarditem:onDestroyView()
	V3a9_WarmUp_rewarditem.super.onDestroyView(self)
end

function V3a9_WarmUp_rewarditem:_editableInitView()
	V3a9_WarmUp_rewarditem.super._editableInitView(self)
...
function V3a9_WarmUp_rewarditem:playAnim_hasget(isIdle)
...
function V3a9_WarmUp_rewarditem:_set_Received()
	self._hasgetAnim:Play(kHasGetAnim, 0, 1)
end

function V3a9_WarmUp_rewarditem:_setActive_canget(isActive)
	gohelper.setActive(self._gocanget, isActive)
end

function V3a9_WarmUp_rewarditem:_setActive_hasget(isActive)
	gohelper.setActive(self._go_hasget, isActive)
end

return V3a9_WarmUp_rewarditem
