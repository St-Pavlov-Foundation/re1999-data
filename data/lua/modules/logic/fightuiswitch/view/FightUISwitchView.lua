...
function var_0_0._initClassify(arg_16_0)
	...
	for iter_16_2, iter_16_3 in ipairs(arg_16_0._styleClassify) do
		local var_16_0 = arg_16_0:_getClassifyItem(iter_16_2)
		local var_16_1 = iter_16_3.Classify

		var_16_0.classify = var_16_1

		var_16_0:onUpdateMO(var_16_1, iter_16_2)
		var_16_0:addBtnListeners(arg_16_0._clickClassifyBtn, arg_16_0)
		var_16_0:setTxt(luaLang(iter_16_3.ClassifyTitle))
		var_16_0:onSelect(arg_16_0._classifyIndex == var_16_1)
		var_16_0:showLine(iter_16_2 < #arg_16_0._styleClassify)
	end
end
...
function var_0_0.playSwitchAnim(arg_20_0)
	arg_20_0._animator:Play(FightUISwitchEnum.AnimKey.Switch, 0, 0)
end

function var_0_0._classifyBtnClickCb(arg_21_0)
	FightUISwitchModel.instance:setCurShowStyleClassify(arg_21_0._classifyIndex)
	arg_21_0:_refreshStyle()
	FightUISwitchListModel.instance:setMoList()

	for iter_21_0, iter_21_1 in ipairs(arg_21_0._classifyItems) do
		iter_21_1:onSelect(arg_21_0._classifyIndex == iter_21_1.classify)
	end
end

function var_0_0._refreshStyle(arg_22_0)
	local var_22_0 = FightUISwitchModel.instance:getCurStyleMo()
	local var_22_1 = var_22_0 and var_22_0:getItemConfig()

	if var_22_1 then
		arg_22_0._txtSceneName.text = var_22_1.name
		arg_22_0._txtSceneDescr.text = var_22_1.desc
	end

	arg_22_0._txtTime.text = var_22_0:getObtainTime() or ""

	arg_22_0._effectComp:refreshEffect(arg_22_0._goScene, FightUISwitchModel.instance:getCurStyleMo(), arg_22_0.viewName)
	arg_22_0._effectComp:setViewAnim(arg_22_0._animator)
	arg_22_0:_refreshBtn()
end

function var_0_0._refreshBtn(arg_23_0)
	local var_23_0 = FightUISwitchModel.instance:getCurStyleMo()
	local var_23_1 = var_23_0:isUse()
	local var_23_2 = var_23_0:isUnlock()
	local var_23_3 = var_23_0:canJump()

	gohelper.setActive(arg_23_0._gouse, var_23_1)
	gohelper.setActive(arg_23_0._goobtain, not var_23_2 and var_23_3)
	gohelper.setActive(arg_23_0._goselect, var_23_2 and not var_23_1)
	gohelper.setActive(arg_23_0._golock, not var_23_2 and not var_23_3)
end

function var_0_0.playCloseAnim(arg_24_0)
	return
end

function var_0_0.onClose(arg_25_0)
	arg_25_0._effectComp:onClose()
	FightUISwitchController.instance:dispose()
end

function var_0_0.onDestroyView(arg_26_0)
	arg_26_0._effectComp:onDestroy()
end
