...
function var_0_0.canJumpToStoreView(arg_3_0, arg_3_1)
	...
	if StoreModel.instance:isTabOpen(var_3_4) then
		...
		if var_3_5 then
			...
			local var_3_11 = string.nilorempty(var_3_8) and var_3_10 or TimeUtil.stringToTimestamp(var_3_8) - ServerTime.clientToServerOffset()
			local var_3_12 = string.nilorempty(var_3_9) and var_3_10 or TimeUtil.stringToTimestamp(var_3_9) - ServerTime.clientToServerOffset()
...
function var_0_0.canJumpToAct1_5DungeonView(arg_33_0, arg_33_1)
	local var_33_0, var_33_1, var_33_2 = ActivityHelper.getActivityStatusAndToast(VersionActivity2_0Enum.ActivityId.EnterView)
