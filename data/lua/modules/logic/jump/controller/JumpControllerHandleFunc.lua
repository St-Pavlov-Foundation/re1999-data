...
function slot0.jumpToVersionEnterView(slot0, slot1)
	...
	if _G[string.format("VersionActivity%sEnterController", slot4)] or VersionActivityFixedEnterController then
