-- chunkname: @modules/logic/assist/model/PickAssistListModel.lua

module("modules.logic.assist.model.PickAssistListModel", package.seeall)
...
local assistType2PickAssistViewName = {
	...
	[PickAssistEnum.Type.TowerComposeSupport1] = "TowerComposePickAssistView",
	[PickAssistEnum.Type.TowerComposeSupport2] = "TowerComposePickAssistView",
