...
function EquipInfoTipsView:onInitView()
	...
	self._txtattributelv = gohelper.findChildText(self.viewGO, "#go_container/scroll_view/Viewport/center/#go_suitattribute/attributename/txttitle/#txt_attributelv")
