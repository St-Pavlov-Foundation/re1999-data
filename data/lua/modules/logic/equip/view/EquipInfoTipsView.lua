...
function slot0.onInitView(slot0)
	...
	slot0._txtattributelv = gohelper.findChildText(slot0.viewGO, "#go_container/scroll_view/Viewport/center/#go_suitattribute/attributename/txttitle/#txt_attributelv")
