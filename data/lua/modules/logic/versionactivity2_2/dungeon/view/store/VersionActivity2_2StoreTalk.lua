...
slot0 = class("VersionActivity2_2StoreTalk", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivity2_2Enum.ActivityId.DungeonStore
...
function slot0.onOpenFinish(slot0)
	if slot0.isFirstEnter then
		...
		slot1 = PlayerModel.instance:getPlayerPrefsKey(PlayerPrefsKey.Version2_2PlayedStoreGroupIdKey)
...
function slot0.initGroupCo(slot0)
	...
	for slot7, slot8 in ipairs(string.split(PlayerPrefsHelper.getString(PlayerModel.instance:getPlayerPrefsKey(PlayerPrefsKey.Version2_2PlayedStoreGroupIdKey), slot8), slot7)) do
