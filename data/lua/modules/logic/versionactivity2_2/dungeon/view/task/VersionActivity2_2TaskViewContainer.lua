...
slot0 = class("VersionActivity2_2TaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivity2_2TaskItem
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity2_2TaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
