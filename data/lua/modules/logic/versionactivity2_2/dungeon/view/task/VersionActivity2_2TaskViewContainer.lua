...
local var_0_0 = class("VersionActivity2_2TaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = VersionActivity2_2TaskItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity2_2TaskListModel.instance, var_1_0, var_1_1)
