...
function slot0.setForecastChess(slot0, slot1)
	...
	for slot12 = 1, #slot1 do
		...
		slot7 = GameUtil.getSubPlaceholderLuaLangTwoParam(lua_eliminate_cost.configDict[39].value, slot2.round - EliminateLevelModel.instance:getRoundNumber(), string.format("<color=#4e6698>【<u><link=%s>%s</link></u>】", slot14, EliminateConfig.instance:getSoldierChessConfig(slot14).name)) .. "\n"
	end
