...
function var_0_0.addEvents(arg_2_0)
	...
	arg_2_0:addEventCb(SummonController.instance, SummonEvent.summonShowBlackScreen, arg_2_0.onReceiveShowBlackScreen, arg_2_0)
	arg_2_0:addEventCb(SummonController.instance, SummonEvent.summonShowExitAnim, arg_2_0.startExitLoading, arg_2_0)
	arg_2_0:addEventCb(SummonController.instance, SummonEvent.summonCloseBlackScreen, arg_2_0.onReceiveCloseBlackScreen, arg_2_0)
	arg_2_0:addEventCb(SummonController.instance, SummonEvent.summonMainCloseImmediately, arg_2_0.closeThis, arg_2_0)
end
...
function var_0_0.removeEvents(arg_3_0)
	...
	arg_3_0:removeEventCb(SummonController.instance, SummonEvent.summonShowBlackScreen, arg_3_0.onReceiveShowBlackScreen, arg_3_0)
	arg_3_0:removeEventCb(SummonController.instance, SummonEvent.summonShowExitAnim, arg_3_0.startExitLoading, arg_3_0)
	arg_3_0:removeEventCb(SummonController.instance, SummonEvent.summonCloseBlackScreen, arg_3_0.onReceiveCloseBlackScreen, arg_3_0)
	arg_3_0:removeEventCb(SummonController.instance, SummonEvent.summonMainCloseImmediately, arg_3_0.closeThis, arg_3_0)
...
function var_0_0._onGetReward(arg_8_0, arg_8_1, arg_8_2)
	...
	if not SummonNewCustomPickChoiceListModel.instance:haveAllRole() then
		local var_8_0 = SummonNewCustomPickChoiceController.instance

		SummonController.instance:doVirtualSummonBehavior({
			arg_8_2
		}, true, true, var_8_0.backFullPage, var_8_0, true)
	end
...
function var_0_0._editableInitView(arg_9_0)
	arg_9_0._goblackloading = gohelper.findChild(arg_9_0.viewGO, "#blackloading")
	arg_9_0._animLoading = arg_9_0._goblackloading:GetComponent(typeof(UnityEngine.Animator))
	arg_9_0._animUI = arg_9_0.viewGO:GetComponent(typeof(UnityEngine.Animator))
...
function var_0_0.onReceiveShowBlackScreen(arg_19_0)
	gohelper.setActive(arg_19_0._goblackloading, true)
	arg_19_0._animLoading:Play("blackloading_open", 0, 0)

	arg_19_0._isShowBlackScreen = true

	TaskDispatcher.runDelay(arg_19_0.afterBlackLoading, arg_19_0, 0.3)
end

function var_0_0.afterBlackLoading(arg_20_0)
	TaskDispatcher.cancelTask(arg_20_0.afterBlackLoading, arg_20_0)
	gohelper.setActive(arg_20_0.viewGO, false)
	SummonController.instance:onFirstLoadSceneBlock()
end

function var_0_0.onReceiveCloseBlackScreen(arg_21_0)
	if not gohelper.isNil(arg_21_0._animLoading) then
		arg_21_0._animLoading:Play("blackloading_close", 0, 0)
	end

	TaskDispatcher.runDelay(arg_21_0.afterCloseLoading, arg_21_0, 0.3)
end

function var_0_0.afterCloseLoading(arg_22_0)
	logNormal("close SummonNewCustomPickFullView")
	TaskDispatcher.cancelTask(arg_22_0.afterCloseLoading, arg_22_0)
	arg_22_0:closeThis()
end

function var_0_0.startExitLoading(arg_23_0)
	if not gohelper.isNil(arg_23_0._animUI) then
		arg_23_0._animUI:Play(UIAnimationName.Close, 0, 0)
	end
...
function var_0_0.onDestroyView(arg_25_0)
	arg_25_0._simagerolehead:UnLoadImage()
end
