...
function slot0.onOpen(slot0)
	...
	elseif slot2 or slot0._isFinishTips then
		...
		slot0._text.text = GameUtil.getSubPlaceholderLuaLang(Activity168Config.instance:getConstValueCfg(uv0, slot1.mapId).mlValue, {
			slot14,
			(slot8[1] < slot9[1] and luaLang("text_dir_east") or slot9[1] < slot8[1] and luaLang("text_dir_west") or "") .. (slot8[2] < slot9[2] and luaLang("text_dir_north") or slot9[2] < slot8[2] and luaLang("text_dir_south") or "")
		})
	end
end
