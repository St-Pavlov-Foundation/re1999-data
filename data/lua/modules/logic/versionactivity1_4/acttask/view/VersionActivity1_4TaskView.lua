...
function var_0_0.refreshRemainTime(arg_17_0)
	local var_17_0 = ActivityModel.instance:getActMO(arg_17_0.actId):getRealEndTimeStamp() - ServerTime.now()
	...
	if var_17_1 > 0 then
		arg_17_0.txtTime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_17_1, luaLang("time_day"), var_17_3, luaLang("time_hour")))
	else
		local var_17_4 = var_17_2 % TimeUtil.OneHourSecond
		local var_17_5 = Mathf.Floor(var_17_4 / TimeUtil.OneMinuteSecond)

		if var_17_3 > 0 then
			arg_17_0.txtTime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_17_3, luaLang("time_hour"), var_17_5, luaLang("time_minute2")))
		elseif var_17_5 > 0 then
			arg_17_0.txtTime.text = string.format(luaLang("remain"), string.format("%s%s", var_17_5, luaLang("time_minute")))
		else
			arg_17_0.txtTime.text = string.format(luaLang("remain"), string.format("<1%s", luaLang("time_minute")))
		end
	end
end
