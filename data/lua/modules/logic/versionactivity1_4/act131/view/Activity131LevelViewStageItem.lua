...
function var_0_0._waitLevelViewCloseFinished(arg_11_0)
	...
	TaskDispatcher.runDelay(arg_11_0._storyFrontViewShowed, arg_11_0, 0.5)
end

function var_0_0._storyFrontViewShowed(arg_12_0)
	arg_12_0._enterStoryId = 0

	local var_12_0 = ViewMgr.instance:getContainer(ViewName.Activity131LevelView).viewGO

	recthelper.setAnchorX(var_12_0.transform, 10000)
	UIBlockMgr.instance:endBlock("waitclose")
end

function var_0_0._onStoryFinished(arg_13_0)
	...
	recthelper.setAnchorX(var_13_0.transform, 0)
	Activity131Controller.instance:dispatchEvent(Activity131Event.BackToLevelView, true)

	if not Activity131Model.instance:isEpisodeFinished(arg_13_0._config.episodeId) then
		Activity131Rpc.instance:sendAct131StoryRequest(arg_13_0._config.activityId, arg_13_0._config.episodeId)
	end
end

function var_0_0._onStoryFinishAndEnterGameView(arg_14_0)
	Activity131Rpc.instance:sendAct131StoryRequest(arg_14_0._config.activityId, arg_14_0._config.episodeId, arg_14_0._enterActivity131GameView, arg_14_0)
end

function var_0_0._enterActivity131GameView(arg_15_0)
	Activity131Controller.instance:dispatchEvent(Activity131Event.StartEnterGameView, arg_15_0._episodeId)
end

function var_0_0._btnReviewOnClick(arg_16_0)
	local var_16_0 = {}

	if Activity131Model.instance:getEpisodeState(arg_16_0._config.episodeId) ~= Activity131Enum.EpisodeState.Finished then
		arg_16_0:_btnclickOnClick()

		return
	end

	if arg_16_0._config.beforeStoryId > 0 then
		table.insert(var_16_0, arg_16_0._config.beforeStoryId)
	end

	if arg_16_0._config.afterStoryId > 0 then
		table.insert(var_16_0, arg_16_0._config.afterStoryId)
	end

	StoryController.instance:playStories(var_16_0)
end

function var_0_0._addEvents(arg_17_0)
	Activity131Controller.instance:registerCallback(Activity131Event.playNewUnlockEpisode, arg_17_0._startNewUnlockEpisodeAni, arg_17_0)
	Activity131Controller.instance:registerCallback(Activity131Event.playNewFinishEpisode, arg_17_0._startNewFinishEpisodeAni, arg_17_0)
	Activity131Controller.instance:registerCallback(Activity131Event.EpisodeClick, arg_17_0._playChooseEpisode, arg_17_0)
	Activity131Controller.instance:registerCallback(Activity131Event.EnterEpisode, arg_17_0._onJumpToEpisode, arg_17_0)
	Activity131Controller.instance:registerCallback(Activity131Event.PlayChessAutoToNewEpisode, arg_17_0._playChessAutoToEpisode, arg_17_0)
end

function var_0_0._removeEvents(arg_18_0)
	Activity131Controller.instance:unregisterCallback(Activity131Event.playNewUnlockEpisode, arg_18_0._startNewUnlockEpisodeAni, arg_18_0)
	Activity131Controller.instance:unregisterCallback(Activity131Event.playNewFinishEpisode, arg_18_0._startNewFinishEpisodeAni, arg_18_0)
	Activity131Controller.instance:unregisterCallback(Activity131Event.EpisodeClick, arg_18_0._playChooseEpisode, arg_18_0)
	Activity131Controller.instance:unregisterCallback(Activity131Event.EnterEpisode, arg_18_0._onJumpToEpisode, arg_18_0)
	Activity131Controller.instance:unregisterCallback(Activity131Event.PlayChessAutoToNewEpisode, arg_18_0._playChessAutoToEpisode, arg_18_0)
end

function var_0_0._startNewUnlockEpisodeAni(arg_19_0, arg_19_1)
	if arg_19_0._episodeId and arg_19_0._episodeId == arg_19_1 then
		gohelper.setActive(arg_19_0._gounlock, true)
		arg_19_0._animator:Play("unlock", 0, 0)
		AudioEffectMgr.instance:playAudio(AudioEnum.UI.play_ui_activity_hero37_checkpoint_tongguan)
	end
end

function var_0_0._startNewFinishEpisodeAni(arg_20_0, arg_20_1)
	if arg_20_0._episodeId and arg_20_0._episodeId == arg_20_1 then
		gohelper.setActive(arg_20_0._gounlock, true)
		arg_20_0._animator:Play("finish", 0, 0)
		AudioEffectMgr.instance:playAudio(AudioEnum.UI.play_ui_activity_hero37_checkpoint_tongguan)
	end
end

function var_0_0._playChooseEpisode(arg_21_0, arg_21_1)
	local var_21_0 = Activity131Model.instance:getCurEpisodeId()

	if arg_21_0._episodeId == var_21_0 then
		AudioEffectMgr.instance:playAudio(AudioEnum.UI.play_ui_activity_hero37_checkpoint_unlock)

		if arg_21_1 < arg_21_0._episodeId then
			arg_21_0._chessAnimator:Play("close_left", 0, 0)
		else
			arg_21_0._chessAnimator:Play("close_right", 0, 0)
		end
	end
end

function var_0_0._playChessAutoToEpisode(arg_22_0, arg_22_1)
	UIBlockMgr.instance:startBlock("chessPlay")
	...
	if arg_22_0._episodeId == arg_22_1 then
		TaskDispatcher.runDelay(arg_22_0._autoChessStartFinished, arg_22_0, 0.25)
	end
end

function var_0_0._autoChessStartFinished(arg_23_0)
	UIBlockMgr.instance:endBlock("chessPlay")
	gohelper.setActive(arg_23_0._imagechess.gameObject, true)

	if Activity131Model.instance:getCurEpisodeId() > arg_23_0._episodeId then
		arg_23_0._chessAnimator:Play("open_left", 0, 0)
	else
		arg_23_0._chessAnimator:Play("open_right", 0, 0)
	end

	Activity131Model.instance:setCurEpisodeId(arg_23_0._episodeId)
end

function var_0_0.onDestroyView(arg_24_0)
	TaskDispatcher.cancelTask(arg_24_0._chessStarFinished, arg_24_0)
	TaskDispatcher.cancelTask(arg_24_0._startEnterGame, arg_24_0)
	TaskDispatcher.cancelTask(arg_24_0._waitLevelViewCloseFinished, arg_24_0)
	TaskDispatcher.cancelTask(arg_24_0._storyFrontViewShowed, arg_24_0)
	TaskDispatcher.cancelTask(arg_24_0._autoChessStartFinished, arg_24_0)
