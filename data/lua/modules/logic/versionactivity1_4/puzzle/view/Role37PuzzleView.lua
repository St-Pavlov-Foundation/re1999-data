...
function var_0_0._skipToPos(arg_41_0, arg_41_1, arg_41_2)
	local var_41_0
	local var_41_1

	if arg_41_0.isFinal then
		local var_41_2 = arg_41_1 - 9

		if var_41_2 < 0 then
			arg_41_0._scrollAreaList2.horizontalNormalizedPosition = 0

			return
		end

		local var_41_3 = 0.015 + var_41_2 * 0.01971

		if var_41_3 > 1 then
			var_41_3 = 1
		end

		arg_41_0._scrollAreaList2.horizontalNormalizedPosition = var_41_3
	else
		local var_41_4 = arg_41_1 - 6

		if var_41_4 < 0 then
			arg_41_0._scrollAreaList1.horizontalNormalizedPosition = 0

			return
		end

		local var_41_5 = 200 * arg_41_2 + 10 * (arg_41_2 - 1) + 5
		local var_41_6 = (var_41_5 - 1380) / var_41_5 * arg_41_2
		local var_41_7, var_41_8 = math.modf(var_41_6)
		local var_41_9 = 1 / var_41_6 * (var_41_8 + var_41_4)

		if var_41_9 > 1 then
			var_41_9 = 1
		end

		arg_41_0._scrollAreaList1.horizontalNormalizedPosition = var_41_9
	end
end

function var_0_0.onErrorOper(arg_42_0, arg_42_1)
	if Role37PuzzleModel.instance:getErrorCnt() == 1 and arg_42_1 ~= 0 then
		local var_42_0 = VersionActivity1_4Enum.ActivityId.Role37
		local var_42_1 = arg_42_0.puzzleCfg.puzzleId
		local var_42_2 = Activity130Config.instance:getActivity130DecryptCo(var_42_0, var_42_1).errorTip

		Activity130Controller.instance:dispatchEvent(Activity130Event.ShowTipDialog, var_42_2)
	end

	arg_42_0:refreshErrorOper()
end

function var_0_0.refreshErrorOper(arg_43_0)
	local var_43_0 = Role37PuzzleModel.instance:getCurErrorIndex()

	if var_43_0 == 0 then
		var_43_0 = 9999
	end

	for iter_43_0, iter_43_1 in pairs(arg_43_0.answerList) do
		iter_43_1:setError(var_43_0 <= iter_43_0)
	end
end

function var_0_0._playAudio(arg_44_0)
	AudioMgr.instance:trigger(AudioEnum.UI.pause_plotmusic_sound)

	arg_44_0.curKey = 1

	TaskDispatcher.runDelay(arg_44_0._playAudioLoop, arg_44_0, var_0_0.StartDealy)
end

function var_0_0._pauseAudio(arg_45_0)
	TaskDispatcher.cancelTask(arg_45_0._playAudioLoop, arg_45_0)
end

function var_0_0._resumeAudio(arg_46_0)
	for iter_46_0, iter_46_1 in pairs(arg_46_0.operList) do
		if iter_46_0 > arg_46_0.maxKey then
			arg_46_0.maxKey = iter_46_0
		end
	end

	arg_46_0:_playAudioLoop()
	TaskDispatcher.runRepeat(arg_46_0._playAudioLoop, arg_46_0, var_0_0.AudioInterval)
end

function var_0_0._stopAudio(arg_47_0)
	AudioMgr.instance:trigger(AudioEnum.UI.resume_plotmusic_sound)
	TaskDispatcher.cancelTask(arg_47_0._playAudioLoop, arg_47_0)

	arg_47_0.curAudioId = nil
	arg_47_0.curKey = nil
end

function var_0_0._playAudioLoop(arg_48_0)
	if arg_48_0.curKey then
		if arg_48_0.curKey == 1 then
			TaskDispatcher.runRepeat(arg_48_0._playAudioLoop, arg_48_0, var_0_0.AudioInterval)
		end

		if arg_48_0.curKey >= 8 then
			arg_48_0._progressAnim.speed = 0
		end

		arg_48_0:_tweenToScrollPos(arg_48_0.curKey)

		local var_48_0 = arg_48_0.operList[arg_48_0.curKey]

		if var_48_0 then
			arg_48_0.curAudioId = arg_48_0.operGroupCfg[var_48_0].audioId

			AudioMgr.instance:trigger(arg_48_0.curAudioId)
		else
			arg_48_0:_playEmptyAudio()
		end

		arg_48_0.curKey = arg_48_0.curKey + 1

		if arg_48_0.curKey > arg_48_0.maxKey then
			TaskDispatcher.runDelay(arg_48_0._btnStopOnClick, arg_48_0, var_0_0.AudioInterval / 2 - 0.1)
		end
	end
end

function var_0_0._playEmptyAudio(arg_49_0)
	return
end

function var_0_0._resumeProgressAnim(arg_50_0)
	if arg_50_0.curKey > 8 then
		arg_50_0._progressAnim:Play("play", 0, 0.82188)

		arg_50_0._progressAnim.speed = 1
	else
		local var_50_0 = 0.9
		local var_50_1 = 0.867
		local var_50_2 = var_50_0 + (arg_50_0.curKey - 1) * var_50_1

		arg_50_0._progressAnim:CrossFadeInFixedTime("play", 0, 0, var_50_2)

		arg_50_0._progressAnim.speed = 1
	end
end

function var_0_0._resumeScrollPos(arg_51_0)
	if arg_51_0.curKey > 8 then
		local var_51_0 = 0.01971

		arg_51_0._scrollAreaList2.horizontalNormalizedPosition = (arg_51_0.curKey - 8) * var_51_0
	else
		arg_51_0._scrollAreaList2.horizontalNormalizedPosition = 0
	end
end

function var_0_0._tweenToScrollPos(arg_52_0, arg_52_1)
	if arg_52_1 - 8 < 0 then
		return
	end

	local var_52_0 = arg_52_0._scrollAreaList2.horizontalNormalizedPosition
	local var_52_1 = var_52_0 + 0.01971

	if var_52_1 > 1 then
		var_52_1 = 1
	end

	arg_52_0._scrollTweenId = ZProj.TweenHelper.DOTweenFloat(var_52_0, var_52_1, var_0_0.AudioInterval, arg_52_0.setScrollValue, nil, arg_52_0, nil, EaseType.Linear)
end

function var_0_0.setScrollValue(arg_53_0, arg_53_1)
	arg_53_0._scrollAreaList2.horizontalNormalizedPosition = arg_53_1
end

function var_0_0.refreshNum(arg_54_0)
	local var_54_0 = 0

	for iter_54_0 = 1, tabletool.len(arg_54_0.answerList) do
		local var_54_1 = arg_54_0.answerList[iter_54_0 + var_54_0]

		while var_54_1 == nil do
			var_54_0 = var_54_0 + 1
			var_54_1 = arg_54_0.answerList[iter_54_0 + var_54_0]
		end

		var_54_1:setNum(iter_54_0)
	end
end

function var_0_0.setFramePut(arg_55_0, arg_55_1, arg_55_2)
	gohelper.setActive(arg_55_0.frameItemList[arg_55_1].notPutImage, not arg_55_2)
	gohelper.setActive(arg_55_0.frameItemList[arg_55_1].putImage, arg_55_2)
end

function var_0_0._playFinalSound(arg_56_0)
	if arg_56_0.isFinal then
		arg_56_0:_closeFinalSound()

		arg_56_0._finalSoundId = AudioMgr.instance:trigger(AudioEnum.UI.set_activityvolume_on)
	end
end

function var_0_0._closeFinalSound(arg_57_0)
	if arg_57_0._finalSoundId then
		AudioMgr.instance:trigger(AudioEnum.UI.set_activityvolume_off)

		arg_57_0._finalSoundId = nil
	end
end

function var_0_0._playDragEndAudio(arg_58_0, arg_58_1)
	if Activity130Model.instance:getCurEpisodeId() == 7 then
		local var_58_0 = Role37PuzzleModel.instance:getOperAudioId(arg_58_1)

		AudioMgr.instance:trigger(var_58_0)
	else
