...
function var_0_0._storyFrontViewShowed(arg_12_0)
	...
	local var_12_0 = ViewMgr.instance:getContainer(ViewName.Activity130LevelView).viewGO
...
function var_0_0._onStoryFinished(arg_13_0)
	...
	if not arg_13_0._config then
		return
	end

	if not Activity130Model.instance:isEpisodeFinished(arg_13_0._config.episodeId) then
		Activity130Rpc.instance:sendAct130StoryRequest(arg_13_0._config.activityId, arg_13_0._config.episodeId)
	end
end

function var_0_0._onStoryFinishAndEnterGameView(arg_14_0)
	Activity130Rpc.instance:sendAct130StoryRequest(arg_14_0._config.activityId, arg_14_0._config.episodeId, arg_14_0._enterActivity130GameView, arg_14_0)
end

function var_0_0._enterActivity130GameView(arg_15_0)
	Activity130Controller.instance:dispatchEvent(Activity130Event.StartEnterGameView, arg_15_0._episodeId)
end

function var_0_0._btnReviewOnClick(arg_16_0)
	local var_16_0 = {}

	if arg_16_0._index == 1 then
		local var_16_1 = ActivityConfig.instance:getActivityCo(VersionActivity1_4Enum.ActivityId.Role37).storyId

		table.insert(var_16_0, var_16_1)
	else
		if Activity130Model.instance:getEpisodeState(arg_16_0._config.episodeId) ~= Activity130Enum.EpisodeState.Finished then
...
function var_0_0.onUpdateMO(arg_17_0, arg_17_1)
	return
end

function var_0_0._addEvents(arg_18_0)
	Activity130Controller.instance:registerCallback(Activity130Event.playNewUnlockEpisode, arg_18_0._startNewUnlockEpisodeAni, arg_18_0)
	Activity130Controller.instance:registerCallback(Activity130Event.playNewFinishEpisode, arg_18_0._startNewFinishEpisodeAni, arg_18_0)
	Activity130Controller.instance:registerCallback(Activity130Event.EpisodeClick, arg_18_0._playChooseEpisode, arg_18_0)
	Activity130Controller.instance:registerCallback(Activity130Event.EnterEpisode, arg_18_0._onJumpToEpisode, arg_18_0)
	Activity130Controller.instance:registerCallback(Activity130Event.PlayChessAutoToNewEpisode, arg_18_0._playChessAutoToEpisode, arg_18_0)
end

function var_0_0._removeEvents(arg_19_0)
	Activity130Controller.instance:unregisterCallback(Activity130Event.playNewUnlockEpisode, arg_19_0._startNewUnlockEpisodeAni, arg_19_0)
	Activity130Controller.instance:unregisterCallback(Activity130Event.playNewFinishEpisode, arg_19_0._startNewFinishEpisodeAni, arg_19_0)
	Activity130Controller.instance:unregisterCallback(Activity130Event.EpisodeClick, arg_19_0._playChooseEpisode, arg_19_0)
	Activity130Controller.instance:unregisterCallback(Activity130Event.EnterEpisode, arg_19_0._onJumpToEpisode, arg_19_0)
	Activity130Controller.instance:unregisterCallback(Activity130Event.PlayChessAutoToNewEpisode, arg_19_0._playChessAutoToEpisode, arg_19_0)
end
...
function var_0_0._autoChessStartFinished(arg_24_0)
	...
	if Activity130Model.instance:getCurEpisodeId() > arg_24_0._episodeId then
		arg_24_0._chessAnimator:Play("open_left", 0, 0)
	else
		arg_24_0._chessAnimator:Play("open_right", 0, 0)
	end

	Activity130Model.instance:setCurEpisodeId(arg_24_0._episodeId)
end
