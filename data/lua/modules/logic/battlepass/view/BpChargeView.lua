...
function slot0.onInitView(slot0)
	...
	slot0._txtPayStatus2 = gohelper.findChildText(slot0.viewGO, "Root/right/#btnBuy/txt")
	slot0._txtPayStatus3 = gohelper.findChildText(slot0.viewGO, "Root/right/#btnBuy/txt_discount")
...
function slot0._onUpdatePayStatus(slot0)
	if BpModel.instance.payStatus == BpEnum.PayStatus.NotPay then
		...
		slot0._txtPayStatus.text = string.format("%s%s", StoreModel.instance:getCostStr(StoreConfig.instance:getChargeGoodsConfig(lua_bp.configDict[BpModel.instance.id].chargeId1).price))
		slot0._txtPayStatus2.text = string.format("%s%s", StoreModel.instance:getCostStr(slot2.price))
		slot0._txtPayStatus3.text = string.format("<s>%s%s</s>", StoreModel.instance:getCostStr(slot2.originalCost))
	...
	elseif BpModel.instance.payStatus == BpEnum.PayStatus.Pay1 then
		...
		slot0._txtPayStatus2.text = string.format("%s%s", StoreModel.instance:getCostStr(StoreConfig.instance:getChargeGoodsConfig(lua_bp.configDict[BpModel.instance.id].chargeId1to2).price))
