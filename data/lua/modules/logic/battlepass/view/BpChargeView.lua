...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtPayStatus2 = gohelper.findChildText(arg_1_0.viewGO, "Root/right/#btnBuy/txt")
	arg_1_0._txtPayStatus3 = gohelper.findChildText(arg_1_0.viewGO, "Root/right/#btnBuy/txt_discount")
...
function var_0_0._onUpdatePayStatus(arg_11_0)
	if BpModel.instance.payStatus == BpEnum.PayStatus.NotPay then
		...
		arg_11_0._txtPayStatus.text = string.format("%s%s", StoreModel.instance:getCostStr(var_11_0.price))
		arg_11_0._txtPayStatus2.text = string.format("%s%s", StoreModel.instance:getCostStr(var_11_1.price))
		arg_11_0._txtPayStatus3.text = string.format("<s>%s%s</s>", StoreModel.instance:getCostStr(var_11_1.originalCost))
	...
	elseif BpModel.instance.payStatus == BpEnum.PayStatus.Pay1 then
		local var_11_2 = StoreConfig.instance:getChargeGoodsConfig(lua_bp.configDict[BpModel.instance.id].chargeId1to2)
		...
		arg_11_0._txtPayStatus2.text = string.format("%s%s", StoreModel.instance:getCostStr(var_11_2.price))
