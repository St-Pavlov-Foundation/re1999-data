...
local var_0_0 = class("V1a7_DungeonEnterView", BaseView)
...
function var_0_0._editableInitView(arg_7_0)
	arg_7_0._simagebg:LoadImage("singlebg/v1a7_mainactivity_singlebg/v1a7_enterview_fullbg.png")
	arg_7_0._simagetitle:LoadImage("singlebg_lang/txt_v1a7_mainactivity_singlebg/v1a7_enterview_title.png")

	arg_7_0.goEnter = arg_7_0._btnEnter.gameObject
	arg_7_0.goFinish = arg_7_0._btnFinish.gameObject
	arg_7_0.actId = VersionActivity1_7Enum.ActivityId.Dungeon
	...
	RedDotController.instance:addRedDot(arg_7_0._goTaskRedDot, RedDotEnum.DotNode.V1a7DungeonTask)
...
function var_0_0.refreshStoreCurrency(arg_14_0)
	local var_14_0 = CurrencyModel.instance:getCurrency(CurrencyEnum.CurrencyType.V1a7Dungeon)
...
function var_0_0.refreshRemainTime(arg_15_0)
	...
	local var_15_1 = ActivityModel.instance:getActivityInfo()[VersionActivity1_7Enum.ActivityId.DungeonStore]
