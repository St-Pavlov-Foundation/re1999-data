...
slot0 = class("V1a7_DungeonEnterView", BaseView)
...
function slot0._editableInitView(slot0)
	slot0._simagebg:LoadImage("singlebg/v1a7_mainactivity_singlebg/v1a7_enterview_fullbg.png")
	slot0._simagetitle:LoadImage("singlebg_lang/txt_v1a7_mainactivity_singlebg/v1a7_enterview_title.png")

	slot0.goEnter = slot0._btnEnter.gameObject
	slot0.goFinish = slot0._btnFinish.gameObject
	slot0.actId = VersionActivity1_7Enum.ActivityId.Dungeon
	...
	RedDotController.instance:addRedDot(slot0._goTaskRedDot, RedDotEnum.DotNode.V1a7DungeonTask)
...
function slot0.refreshStoreCurrency(slot0)
	slot0._txtStoreNum.text = GameUtil.numberDisplay(CurrencyModel.instance:getCurrency(CurrencyEnum.CurrencyType.V1a7Dungeon) and slot1.quantity or 0)
end
...
function slot0.refreshRemainTime(slot0)
	...
	slot0._txtStoreTime.text = ActivityModel.instance:getActivityInfo()[VersionActivity1_7Enum.ActivityId.DungeonStore]:getRemainTimeStr2ByEndTime(true)
end
