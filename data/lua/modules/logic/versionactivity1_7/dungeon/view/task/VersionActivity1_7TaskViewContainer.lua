...
local var_0_0 = class("VersionActivity1_7TaskViewContainer", BaseViewContainer)
...
function var_0_0.buildViews(arg_1_0)
	...
	var_1_0.cellClass = VersionActivity1_7TaskItem
	...
	arg_1_0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivity1_7TaskListModel.instance, var_1_0, var_1_1)
