...
function var_0_0.getRemainTimeStr3(arg_17_0, arg_17_1, arg_17_2)
	local var_17_0 = arg_17_1 and TimeUtil.DateEnFormat.Day or luaLang("time_day")
	local var_17_1 = arg_17_1 and TimeUtil.DateEnFormat.Hour or luaLang("time_hour2")
	local var_17_2 = arg_17_1 and TimeUtil.DateEnFormat.Minute or luaLang("time_minute2")
	local var_17_3 = arg_17_0:getRealEndTimeStamp() - ServerTime.now()

	if not var_17_3 or var_17_3 <= 0 then
		return arg_17_2 and string.format("%s%s%s%s", 0, var_17_1, 0, var_17_2) or string.format("%s%s", 0, var_17_2), true
	end

	local var_17_4 = ""
	local var_17_5 = Mathf.Floor(var_17_3 / TimeUtil.OneDaySecond)
	local var_17_6 = var_17_3 % TimeUtil.OneDaySecond
	local var_17_7 = Mathf.Floor(var_17_6 / TimeUtil.OneHourSecond)
	local var_17_8 = var_17_6 % TimeUtil.OneHourSecond
	local var_17_9 = Mathf.Floor(var_17_8 / TimeUtil.OneMinuteSecond)

	if var_17_5 > 0 then
		var_17_4 = string.format("%s%s%s%s", var_17_5, var_17_0, var_17_7, var_17_1)
	elseif arg_17_2 then
		var_17_4 = string.format("%s%s%s%s", var_17_7, var_17_1, var_17_9, var_17_2)
	elseif var_17_7 > 0 then
		var_17_4 = string.format("%s%s", var_17_7, var_17_1)
	else
		if var_17_9 <= 0 then
			var_17_9 = "<1"
		end

		var_17_4 = string.format("%s%s", var_17_9, var_17_2)
	end

	return var_17_4, false
end
