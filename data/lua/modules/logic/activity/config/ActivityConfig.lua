...
function var_0_0.getConstAsNum(arg_35_0, arg_35_1, arg_35_2)
	local var_35_0 = var_0_1(arg_35_1).strValue

	return tonumber(var_35_0) or arg_35_2
end

function var_0_0.getConstAsNumList(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	arg_36_2 = arg_36_2 or "#"

	local var_36_0 = var_0_1(arg_36_1).strValue

	if string.nilorempty(var_36_0) then
		return arg_36_3
	end

	return string.splitToNumber(var_36_0, arg_36_2) or arg_36_3
end
