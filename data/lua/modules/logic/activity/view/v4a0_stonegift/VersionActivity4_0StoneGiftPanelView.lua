-- chunkname: @modules/logic/activity/view/v4a0_stonegift/VersionActivity4_0StoneGiftPanelView.lua

module("modules.logic.activity.view.v4a0_stonegift.VersionActivity4_0StoneGiftPanelView", package.seeall)

local VersionActivity4_0StoneGiftPanelView = class("VersionActivity4_0StoneGiftPanelView", BaseView)

function VersionActivity4_0StoneGiftPanelView:onInitView()
...
function VersionActivity4_0StoneGiftPanelView:addEvents()
...
function VersionActivity4_0StoneGiftPanelView:removeEvents()
...
function VersionActivity4_0StoneGiftPanelView:_btnuseOnClick()
...
function VersionActivity4_0StoneGiftPanelView:_btncloseOnClick()
	self:closeThis()
end

function VersionActivity4_0StoneGiftPanelView:_btnclickOnClick()
...
function VersionActivity4_0StoneGiftPanelView:_btncliamOnClick()
...
function VersionActivity4_0StoneGiftPanelView:_addSelfEvents()
...
function VersionActivity4_0StoneGiftPanelView:_removeSelfEvents()
...
function VersionActivity4_0StoneGiftPanelView:_onCloseView(viewName)
...
function VersionActivity4_0StoneGiftPanelView:_editableInitView()
	self._itemId = DestinyStoneGiftPickChoiceEnum.V4a0ItemId

	self:_addSelfEvents()
end

function VersionActivity4_0StoneGiftPanelView:onOpen()
...
function VersionActivity4_0StoneGiftPanelView:_refreshTime()
	self._txtremainTime.text = ActivityModel.getRemainTimeStr(self._actId)
end

function VersionActivity4_0StoneGiftPanelView:_initRewards()
	self._rewardItems = {}
...
function VersionActivity4_0StoneGiftPanelView:_btncheckOnClick(index)
...
function VersionActivity4_0StoneGiftPanelView:_refresh()
	local hasGet = ActivityType101Model.instance:isType101RewardGet(self._actId, 1)
	local itemcount = ItemModel.instance:getItemCount(self._itemId)
...
function VersionActivity4_0StoneGiftPanelView:onClose()
	return
end

function VersionActivity4_0StoneGiftPanelView:onDestroyView()
...
return VersionActivity4_0StoneGiftPanelView
