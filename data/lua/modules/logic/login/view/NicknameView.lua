...
function var_0_0.onOpen(arg_18_0)
	...
	arg_18_0._inputname:AddOnValueChanged(arg_18_0._inputValueChanged, arg_18_0)
...
function var_0_0._inputValueChanged(arg_21_0)
	...
	gohelper.setActive(arg_21_0._gonormal, not string.nilorempty(var_21_0))
end
...
function var_0_0._playStory(arg_23_0)
	...
	SDKMgr.instance:createRole(var_23_3)
