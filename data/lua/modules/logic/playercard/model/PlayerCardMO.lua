...
function var_0_0.getBaseInfoByIndex(arg_29_0, arg_29_1, arg_29_2)
	...
	elseif arg_29_1 == PlayerCardEnum.RightContent.TotalCostPower then
		...
		if arg_29_2 then
			return var_29_2, luaLang("p_mainview_power")
		else
			local var_29_3 = luaLang("p_mainview_power")

			return var_29_2 .. var_29_3
		end
	elseif arg_29_1 == PlayerCardEnum.RightContent.HeroCoverTimes then
		local var_29_4 = arg_29_0.heroCoverTimes or 0

		if arg_29_2 then
			return var_29_4, luaLang("p_newwelfarepanelview_txt1_Title")
		else
			local var_29_5 = luaLang("p_newwelfarepanelview_txt1_Title")
