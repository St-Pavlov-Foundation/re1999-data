...
function var_0_0.getBaseInfoByIndex(arg_28_0, arg_28_1, arg_28_2)
	...
	elseif arg_28_1 == PlayerCardEnum.RightContent.TotalCostPower then
		...
		if arg_28_2 then
			return var_28_2, luaLang("p_mainview_power")
		else
			local var_28_3 = luaLang("p_mainview_power")

			return var_28_2 .. var_28_3
		end
	elseif arg_28_1 == PlayerCardEnum.RightContent.HeroCoverTimes then
		local var_28_4 = arg_28_0.heroCoverTimes or 0

		if arg_28_2 then
			return var_28_4, luaLang("p_newwelfarepanelview_txt1_Title")
		else
			local var_28_5 = luaLang("p_newwelfarepanelview_txt1_Title")

			return var_28_4 .. var_28_5
		end
	end
end
