...
function slot0.getBaseInfoByIndex(slot0, slot1, slot2)
	...
	elseif slot1 == PlayerCardEnum.RightContent.TotalCostPower then
		if slot2 then
			return slot0.totalCostPower or 0, luaLang("p_mainview_power")
		else
			return slot4 .. luaLang("p_mainview_power")
		end
	elseif slot1 == PlayerCardEnum.RightContent.HeroCoverTimes then
		if slot2 then
			return slot0.heroCoverTimes or 0, luaLang("p_newwelfarepanelview_txt1_Title")
		else
			return slot4 .. luaLang("p_newwelfarepanelview_txt1_Title")
		end
	end
end
