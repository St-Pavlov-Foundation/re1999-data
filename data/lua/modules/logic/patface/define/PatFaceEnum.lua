...
var_0_0.CustomCheckCanPatFun = {
	...
	[var_0_0.patFace.V2a9_FreeMonthCard_PanelView] = PatFaceCustomHandler.freeMonthCardCanPat,
	...
	[var_0_0.patFace.PowerMakerPatFaceView] = PatFaceCustomHandler.PowerMakerPatFaceViewCanPat
}
var_0_0.CustomPatFun = {
	...
	[var_0_0.patFace.PowerMakerPatFaceView] = PatFaceCustomHandler.PowerMakerPatFaceViewPat
}
var_0_0.patFaceCustomWork = {
	...
	[var_0_0.patFace.V3a1_NewCultivationDestiny] = NewCultivationGiftPatFaceWork
}
