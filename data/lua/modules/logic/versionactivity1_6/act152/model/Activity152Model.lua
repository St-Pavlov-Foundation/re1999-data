...
function var_0_0.getAllUnlockPresents(arg_8_0)
	...
	for iter_8_0, iter_8_1 in pairs(var_8_0) do
		if TimeUtil.stringToTimestamp(iter_8_1.acceptDate) + ServerTime.clientToServerOffset() <= ServerTime.now() then
...
function var_0_0.getNextUnlockLimitTime(arg_10_0)
	...
	for iter_10_0, iter_10_1 in pairs(var_10_0) do
		local var_10_2 = TimeUtil.stringToTimestamp(iter_10_1.acceptDate) + ServerTime.clientToServerOffset()
