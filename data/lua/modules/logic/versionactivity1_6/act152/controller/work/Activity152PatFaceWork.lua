...
function var_0_0.onStart(arg_1_0, arg_1_1)
	if arg_1_0:_needWaitShow() then
		arg_1_0:_startCheckShow()
...
function var_0_0._enterNext(arg_6_0, arg_6_1, arg_6_2, arg_6_3)
	...
	ViewMgr.instance:registerCallback(ViewEvent.OnOpenViewFinish, arg_6_0._checkRewardGet, arg_6_0)
end
