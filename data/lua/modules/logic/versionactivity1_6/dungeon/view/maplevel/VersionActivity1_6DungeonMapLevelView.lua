-- chunkname: @modules/logic/versionactivity1_6/dungeon/view/maplevel/VersionActivity1_6DungeonMapLevelView.lua

module("modules.logic.versionactivity1_6.dungeon.view.maplevel.VersionActivity1_6DungeonMapLevelView", package.seeall)

local VersionActivity1_6DungeonMapLevelView = class("VersionActivity1_6DungeonMapLevelView", BaseView)

function VersionActivity1_6DungeonMapLevelView:onInitView()
...
function VersionActivity1_6DungeonMapLevelView:addEvents()
...
function VersionActivity1_6DungeonMapLevelView:removeEvents()
...
function VersionActivity1_6DungeonMapLevelView:_btnreplayStoryOnClick()
...
function VersionActivity1_6DungeonMapLevelView:refreshStoryIdList()
...
function VersionActivity1_6DungeonMapLevelView:_btncloseviewOnClick()
	self:startCloseTaskNextFrame()
end

function VersionActivity1_6DungeonMapLevelView:startCloseTaskNextFrame()
	TaskDispatcher.runDelay(self.reallyClose, self, 0.01)
end

function VersionActivity1_6DungeonMapLevelView:cancelStartCloseTask()
	TaskDispatcher.cancelTask(self.reallyClose, self)
end

function VersionActivity1_6DungeonMapLevelView:reallyClose()
	self:closeThis()
end

function VersionActivity1_6DungeonMapLevelView:_btnleftarrowOnClick()
	if self.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard then
		return
	end
...
function VersionActivity1_6DungeonMapLevelView:_btnrightarrowOnClick()
	if self.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard then
		return
	end
...
function VersionActivity1_6DungeonMapLevelView:refreshUIByMode(mode)
...
function VersionActivity1_6DungeonMapLevelView:startRefreshUI()
	self:refreshUI()
end

function VersionActivity1_6DungeonMapLevelView:_btnactivityrewardOnClick()
	DungeonController.instance:openDungeonRewardView(self.showEpisodeCo)
end

function VersionActivity1_6DungeonMapLevelView:_btnnormalStartOnClick()
...
function VersionActivity1_6DungeonMapLevelView:_btnhardStartOnClick()
	self:startBattle()
end

function VersionActivity1_6DungeonMapLevelView:_btnLockStartOnClick()
	GameFacade.showToast(ToastEnum.VersionActivityCanFight, self:getPreModeName())
end

function VersionActivity1_6DungeonMapLevelView:_btncloseruleOnClick()
	return
end

function VersionActivity1_6DungeonMapLevelView:startBattle()
...
function VersionActivity1_6DungeonMapLevelView:_playMainStory()
...
function VersionActivity1_6DungeonMapLevelView:_playSkipMainStory()
	DungeonRpc.instance:sendStartDungeonRequest(self.showEpisodeCo.chapterId, self.showEpisodeCo.id)
	self:onStoryFinished()
end

function VersionActivity1_6DungeonMapLevelView:playAfterStory(storyId)
	local param = {}
...
function VersionActivity1_6DungeonMapLevelView:_playStoryAndEnterFight(storyId)
...
function VersionActivity1_6DungeonMapLevelView:_enterFight()
	DungeonFightController.instance:enterFight(self.showEpisodeCo.chapterId, self.showEpisodeCo.id, 1)
end

function VersionActivity1_6DungeonMapLevelView:onStoryFinished()
...
function VersionActivity1_6DungeonMapLevelView:initLocalEpisodeMode()
	self.unlockedEpisodeModeDict = self:loadDict(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode))
	self.lastEpisodeSelectModeDict = self:loadDict(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode))
end

function VersionActivity1_6DungeonMapLevelView:_onCurrencyChange(changeIds)
...
function VersionActivity1_6DungeonMapLevelView:refreshEye()
	...
	local isHard = self.originEpisodeConfig.chapterId == VersionActivity1_6DungeonEnum.DungeonChapterId.LeiMiTeBeiHard

	gohelper.setActive(self._gonormaleye, not isHard)
	gohelper.setActive(self._gohardeye, isHard)
end

function VersionActivity1_6DungeonMapLevelView:_editableInitView()
	...
	self._simageactivitynormalbg:LoadImage(ResUrl.getV1a6DungeonSingleBg("v1a6_dungeon_bg_storypanel"))
	self._simageactivityhardbg:LoadImage(ResUrl.getV1a6DungeonSingleBg("v1a6_dungeon_bg_hardpanel"))
...
function VersionActivity1_6DungeonMapLevelView:initViewParam()
...
function VersionActivity1_6DungeonMapLevelView:getEpisodeIndex()
	return VersionActivity1_6DungeonController.instance:getEpisodeIndex(self.originEpisodeId)
end

function VersionActivity1_6DungeonMapLevelView:markSelectEpisode()
	if self.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_6Dungeon or self.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_6DungeonBoss then
...
function VersionActivity1_6DungeonMapLevelView:onUpdateParam()
	self:onOpen()
	self.animator:Play(UIAnimationName.Open, 0, 0)
end

function VersionActivity1_6DungeonMapLevelView:onOpen()
...
function VersionActivity1_6DungeonMapLevelView:initMode()
...
function VersionActivity1_6DungeonMapLevelView:refreshBg()
...
function VersionActivity1_6DungeonMapLevelView:refreshUI()
...
function VersionActivity1_6DungeonMapLevelView:refreshModeCanFight()
...
function VersionActivity1_6DungeonMapLevelView:refreshEpisodeTextInfo()
	local chapterCo = DungeonConfig.instance:getChapterCO(self.showEpisodeCo.chapterId)
	local targetConfig

	if chapterCo.id == VersionActivity1_6DungeonEnum.DungeonChapterId.Story then
		targetConfig = self.showEpisodeCo
	else
		targetConfig = VersionActivity1_6DungeonController.instance:getStoryEpisodeCo(self.showEpisodeCo.id)
	end
...
function VersionActivity1_6DungeonMapLevelView:refreshStar()
...
function VersionActivity1_6DungeonMapLevelView:refreshMode()
...
function VersionActivity1_6DungeonMapLevelView:refreshArrow()
...
function VersionActivity1_6DungeonMapLevelView:refreshReward()
	local rewardList = {}
...
function VersionActivity1_6DungeonMapLevelView:refreshStartBtn()
	self:refreshCostPower()
...
function VersionActivity1_6DungeonMapLevelView:refreshCostPower()
	local cost = 0
...
function VersionActivity1_6DungeonMapLevelView:checkNeedPlayModeUnLockAnimation()
...
function VersionActivity1_6DungeonMapLevelView:_playModeUnLockAnimation(animationName)
	local animator = self.lockGoType:GetComponent(typeof(UnityEngine.Animator))
...
function VersionActivity1_6DungeonMapLevelView:playModeUnlockAnimation()
	if self.needPlayUnlockModeAnimation then
...
function VersionActivity1_6DungeonMapLevelView:onModeUnlockAnimationPlayDone()
...
function VersionActivity1_6DungeonMapLevelView:setImage(image, light, episodeId)
	if light then
...
function VersionActivity1_6DungeonMapLevelView:buildEpisodeName(episodeCo)
...
function VersionActivity1_6DungeonMapLevelView:buildColorText(text, color)
	return string.format("<color=%s>%s</color>", color, text)
end

function VersionActivity1_6DungeonMapLevelView:getPreModeName()
...
function VersionActivity1_6DungeonMapLevelView:getKey(key)
	return key .. self.userId
end

function VersionActivity1_6DungeonMapLevelView:loadDict(key)
	key = self:getKey(key)
...
function VersionActivity1_6DungeonMapLevelView:saveEpisodeUnlockMode()
	PlayerPrefsHelper.setString(self:getKey(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode)), cjson.encode(self.unlockedEpisodeModeDict))
end

function VersionActivity1_6DungeonMapLevelView:saveEpisodeLastSelectMode()
	PlayerPrefsHelper.setString(self:getKey(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode)), cjson.encode(self.lastEpisodeSelectModeDict))
end

function VersionActivity1_6DungeonMapLevelView:onClose()
...
function VersionActivity1_6DungeonMapLevelView:onDestroyView()
...
return VersionActivity1_6DungeonMapLevelView
