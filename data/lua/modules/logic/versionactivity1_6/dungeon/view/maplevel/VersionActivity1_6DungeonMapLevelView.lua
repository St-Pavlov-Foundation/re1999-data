...
local var_0_0 = class("VersionActivity1_6DungeonMapLevelView", BaseView)
...
function var_0_0.refreshStoryIdList(arg_5_0)
	...
	if arg_5_0.originEpisodeConfig.beforeStory > 0 and StoryModel.instance:isStoryHasPlayed(arg_5_0.originEpisodeConfig.beforeStory) then
		table.insert(arg_5_0.storyIdList, arg_5_0.originEpisodeConfig.beforeStory)
	end

	if arg_5_0.originEpisodeConfig.afterStory > 0 and StoryModel.instance:isStoryHasPlayed(arg_5_0.originEpisodeConfig.afterStory) then
		table.insert(arg_5_0.storyIdList, arg_5_0.originEpisodeConfig.afterStory)
	end
end
...
function var_0_0.initLocalEpisodeMode(arg_27_0)
	arg_27_0.unlockedEpisodeModeDict = arg_27_0:loadDict(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode))
	arg_27_0.lastEpisodeSelectModeDict = arg_27_0:loadDict(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode))
end
...
function var_0_0.refreshEye(arg_29_0)
	...
	local var_29_0 = arg_29_0.originEpisodeConfig.chapterId == VersionActivity1_6DungeonEnum.DungeonChapterId.LeiMiTeBeiHard
...
function var_0_0._editableInitView(arg_30_0)
	...
	arg_30_0._simageactivitynormalbg:LoadImage(ResUrl.getV1a6DungeonSingleBg("v1a6_dungeon_bg_storypanel"))
	arg_30_0._simageactivityhardbg:LoadImage(ResUrl.getV1a6DungeonSingleBg("v1a6_dungeon_bg_hardpanel"))
...
function var_0_0.getEpisodeIndex(arg_32_0)
	return VersionActivity1_6DungeonController.instance:getEpisodeIndex(arg_32_0.originEpisodeId)
end

function var_0_0.markSelectEpisode(arg_33_0)
	if arg_33_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_6Dungeon or arg_33_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_6DungeonBoss then
...
function var_0_0.refreshEpisodeTextInfo(arg_40_0)
	...
	if var_40_0.id == VersionActivity1_6DungeonEnum.DungeonChapterId.Story then
		var_40_1 = arg_40_0.showEpisodeCo
	else
		var_40_1 = VersionActivity1_6DungeonController.instance:getStoryEpisodeCo(arg_40_0.showEpisodeCo.id)
	end
	...
	local var_40_3 = FightHelper.getEpisodeRecommendLevel(arg_40_0.showEpisodeCo.id)

	gohelper.setActive(arg_40_0._gorecommond, var_40_3 > 0)

	if var_40_3 > 0 then
		arg_40_0._txtrecommondlv.text = HeroConfig.instance:getCommonLevelDisplay(var_40_3)
	end
end
...
function var_0_0.refreshMode(arg_42_0)
	...
	if var_42_0 then
		arg_42_0.lockGoType:GetComponent(typeof(UnityEngine.Animator)).enabled = true
...
function var_0_0.refreshReward(arg_44_0)
	...
	tabletool.addValues(var_44_0, DungeonModel.instance:getEpisodeReward(arg_44_0.showEpisodeCo.id))
	...
	for iter_44_0 = 1, var_44_4 do
		...
		elseif iter_44_0 <= var_44_1 then
			...
			local var_44_13 = var_44_8[3]

			var_44_12 = true

			if var_44_8.tagType then
				var_44_13 = var_44_8.tagType
				var_44_12 = var_44_11 ~= 0
			elseif #var_44_8 >= 4 then
				var_44_11 = var_44_8[4]
			else
				var_44_12 = false
			end

			var_44_7.txtnormal.text = luaLang("dungeon_prob_flag" .. var_44_13)
		end
...
function var_0_0.refreshStartBtn(arg_45_0)
	...
	gohelper.setActive(arg_45_0._btnreplayStory.gameObject, DungeonModel.instance:hasPassLevelAndStory(arg_45_0.originEpisodeConfig.id) and arg_45_0.storyIdList and #arg_45_0.storyIdList > 0)
...
function var_0_0._playModeUnLockAnimation(arg_48_0, arg_48_1)
	local var_48_0 = arg_48_0.lockGoType:GetComponent(typeof(UnityEngine.Animator))

	var_48_0.enabled = true

	var_48_0:Play(arg_48_1)
...
function var_0_0.setImage(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
	if arg_51_2 then
		...
		local var_51_1 = VersionActivity1_6DungeonEnum.EpisodeStarType[var_51_0.chapterId]

		UISpriteSetMgr.instance:setV1a6DungeonSprite(arg_51_1, var_51_1)
	else
		local var_51_2 = DungeonConfig.instance:getEpisodeCO(arg_51_3)
		local var_51_3 = VersionActivity1_6DungeonEnum.EpisodeStarEmptyType[var_51_2.chapterId]

		UISpriteSetMgr.instance:setV1a6DungeonSprite(arg_51_1, var_51_3)
	end
end

function var_0_0.buildEpisodeName(arg_52_0, arg_52_1)
	local var_52_0 = arg_52_1.name
...
function var_0_0.saveEpisodeUnlockMode(arg_57_0)
	PlayerPrefsHelper.setString(arg_57_0:getKey(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode)), cjson.encode(arg_57_0.unlockedEpisodeModeDict))
end

function var_0_0.saveEpisodeLastSelectMode(arg_58_0)
	PlayerPrefsHelper.setString(arg_58_0:getKey(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode)), cjson.encode(arg_58_0.lastEpisodeSelectModeDict))
end
