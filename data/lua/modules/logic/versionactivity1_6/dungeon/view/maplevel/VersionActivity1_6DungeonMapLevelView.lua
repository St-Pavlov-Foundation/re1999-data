...
slot0 = class("VersionActivity1_6DungeonMapLevelView", BaseView)
...
function slot0.initLocalEpisodeMode(slot0)
	slot0.unlockedEpisodeModeDict = slot0:loadDict(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode))
	slot0.lastEpisodeSelectModeDict = slot0:loadDict(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode))
end
...
function slot0.refreshEye(slot0)
	...
	slot2 = slot0.originEpisodeConfig.chapterId == VersionActivity1_6DungeonEnum.DungeonChapterId.LeiMiTeBeiHard
...
function slot0._editableInitView(slot0)
	...
	slot0._simageactivitynormalbg:LoadImage(ResUrl.getV1a6DungeonSingleBg("v1a6_dungeon_bg_storypanel"))
	slot0._simageactivityhardbg:LoadImage(ResUrl.getV1a6DungeonSingleBg("v1a6_dungeon_bg_hardpanel"))
...
function slot0.getEpisodeIndex(slot0)
	return VersionActivity1_6DungeonController.instance:getEpisodeIndex(slot0.originEpisodeId)
end

function slot0.markSelectEpisode(slot0)
	if slot0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_6Dungeon or slot0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_6DungeonBoss then
...
function slot0.refreshEpisodeTextInfo(slot0)
	slot2 = nil
	slot2 = (DungeonConfig.instance:getChapterCO(slot0.showEpisodeCo.chapterId).id ~= VersionActivity1_6DungeonEnum.DungeonChapterId.Story or slot0.showEpisodeCo) and VersionActivity1_6DungeonController.instance:getStoryEpisodeCo(slot0.showEpisodeCo.id)
...
function slot0.refreshMode(slot0)
	...
	if slot1 then
		slot0.lockGoType:GetComponent(typeof(UnityEngine.Animator)).enabled = true
...
function slot0.saveEpisodeUnlockMode(slot0)
	PlayerPrefsHelper.setString(slot0:getKey(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode)), cjson.encode(slot0.unlockedEpisodeModeDict))
end

function slot0.saveEpisodeLastSelectMode(slot0)
	PlayerPrefsHelper.setString(slot0:getKey(VersionActivity1_6EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode)), cjson.encode(slot0.lastEpisodeSelectModeDict))
end
