...
function slot1._refreshSkillEffects(slot0)
	...
	for slot5 = 1, #slot1 do
		...
		slot8:GetComponent(gohelper.Type_TextMesh).text = gohelper.getRichColorText(Activity148Config.instance:getAct148SkillTypeCfg(slot6.type).skillName .. " Lv." .. slot6.level .. "：", "#E99B56") .. (FightConfig.instance:getSkillEffectCO(slot6.skillId) and FightConfig.instance:getSkillEffectDesc(nil, slot10))
	end
