...
function slot0._refreshSkillPointNum(slot0)
	...
	slot0._txtSkillPointNum.text = string.format("<color=#EB5F34>%s</color>/%s", VersionActivity1_6DungeonSkillModel.instance:getTotalGotSkillPointNum() or 0, Activity148Config.instance:getAct148ConstValue(VersionActivity1_6Enum.ActivityId.DungeonSkillTree, VersionActivity1_6DungeonEnum.DungeonConstId.MaxSkillPointNum))
end
