...
local var_0_0 = class("VersionActivity1_6NormalStoreGoodsView", BaseView)
...
function var_0_0.onOpen(arg_14_0)
	...
	local var_14_0 = GameUtil.splitString2(arg_14_0.storeGoodsCo.product, true)[1]
...
function var_0_0.refreshRemain(arg_17_0)
	if arg_17_0.storeGoodsCo.maxBuyCount == 0 then
		...
		arg_17_0._txtremain.text = GameUtil.getSubPlaceholderLuaLang(luaLang("store_buylimit_count"), {
			arg_17_0.remainBuyCount
		})
	end
end
