...
function var_0_0.calculatePosInContent(arg_34_0)
	...
	local var_34_3 = var_34_1 + arg_34_0._txtsectionname.preferredWidth
	local var_34_4 = math.max(var_34_2, var_34_3)

	arg_34_0._maxWidth = math.max(var_34_4 * 2, VersionActivity1_3DungeonEnum.EpisodeItemMinWidth) + 30
