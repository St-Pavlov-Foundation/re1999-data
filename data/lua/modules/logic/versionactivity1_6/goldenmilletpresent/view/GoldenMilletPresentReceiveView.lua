...
function var_0_0.refreshRemainTime(arg_8_0)
	...
	local var_8_1 = ActivityModel.instance:getActMO(var_8_0):getRemainTimeStr3(false, true)

	arg_8_0._txtReceiveRemainTime.text = string.format(luaLang("remain"), var_8_1)
end
