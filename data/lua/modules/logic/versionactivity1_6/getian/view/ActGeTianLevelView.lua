...
slot0 = class("ActGeTianLevelView", BaseView)
...
function slot0.addEvents(slot0)
	...
	slot0._animEvent:AddEventListener(ActGeTianEnum.AnimEvt.OnStoryOpenEnd, slot0._onStoryOpenEnd, slot0)
	slot0._animEvent:AddEventListener(ActGeTianEnum.AnimEvt.OnFightOpenEnd, slot0._onFightOpenEnd, slot0)
	slot0._animEvent:AddEventListener(ActGeTianEnum.AnimEvt.OnGoStoryEnd, slot0._onGoStoryEnd, slot0)
end
...
function slot0.onOpen(slot0)
	slot0:addEventCb(ActGeTianController.instance, ActGeTianEvent.StoryItemClick, slot0.OnStoryItemClick, slot0)
	slot0:addEventCb(ActGeTianController.instance, ActGeTianEvent.FightItemClick, slot0.OnFightItemClick, slot0)
	slot0:addEventCb(ActGeTianController.instance, ActGeTianEvent.TabSwitch, slot0.OnTabSwitch, slot0)
...
function slot0.OnCheckActEnd(slot0, slot1)
	...
	if slot1 ~= ActGeTianEnum.ActivityId then
		return
	end
...
function slot0._initStageItems(slot0)
	...
	for slot7 = 1, #RoleActivityConfig.instance:getStoryLevelList(ActGeTianEnum.ActivityId) do
		slot0.storyItemList[slot7] = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], gohelper.findChild(slot0._gostoryStages, "stage" .. slot7)), GeTianStoryItem, slot0)
	...
	for slot8 = 1, #RoleActivityConfig.instance:getBattleLevelList(ActGeTianEnum.ActivityId) / 2 do
		slot0.fightItemList[slot8] = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[2], gohelper.findChild(slot0._gofightStages, "stage" .. slot8)), GeTianFightItem, slot0)
...
function slot0._playStoryFinishAnim(slot0)
	if ActGeTianModel.instance:getNewFinishStoryLvl() then
		...
		ActGeTianModel.instance:clearNewFinishStoryLvl()
	end
end
...
function slot0._playFightFinishAnim(slot0)
	...
	if ActGeTianModel.instance:getNewFinishFightLvl() then
		for slot5, slot6 in ipairs(slot0.fightItemList) do
			if slot6.id == slot1 then
		...
		ActGeTianModel.instance:clearNewFinishFightLvl()
...
function slot0._showLeftTime(slot0)
	slot0._txtlimittime.text = ActivityHelper.getActivityRemainTimeStr(ActGeTianEnum.ActivityId)
end
