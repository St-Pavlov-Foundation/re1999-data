...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0.odysseySuitRoot = gohelper.findChild(arg_1_0.viewGO, "fightinfocontainer/#go_odysseySuit")
	arg_1_0.aiJiAoSliderRoot = gohelper.findChild(arg_1_0.viewGO, "fightinfocontainer/#go_infoView/content/player/#go_azio")
	arg_1_0.alertRoot = gohelper.findChild(arg_1_0.viewGO, "fightinfocontainer/#go_infoView/content/info/#go_alert")
...
function var_0_0._editableInitView(arg_13_0)
	...
	local var_13_1 = gohelper.findChild(arg_13_0.viewGO, "fightinfocontainer/#go_infoView/content/player/#go_playerpassive/playerpassivelevel/go_playerpassivelevel4")

	arg_13_0._playerpassiveGOList[0] = var_13_1
	...
	for iter_13_1 = 1, 3 do
		local var_13_3 = arg_13_0:createSuperItem()

		table.insert(arg_13_0._superItemList, var_13_3)
	end
	...
	for iter_13_2 = 1, 3 do
		local var_13_5 = arg_13_0:createSkillItem()

		table.insert(arg_13_0._skillGOs, var_13_5)
	end
	...
	local var_13_6 = DungeonModel.instance.curSendChapterId

	if var_13_6 then
		local var_13_7 = DungeonConfig.instance:getChapterCO(var_13_6)

		arg_13_0.isSimple = var_13_7 and var_13_7.type == DungeonEnum.ChapterType.Simple
	end
...
function var_0_0._getEntityList(arg_18_0)
	...
	for iter_18_5 = #var_18_0, 1, -1 do
		local var_18_4 = FightLocalDataMgr.instance.entityMgr:getById(var_18_0[iter_18_5].id)

		if var_18_4 and var_18_4:isStatusDead() then
			table.remove(var_18_0, iter_18_5)
		end
	end

	arg_18_0:sortFightEntityList(var_18_0)

	local var_18_5 = FightDataHelper.entityMgr:getAssistBoss()

	if var_18_5 and arg_18_0._curSelectSide == FightEnum.EntitySide.MySide then
...
function var_0_0.onOpen(arg_21_0)
	...
	if #arg_21_0._entityList == 0 then
		arg_21_0._curSelectSide = FightEnum.EntitySide.MySide

		gohelper.setActive(arg_21_0._btnSwitchEnemy.gameObject, false)
		arg_21_0:_refreshEntityList()
	end
...
function var_0_0._refreshUI(arg_23_0)
	...
	arg_23_0:showOdysseyEquip()
	arg_23_0:showOdysseyEquipSuit()
	arg_23_0:showAiJiAoExPointSlider()
	arg_23_0:showAlert()
end
...
function var_0_0._refreshInfo(arg_25_0, arg_25_1)
	...
	arg_25_0:refreshKillLine(arg_25_0._entityMO)
	gohelper.setActive(arg_25_0._goplayerequipinfo, false)
	arg_25_0:refreshHealth(arg_25_0._entityMO)
end

function var_0_0.refreshKillLine(arg_26_0, arg_26_1)
	if not arg_26_0.killLineComp then
		arg_26_0.killLineComp = FightFocusHpKillLineComp.New(FightHpKillLineComp.KillLineType.FocusHp)

		arg_26_0.killLineComp:init(arg_26_0._sliderhp.gameObject)
	end

	arg_26_0.killLineComp:refreshByEntityMo(arg_26_1)
end
...
function var_0_0._refreshCharacterInfo(arg_32_0, arg_32_1)
	...
	arg_32_0:refreshKillLine(arg_32_0._entityMO)
	arg_32_0:refreshHealth(arg_32_0._entityMO)
end
...
function var_0_0._refreshHeroEquipInfo(arg_33_0, arg_33_1)
	...
	if arg_33_1.equipRecord then
		var_33_0 = arg_33_1:getEquipMo()
	elseif tonumber(arg_33_1.uid) < 0 then
...
function var_0_0._refreshCharacterPassiveSkill(arg_42_0, arg_42_1)
	...
	HeroDestinyStoneMO.replaceSkillList(var_42_4, arg_42_1.destinyStone, arg_42_1.destinyRank)
...
function var_0_0._refreshSuper(arg_46_0, arg_46_1)
	if arg_46_1 and #arg_46_1 > 0 then
		...
		for iter_46_0 = 1, #arg_46_1 do
			...
			gohelper.setActive(var_46_3.go, var_46_4 ~= 0)
		end
	end
...
function var_0_0.onClickPassiveHyperLink(arg_51_0, arg_51_1, arg_51_2)
	...
	local var_51_0 = FightConfig.instance:getEntityName(arg_51_0._curSelectId)

	CommonBuffTipController.instance:openCommonTipViewWithCustomPos(arg_51_1, arg_51_0.commonBuffTipAnchorPos, CommonBuffTipEnum.Pivot.Right, var_51_0)
end

function var_0_0._refreshHp(arg_52_0, arg_52_1)
	local var_52_0 = arg_52_1:getLockMaxHpRate()
	local var_52_1 = math.max(arg_52_1.currentHp, 0)
	local var_52_2 = (arg_52_1.attrMO and math.max(arg_52_1.attrMO.hp, 0)) * var_52_0

	arg_52_0._txthp.text = string.format("%d/%d", var_52_1, var_52_2)

	local var_52_3 = var_52_1 / var_52_2 * var_52_0

	arg_52_0._sliderhp:SetValue(var_52_3)

	local var_52_4 = var_52_0 < 1

	gohelper.setActive(arg_52_0.reduceHpGo, var_52_4)

	if var_52_4 then
		arg_52_0.reduceHpImage.fillAmount = Mathf.Clamp01(1 - var_52_0)
	end
end
...
function var_0_0._refreshBuff(arg_53_0, arg_53_1)
	...
	for iter_53_0 = 1, var_53_2 do
		...
		if var_53_6 and var_53_6.isNoShow == 0 then
			...
			gohelper.setActive(arg_53_0._buffTables[var_53_3].go, true)
		end
	end
...
function var_0_0._onClickBuff(arg_55_0, arg_55_1)
	...
	ViewMgr.instance:openView(ViewName.FightBuffTipsView, arg_55_1)
...
function var_0_0.refreshScrollEnemy(arg_57_0)
	...
	for iter_57_0, iter_57_1 in ipairs(arg_57_0._entityList) do
		...
		local var_57_3 = arg_57_0:getHeadIcon(iter_57_1)

		gohelper.getSingleImage(var_57_1.imageIcon.gameObject):LoadImage(ResUrl.monsterHeadIcon(var_57_3))
		...
		local var_57_4 = FightHelper.getSurvivalEntityHealth(iter_57_1.id)

		gohelper.setActive(var_57_1.healthGo, var_57_4 ~= nil)

		if var_57_4 then
			local var_57_5 = FightNameUIHealthComp.getHealthIcon(var_57_4)

			UISpriteSetMgr.instance:setFightSprite(var_57_1.healthTag, var_57_5, true)
		end
	end
...
function var_0_0.getHeadIcon(arg_58_0, arg_58_1)
	if not arg_58_1 then
		return
	end

	local var_58_0 = arg_58_1.modelId
	local var_58_1 = lua_fight_sp_500m_model.configDict[var_58_0]

	if var_58_1 then
		return var_58_1.headIconName
	end

	return arg_58_1:getSpineSkinCO().headIcon
end
...
function var_0_0._onBtnBuffMore(arg_80_0)
	ViewMgr.instance:openView(ViewName.FightBuffTipsView, arg_80_0._curSelectId)
end
...
function var_0_0.showOdysseyEquip(arg_84_0)
	...
	if var_84_0 then
		...
		if arg_84_0.odysseyEquipView then
			arg_84_0.odysseyEquipView:refreshEntityMO(arg_84_0._entityMO)
		else
			arg_84_0.odysseyEquipView = arg_84_0:com_openSubView(FightFocusOdysseyEquipView, "ui/viewres/fight/fight_odysseycollectionview.prefab", arg_84_0.go_collection, arg_84_0._entityMO)
		end
	end
end

function var_0_0.showOdysseyEquipSuit(arg_85_0)
	...
	if var_85_0 then
		...
		if arg_85_0.odysseyEquipSuitView then
			arg_85_0.odysseyEquipSuitView:refreshEntityMO(arg_85_0._entityMO)
		else
			arg_85_0.odysseyEquipSuitView = arg_85_0:com_openSubView(FightFocusOdysseyEquipSuitView, "ui/viewres/fight/fight_odysseysuitview.prefab", arg_85_0.odysseySuitRoot, arg_85_0._entityMO)
		end
	end
end

function var_0_0.showAiJiAoExPointSlider(arg_86_0)
	if arg_86_0._entityMO.exPointType == FightEnum.ExPointType.Synchronization then
		gohelper.setActive(arg_86_0.aiJiAoSliderRoot, true)

		if arg_86_0.aiJiAoExPointSliderView then
			arg_86_0.aiJiAoExPointSliderView:refreshEntityMO(arg_86_0._entityMO)
		else
			arg_86_0.aiJiAoExPointSliderView = arg_86_0:com_openSubView(FightFocusAiJiAoExPointSliderView, "ui/viewres/fight/fightaijiaoenergysliderview.prefab", arg_86_0.aiJiAoSliderRoot, arg_86_0._entityMO)
		end
	else
		gohelper.setActive(arg_86_0.aiJiAoSliderRoot, false)
	end
end

function var_0_0.showAlert(arg_87_0)
	gohelper.setActive(arg_87_0.alertRoot, false)

	local var_87_0 = arg_87_0._entityMO._powerInfos

	if var_87_0 then
		for iter_87_0, iter_87_1 in pairs(var_87_0) do
			if iter_87_0 == FightEnum.PowerType.Alert then
				gohelper.setActive(arg_87_0.alertRoot, true)

				if arg_87_0.alertView then
					arg_87_0.alertView:refreshData(arg_87_0._entityMO.id, iter_87_1)
				else
					local var_87_1 = "ui/viewres/fight/fightalertview.prefab"

					arg_87_0.alertView = arg_87_0:com_openSubView(FightNamePowerInfoView6, var_87_1, arg_87_0.alertRoot, arg_87_0._entityMO.id, iter_87_1, true)
				end
			end
		end
	end
...
function var_0_0.onClickHealth(arg_88_0)
	local var_88_0 = arg_88_0._entityMO and FightHelper.getSurvivalEntityHealth(arg_88_0._entityMO.id)

	if not var_88_0 then
		return
	end

	local var_88_1 = FightNameUIHealthComp.getCurHealthStatus(var_88_0)
	local var_88_2 = FightNameUIHealthComp.getHealthTitle(var_88_1)
	local var_88_3 = FightNameUIHealthComp.getHealthDesc(var_88_1)
	local var_88_4 = recthelper.getWidth(arg_88_0.rectSurvivalHealth)
	local var_88_5 = recthelper.getHeight(arg_88_0.rectSurvivalHealth)
	local var_88_6 = recthelper.uiPosToScreenPos(arg_88_0.rectSurvivalHealth)

	var_88_6.x = var_88_6.x + var_88_4 / 2 + var_0_0.HealthInterval
	var_88_6.y = var_88_6.y + var_88_5 / 2

	FightCommonTipController.instance:openCommonView(var_88_2, var_88_3, var_88_6)
end

function var_0_0.refreshHealth(arg_89_0, arg_89_1)
	local var_89_0 = arg_89_1 and FightHelper.getSurvivalEntityHealth(arg_89_1.id)

	if not var_89_0 then
		gohelper.setActive(arg_89_0.goSurvivalHealth, false)

		return
	end

	gohelper.setActive(arg_89_0.goSurvivalHealth, true)

	arg_89_0.txtHealth.text = string.format("%d/%d", var_89_0, FightHelper.getSurvivalMaxHealth() or 120)

	local var_89_1 = FightNameUIHealthComp.getHealthIcon(var_89_0)

	UISpriteSetMgr.instance:setFightSprite(arg_89_0.imageHealth, var_89_1, true)
end
