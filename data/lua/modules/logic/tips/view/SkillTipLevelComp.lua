...
function var_0_0.initInfo(arg_13_0, arg_13_1)
	arg_13_0.viewParam = arg_13_1
	arg_13_0.srcSkillIdList = arg_13_1.skillIdList
	arg_13_0.isSuper = arg_13_1.super
	arg_13_0.viewName = arg_13_1.viewName

	arg_13_0:updateMonsterName()

	arg_13_0.srcSkillIdList = arg_13_1.skillIdList
	arg_13_0.isSuper = arg_13_1.super
	arg_13_0.isCharacter = true
	arg_13_0.entityMo = FightDataHelper.entityMgr:getById(arg_13_1.entityId)
	arg_13_0.entitySkillIndex = arg_13_1.entitySkillIndex
	arg_13_0._supplement = false

	arg_13_0:refreshUpgradeBtn(arg_13_0.isCharacter)
	arg_13_0:_setNewSkills(arg_13_0.srcSkillIdList, arg_13_0.isSuper, arg_13_0.isCharacter)
end

function var_0_0.updateMonsterName(arg_14_0)
	arg_14_0.monsterName = arg_14_0.viewParam.monsterName
...
function var_0_0.refreshUpgradeBtn(arg_15_0, arg_15_1)
	if not arg_15_0._canShowUpgradeBtn then
		gohelper.setActive(arg_15_0._btnupgradeShow.gameObject, false)

		return
	end

	if arg_15_0.viewName ~= ViewName.FightFocusView then
		arg_15_0:refreshHeroUpgrade()
	else
		arg_15_0:refreshEntityUpgrade(arg_15_1)
	end
end

function var_0_0.refreshHeroUpgrade(arg_16_0)
	local var_16_0 = arg_16_0.viewParam.heroMo
	local var_16_1 = arg_16_0.viewParam.skillIndex

	if not var_16_0 or not var_16_0.exSkillLevel then
		local var_16_2 = 0
	end

	arg_16_0.hasBreakLevelSkill, arg_16_0.upgradeSkillIdList = SkillConfig.instance:getHeroUpgradeSkill(arg_16_0.srcSkillIdList)

	arg_16_0:refreshUpgradeUI()
end

function var_0_0.refreshEntityUpgrade(arg_17_0, arg_17_1)
	...
	local var_17_0 = arg_17_0.entityMo and arg_17_0.entityMo:getCO()

	if not (var_17_0 and var_17_0.id) then
		gohelper.setActive(arg_17_0._btnupgradeShow.gameObject, false)
	...
	if arg_17_0.upgradeSkillIdList and arg_17_0.srcSkillIdList[1] == arg_17_0.upgradeSkillIdList[1] then
		arg_17_0.upgraded = true
	else
		arg_17_0.upgraded = false
	end

	arg_17_0:refreshUpgradeUI()
end

function var_0_0._btnUpgradeShowOnClick(arg_18_0)
	arg_18_0._upgradeSelectShow = not arg_18_0._upgradeSelectShow

	arg_18_0:refreshUpgradeUI()
	arg_18_0:_setNewSkills(arg_18_0.srcSkillIdList, arg_18_0.isSuper, arg_18_0.isCharacter)
end

function var_0_0.refreshUpgradeUI(arg_19_0)
	local var_19_0 = not arg_19_0.upgraded and arg_19_0.hasBreakLevelSkill
	local var_19_1 = arg_19_0.upgraded or arg_19_0._upgradeSelectShow

	gohelper.setActive(arg_19_0._btnupgradeShow, var_19_0)
	gohelper.setActive(arg_19_0._goshowSelect, var_19_1)
	gohelper.setActive(arg_19_0._goBtnUpgraded, arg_19_0._upgradeSelectShow)
	gohelper.setActive(arg_19_0._goBtnNormal, not arg_19_0._upgradeSelectShow)
end

function var_0_0.setUpgradebtnShowState(arg_20_0, arg_20_1)
	arg_20_0._canShowUpgradeBtn = arg_20_1
end

function var_0_0._btnSupplementOnClick(arg_21_0)
	arg_21_0._supplement = not arg_21_0._supplement

	arg_21_0:_refreshSupplementUI()
end

function var_0_0._refreshSupplement(arg_22_0, arg_22_1)
	local var_22_0 = SkillConfig.instance:getFightCardFootnoteConfig(arg_22_1)

	if not arg_22_0._footnoteItem then
		arg_22_0._footnoteItem = arg_22_0:getUserDataTb_()

		local var_22_1 = gohelper.findChild(arg_22_0._goskillspecial, "footnoteItem") or gohelper.cloneInPlace(arg_22_0._goskillspecialitem, "footnoteItem")

		arg_22_0._footnoteItem.go = var_22_1
		arg_22_0._footnoteItem.gonameBg = gohelper.findChild(var_22_1, "titlebg")
		arg_22_0._footnoteItem.desc = gohelper.findChildText(var_22_1, "desc")
	end

	gohelper.setActive(arg_22_0._footnoteItem.gonameBg.gameObject, false)

	if var_22_0 then
		arg_22_0._footnoteItem.desc.text = var_22_0.desc
	else
		arg_22_0._supplement = false
	end

	gohelper.setActive(arg_22_0._btnsupplement.gameObject, var_22_0 ~= nil)
	arg_22_0:_refreshSupplementUI()
end

function var_0_0._refreshSupplementUI(arg_23_0)
	gohelper.setActive(arg_23_0._goBtnsupplementNormal, not arg_23_0._supplement)
	gohelper.setActive(arg_23_0._goBtnsupplement, arg_23_0._supplement)
	gohelper.setActive(arg_23_0._goline.gameObject, arg_23_0._supplement)

	if arg_23_0._footnoteItem then
		gohelper.setActive(arg_23_0._footnoteItem.go, arg_23_0._supplement)
	end
end

function var_0_0.onDestroyView(arg_24_0)
	arg_24_0._scrollSkilltip:RemoveOnValueChanged()

	if arg_24_0._newskillitems then
		for iter_24_0, iter_24_1 in pairs(arg_24_0._newskillitems) do
			iter_24_1.icon:UnLoadImage()
...
function var_0_0.SetParent(arg_25_0, arg_25_1)
	arg_25_0._gonewskilltip.transform:SetParent(arg_25_1.transform)
end

function var_0_0.hideInfo(arg_26_0)
	gohelper.setActive(arg_26_0._gonewskilltip, false)
end
