...
function slot0.onInitView(slot0)
	...
	slot0._txtproptip = gohelper.findChildText(slot0.viewGO, "#txt_proptip")
	slot0._txtexpire = gohelper.findChildText(slot0.viewGO, "#txt_expire")
...
function slot0._cloneJumpItem(slot0)
		...
		for slot8, slot9 in ipairs(slot2) do
			if ItemModel.instance:getItemCount(slot9.sourceParam) > 0 then
				if not slot0._boxItemGos[slot8] then
					...
					slot12.go = slot11
					slot12.originText = gohelper.findChildText(slot11, "layout/originText")
					...
					slot12.jumpHardTagGO = gohelper.findChild(slot11, "layout/hardtag")
					slot12.jumpBgGO = gohelper.findChild(slot11, "jump/bg")
					slot12.probalityBg = gohelper.findChild(slot11, "layout/bg")
					slot12.txtProbality = gohelper.findChildText(slot11, "layout/bg/probality")
					slot12.jumpText.text = uv0(luaLang("level_limit_unlock"), "")
	...
	for slot11 = 1, #slot6 do
		if not slot0.jumpItemGos[slot11] then
			...
			slot12 = slot0:getUserDataTb_()
			slot12.go = slot13
			slot12.originText = gohelper.findChildText(slot13, "layout/originText")
			...
			slot12.jumpHardTagGO = gohelper.findChild(slot13, "layout/hardtag")
			slot12.jumpBgGO = gohelper.findChild(slot13, "jump/bg")
			slot12.probalityBg = gohelper.findChild(slot13, "layout/bg")
			slot12.txtProbality = gohelper.findChildText(slot13, "layout/bg/probality")
...
function slot0._refreshUI(slot0)
	...
	slot0._txtusedesc.text = slot0._config.useDesc
...
function slot0.getRemainTimeStr(slot0, slot1)
	return TimeUtil.secondToRoughTime3(slot1, false) and uv0(luaLang("remain"), " " .. slot2) or ""
end
