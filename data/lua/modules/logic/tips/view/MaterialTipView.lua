...
function var_0_0._btnuseOnClick(arg_24_0)
	...
	elseif arg_24_0._config.subType == ItemEnum.SubType.RoomBlockGift then
		local function var_24_14()
			RoomBlockGiftController.instance:openBlockView(arg_24_0._config.rare, arg_24_0._config.id, arg_24_0.closeThis, arg_24_0)
		end
...
function var_0_0._refreshUI(arg_40_0)
	...
	if arg_40_0:_isUseBtnShow() then
		...
		elseif arg_40_0._config.subType == ItemEnum.SubType.RoomBlockGift then
			var_40_0 = false
		...
		gohelper.setActive(arg_40_0._gouseDetail, var_40_0)
	else
	...
	local var_40_1 = arg_40_0._config.subType == ItemEnum.SubType.Portrait
	...
	elseif arg_40_0.viewParam.type == MaterialEnum.MaterialType.Equip then
		...
		gohelper.setActive(arg_40_0._simagepropicon.gameObject, not var_40_1)
		TaskDispatcher.runRepeat(arg_40_0._onRefreshItemDeadline, arg_40_0, 1)
	end

	arg_40_0._txtdesc.text = arg_40_0._config.desc
	arg_40_0._txtusedesc.text = arg_40_0._config.useDesc
	...
	local var_40_2 = arg_40_0._config.subType == ItemEnum.SubType.SummonSimulationPick
	local var_40_3 = var_40_2 or arg_40_0:_isPackageSkin()

	gohelper.setActive(arg_40_0._goSummonsimulationtips, var_40_3)
	gohelper.setActive(arg_40_0._btnsummonsimulation, var_40_3)

	local var_40_4 = arg_40_0.viewParam.type == MaterialEnum.MaterialType.Exp

	gohelper.setActive(arg_40_0._gohadnumber, not var_40_4 and arg_40_0._config.subType ~= ItemEnum.SubType.Portrait and not arg_40_0:_checkIsFakeIcon())
	...
	local var_40_5 = string.split(arg_40_0._config.effect, "#")

	if arg_40_0._config.subType == ItemEnum.SubType.Portrait then
		if #var_40_5 > 1 then
			if arg_40_0._config.id == tonumber(var_40_5[#var_40_5]) then
				...
				local var_40_6 = "ui/viewres/common/effect/frame.prefab"

				arg_40_0._loader:addPath(var_40_6)
...
function var_0_0.getRemainTimeStr(arg_44_0, arg_44_1)
	local var_44_0 = TimeUtil.secondToRoughTime3(arg_44_1, false)
...
function var_0_0._refreshInclude(arg_51_0)
	...
	if arg_51_0._config.subType == ItemEnum.SubType.SelfSelectSix or arg_51_0._config.subType == ItemEnum.SubType.RoomBlockGift then
		var_51_0 = true
	end
	...
	if var_51_0 then
		...
		elseif arg_51_0._config.subType == ItemEnum.SubType.RoomBlockGift then
			...
			var_51_3 = RoomBlockBuildingGiftModel.instance:getGiftlocks(arg_51_0._config.rare)
...
function var_0_0._isUseBtnShow(arg_53_0)
	...
	if arg_53_0._config.subType == ItemEnum.SubType.RoomBlockGift then
