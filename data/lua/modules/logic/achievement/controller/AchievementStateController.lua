...
function var_0_0.getAchievementStartLeftSeconds(arg_12_0, arg_12_1)
	...
	return TimeUtil.stringToTimestamp(var_12_0) + ServerTime.clientToServerOffset() - ServerTime.now()
end

function var_0_0.getAchievementEndLeftSeconds(arg_13_0, arg_13_1)
	local var_13_0 = arg_13_1.endTime

	return TimeUtil.stringToTimestamp(var_13_0) + ServerTime.clientToServerOffset() - ServerTime.now()
end
