...
function slot0.getAchievementStartLeftSeconds(slot0, slot1)
	return TimeUtil.stringToTimestamp(slot1.startTime) + ServerTime.clientToServerOffset() - ServerTime.now()
end

function slot0.getAchievementEndLeftSeconds(slot0, slot1)
	return TimeUtil.stringToTimestamp(slot1.endTime) + ServerTime.clientToServerOffset() - ServerTime.now()
end
