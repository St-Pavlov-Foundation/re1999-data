...
local var_0_0 = class("VersionActivity2_8StoreTalk", BaseView)
...
var_0_0.ChessOpenAnimDuration = 1.5
var_0_0.ScrollTalkMargin = 60
...
function var_0_0._editableInitView(arg_6_0)
	...
	arg_6_0.actId = VersionActivity2_8DungeonTaskStoreController.instance:getModuleConfig().DungeonStore
...
function var_0_0._tickContent(arg_10_0)
	...
	if utf8.sub(arg_10_0.content, arg_10_0.currentCharIndex - 1, arg_10_0.currentCharIndex) == "<" then
		if utf8.sub(arg_10_0.content, arg_10_0.currentCharIndex - 1, arg_10_0.currentCharIndex + 2) == "<i>" then
			arg_10_0.currentCharIndex = arg_10_0.currentCharIndex + 3
		end

		if utf8.sub(arg_10_0.content, arg_10_0.currentCharIndex - 1, arg_10_0.currentCharIndex + 3) == "</i>" then
			arg_10_0.currentCharIndex = arg_10_0.currentCharIndex + 4
		end
	end
...
function var_0_0.onOpenFinish(arg_19_0)
	if arg_19_0.isFirstEnter then
		...
		local var_19_0 = PlayerModel.instance:getPlayerPrefsKey(PlayerPrefsKey.Version2_8PlayedStoreGroupIdKey)
...
function var_0_0.initGroupCo(arg_20_0)
	...
	local var_20_1 = PlayerModel.instance:getPlayerPrefsKey(PlayerPrefsKey.Version2_8PlayedStoreGroupIdKey)
	local var_20_2 = {}
...
function var_0_0.triggerTalkByType(arg_22_0, arg_22_1, arg_22_2)
	...
	TaskDispatcher.cancelTask(arg_22_0._checkTriggerTalk, arg_22_0)

	if not arg_22_0._hasOpen then
		arg_22_0._hasOpen = true

		arg_22_0.chessAnim:Play("open", 0, 0)
		TaskDispatcher.runDelay(arg_22_0._checkTriggerTalk, arg_22_0, var_0_0.ChessOpenAnimDuration)
	else
		arg_22_0:_checkTriggerTalk()
	end
end

function var_0_0._checkTriggerTalk(arg_23_0)
	arg_23_0:_triggerTalk(arg_23_0:getRandomTalkCo(arg_23_0.canTriggerList))
end

function var_0_0.getRandomTalkCo(arg_24_0, arg_24_1)
	...
	for iter_24_0, iter_24_1 in ipairs(arg_24_1) do
		var_24_1 = var_24_1 + iter_24_1.weight
	end

	local var_24_2 = math.random(var_24_1)
	local var_24_3 = 0

	for iter_24_2, iter_24_3 in ipairs(arg_24_1) do
		var_24_3 = var_24_3 + iter_24_3.weight
	...
	return arg_24_1[var_24_0]
end

function var_0_0._triggerTalk(arg_25_0, arg_25_1)
	local var_25_0 = Time.time

	if var_25_0 - arg_25_0.lastTriggerTime < var_0_0.TalkMinTriggerDuration then
		return
	end

	arg_25_0:buildStepCoList(arg_25_1)
	TaskDispatcher.cancelTask(arg_25_0.playNextStep, arg_25_0)
	TaskDispatcher.cancelTask(arg_25_0.onFinishTalk, arg_25_0)
	gohelper.setActive(arg_25_0._goTalk, true)
	gohelper.setActive(arg_25_0._goArrowTip, false)

	arg_25_0._txttalk.text = ""
	arg_25_0.lastTriggerTime = var_25_0
	arg_25_0.lastSpawnTime = var_25_0 - var_0_0.TextSpawnInterval

	arg_25_0:playStep(1)

	arg_25_0.start = true
	arg_25_0.waitFinishTalk = false
	arg_25_0.waitPlayNextStep = false
end

function var_0_0.playStep(arg_26_0, arg_26_1)
	local var_26_0 = arg_26_0.triggerStepList[arg_26_1]

	if not var_26_0 then
		return
	end

	TaskDispatcher.cancelTask(arg_26_0.stopChessAnim, arg_26_0)
	TaskDispatcher.runRepeat(arg_26_0.stopChessAnim, arg_26_0, var_0_0.ChessJumpAnimDuration)
	arg_26_0.chessAnim:Play("jump")
	gohelper.setActive(arg_26_0._godot, true)

	arg_26_0.currentCharIndex = 1
	arg_26_0.currentStepIndex = arg_26_1
	arg_26_0.content = var_26_0.content
	arg_26_0.contentLen = utf8.len(arg_26_0.content)

	AudioMgr.instance:trigger(AudioEnum2_8.VersionActivity2_8Store.play_ui_jinye_chess_talk)
end

function var_0_0.buildStepCoList(arg_27_0, arg_27_1)
	tabletool.clear(arg_27_0.triggerStepList)

	local var_27_0 = lua_activity107_bubble_talk_step.configDict[arg_27_1.id]

	for iter_27_0, iter_27_1 in pairs(var_27_0) do
		table.insert(arg_27_0.triggerStepList, iter_27_1)
	end

	if #arg_27_0.triggerStepList > 1 then
		table.sort(arg_27_0.triggerStepList, var_0_0.sortStep)
	end
end

function var_0_0.stopChessAnim(arg_28_0)
	if arg_28_0.waitPlayNextStep or arg_28_0.waitFinishTalk then
		arg_28_0.chessAnim:Play("idle")
		gohelper.setActive(arg_28_0._godot, false)
		TaskDispatcher.cancelTask(arg_28_0.stopChessAnim, arg_28_0)
	end
end

function var_0_0.onClose(arg_29_0)
	TaskDispatcher.cancelTask(arg_29_0.stopChessAnim, arg_29_0)
	TaskDispatcher.cancelTask(arg_29_0.playNextStep, arg_29_0)
	TaskDispatcher.cancelTask(arg_29_0.onFinishTalk, arg_29_0)
	AudioMgr.instance:trigger(AudioEnum2_8.VersionActivity2_8Store.stop_ui_jinye_chess_talk)
	TaskDispatcher.cancelTask(arg_29_0._triggerEnterAudio, arg_29_0)

	if arg_29_0.updateHandle then
		UpdateBeat:RemoveListener(arg_29_0.updateHandle)
	end

	if arg_29_0.lateUpdateHandle then
		LateUpdateBeat:RemoveListener(arg_29_0.lateUpdateHandle)
	end

	arg_29_0.closed = true
end

function var_0_0.onDestroyView(arg_30_0)
	TaskDispatcher.cancelTask(arg_30_0._checkTriggerTalk, arg_30_0)
	arg_30_0.stageClick:RemoveClickListener()
	arg_30_0.talkTextClick:RemoveClickListener()
end

function var_0_0.sortStep(arg_31_0, arg_31_1)
	return arg_31_0.step < arg_31_1.step
end
