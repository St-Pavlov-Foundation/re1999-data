...
local var_0_0 = class("VersionActivity2_8NuoDiKaEnterView", VersionActivityEnterBaseSubView)
...
function var_0_0._editableInitView(arg_4_0)
	arg_4_0.actId = VersionActivity2_8Enum.ActivityId.NuoDiKa
...
function var_0_0.onOpen(arg_5_0)
	RedDotController.instance:addRedDot(arg_5_0._goEnterRedDot, RedDotEnum.DotNode.V2a4WuErLiXiTask, arg_5_0.actId)
