-- chunkname: @modules/logic/versionactivity2_8/enter/view/subview/VersionActivity2_8NuoDiKaEnterView.lua

module("modules.logic.versionactivity2_8.enter.view.subview.VersionActivity2_8NuoDiKaEnterView", package.seeall)

local VersionActivity2_8NuoDiKaEnterView = class("VersionActivity2_8NuoDiKaEnterView", VersionActivityEnterBaseSubView)

function VersionActivity2_8NuoDiKaEnterView:onInitView()
...
function VersionActivity2_8NuoDiKaEnterView:addEvents()
...
function VersionActivity2_8NuoDiKaEnterView:removeEvents()
...
function VersionActivity2_8NuoDiKaEnterView:_editableInitView()
...
function VersionActivity2_8NuoDiKaEnterView:onOpen()
	RedDotController.instance:addRedDot(self._goEnterRedDot, RedDotEnum.DotNode.V2a4WuErLiXiTask, self.actId)
	self:_refreshTime()
	TaskDispatcher.runRepeat(self._refreshTime, self, TimeUtil.OneMinuteSecond)
	self._animator:Play("open", 0, 0)
end

function VersionActivity2_8NuoDiKaEnterView:_enterGame()
...
function VersionActivity2_8NuoDiKaEnterView:_clickLock()
...
function VersionActivity2_8NuoDiKaEnterView:_btnitemOnClick()
	return
end

function VersionActivity2_8NuoDiKaEnterView:_btnTrialOnClick()
...
function VersionActivity2_8NuoDiKaEnterView:everySecondCall()
	self:_refreshTime()
end

function VersionActivity2_8NuoDiKaEnterView:_refreshTime()
...
function VersionActivity2_8NuoDiKaEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity2_8NuoDiKaEnterView:onDestroyView()
	return
end

return VersionActivity2_8NuoDiKaEnterView
