...
function var_0_0.getLangTitle(arg_7_0)
	...
	local var_7_1 = arg_7_0.titleMap[var_7_0] or arg_7_0:getTemplateTitle()
...
function var_0_0.getJumpLink(arg_8_0)
	if arg_8_0.mailId == 0 then
		...
		return arg_8_0.jump and arg_8_0.jump[var_8_0] or ""
	end
...
function var_0_0.getTemplateJumpTitle(arg_11_0)
	if arg_11_0.mailId == 0 then
		...
		return arg_11_0.jumpTitle and arg_11_0.jumpTitle[var_11_0] or ""
	end
...
function var_0_0.getLangSender(arg_12_0)
	...
	local var_12_1 = arg_12_0.senderMap[var_12_0] or arg_12_0:getTemplateSender()
...
function var_0_0.getLangContent(arg_15_0)
	...
	local var_15_1 = arg_15_0.contentMap[var_15_0] or arg_15_0:getTemplateContent()
