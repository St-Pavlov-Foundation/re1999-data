...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtunreadmailcount = gohelper.findChildText(arg_1_0.viewGO, "mailtipview/mailcount/unreadmailcount/#txt_unreadmailcount")
...
function var_0_0._updateSelectMail(arg_15_0, arg_15_1)
	...
	if not var_15_0 then
		...
		arg_15_0._txtsendtxt.text = TimeUtil.timestampToString3(arg_15_1.createTime / 1000)
