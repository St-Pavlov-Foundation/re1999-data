...
function slot0.onInitView(slot0)
	...
	slot0._txtunreadmailcount = gohelper.findChildText(slot0.viewGO, "mailtipview/mailcount/unreadmailcount/#txt_unreadmailcount")
...
function slot0._updateSelectMail(slot0, slot1)
	...
	if not (slot0._selectMO and slot0._selectMO.id == slot1.id) then
		...
		slot0._txtsendtxt.text = TimeUtil.timestampToString3(slot1.createTime / 1000)
