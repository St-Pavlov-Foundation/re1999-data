...
function var_0_0._refreshInfo(arg_6_0)
	...
	if arg_6_0._select then
		arg_6_0._txtmailTimeSelect.text = TimeUtil.timestampToString3(arg_6_0._mo.createTime / 1000)
	else
		arg_6_0._txtmailTimeUnSelect.text = TimeUtil.timestampToString3(arg_6_0._mo.createTime / 1000)
	end
end
