...
function slot0._refreshInfo(slot0)
	...
	if slot0._select then
		slot0._txtmailTimeSelect.text = TimeUtil.timestampToString3(slot0._mo.createTime / 1000)
	else
		slot0._txtmailTimeUnSelect.text = TimeUtil.timestampToString3(slot0._mo.createTime / 1000)
	end
end
