...
function var_0_0._tweenFillAmount(arg_43_0)
	...
	ZProj.TweenHelper.DOFillAmount(arg_43_0._imgHpMinus, var_43_0, 0.5)
...
function var_0_0.resetHp(arg_44_0)
	...
	local var_44_0, var_44_1 = arg_44_0:_getFillAmount()

	arg_44_0._imgHpMinus.fillAmount = var_44_0
	arg_44_0._imgHp.fillAmount = var_44_0
	arg_44_0._imgHpShield.fillAmount = var_44_1
	arg_44_0._txtHp.text = arg_44_0._curHp

	gohelper.setActive(arg_44_0._imgHpMinus.gameObject, arg_44_0._curShield <= 0)
...
function var_0_0._getFillAmount(arg_46_0)
	...
	if var_46_4 < var_46_3 then
		local var_46_5 = var_46_3 - var_46_4

		var_46_1 = var_46_1 * var_46_4 / var_46_3 + var_46_5 / var_46_3
		var_46_2 = var_46_2 * var_46_4 / var_46_3 + var_46_5 / var_46_3
	end
...
function var_0_0._onFloatEquipEffect(arg_47_0, arg_47_1, arg_47_2)
	...
	FightFloatMgr.instance:float(arg_47_1, FightEnum.FloatType.equipeffect, "", arg_47_2)
end
...
function var_0_0._onLockHpChange(arg_60_0)
	arg_60_0:resetHp()
end
