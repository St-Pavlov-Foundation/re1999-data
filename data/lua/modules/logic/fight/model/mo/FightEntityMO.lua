...
function var_0_0.setPowerInfos(arg_60_0, arg_60_1)
	arg_60_0._powerInfos = {}

	for iter_60_0, iter_60_1 in ipairs(arg_60_1) do
		arg_60_0:refreshPowerInfo(iter_60_1)
	end
end

function var_0_0.refreshPowerInfo(arg_61_0, arg_61_1)
	local var_61_0 = arg_61_0._powerInfos[arg_61_1.powerId] or {}

	var_61_0.powerId = arg_61_1.powerId
	var_61_0.num = arg_61_1.num
	var_61_0.max = arg_61_1.max
	arg_61_0._powerInfos[arg_61_1.powerId] = var_61_0
end
