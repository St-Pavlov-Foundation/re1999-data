...
function var_0_0.getEquipMo(arg_93_0)
	if not arg_93_0.equipRecord then
		return
	end

	if not arg_93_0.equipMo then
		arg_93_0.equipMo = EquipMO.New()

		arg_93_0.equipMo:init({
			count = 1,
			exp = 0,
			uid = arg_93_0.equipRecord.equipUid,
			equipId = arg_93_0.equipRecord.equipId,
			level = arg_93_0.equipRecord.equipLv,
			refineLv = arg_93_0.equipRecord.refineLv
		})
		arg_93_0.equipMo:setBreakLvByLevel()
	end

	return arg_93_0.equipMo
end

function var_0_0.getLockMaxHpRate(arg_94_0)
	for iter_94_0, iter_94_1 in pairs(arg_94_0.buffDic) do
		local var_94_0 = iter_94_1.actCommonParams

		if not string.nilorempty(var_94_0) then
			local var_94_1 = FightStrUtil.instance:getSplitString2Cache(var_94_0, true, "|", "#")

			for iter_94_2, iter_94_3 in ipairs(var_94_1) do
				if iter_94_3[1] == FightEnum.BuffActId.LockHpMax then
					return iter_94_3[2] and iter_94_3[2] / 1000 or 1
				end
			end
		end
	end
...
function var_0_0.getHpAndShieldFillAmount(arg_95_0, arg_95_1, arg_95_2)
	local var_95_0 = arg_95_0:getLockMaxHpRate()
	local var_95_1 = (arg_95_0.attrMO and arg_95_0.attrMO.hp > 0 and arg_95_0.attrMO.hp or 1) * var_95_0
	local var_95_2 = arg_95_1 or arg_95_0.currentHp
	local var_95_3 = arg_95_2 or arg_95_0.shieldValue
	local var_95_4 = var_95_2 / var_95_1 or 0
	local var_95_5 = 0

	if var_95_1 >= var_95_3 + var_95_2 then
		var_95_4 = var_95_2 / var_95_1
		var_95_5 = (var_95_3 + var_95_2) / var_95_1
	else
		var_95_4 = var_95_2 / (var_95_2 + var_95_3)
		var_95_5 = 1
	end

	local var_95_6 = var_95_4 * var_95_0
	local var_95_7 = var_95_5 * var_95_0

	return var_95_6, var_95_7
end
