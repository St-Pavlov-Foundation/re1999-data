...
function var_0_0.moveActCost(arg_31_0)
	if FightEnum.UniversalCard[arg_31_0.skillId] then
		return 0
	end
...
function var_0_0.playActCost(arg_32_0)
	local var_32_0 = 1
	local var_32_1 = arg_32_0.uid
	local var_32_2 = arg_32_0.skillId
	local var_32_3 = arg_32_0.cardType

	if var_0_0.isSpecialCardById(var_32_1, var_32_2) then
		var_32_0 = (var_32_3 == FightEnum.CardType.ROUGE_SP or var_32_3 == FightEnum.CardType.USE_ACT_POINT) and 1 or 0
	end

	if var_0_0.isSkill3(arg_32_0) then
		var_32_0 = 0
	end

	if not var_0_0.checkIsBigSkillCostActPoint(var_32_1, var_32_2) then
		var_32_0 = 0
	end
...
function var_0_0.canPlayCard(arg_33_0)
	if not arg_33_0 then
		return false
	end

	if var_0_0.isFrozenCard(arg_33_0) then
		return false
	end

	if var_0_0.isBlockade(arg_33_0) then
		local var_33_0 = FightDataHelper.handCardMgr:getHandCard()
		local var_33_1 = tabletool.indexOf(var_33_0, arg_33_0)

		if var_33_1 then
			local var_33_2 = var_33_0

			return var_33_1 == 1 or var_33_1 == #var_33_2
		end
	end
...
function var_0_0.checkCanPlayCard(arg_34_0, arg_34_1)
	...
	if var_0_0.isBlockade(arg_34_0) then
		local var_34_0 = tabletool.indexOf(arg_34_1, arg_34_0)

		if var_34_0 then
			return var_34_0 == 1 or var_34_0 == #arg_34_1
		end
	end
...
function var_0_0.canMoveCard(arg_35_0)
	if not arg_35_0 then
		return false
	end

	if var_0_0.isSpecialCard(arg_35_0) then
		return false
	end
	...
	if var_0_0.isSkill3(arg_35_0) then
		return false
	end
...
function var_0_0.playCanAddExpoint(arg_36_0, arg_36_1)
	if not arg_36_1 then
		return false
	end

	if var_0_0.isSpecialCard(arg_36_1) then
		return false
	end

	if var_0_0.isSkill3(arg_36_1) then
		return false
	end

	local var_36_0 = FightDataHelper.entityMgr:getById(arg_36_1.uid)

	if var_36_0 then
		local var_36_1 = FightEnum.ExPointTypeFeature[var_36_0.exPointType]

		if var_36_1 then
			return var_36_1.playAddExpoint
		end
	end
...
function var_0_0.moveCanAddExpoint(arg_37_0, arg_37_1)
	...
	if FightEnum.UniversalCard[arg_37_1.skillId] then
		return false
	end
	...
	local var_37_0 = FightDataHelper.operationDataMgr.extraMoveAct

	if var_37_0 > 0 and var_37_0 > #FightDataHelper.operationDataMgr:getMoveCardOpCostActList() then
		return false
	end

	local var_37_1 = FightDataHelper.entityMgr:getById(arg_37_1.uid)

	if var_37_1 then
		local var_37_2 = FightEnum.ExPointTypeFeature[var_37_1.exPointType]

		if var_37_2 then
			return var_37_2.moveAddExpoint
		end
	end
...
function var_0_0.combineCanAddExpoint(arg_38_0, arg_38_1, arg_38_2)
	if not arg_38_1 or not arg_38_2 then
		return false
	end

	if var_0_0.isSkill3(arg_38_1) or var_0_0.isSkill3(arg_38_2) then
		return false
	end

	local var_38_0 = FightDataHelper.entityMgr:getById(FightEnum.UniversalCard[arg_38_1.skillId] and arg_38_2.uid or arg_38_1.uid)

	if var_38_0 then
		local var_38_1 = FightEnum.ExPointTypeFeature[var_38_0.exPointType]

		if var_38_1 then
			return var_38_1.combineAddExpoint
		end
	end
...
function var_0_0.allFrozenCard(arg_39_0)
	local var_39_0 = 0

	for iter_39_0, iter_39_1 in ipairs(arg_39_0) do
		if var_0_0.isFrozenCard(iter_39_1) then
			var_39_0 = var_39_0 + 1
		end
	end

	return var_39_0 == #arg_39_0
end

function var_0_0.calcRemoveCardTime(arg_40_0, arg_40_1, arg_40_2)
	local var_40_0 = 0.033
	local var_40_1 = arg_40_2 or 1.2
	local var_40_2 = #arg_40_0
	local var_40_3 = #arg_40_1

	for iter_40_0, iter_40_1 in ipairs(arg_40_1) do
		if iter_40_1 < var_40_2 then
			var_40_1 = var_40_1 + var_40_0 * 7
			var_40_1 = var_40_1 + 3 * var_40_0 * (var_40_2 - arg_40_1[var_40_3] - var_40_3)
...
function var_0_0.calcRemoveCardTime2(arg_41_0, arg_41_1, arg_41_2)
	local var_41_0 = 0.033
	local var_41_1 = arg_41_2 or 1.2
	local var_41_2 = tabletool.copy(arg_41_0)

	for iter_41_0, iter_41_1 in ipairs(arg_41_1) do
		table.remove(var_41_2, iter_41_1)
	end

	for iter_41_2, iter_41_3 in ipairs(var_41_2) do
		if iter_41_3 ~= arg_41_0[iter_41_2] then
			var_41_1 = var_41_1 + var_41_0 * 7
			var_41_1 = var_41_1 + 3 * var_41_0 * (#var_41_2 - iter_41_2)
...
function var_0_0.cardChangeIsMySide(arg_42_0)
	if FightModel.instance:getVersion() >= 1 then
		if not arg_42_0 then
			return false
		end

		if arg_42_0 and arg_42_0.teamType ~= FightEnum.TeamType.MySide then
			return false
		end
	end
...
function var_0_0.newCardList(arg_43_0)
	local var_43_0 = {}

	for iter_43_0, iter_43_1 in ipairs(arg_43_0) do
		table.insert(var_43_0, FightCardInfoData.New(iter_43_1))
	end

	return var_43_0
end

function var_0_0.newPlayCardList(arg_44_0)
	local var_44_0 = {}

	for iter_44_0, iter_44_1 in ipairs(arg_44_0) do
		table.insert(var_44_0, FightClientPlayCardData.New(iter_44_1, iter_44_0))
	end

	return var_44_0
end

function var_0_0.remainedAfterCombine(arg_45_0, arg_45_1)
	local var_45_0 = arg_45_0.cardData
	local var_45_1 = arg_45_1.cardData

	if FightEnum.UniversalCard[var_45_0.skillId] or FightEnum.UniversalCard[var_45_1.skillId] then
		local var_45_2 = FightEnum.UniversalCard[arg_45_0.cardData.skillId] and arg_45_1 or arg_45_0
		local var_45_3 = var_45_2 == arg_45_0 and arg_45_1 or arg_45_0

		return var_45_2, var_45_3
	end

	if arg_45_0:getItemIndex() < arg_45_1:getItemIndex() then
...
function var_0_0.isBigSkill(arg_46_0)
	local var_46_0 = lua_skill.configDict[arg_46_0]

	if not var_46_0 then
		return false
	end

	return var_46_0.isBigSkill == 1
end

function var_0_0.getSkillLv(arg_47_0, arg_47_1)
	local var_47_0 = FightDataHelper.entityMgr:getById(arg_47_0)

	if var_47_0 then
		return var_47_0:getSkillLv(arg_47_1)
	end

	return FightConfig.instance:getSkillLv(arg_47_1)
end

function var_0_0.getSkillNextLvId(arg_48_0, arg_48_1)
	local var_48_0 = lua_skill_next.configDict[arg_48_1]

	if var_48_0 and var_48_0.nextId ~= 0 then
		return var_48_0.nextId
	end

	local var_48_1 = FightDataHelper.entityMgr:getById(arg_48_0)

	if var_48_1 then
		return var_48_1:getSkillNextLvId(arg_48_1)
	end

	return FightConfig.instance:getSkillNextLvId(arg_48_1)
end

function var_0_0.getSkillPrevLvId(arg_49_0, arg_49_1)
	local var_49_0 = FightDataHelper.entityMgr:getById(arg_49_0)

	if var_49_0 then
		return var_49_0:getSkillPrevLvId(arg_49_1)
	end

	return FightConfig.instance:getSkillPrevLvId(arg_49_1)
end

function var_0_0.isActiveSkill(arg_50_0, arg_50_1)
	local var_50_0 = FightDataHelper.entityMgr:getById(arg_50_0)

	if var_50_0 then
		return var_50_0:isActiveSkill(arg_50_1)
	end

	return FightConfig.instance:isActiveSkill(arg_50_1)
end

function var_0_0.calcCardsAfterCombine(arg_51_0)
	arg_51_0 = FightDataUtil.copyData(arg_51_0)

	var_0_0.combineCardListForPerformance(arg_51_0)
...
function var_0_0.getHandCardContainerScale(arg_52_0, arg_52_1)
	local var_52_0 = #(arg_52_1 or FightDataHelper.handCardMgr.handCard)
	...
	if arg_52_0 and var_52_0 >= 8 then
...
function var_0_0.moveOnly(arg_53_0, arg_53_1, arg_53_2)
	local var_53_0 = table.remove(arg_53_0, arg_53_1)

	table.insert(arg_53_0, arg_53_2, var_53_0)
end

function var_0_0.checkOpAsPlayCardHandle(arg_54_0)
	if not arg_54_0 then
		return false
	end

	if arg_54_0:isPlayCard() then
		return true
	end

	if arg_54_0:isAssistBossPlayCard() then
		return true
	end

	if arg_54_0:isBloodPoolSkill() then
		return true
	end

	if arg_54_0:isPlayerFinisherSkill() then
		return true
	end
