...
FightMsgId.AfterDestroyEntity = GameUtil.getMsgId()
FightMsgId.OnTimelineWorkCreated = GameUtil.getMsgId()
...
FightMsgId.ReleasePreloadTimelineAssetByStepId = GameUtil.getMsgId()
FightMsgId.OnSetEntityRederOrder = GameUtil.getMsgId()
FightMsgId.PlayNameUIToughnessBrokenRewardEffect = GameUtil.getMsgId()
FightMsgId.AddDeLeiKeSlider1171 = GameUtil.getMsgId()
FightMsgId.UpdateDeLeiKeSlider1171 = GameUtil.getMsgId()
FightMsgId.RemoveDeLeiKeSlider1171 = GameUtil.getMsgId()
FightMsgId.AddDeLeiKeSlider1172 = GameUtil.getMsgId()
FightMsgId.UpdateDeLeiKeSlider1172 = GameUtil.getMsgId()
FightMsgId.RemoveDeLeiKeSlider1172 = GameUtil.getMsgId()
FightMsgId.GetSummonedEntity = GameUtil.getMsgId()
