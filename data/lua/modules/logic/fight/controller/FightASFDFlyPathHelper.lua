...
function slot0.straightLineFlyMover(slot0, slot1, slot2, slot3, slot4, slot5, slot6, slot7)
	...
	slot12 = FightASFDConfig.instance:getFlyPathCo(slot0)

	slot8:setEaseType(slot12.lineType)
	slot8:simpleMove(slot10.x, slot10.y, slot10.z, slot11.x, slot11.y, slot11.z, FightASFDConfig.instance:getFlyDuration(slot12.flyDuration, slot5.emitterAttackNum) / FightModel.instance:getSpeed())
