...
slot0.UpgradeMagicCircile = GameUtil.getEventId()
slot0.OnClickMagicCircleText = GameUtil.getEventId()
...
slot0.AfterAddUseCardContainer = GameUtil.getEventId()
...
slot0.RougeShowTip = GameUtil.getEventId()
...
slot0.BeforeCancelOperation = GameUtil.getEventId()
...
slot0.OperationForPlayEffect = GameUtil.getEventId()
slot0.SetGMViewVisible = GameUtil.getEventId()
...
slot0.UpdateFightParam = GameUtil.getEventId()
slot0.PlayTimelineHit = GameUtil.getEventId()
slot0.AfterCorrectData = GameUtil.getEventId()
...
slot0.GuideRecordAutoState = GameUtil.getEventId()
slot0.GuideRefreshAutoStateByRecord = GameUtil.getEventId()
...
slot0.HaveNextWave = GameUtil.getEventId()
...
slot0.ASFD_OnChangeCardEnergy = GameUtil.getEventId()
...
slot0.RightElements_ShowElement = GameUtil.getEventId()
slot0.RightElements_HideElement = GameUtil.getEventId()
slot0.RightBottomElements_ShowElement = GameUtil.getEventId()
slot0.RightBottomElements_HideElement = GameUtil.getEventId()
slot0.BloodPool_OnCreate = GameUtil.getEventId()
slot0.BloodPool_MaxValueChange = GameUtil.getEventId()
slot0.BloodPool_ValueChange = GameUtil.getEventId()
slot0.BloodPool_OnPlayCard = GameUtil.getEventId()
slot0.BloodPool_OnCancelPlayCard = GameUtil.getEventId()
slot0.DoomsdayClock_OnValueChange = GameUtil.getEventId()
slot0.DoomsdayClock_OnAreaChange = GameUtil.getEventId()
slot0.DoomsdayClock_OnBroken = GameUtil.getEventId()
slot0.DoomsdayClock_OnClear = GameUtil.getEventId()
