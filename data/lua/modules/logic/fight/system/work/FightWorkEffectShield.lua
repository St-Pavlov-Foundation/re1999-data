...
function slot0._getOriginFloatType(slot0)
	if tabletool.indexOf(slot0.fightStepData.actEffect, slot0.actEffectData) then
		...
		if slot2 and slot2.targetId == slot0.actEffectData.targetId then
			...
			elseif slot2.effectType == FightEnum.EffectType.DAMAGE then
				return FightHelper.isRestrain(slot0.fightStepData.fromId, slot0.actEffectData.targetId) and FightEnum.FloatType.restrain or FightEnum.FloatType.damage
			elseif slot2.effectType == FightEnum.EffectType.CRIT then
				return FightHelper.isRestrain(slot0.fightStepData.fromId, slot0.actEffectData.targetId) and FightEnum.FloatType.crit_restrain or FightEnum.FloatType.crit_damage
