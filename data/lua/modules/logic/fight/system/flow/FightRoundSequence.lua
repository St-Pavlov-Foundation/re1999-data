...
function slot0.buildRoundFlows(slot0)
	...
	slot1, slot0._skillFlowList = FightStepBuilder.buildStepWorkList(slot0.roundData and slot0.roundData.fightStep)
	...
	if not FightModel.instance:isFinish() then
		...
		slot5, slot6 = FightStepBuilder.buildStepWorkList(slot0.roundData and slot0.roundData.nextRoundBeginStep)
