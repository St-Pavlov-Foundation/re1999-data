...
function var_0_0._refreshContentData(arg_22_0)
	...
	arg_22_0._simageicon:LoadImage(ResUrl.getTechniqueLangIcon(arg_22_0.cur_select_data.picture1, arg_22_0.cur_select_data.isCn == 1))
		...
		if var_22_1 then
			...
			if arg_22_0.cur_select_data.id == iter_22_1.id then
				for iter_22_2, iter_22_3 in ipairs(var_22_0) do
					...
					gohelper.findChildTextMesh(var_22_1, "txt_" .. iter_22_2).text = iter_22_3
				end
			end
		end
	end
