...
function var_0_0._refreshView(arg_8_0)
	...
	arg_8_0._simageicon:LoadImage(ResUrl.getTechniqueLangIcon(arg_8_0.config.picture2 or "", arg_8_0.config.isCn == 1))
		...
		if var_8_1 then
			...
			if arg_8_0.config.id == iter_8_1.id then
				for iter_8_2, iter_8_3 in ipairs(var_8_0) do
					...
					gohelper.findChildTextMesh(var_8_1, "txt_" .. iter_8_2).text = iter_8_3
				end
			end
		end
	end
