...
function var_0_0._onLongPress(arg_49_0)
	...
	if not arg_49_0._isDraging then
		arg_49_0._isLongPress = true

		FightController.instance:dispatchEvent(FightEvent.LongPressHandCard, arg_49_0.index)
	end
end

function var_0_0._onHover(arg_50_0)
	if GuideController.instance:isGuiding() then
		return
	end

	if not arg_50_0._isLongPress then
		arg_50_0:_onLongPress()
	end
end

function var_0_0._simulateDragHandCardBegin(arg_51_0, arg_51_1)
	if not arg_51_0.cardInfoMO then
		return
	end

	if arg_51_0.index ~= arg_51_1 then
		return
	end
...
function var_0_0._simulateDragHandCard(arg_52_0, arg_52_1, arg_52_2)
	...
	local var_52_0 = arg_52_0._subViewInst:getHandCardItem(arg_52_2)
...
function var_0_0._simulateDragHandCardEnd(arg_53_0, arg_53_1, arg_53_2)
...
function var_0_0.playCardAni(arg_55_0, arg_55_1, arg_55_2)
	arg_55_0._cardAniName = arg_55_2 or UIAnimationName.Open

	arg_55_0._loader:loadAsset(arg_55_1, arg_55_0._onCardAniLoaded, arg_55_0)
end

function var_0_0._onCardAniLoaded(arg_56_0, arg_56_1)
	arg_56_0._cardAni.runtimeAnimatorController = arg_56_1:GetResource()
	arg_56_0._cardAni.enabled = true
	arg_56_0._cardAni.speed = FightModel.instance:getUISpeed()

	gohelper.setActive(arg_56_0.go, true)
	SLFramework.AnimatorPlayer.Get(arg_56_0._innerGO):Play(arg_56_0._cardAniName, arg_56_0._onCardAniFinish, arg_56_0)
end

function var_0_0._onCardAniFinish(arg_57_0)
	arg_57_0._cardAni.enabled = false

	arg_57_0:_hideEffect()
end

function var_0_0.playAni(arg_58_0, arg_58_1, arg_58_2)
	arg_58_0._aniName = arg_58_2 or UIAnimationName.Open

	arg_58_0._loader:loadAsset(arg_58_1, arg_58_0._onAniLoaded, arg_58_0)
end

function var_0_0._onAniLoaded(arg_59_0, arg_59_1)
	arg_59_0._foranim.runtimeAnimatorController = arg_59_1:GetResource()
	arg_59_0._foranim.enabled = true
	arg_59_0._foranim.speed = FightModel.instance:getUISpeed()

	gohelper.setActive(arg_59_0.go, true)
	SLFramework.AnimatorPlayer.Get(arg_59_0._forAnimGO):Play(arg_59_0._aniName, arg_59_0._onAniFinish, arg_59_0)
end

function var_0_0._onAniFinish(arg_60_0)
	arg_60_0._foranim.enabled = false
end

function var_0_0._hideEffect(arg_61_0)
	gohelper.setActive(gohelper.findChild(arg_61_0._innerGO, "vx_balance"), false)
end

function var_0_0._onRefreshOneHandCard(arg_62_0, arg_62_1)
	if not arg_62_0.cardInfoMO then
		return
	end

	if arg_62_1 == arg_62_0.index then
		arg_62_0:updateItem(arg_62_0.index, arg_62_0.cardInfoMO)
	end
end

function var_0_0._onGMForceRefreshNameUIBuff(arg_63_0)
	arg_63_0:_onRefreshOneHandCard(arg_63_0.index)
end

function var_0_0.playDistribute(arg_64_0)
	if not arg_64_0._distributeFlow then
		arg_64_0._distributeFlow = FlowSequence.New()

		arg_64_0._distributeFlow:addWork(FigthCardDistributeEffect.New())
	else
		arg_64_0._distributeFlow:stop()
	end

	local var_64_0 = arg_64_0:getUserDataTb_()

	var_64_0.cards = tabletool.copy(FightDataHelper.handCardMgr.handCard)
	var_64_0.handCardItemList = arg_64_0._subViewInst._handCardItemList
	var_64_0.preCardCount = #var_64_0.cards - 1
	var_64_0.newCardCount = 1

	arg_64_0._distributeFlow:start(var_64_0)
end

function var_0_0.playMasterAddHandCard(arg_65_0)
	if not arg_65_0._masterAddHandCardFlow then
		arg_65_0._masterAddHandCardFlow = FlowSequence.New()

		arg_65_0._masterAddHandCardFlow:addWork(FigthMasterAddHandCardEffect.New())
	else
		arg_65_0._masterAddHandCardFlow:stop()
	end

	local var_65_0 = arg_65_0:getUserDataTb_()

	var_65_0.card = arg_65_0

	arg_65_0._masterAddHandCardFlow:start(var_65_0)
end

function var_0_0.playMasterCardRemove(arg_66_0)
	if not arg_66_0._masterCardRemoveFlow then
		arg_66_0._masterCardRemoveFlow = FlowSequence.New()

		arg_66_0._masterCardRemoveFlow:addWork(FigthMasterCardRemoveEffect.New())
	else
		arg_66_0._masterCardRemoveFlow:stop()
	end
	...
	arg_66_0._masterCardRemoveFlow:start(var_66_0)
end

function var_0_0.dissolveEntityCard(arg_67_0, arg_67_1)
	if not arg_67_0.cardInfoMO then
		return
	end

	if arg_67_0.cardInfoMO.uid ~= arg_67_1 then
		return
	end

	arg_67_0:dissolveCard()

	return true
end

function var_0_0.dissolveCard(arg_68_0)
	if not arg_68_0.go.activeInHierarchy then
		return
	end

	arg_68_0:setASFDActive(false)
	arg_68_0._cardItem:dissolveCard(transformhelper.getLocalScale(arg_68_0._subViewInst._handCardContainer.transform), arg_68_0.go)
end

function var_0_0.moveSelfPos(arg_69_0, arg_69_1, arg_69_2)
	arg_69_0:_releaseMoveFlow()

	arg_69_0._moveCardFlow = FlowParallel.New()

	local var_69_0 = 0.033 / FightModel.instance:getUISpeed()
	local var_69_1 = arg_69_0.go.transform
	local var_69_2 = FlowSequence.New()

	var_69_2:addWork(WorkWaitSeconds.New(3 * arg_69_2 * var_69_0))

	local var_69_3 = FightViewHandCard.calcCardPosX(arg_69_1)
	local var_69_4 = var_69_3 + 10

	var_69_2:addWork(TweenWork.New({
		type = "DOAnchorPosX",
		tr = var_69_1,
		to = var_69_4,
		t = var_69_0 * 5
	...
	arg_69_0._moveCardFlow:addWork(var_69_2)
	arg_69_0._moveCardFlow:start()
end

function var_0_0.playCardLevelChange(arg_70_0, arg_70_1)
	if not arg_70_0.cardInfoMO then
		return
	end
	...
	gohelper.setActive(arg_70_0._lockGO, false)
	arg_70_0._cardItem:playCardLevelChange(arg_70_0.cardInfoMO, arg_70_1)
end

function var_0_0._onCardLevelChangeDone(arg_71_0, arg_71_1)
	if arg_71_1 == arg_71_0.cardInfoMO then
		gohelper.setActive(arg_71_0._lockGO, true)
		arg_71_0:updateItem(arg_71_0.index, arg_71_0.cardInfoMO)
	end
end

function var_0_0.playCardAConvertCardB(arg_72_0)
	if not arg_72_0.cardInfoMO then
		return
	end

	gohelper.setActive(arg_72_0._cardConvertEffect, true)
	TaskDispatcher.cancelTask(arg_72_0._afterConvertCardEffect, arg_72_0)

	if arg_72_0._convertEffect then
		local var_72_0 = arg_72_0._convertEffect.transform
		local var_72_1 = var_72_0.childCount
		local var_72_2 = FightCardDataHelper.isBigSkill(arg_72_0.cardInfoMO.skillId)
		local var_72_3

		if var_72_2 then
			for iter_72_0 = 0, var_72_1 - 1 do
				local var_72_4 = var_72_0:GetChild(iter_72_0).gameObject

				if iter_72_0 == 3 then
					gohelper.setActive(var_72_4, true)

					var_72_3 = gohelper.onceAddComponent(var_72_4, typeof(UnityEngine.Animation))
				else
					gohelper.setActive(var_72_4, false)
				end
			end
		else
			local var_72_5 = FightCardDataHelper.getSkillLv(arg_72_0.cardInfoMO.uid, arg_72_0.cardInfoMO.skillId)

			for iter_72_1 = 0, var_72_1 - 1 do
				local var_72_6 = var_72_0:GetChild(iter_72_1).gameObject

				if iter_72_1 + 1 == var_72_5 then
					gohelper.setActive(var_72_6, true)

					var_72_3 = gohelper.onceAddComponent(var_72_6, typeof(UnityEngine.Animation))
				else
					gohelper.setActive(var_72_6, false)
				end
			end
		end

		if var_72_3 then
			var_72_3.this:get(var_72_3.clip.name).speed = FightModel.instance:getUISpeed()
		end

		TaskDispatcher.runDelay(arg_72_0._afterConvertCardEffect, arg_72_0, FightEnum.PerformanceTime.CardAConvertCardB / FightModel.instance:getUISpeed())
	else
		arg_72_0._loader:loadAsset("ui/viewres/fight/card_intensive.prefab", arg_72_0._onCardAConvertCardBLoaded, arg_72_0)
	end
end

function var_0_0._onCardAConvertCardBLoaded(arg_73_0, arg_73_1)
	local var_73_0 = arg_73_1:GetResource()

	arg_73_0._convertEffect = gohelper.clone(var_73_0, arg_73_0._cardConvertEffect)

	arg_73_0:playCardAConvertCardB()
...
function var_0_0._afterConvertCardEffect(arg_74_0)
	gohelper.setActive(arg_74_0._cardConvertEffect, false)
end

function var_0_0.changeToTempCard(arg_75_0)
	arg_75_0._cardItem:changeToTempCard()
end

function var_0_0.getASFDScreenPos(arg_76_0)
	return arg_76_0._cardItem:getASFDScreenPos()
end

function var_0_0.refreshPreDeleteImage(arg_77_0, arg_77_1)
	if arg_77_0._cardItem then
		arg_77_0._cardItem:_refreshPreDeleteImage(arg_77_1)
	end
end

function var_0_0.setActiveRed(arg_78_0, arg_78_1)
	if arg_78_0._cardItem then
		arg_78_0._cardItem:setActiveRed(arg_78_1)
	end
end

function var_0_0.setActiveBlue(arg_79_0, arg_79_1)
	if arg_79_0._cardItem then
		arg_79_0._cardItem:setActiveBlue(arg_79_1)
	end
end

function var_0_0.setActiveBoth(arg_80_0, arg_80_1)
	if arg_80_0._cardItem then
		arg_80_0._cardItem:setActiveBoth(arg_80_1)
	end
end

function var_0_0.resetRedAndBlue(arg_81_0)
	if arg_81_0._cardItem then
		arg_81_0._cardItem:resetRedAndBlue()
	end
end

function var_0_0._releaseMoveFlow(arg_82_0)
	if arg_82_0._moveCardFlow then
		arg_82_0._moveCardFlow:stop()

		arg_82_0._moveCardFlow = nil
	end
end

function var_0_0.releaseSelf(arg_83_0)
	TaskDispatcher.cancelTask(arg_83_0._afterConvertCardEffect, arg_83_0)

	if arg_83_0._distributeFlow then
		arg_83_0._distributeFlow:stop()

		arg_83_0._distributeFlow = nil
	end

	if arg_83_0._dissolveFlow then
		arg_83_0._dissolveFlow:stop()

		arg_83_0._dissolveFlow = nil
	end

	if arg_83_0._masterAddHandCardFlow then
		arg_83_0._masterAddHandCardFlow:stop()

		arg_83_0._masterAddHandCardFlow = nil
	end

	if arg_83_0._masterCardRemoveFlow then
		arg_83_0._masterCardRemoveFlow:stop()

		arg_83_0._masterCardRemoveFlow = nil
	end

	arg_83_0:_releaseMoveFlow()

	if arg_83_0._loader then
