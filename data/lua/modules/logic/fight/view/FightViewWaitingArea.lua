...
function slot0._makeTipsOutofSight(slot0)
	slot1 = slot0._skillTipsGO.transform

	recthelper.setAnchorX(slot1, 960 + recthelper.getWidth(slot1))
end
...
function slot0._updateView(slot0)
	...
	recthelper.setHeight(slot0._skillTipsGO.transform, GameUtil.getTextHeightByLine(slot0._txtCardDesc, FightConfig.instance:getEntitySkillDesc(slot1[slot2] and slot1[slot2].entityId, slot5, slot3), 38) + 83)

	slot0._txtCardTitle.text = slot5 and slot5.name or ""
	slot0._txtCardDesc.text = slot5 and HeroSkillModel.instance:skillDesToSpot(slot6) or ""
	...
	transformhelper.setLocalScale(slot0._skillTipsGO.transform, slot9, slot9, slot9)

	slot0._tweenScale = ZProj.TweenHelper.DOScale(slot0._waitingAreaTran, slot8, slot8, slot8, 0.1)
end
