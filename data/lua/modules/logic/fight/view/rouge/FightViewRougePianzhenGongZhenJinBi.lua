...
function slot0._hideObj(slot0)
	...
	gohelper.setActive(slot0._desTips, false)
	slot0.viewContainer.rightElementLayoutView:hideElement(FightRightElementEnum.Elements.Rouge)
end
...
function slot0._refreshPianZhenGongZhen(slot0)
	...
	if slot1 then
		slot0.viewContainer.rightElementLayoutView:showElement(FightRightElementEnum.Elements.Rouge)
...
function slot0._refreshCoin(slot0)
	if DungeonConfig.instance:getEpisodeCO(DungeonModel.instance.curSendEpisodeId) and slot1.type == DungeonEnum.EpisodeType.Rouge then
		slot0.viewContainer.rightElementLayoutView:showElement(FightRightElementEnum.Elements.Rouge)
	end

	gohelper.setActive(slot0._coinRoot, slot2)
