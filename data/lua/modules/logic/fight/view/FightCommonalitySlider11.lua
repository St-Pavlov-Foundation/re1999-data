-- chunkname: @modules/logic/fight/view/FightCommonalitySlider11.lua

module("modules.logic.fight.view.FightCommonalitySlider11", package.seeall)

local FightCommonalitySlider11 = class("FightCommonalitySlider11", FightBaseView)

function FightCommonalitySlider11:onInitView()
...
function FightCommonalitySlider11:onConstructor(progressData)
	self.progressData = progressData
end

function FightCommonalitySlider11:onOpen()
	self:_refreshData()
...
function FightCommonalitySlider11:_onTouchFightViewScreen()
	gohelper.setActive(self._tips, false)
end

function FightCommonalitySlider11:_onBtnClick()
	gohelper.setActive(self._tips, true)
end

function FightCommonalitySlider11:_refreshData()
...
function FightCommonalitySlider11:onClose()
	ZProj.TweenHelper.KillByObj(self._slider)
end

return FightCommonalitySlider11
