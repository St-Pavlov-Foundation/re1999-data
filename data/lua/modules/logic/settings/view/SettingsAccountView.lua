...
function var_0_0.onOpen(arg_10_0)
	...
	local var_10_0 = GameChannelConfig.isXfsdk() and not SettingsModel.isBilibili()

	gohelper.setActive(arg_10_0.goAccountContainer, arg_10_0.isShowUserCenter and var_10_0)

	local var_10_1 = SettingsModel.isBilibili()
	local var_10_2 = SDKMgr.instance:isShowUnregisterButton()

	logNormal(string.format("SettingsAccountView isShowUserCenter:%s,isBilibili:%s,isShowUnregisterButton:%s", tostring(arg_10_0.isShowUserCenter), tostring(var_10_1), tostring(var_10_2)))

	if var_10_2 and not BootNativeUtil.isIOS() then
		gohelper.setActive(arg_10_0.goAccountLogoutContainer, true)
	end
end
