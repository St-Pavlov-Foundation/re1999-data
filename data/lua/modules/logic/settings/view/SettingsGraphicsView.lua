...
function slot0.onInitView(slot0)
	...
	slot0._btnfullscreenswitch = gohelper.findChildButtonWithAudio(slot0.viewGO, "graphicsScroll/Viewport/Content/screen/fullscreen/#btn_fullscreenswitch")
	slot0._gofullscreenon = gohelper.findChild(slot0.viewGO, "graphicsScroll/Viewport/Content/screen/fullscreen/#btn_fullscreenswitch/#go_fullscreenon")
	slot0._gofullscreenoff = gohelper.findChild(slot0.viewGO, "graphicsScroll/Viewport/Content/screen/fullscreen/#btn_fullscreenswitch/#go_fullscreenoff")
...
function slot0._btnVerticalmodeClick(slot0)
	UnityEngine.QualitySettings.vSyncCount = UnityEngine.QualitySettings.vSyncCount == 1 and 0 or 1
