-- chunkname: @modules/logic/versionactivity3_9/racingcar/view/talent/V3a9RacingTalentRoleItem.lua

module("modules.logic.versionactivity3_9.racingcar.view.talent.V3a9RacingTalentRoleItem", package.seeall)

local V3a9RacingTalentRoleItem = class("V3a9RacingTalentRoleItem", V3a9RacingCarRoleItemBase)

function V3a9RacingTalentRoleItem:onInitView()
...
function V3a9RacingTalentRoleItem:onUpdateMO(mo)
...
return V3a9RacingTalentRoleItem
