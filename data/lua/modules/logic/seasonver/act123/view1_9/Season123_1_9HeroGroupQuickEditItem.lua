module("modules.logic.seasonver.act123.view1_9.Season123_1_9HeroGroupQuickEditItem", package.seeall)

local var_0_0 = class("Season123_1_9HeroGroupQuickEditItem", Season123_1_9HeroGroupEditItem)
