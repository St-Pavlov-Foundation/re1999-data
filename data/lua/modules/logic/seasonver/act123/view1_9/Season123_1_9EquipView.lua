...
slot0 = class("Season123_1_9EquipView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0._slotItems = {}
	slot0._descItems = {}
	slot0._skillContainer = MonoHelper.addNoUpdateLuaComOnceToGo(slot0._gobuffContainer, Season123_1_9ShowSkillEffectTip)
end
...
function slot0.getOrCreateSlotIcon(slot0, slot1)
	if not slot1.icon then
		slot1.icon = MonoHelper.addNoUpdateLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[2], slot1.goPos, "icon"), Season123_1_9CelebrityCardEquip)
	end
