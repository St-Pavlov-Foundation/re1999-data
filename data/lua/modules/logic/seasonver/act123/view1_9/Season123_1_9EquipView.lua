module("modules.logic.seasonver.act123.view1_9.Season123_1_9EquipView", package.seeall)

local var_0_0 = class("Season123_1_9EquipView", BaseView)
...
function var_0_0._editableInitView(arg_4_0)
	...
	arg_4_0._slotItems = {}
	arg_4_0._descItems = {}
	arg_4_0._skillContainer = MonoHelper.addNoUpdateLuaComOnceToGo(arg_4_0._gobuffContainer, Season123_1_9ShowSkillEffectTip)
end
...
function var_0_0.refreshSkills(arg_15_0, arg_15_1, arg_15_2, arg_15_3)
	...
	for iter_15_0, iter_15_1 in ipairs(var_15_0) do
		...
		var_15_2.txtDesc.text = arg_15_0._skillContainer:addLink(iter_15_1)
...
function var_0_0.getOrCreateSkillText(arg_17_0, arg_17_1, arg_17_2)
	...
	if not var_17_0 then
		...
		arg_17_0._skillContainer:addHyperLinkClick(var_17_0.txtDesc)
...
function var_0_0.getOrCreateSlotIcon(arg_19_0, arg_19_1)
	...
	if not var_19_0 then
		...
		var_19_0 = MonoHelper.addNoUpdateLuaComOnceToGo(var_19_2, Season123_1_9CelebrityCardEquip)
...
function var_0_0.onClickSlot(arg_21_0, arg_21_1)
	if Season123EquipItemListModel.instance.curSelectSlot ~= arg_21_1 then
		if not Season123EquipItemListModel.instance:slotIsLock(arg_21_1) then
			Season123EquipController.instance:setSlot(arg_21_1)
		else
...
function var_0_0.handleEquipCardChanged(arg_25_0, arg_25_1)
	local var_25_0 = Season123EquipItemListModel.instance.curSelectSlot
...
function var_0_0._btnequipOnClick(arg_27_0)
	arg_27_0._isManualSave = Season123EquipController.instance:checkCanSaveSlot()
...
function var_0_0._btnhandbookOnClick(arg_28_0)
	Season123Controller.instance:openSeasonEquipBookView(arg_28_0.viewParam.actId)
end
