-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9EquipView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9EquipView", package.seeall)

local Season123_1_9EquipView = class("Season123_1_9EquipView", BaseView)

function Season123_1_9EquipView:onInitView()
...
function Season123_1_9EquipView:addEvents()
...
function Season123_1_9EquipView:removeEvents()
	self._btnequip:RemoveClickListener()
	self._btnopenhandbook:RemoveClickListener()
end

function Season123_1_9EquipView:_editableInitView()
...
function Season123_1_9EquipView:onDestroyView()
...
function Season123_1_9EquipView:onOpen()
...
function Season123_1_9EquipView:onClose()
	return
end

function Season123_1_9EquipView:refreshUI()
...
function Season123_1_9EquipView:handleEquipUpdate()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_1_9EquipView:refreshSlots()
...
function Season123_1_9EquipView:refreshSlot(slotIndex)
...
Season123_1_9EquipView.MaxUISlot = 2

function Season123_1_9EquipView:refreshDescGroup()
	for slot = 1, Season123_1_9EquipView.MaxUISlot do
...
function Season123_1_9EquipView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_1_9EquipView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_1_9EquipView:refreshSkills(itemCfg, descItem, colorStr)
	...
	for index, skillStr in ipairs(skillList) do
		...
		item.txtDesc.text = self._skillContainer:addLink(skillStr)
		processedSet[item] = true
	end
...
function Season123_1_9EquipView:getOrCreatePropText(index, descItem)
...
function Season123_1_9EquipView:getOrCreateSkillText(index, descItem)
	...
	if not item then
		...
		self._skillContainer:addHyperLinkClick(item.txtDesc)
...
function Season123_1_9EquipView:getOrCreateSlot(slotIndex)
...
function Season123_1_9EquipView:getOrCreateSlotIcon(slotItem)
...
function Season123_1_9EquipView:getOrCreateDesc(index)
...
function Season123_1_9EquipView:onClickSlot(slotIndex)
	if Season123EquipItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_1_9EquipView:handleSaveSucc()
...
function Season123_1_9EquipView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_1_9EquipView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_1_9EquipView:handleEquipCardChanged(param)
...
function Season123_1_9EquipView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123_1_9EquipView:_btnequipOnClick()
...
function Season123_1_9EquipView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_1_9EquipView
