-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9PickHeroDetailView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9PickHeroDetailView", package.seeall)

local Season123_1_9PickHeroDetailView = class("Season123_1_9PickHeroDetailView", BaseView)

function Season123_1_9PickHeroDetailView:onInitView()
...
function Season123_1_9PickHeroDetailView:addEvents()
...
function Season123_1_9PickHeroDetailView:removeEvents()
...
function Season123_1_9PickHeroDetailView:_editableInitView()
	self._careerGOs = {}
...
function Season123_1_9PickHeroDetailView:onDestroyView()
...
function Season123_1_9PickHeroDetailView:onOpen()
...
function Season123_1_9PickHeroDetailView:onClose()
	return
end

function Season123_1_9PickHeroDetailView:initStatus()
	for i = 1, 6 do
...
function Season123_1_9PickHeroDetailView:refreshUI()
...
function Season123_1_9PickHeroDetailView:_refreshMainInfo()
	if self._heroMO then
...
function Season123_1_9PickHeroDetailView:_refreshAttribute()
	if self._heroMO then
...
function Season123_1_9PickHeroDetailView:_refreshPassiveSkill()
...
function Season123_1_9PickHeroDetailView:_refreshSkill()
	self._skillContainer:onUpdateMO(self._heroMO and self._heroMO.heroId, false, self._heroMO)
end

function Season123_1_9PickHeroDetailView:_refreshBtnIcon()
...
function Season123_1_9PickHeroDetailView:_btnattributeOnClick()
	if self._heroMO then
		local info = {}
...
function Season123_1_9PickHeroDetailView:_btncharacterOnClick()
	if self._heroMO then
...
function Season123_1_9PickHeroDetailView:_btnpassiveskillOnClick()
	if not self._heroMO then
		return
	end
...
function Season123_1_9PickHeroDetailView:_refreshFilterView()
	for i = 1, 2 do
...
function Season123_1_9PickHeroDetailView:refreshHeroListByFilter()
	local dmgs = {}
...
function Season123_1_9PickHeroDetailView:_onAttributeChanged(level, heroId)
	CharacterModel.instance:setFakeLevel(heroId, level)
end

function Season123_1_9PickHeroDetailView:_showCharacterRankUpView(func)
	func()
end

function Season123_1_9PickHeroDetailView:_attrBtnOnClick(i)
	self._selectAttrs[i] = not self._selectAttrs[i]

	self:_refreshFilterView()
end

function Season123_1_9PickHeroDetailView:_dmgBtnOnClick(i)
...
function Season123_1_9PickHeroDetailView:_locationBtnOnClick(i)
	self._selectLocations[i] = not self._selectLocations[i]

	self:_refreshFilterView()
end

function Season123_1_9PickHeroDetailView:_showRecommendCareer()
...
function Season123_1_9PickHeroDetailView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_1_9PickHeroDetailView:_btncloseFilterViewOnClick()
...
function Season123_1_9PickHeroDetailView:_btnclassifyOnClick()
	gohelper.setActive(self._gosearchfilter, true)
	self:_refreshFilterView()
end

function Season123_1_9PickHeroDetailView:_btnresetOnClick()
	for i = 1, 6 do
		self._selectAttrs[i] = false
	end
...
function Season123_1_9PickHeroDetailView:_btnokOnClick()
	gohelper.setActive(self._gosearchfilter, false)
