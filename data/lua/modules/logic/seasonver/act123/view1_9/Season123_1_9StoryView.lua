-- chunkname: @modules/logic/seasonver/act123/view1_9/Season123_1_9StoryView.lua

module("modules.logic.seasonver.act123.view1_9.Season123_1_9StoryView", package.seeall)

local Season123_1_9StoryView = class("Season123_1_9StoryView", BaseView)

function Season123_1_9StoryView:onInitView()
...
function Season123_1_9StoryView:addEvents()
...
function Season123_1_9StoryView:_btnRightOnClick()
...
function Season123_1_9StoryView:_editableInitView()
...
function Season123_1_9StoryView:onOpen()
...
function Season123_1_9StoryView:refreshUI()
...
function Season123_1_9StoryView:initCoverPageUI()
...
function Season123_1_9StoryView:refreshDetailPageUI()
...
function Season123_1_9StoryView:createCoverItem()
	...
	for storyId, storyConfig in pairs(allStoryConfig) do
		...
		if not coverItem then
			...
			coverItem.item = MonoHelper.addNoUpdateLuaComOnceToGo(coverItem.go, Season123_1_9StoryCoverItem, {
				actId = self.actId,
				storyId = storyId,
...
function Season123_1_9StoryView:refreshUnlockState()
...
function Season123_1_9StoryView:setStrToBool(unlockStateStr)
...
function Season123_1_9StoryView:onCoverItemClick(param)
	self.curPageIndex = param.storyId

	self:showSwitchPageAnim("todetail")
end

function Season123_1_9StoryView:showSwitchPageAnim(animName)
...
function Season123_1_9StoryView:refreshPage()
	UIBlockMgr.instance:endBlock("playSwitchPageAnim")
	self:refreshUI()
end

Season123_1_9StoryView.scrollDescHeight = 650
Season123_1_9StoryView.maxDescSpacing = 41
Season123_1_9StoryView.minDescSpacing = 35
Season123_1_9StoryView.minDescFontSize = 27

function Season123_1_9StoryView:fitScrollHeight()
	...
	recthelper.setHeight(self.transScrollDesc, Season123_1_9StoryView.scrollDescHeight - heightOffset)
	TaskDispatcher.cancelTask(self.setDescSpacing, self)
	TaskDispatcher.runDelay(self.setDescSpacing, self, 0.01)
end

function Season123_1_9StoryView:setDescSpacing()
	local spacing = Mathf.Lerp(Season123_1_9StoryView.maxDescSpacing, Season123_1_9StoryView.minDescSpacing, self._txtdesc.fontSize - Season123_1_9StoryView.minDescFontSize)

	self._txtdesc.lineSpacing = spacing
end

function Season123_1_9StoryView:onClose()
	self:saveUnlockState()
...
function Season123_1_9StoryView:onDestroyView()
	self._simageCover:UnLoadImage()
	self._simagePolaroid:UnLoadImage()
end

return Season123_1_9StoryView
