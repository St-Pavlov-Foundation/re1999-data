...
local var_0_0 = class("Season123_1_9StoryView", BaseView)
...
function var_0_0.initCoverPageUI(arg_9_0)
	...
	arg_9_0._txttitleDesc.text = Season123Config.instance:getSeasonConstStr(arg_9_0.actId, Activity123Enum.Const.StoryCoverDesc)
	arg_9_0._txtcoverTitle.text = Season123Config.instance:getSeasonConstStr(arg_9_0.actId, Activity123Enum.Const.StoryCoverTitle)
end
...
function var_0_0.createCoverItem(arg_11_0)
	...
	for iter_11_0, iter_11_1 in pairs(var_11_0) do
		...
		if not var_11_1 then
			...
			var_11_1.item = MonoHelper.addNoUpdateLuaComOnceToGo(var_11_1.go, Season123_1_9StoryCoverItem, {
...
function var_0_0.setDescSpacing(arg_20_0)
	local var_20_0 = Mathf.Lerp(var_0_0.maxDescSpacing, var_0_0.minDescSpacing, arg_20_0._txtdesc.fontSize - var_0_0.minDescFontSize)

	arg_20_0._txtdesc.lineSpacing = var_20_0
end
