...
slot0 = class("Season123_2_1FightRuleView", BaseView)
...
function slot0.getRuleList()
	...
	if Season123Model.instance:getBattleContext() then
		if slot4.stage then
			slot3 = Season123Config.instance:filterRule(Season123HeroGroupModel.filterRule(slot4.actId, GameUtil.splitString2(slot1.additionRule, true, "|", "#")), slot4.stage)
		end
	end
