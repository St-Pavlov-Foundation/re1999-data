-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1FightRuleView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1FightRuleView", package.seeall)

local Season123_2_1FightRuleView = class("Season123_2_1FightRuleView", BaseView)

function Season123_2_1FightRuleView:onInitView()
...
function Season123_2_1FightRuleView:addEvents()
	return
end

function Season123_2_1FightRuleView:removeEvents()
	return
end

function Season123_2_1FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season123_2_1FightRuleView:onOpen()
	self:refreshRule()
end

function Season123_2_1FightRuleView:refreshRule()
	local dataList = Season123_2_1FightRuleView.getRuleList() or {}
...
function Season123_2_1FightRuleView:createItem(index)
	local item = {}
...
function Season123_2_1FightRuleView:updateItem(item, data)
...
function Season123_2_1FightRuleView:destroyItem(item)
	return
end

function Season123_2_1FightRuleView.getRuleList()
...
function Season123_2_1FightRuleView:setDecorateVisible(isVisible)
...
function Season123_2_1FightRuleView:onClose()
	return
end

function Season123_2_1FightRuleView:onDestroyView()
...
return Season123_2_1FightRuleView
