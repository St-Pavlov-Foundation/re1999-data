-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1PickHeroDetailView.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1PickHeroDetailView", package.seeall)

local Season123_2_1PickHeroDetailView = class("Season123_2_1PickHeroDetailView", BaseView)

function Season123_2_1PickHeroDetailView:onInitView()
...
function Season123_2_1PickHeroDetailView:addEvents()
...
function Season123_2_1PickHeroDetailView:removeEvents()
...
function Season123_2_1PickHeroDetailView:_editableInitView()
	self._careerGOs = {}
...
function Season123_2_1PickHeroDetailView:onDestroyView()
...
function Season123_2_1PickHeroDetailView:onOpen()
...
function Season123_2_1PickHeroDetailView:onClose()
	return
end

function Season123_2_1PickHeroDetailView:initStatus()
	for i = 1, 6 do
...
function Season123_2_1PickHeroDetailView:refreshUI()
...
function Season123_2_1PickHeroDetailView:_refreshMainInfo()
	if self._heroMO then
...
function Season123_2_1PickHeroDetailView:_refreshAttribute()
	if self._heroMO then
...
function Season123_2_1PickHeroDetailView:_refreshPassiveSkill()
...
function Season123_2_1PickHeroDetailView:_refreshSkill()
	self._skillContainer:onUpdateMO(self._heroMO and self._heroMO.heroId, false, self._heroMO)
end

function Season123_2_1PickHeroDetailView:_refreshBtnIcon()
...
function Season123_2_1PickHeroDetailView:_btnattributeOnClick()
	if self._heroMO then
		local info = {}
...
function Season123_2_1PickHeroDetailView:_btncharacterOnClick()
	if self._heroMO then
...
function Season123_2_1PickHeroDetailView:_btnpassiveskillOnClick()
	if not self._heroMO then
		return
	end
...
function Season123_2_1PickHeroDetailView:_refreshFilterView()
	for i = 1, 2 do
...
function Season123_2_1PickHeroDetailView:refreshHeroListByFilter()
	local dmgs = {}
...
function Season123_2_1PickHeroDetailView:_onAttributeChanged(level, heroId)
	CharacterModel.instance:setFakeLevel(heroId, level)
end

function Season123_2_1PickHeroDetailView:_showCharacterRankUpView(func)
	func()
end

function Season123_2_1PickHeroDetailView:_attrBtnOnClick(i)
	self._selectAttrs[i] = not self._selectAttrs[i]

	self:_refreshFilterView()
end

function Season123_2_1PickHeroDetailView:_dmgBtnOnClick(i)
...
function Season123_2_1PickHeroDetailView:_locationBtnOnClick(i)
	self._selectLocations[i] = not self._selectLocations[i]

	self:_refreshFilterView()
end

function Season123_2_1PickHeroDetailView:_showRecommendCareer()
...
function Season123_2_1PickHeroDetailView:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_2_1PickHeroDetailView:_btncloseFilterViewOnClick()
...
function Season123_2_1PickHeroDetailView:_btnclassifyOnClick()
	gohelper.setActive(self._gosearchfilter, true)
	self:_refreshFilterView()
end

function Season123_2_1PickHeroDetailView:_btnresetOnClick()
	for i = 1, 6 do
		self._selectAttrs[i] = false
	end
...
function Season123_2_1PickHeroDetailView:_btnokOnClick()
	gohelper.setActive(self._gosearchfilter, false)
