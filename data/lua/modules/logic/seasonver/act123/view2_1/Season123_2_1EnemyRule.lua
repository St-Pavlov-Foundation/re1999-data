-- chunkname: @modules/logic/seasonver/act123/view2_1/Season123_2_1EnemyRule.lua

module("modules.logic.seasonver.act123.view2_1.Season123_2_1EnemyRule", package.seeall)

local Season123_2_1EnemyRule = class("Season123_2_1EnemyRule", BaseView)

function Season123_2_1EnemyRule:onInitView()
...
function Season123_2_1EnemyRule:addEvents()
...
function Season123_2_1EnemyRule:removeEvents()
	self._btnadditionRuleclick:RemoveClickListener()
	self._btncloserule:RemoveClickListener()
end

function Season123_2_1EnemyRule:_btncloseruleOnClick()
...
function Season123_2_1EnemyRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season123_2_1EnemyRule:_editableInitView()
...
function Season123_2_1EnemyRule:_addRuleItem(ruleCo, targetId)
...
function Season123_2_1EnemyRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123_2_1EnemyRule:_clear()
...
function Season123_2_1EnemyRule:onDestroyView()
	self:_clear()
end

return Season123_2_1EnemyRule
