-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5TaskItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5TaskItem", package.seeall)

local Season123_3_5TaskItem = class("Season123_3_5TaskItem", ListScrollCell)

Season123_3_5TaskItem.BlockKey = "Season123_3_5TaskItemAni"

function Season123_3_5TaskItem:init(go)
	self._viewGO = go
...
function Season123_3_5TaskItem:addEventListeners()
...
function Season123_3_5TaskItem:initTotal()
	self._btnGetTotal = gohelper.findChildButtonWithAudio(self._goTotal, "#btn_getall")
end

Season123_3_5TaskItem.TaskMaskTime = 0.65
Season123_3_5TaskItem.ColumnCount = 1
Season123_3_5TaskItem.AnimRowCount = 7
Season123_3_5TaskItem.OpenAnimTime = 0.06
Season123_3_5TaskItem.OpenAnimStartTime = 0

function Season123_3_5TaskItem:onUpdateMO(mo)
	if mo == nil then
		return
	end
...
function Season123_3_5TaskItem:endPlayOpenAnim()
...
function Season123_3_5TaskItem:checkPlayAnim()
...
function Season123_3_5TaskItem:onDelayPlayOpen()
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
	self._animator:Play("open", 0, 0)
...
function Season123_3_5TaskItem:refreshNormal()
...
function Season123_3_5TaskItem:refreshReward()
...
function Season123_3_5TaskItem:createRewardItem(index)
...
function Season123_3_5TaskItem:refreshRewardItem(item, data)
	if not data then
	...
	if data.equipId then
		...
		if not item.equipIcon then
			item.equipIcon = Season123_3_5CelebrityCardItem.New()
...
function Season123_3_5TaskItem:getAnimator()
	return self._ani
end

function Season123_3_5TaskItem:destroyRewardItem(item)
...
function Season123_3_5TaskItem:refreshDesc()
	local config = self.mo.config
...
function Season123_3_5TaskItem:refreshProgress()
...
function Season123_3_5TaskItem:refreshState()
...
function Season123_3_5TaskItem:onClickGoto()
...
function Season123_3_5TaskItem:onClickReceive()
	...
	UIBlockMgr.instance:startBlock(Season123_3_5TaskItem.BlockKey)
	Season123Controller.instance:dispatchEvent(Season123Event.OnTaskRewardGetFinish, self._index)
	TaskDispatcher.runDelay(self._onPlayActAniFinished, self, Season123_3_5TaskItem.TaskMaskTime)
end

function Season123_3_5TaskItem:_onPlayActAniFinished()
	...
	UIBlockMgr.instance:endBlock(Season123_3_5TaskItem.BlockKey)
end

function Season123_3_5TaskItem:onClickGetTotal()
	self:onClickReceive()
end

function Season123_3_5TaskItem:onDestroy()
	TaskDispatcher.cancelTask(self._onPlayActAniFinished, self)
	TaskDispatcher.cancelTask(self.onDelayPlayOpen, self)
