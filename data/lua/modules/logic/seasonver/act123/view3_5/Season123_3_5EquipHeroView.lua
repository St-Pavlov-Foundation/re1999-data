-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5EquipHeroView.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5EquipHeroView", package.seeall)

local Season123_3_5EquipHeroView = class("Season123_3_5EquipHeroView", BaseView)

function Season123_3_5EquipHeroView:onInitView()
...
function Season123_3_5EquipHeroView:addEvents()
...
function Season123_3_5EquipHeroView:onDestroyView()
...
function Season123_3_5EquipHeroView:onOpen()
...
function Season123_3_5EquipHeroView:onClose()
	return
end

function Season123_3_5EquipHeroView:refreshUI()
...
function Season123_3_5EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end

function Season123_3_5EquipHeroView:refreshSlots()
	for slotIndex = 1, Activity123Enum.MainCardNum do
		self:refreshSlot(slotIndex)
	end
end

function Season123_3_5EquipHeroView:refreshSlot(slotIndex)
...
Season123_3_5EquipHeroView.MaxUISlot = 2

function Season123_3_5EquipHeroView:refreshDescGroup()
	for slot = 1, Season123_3_5EquipHeroView.MaxUISlot do
		local curShowItemUid = Season123EquipHeroItemListModel.instance.curEquipMap[slot]
		local descItem = self:getOrCreateDesc(slot)

		if curShowItemUid then
			self:refreshDesc(descItem, curShowItemUid, slot)
		end
	end
end

function Season123_3_5EquipHeroView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_3_5EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_3_5EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123_3_5EquipHeroView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_3_5EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season123_3_5EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season123_3_5EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season123_3_5EquipHeroView:getOrCreateSlotIcon(slotItem)
...
function Season123_3_5EquipHeroView:getOrCreateDesc(index)
...
function Season123_3_5EquipHeroView:onClickSlot(slotIndex)
	if Season123EquipHeroItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_3_5EquipHeroView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_3_5EquipHeroView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_3_5EquipHeroView:handleEquipCardChanged(param)
...
function Season123_3_5EquipHeroView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end
...
function Season123_3_5EquipHeroView:_btnequipOnClick()
...
function Season123_3_5EquipHeroView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_3_5EquipHeroView
