-- chunkname: @modules/logic/seasonver/act123/view3_5/Season123_3_5FightCardItem.lua

module("modules.logic.seasonver.act123.view3_5.Season123_3_5FightCardItem", package.seeall)

local Season123_3_5FightCardItem = class("Season123_3_5FightCardItem", UserDataDispose)

function Season123_3_5FightCardItem:ctor(go)
	self:__onInit()
...
Season123_3_5FightCardItem.MainRoleItemMinHeight = 390
Season123_3_5FightCardItem.NormalRoleItemMinHeight = 315
Season123_3_5FightCardItem.RoleCardPos = {
	Vector2(-16.5, 0.5),
	Vector2(-16.5, 0.5),
	Vector2(-16.5, -6.5),
	Vector2(-16.5, -17),
...
function Season123_3_5FightCardItem:setData(data)
	if not data then
	...
	self.layoutElement.minHeight = self.isMainRole and Season123_3_5FightCardItem.MainRoleItemMinHeight or Season123_3_5FightCardItem.NormalRoleItemMinHeight
...
function Season123_3_5FightCardItem:_setName()
...
function Season123_3_5FightCardItem:_setHead()
...
function Season123_3_5FightCardItem:getHeroMO()
...
function Season123_3_5FightCardItem:_setCard(equipId)
	...
	local targetCardPos = Season123_3_5FightCardItem.RoleCardPos[tonumber(rare)] or Vector2(0, 0)

	recthelper.setAnchor(self.goCardPos.transform, targetCardPos.x, targetCardPos.y)
end

function Season123_3_5FightCardItem:_setDesc(equipId)
...
function Season123_3_5FightCardItem:createDescItem(index)
	local item = {}
...
function Season123_3_5FightCardItem:updateDescItem(item, skillStr)
...
function Season123_3_5FightCardItem:destroy()
...
return Season123_3_5FightCardItem
