-- chunkname: @modules/logic/seasonver/act123/view2_3/Season123_2_3BatchDecomposeView.lua

module("modules.logic.seasonver.act123.view2_3.Season123_2_3BatchDecomposeView", package.seeall)

local Season123_2_3BatchDecomposeView = class("Season123_2_3BatchDecomposeView", BaseView)

function Season123_2_3BatchDecomposeView:onInitView()
...
function Season123_2_3BatchDecomposeView:addEvents()
...
function Season123_2_3BatchDecomposeView:removeEvents()
...
Season123_2_3BatchDecomposeView.maxOverCount = 4

function Season123_2_3BatchDecomposeView:_btnrarerankOnClick()
...
function Season123_2_3BatchDecomposeView:_btnfilterOnClick()
	ViewMgr.instance:openView(ViewName.Season123_2_3DecomposeFilterView)
end

function Season123_2_3BatchDecomposeView:_btnfastaddOnClick()
...
function Season123_2_3BatchDecomposeView:_btnclearOnClick()
	Season123EquipBookController.instance:clearItemSelectState()
	self:resetDataUI()
end

function Season123_2_3BatchDecomposeView:_btndecomposeOnClick()
...
function Season123_2_3BatchDecomposeView:showDecomposeTip()
...
function Season123_2_3BatchDecomposeView:decomposeYesCallBack()
...
function Season123_2_3BatchDecomposeView:sendDecomposeRequest()
...
function Season123_2_3BatchDecomposeView:_dropFilterOnClick()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_2_3BatchDecomposeView:_editableInitView()
...
function Season123_2_3BatchDecomposeView:onOpen()
...
function Season123_2_3BatchDecomposeView:initDropFilter()
	...
	for i = 1, Season123_2_3BatchDecomposeView.maxOverCount do
...
function Season123_2_3BatchDecomposeView:refreshUI()
	local coinConfig = CurrencyConfig.instance:getCurrencyCo(self.coinId)
...
function Season123_2_3BatchDecomposeView:initCoinItem()
...
function Season123_2_3BatchDecomposeView:onDecomposeItemClick()
	self._countAnim:Play("vx_count", 0, 0)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_checkpoint_light_up)
	self:refreshUI()
end

function Season123_2_3BatchDecomposeView:resetDataUI()
...
function Season123_2_3BatchDecomposeView:getDecomposeCoin()
...
function Season123_2_3BatchDecomposeView:dropFilterValueChanged(index)
	Season123DecomposeModel.instance:setCurOverPartSelectIndex(index)
end

function Season123_2_3BatchDecomposeView:onDropListShow()
	transformhelper.setLocalScale(self._arrowTrans, 1, -1, 1)
end

function Season123_2_3BatchDecomposeView:onDropListHide()
	transformhelper.setLocalScale(self._arrowTrans, 1, 1, 1)
end

function Season123_2_3BatchDecomposeView:onClose()
	Season123DecomposeModel.instance._itemStartAnimTime = nil
end

function Season123_2_3BatchDecomposeView:onDestroyView()
...
return Season123_2_3BatchDecomposeView
