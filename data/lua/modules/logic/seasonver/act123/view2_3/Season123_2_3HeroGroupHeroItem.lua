module("modules.logic.seasonver.act123.view2_3.Season123_2_3HeroGroupHeroItem", package.seeall)

slot0 = class("Season123_2_3HeroGroupHeroItem", LuaCompBase)
...
function slot0.init(slot0, slot1)
	...
	slot0._cardItem1 = Season123_2_3HeroGroupCardItem.New(slot0._gocarditem1, slot0, {
		slot = 1
	})
