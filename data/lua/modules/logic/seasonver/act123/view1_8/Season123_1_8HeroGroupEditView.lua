-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8HeroGroupEditView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8HeroGroupEditView", package.seeall)

local Season123_1_8HeroGroupEditView = class("Season123_1_8HeroGroupEditView", BaseView)

function Season123_1_8HeroGroupEditView:onInitView()
...
function Season123_1_8HeroGroupEditView:addEvents()
...
function Season123_1_8HeroGroupEditView:removeEvents()
...
function Season123_1_8HeroGroupEditView:_btncloseFilterViewOnClick()
...
function Season123_1_8HeroGroupEditView:_btnclassifyOnClick()
	gohelper.setActive(self._gosearchfilter, true)
	self:_refreshFilterView()
end

function Season123_1_8HeroGroupEditView:_btnresetOnClick()
	for i = 1, 6 do
...
function Season123_1_8HeroGroupEditView:_btnokOnClick()
	gohelper.setActive(self._gosearchfilter, false)
...
function Season123_1_8HeroGroupEditView:_btnpassiveskillOnClick()
...
function Season123_1_8HeroGroupEditView:_btnconfirmOnClick()
...
function Season123_1_8HeroGroupEditView:_btncancelOnClick()
	self:closeThis()
end

function Season123_1_8HeroGroupEditView:_btncharacterOnClick()
	if self._heroMO then
		local heroMoList = {}
...
function Season123_1_8HeroGroupEditView:_btnattributeOnClick()
	if self._heroMO then
...
function Season123_1_8HeroGroupEditView:_btnexskillrankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_1_8HeroGroupEditView:_btnlvrankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_1_8HeroGroupEditView:_btnrarerankOnClick()
	local x, y = transformhelper.getLocalPos(self._goScrollContent.transform)
...
function Season123_1_8HeroGroupEditView:_btnquickeditOnClick()
...
function Season123_1_8HeroGroupEditView:_attrBtnOnClick(i)
	self._selectAttrs[i] = not self._selectAttrs[i]

	self:_refreshFilterView()
end

function Season123_1_8HeroGroupEditView:_dmgBtnOnClick(i)
...
function Season123_1_8HeroGroupEditView:_locationBtnOnClick(i)
	self._selectLocations[i] = not self._selectLocations[i]

	self:_refreshFilterView()
end

function Season123_1_8HeroGroupEditView:_onHeroItemClick(heroMO)
	self._heroMO = heroMO

	self:_refreshCharacterInfo()
end

function Season123_1_8HeroGroupEditView:_refreshCharacterInfo()
	if self._heroMO then
...
function Season123_1_8HeroGroupEditView:_refreshMainInfo()
	if self._heroMO then
...
function Season123_1_8HeroGroupEditView:_refreshAttribute()
	if self._heroMO then
...
function Season123_1_8HeroGroupEditView:_refreshPassiveSkill()
	if not self._heroMO then
		return
	end
...
function Season123_1_8HeroGroupEditView:_refreshSkill()
	self._skillContainer:onUpdateMO(self._heroMO and self._heroMO.heroId, false, self._heroMO)
end

function Season123_1_8HeroGroupEditView:_refreshBtnIcon()
...
function Season123_1_8HeroGroupEditView:_refreshFilterView()
	for i = 1, 2 do
...
function Season123_1_8HeroGroupEditView:_updateHeroList()
	local dmgs = {}
...
function Season123_1_8HeroGroupEditView:replaceSelectHeroDefaultEquip()
...
function Season123_1_8HeroGroupEditView:_saveCurGroupInfo()
...
function Season123_1_8HeroGroupEditView:_saveQuickGroupInfo()
...
function Season123_1_8HeroGroupEditView:_onAttributeChanged(level, heroId)
	CharacterModel.instance:setFakeLevel(heroId, level)
end

function Season123_1_8HeroGroupEditView:_normalEditHasChange()
	return true
end

function Season123_1_8HeroGroupEditView:_refreshEditMode()
...
function Season123_1_8HeroGroupEditView:_refreshCurScrollBySort()
	if self._isShowQuickEdit then
		if Season123HeroGroupQuickEditModel.instance:getIsDirty() then
			self:_saveQuickGroupInfo()
		end
...
function Season123_1_8HeroGroupEditView:_onGroupModify()
	if self._isShowQuickEdit then
		Season123HeroGroupQuickEditModel.instance:copyQuickEditCardList()
	else
...
function Season123_1_8HeroGroupEditView:_editableInitView()
...
function Season123_1_8HeroGroupEditView:onOpen()
...
function Season123_1_8HeroGroupEditView:onClose()
...
function Season123_1_8HeroGroupEditView:_onOpenView(viewName)
...
function Season123_1_8HeroGroupEditView:_onCloseView(viewName)
...
function Season123_1_8HeroGroupEditView:_delyStopBgm()
	self._isStopBgm = false

	AudioMgr.instance:trigger(AudioEnum.Bgm.Pause_FightingMusic)
end

function Season123_1_8HeroGroupEditView:_showCharacterRankUpView(func)
	func()
end

function Season123_1_8HeroGroupEditView:onDestroyView()
...
return Season123_1_8HeroGroupEditView
