...
slot0 = class("Season123_1_8BatchDecomposeView", BaseView)
...
function slot0.showDecomposeTip(slot0)
	...
	GameFacade.showMessageBox(MessageBoxIdDefine.Season123DecomposeTip, MsgBoxEnum.BoxType.Yes_No, slot0.decomposeYesCallBack, nil, , slot0, nil, , string.format("<color=#AB5220>%s</color>", slot2), string.format("<color=#AB5220>%s%s</color>", slot4, slot3.name))
end
