-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8BatchDecomposeView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8BatchDecomposeView", package.seeall)

local Season123_1_8BatchDecomposeView = class("Season123_1_8BatchDecomposeView", BaseView)

function Season123_1_8BatchDecomposeView:onInitView()
...
function Season123_1_8BatchDecomposeView:addEvents()
...
function Season123_1_8BatchDecomposeView:removeEvents()
...
Season123_1_8BatchDecomposeView.maxOverCount = 4

function Season123_1_8BatchDecomposeView:_btnrarerankOnClick()
...
function Season123_1_8BatchDecomposeView:_btnfilterOnClick()
	ViewMgr.instance:openView(ViewName.Season123_1_8DecomposeFilterView)
end

function Season123_1_8BatchDecomposeView:_btnfastaddOnClick()
...
function Season123_1_8BatchDecomposeView:_btnclearOnClick()
	Season123EquipBookController.instance:clearItemSelectState()
	self:resetDataUI()
end

function Season123_1_8BatchDecomposeView:_btndecomposeOnClick()
...
function Season123_1_8BatchDecomposeView:showDecomposeTip()
...
function Season123_1_8BatchDecomposeView:decomposeYesCallBack()
...
function Season123_1_8BatchDecomposeView:sendDecomposeRequest()
...
function Season123_1_8BatchDecomposeView:_dropFilterOnClick()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Common_Click)
end

function Season123_1_8BatchDecomposeView:_editableInitView()
...
function Season123_1_8BatchDecomposeView:onOpen()
...
function Season123_1_8BatchDecomposeView:initDropFilter()
	...
	for i = 1, Season123_1_8BatchDecomposeView.maxOverCount do
...
function Season123_1_8BatchDecomposeView:refreshUI()
	local coinConfig = CurrencyConfig.instance:getCurrencyCo(self.coinId)
...
function Season123_1_8BatchDecomposeView:initCoinItem()
...
function Season123_1_8BatchDecomposeView:onDecomposeItemClick()
	self._countAnim:Play("vx_count", 0, 0)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_checkpoint_light_up)
	self:refreshUI()
end

function Season123_1_8BatchDecomposeView:resetDataUI()
...
function Season123_1_8BatchDecomposeView:getDecomposeCoin()
...
function Season123_1_8BatchDecomposeView:dropFilterValueChanged(index)
	Season123DecomposeModel.instance:setCurOverPartSelectIndex(index)
end

function Season123_1_8BatchDecomposeView:onDropListShow()
	transformhelper.setLocalScale(self._arrowTrans, 1, -1, 1)
end

function Season123_1_8BatchDecomposeView:onDropListHide()
	transformhelper.setLocalScale(self._arrowTrans, 1, 1, 1)
end

function Season123_1_8BatchDecomposeView:onClose()
	Season123DecomposeModel.instance._itemStartAnimTime = nil
end

function Season123_1_8BatchDecomposeView:onDestroyView()
...
return Season123_1_8BatchDecomposeView
