module("modules.logic.seasonver.act123.view1_8.Season123_1_8EquipBookView", package.seeall)

local var_0_0 = class("Season123_1_8EquipBookView", BaseView)
...
function var_0_0._btndecomposeOnClick(arg_6_0)
	...
	ViewMgr.instance:openView(ViewName.Season123_1_8DecomposeView, var_6_0)
end
...
function var_0_0.cardDescItemShow(arg_16_0, arg_16_1, arg_16_2, arg_16_3)
	...
	var_16_0.text = arg_16_2

	var_16_1:refreshTmpContent(var_16_0)
	SLFramework.UGUI.GuiHelper.SetColor(var_16_0, arg_16_0.colorStr)
end

function var_0_0.refreshIcon(arg_17_0)
	if not arg_17_0._icon then
		local var_17_0 = arg_17_0._gocarditem

		arg_17_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_17_0, Season123_1_8CelebrityCardEquip)
	end

	if arg_17_0.itemId then
		arg_17_0._icon:updateData(arg_17_0.itemId)
	end
end

function var_0_0.refreshBtn(arg_18_0)
	local var_18_0 = arg_18_0:getItemCount()

	ZProj.UGUIHelper.SetGrayscale(arg_18_0._btnbatchDecompose.gameObject, var_18_0 == 0)

	local var_18_1

	if arg_18_0.itemId then
		local var_18_2 = Season123Config.instance:getSeasonEquipCo(arg_18_0.itemId)
		local var_18_3 = CurrencyConfig.instance:getCurrencyCo(arg_18_0.coinId)

		arg_18_0._txtdecomposeNum.text = string.format("+%s", var_18_2.decomposeGet)
		arg_18_0._txtcomposeNum.text = string.format("-%s", var_18_2.composeCost)

		UISpriteSetMgr.instance:setCurrencyItemSprite(arg_18_0._imagecomposeCoin, var_18_3.icon .. "_1")
		UISpriteSetMgr.instance:setCurrencyItemSprite(arg_18_0._imagedecomposeCoin, var_18_3.icon .. "_1")
	end

	gohelper.setActive(arg_18_0._txtdecomposeNum.gameObject, arg_18_0.itemId)
	gohelper.setActive(arg_18_0._txtcomposeNum.gameObject, arg_18_0.itemId)
	gohelper.setActive(arg_18_0._imagecomposeCoin.gameObject, arg_18_0.itemId)
	gohelper.setActive(arg_18_0._imagedecomposeCoin.gameObject, arg_18_0.itemId)

	local var_18_4 = arg_18_0.itemId and Season123EquipBookModel.instance:getEquipBookItemCount(arg_18_0.itemId) or 0

	SLFramework.UGUI.GuiHelper.SetColor(arg_18_0._txtcomposeNum, arg_18_0:canCompose() and "#070706" or "#800015")
	gohelper.setActive(arg_18_0._gonormaldecomposebg, var_18_4 > 0)
	gohelper.setActive(arg_18_0._golockdecomposebg, var_18_4 == 0)
	gohelper.setActive(arg_18_0._gonormalcomposebg, not arg_18_0:isMainCardOverCount())
	gohelper.setActive(arg_18_0._golockcomposebg, arg_18_0:isMainCardOverCount())
end

function var_0_0.isMainCardOverCount(arg_19_0)
	if arg_19_0.itemId then
		local var_19_0 = Season123EquipBookModel.instance:getEquipBookItemCount(arg_19_0.itemId)

		if Season123Config.instance:getSeasonEquipCo(arg_19_0.itemId).isMain == 1 and var_19_0 >= 1 then
			return true
		end
	end
...
function var_0_0.canCompose(arg_20_0)
	if not arg_20_0.itemId then
		return false
	end

	local var_20_0 = Season123Config.instance:getSeasonEquipCo(arg_20_0.itemId)
	local var_20_1 = CurrencyModel.instance:getCurrency(arg_20_0.coinId)
	local var_20_2 = var_20_1 and var_20_1.quantity or 0

	return var_20_0 and var_20_2 >= var_20_0.composeCost
end

function var_0_0.getItemCount(arg_21_0)
	local var_21_0 = Season123Model.instance:getAllItemMo(arg_21_0.actId)

	return GameUtil.getTabLen(var_21_0)
end

function var_0_0.onChangeSelectCard(arg_22_0)
	arg_22_0._animatorCard:Play("switch", 0, 0)
	arg_22_0:hideEffect()
end

function var_0_0.doDecompose(arg_23_0, arg_23_1)
	arg_23_0.decomposeList = arg_23_1

	gohelper.setActive(arg_23_0._btnskipEffect.gameObject, true)
	arg_23_0:showDecomposeEffect()

	arg_23_0.isDecompose = true

	TaskDispatcher.runDelay(arg_23_0.sendDecomposeEquipRequest, arg_23_0, 1.5)
end

function var_0_0.sendDecomposeEquipRequest(arg_24_0)
	Activity123Rpc.instance:sendDecomposeAct123EquipRequest(arg_24_0.actId, arg_24_0.decomposeList)

	arg_24_0.isDecompose = false

	gohelper.setActive(arg_24_0._btnskipEffect.gameObject, false)
end

function var_0_0.showDecomposeEffect(arg_25_0)
	gohelper.setActive(arg_25_0._godecomposeEffect, false)
	gohelper.setActive(arg_25_0._godecomposeEffect, true)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_qiutu_list_maintain)
end

function var_0_0.showComposeEffect(arg_26_0)
	gohelper.setActive(arg_26_0._gocomposeEffect, false)
	gohelper.setActive(arg_26_0._gocomposeEffect, true)
	AudioMgr.instance:trigger(AudioEnum.Season123.play_ui_leimi_celebrity_synthesis)
end

function var_0_0.hideEffect(arg_27_0)
	gohelper.setActive(arg_27_0._godecomposeEffect, false)
	gohelper.setActive(arg_27_0._gocomposeEffect, false)
end

function var_0_0.onClose(arg_28_0)
	TaskDispatcher.cancelTask(arg_28_0.sendComposeRequest, arg_28_0)
	TaskDispatcher.cancelTask(arg_28_0.sendDecomposeEquipRequest, arg_28_0)

	Season123EquipBookModel.instance._itemStartAnimTime = nil
end

function var_0_0.onDestroyView(arg_29_0)
	if arg_29_0._animCardEventWrap then
		arg_29_0._animCardEventWrap:RemoveAllEventListener()

		arg_29_0._animCardEventWrap = nil
	end

	if arg_29_0._icon ~= nil then
		arg_29_0._icon:disposeUI()
