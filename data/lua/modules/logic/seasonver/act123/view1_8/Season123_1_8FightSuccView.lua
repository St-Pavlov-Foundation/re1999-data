-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8FightSuccView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8FightSuccView", package.seeall)

local Season123_1_8FightSuccView = class("Season123_1_8FightSuccView", FightSuccView)

function Season123_1_8FightSuccView:onInitView()
...
function Season123_1_8FightSuccView:addEvents()
...
function Season123_1_8FightSuccView:removeEvents()
...
function Season123_1_8FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season123_1_8FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season123_1_8FightSuccView.super._onClickClose(self)
end

function Season123_1_8FightSuccView:onOpen()
	Season123_1_8FightSuccView.super.onOpen(self)
...
function Season123_1_8FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season123_1_8FightSuccView:_loadBonusItems()
	return
end

function Season123_1_8FightSuccView:_showGetCardView()
...
function Season123_1_8FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season123_1_8FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season123_1_8FightSuccView.super._loadBonusItems(self)
end

function Season123_1_8FightSuccView:_onCloseViewFinish(viewName)
	local getViewName = ViewName.Season123_1_8CelebrityCardGetView
...
function Season123_1_8FightSuccView:_addItem(material)
...
function Season123_1_8FightSuccView:_setFbName(episodeCO)
	self._txtFbName.text = episodeCO.name
	self._txtFbNameEn.text = episodeCO.name_En
end

function Season123_1_8FightSuccView:_showGoal()
	gohelper.setActive(self._goallist, false)
end

function Season123_1_8FightSuccView:_checkTypeDetails()
	return
end

function Season123_1_8FightSuccView:_hideGoDemand()
	return
end

function Season123_1_8FightSuccView:onClose()
	...
	Season123_1_8FightSuccView.super.onClose(self)
end

function Season123_1_8FightSuccView:onDestroyView()
	Season123_1_8FightSuccView.super.onDestroyView(self)
end

return Season123_1_8FightSuccView
