-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8StoryView.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8StoryView", package.seeall)

local Season123_1_8StoryView = class("Season123_1_8StoryView", BaseView)

function Season123_1_8StoryView:onInitView()
...
function Season123_1_8StoryView:addEvents()
...
function Season123_1_8StoryView:_btnRightOnClick()
...
function Season123_1_8StoryView:_editableInitView()
...
function Season123_1_8StoryView:onOpen()
...
function Season123_1_8StoryView:refreshUI()
...
function Season123_1_8StoryView:initCoverPageUI()
...
function Season123_1_8StoryView:refreshDetailPageUI()
...
function Season123_1_8StoryView:createCoverItem()
	...
	for storyId, storyConfig in pairs(allStoryConfig) do
		...
		if not coverItem then
			...
			coverItem.item = MonoHelper.addNoUpdateLuaComOnceToGo(coverItem.go, Season123_1_8StoryCoverItem, {
				actId = self.actId,
				storyId = storyId,
...
function Season123_1_8StoryView:refreshUnlockState()
...
function Season123_1_8StoryView:setStrToBool(unlockStateStr)
...
function Season123_1_8StoryView:onCoverItemClick(param)
	self.curPageIndex = param.storyId

	self:showSwitchPageAnim("todetail")
end

function Season123_1_8StoryView:showSwitchPageAnim(animName)
...
function Season123_1_8StoryView:refreshPage()
	UIBlockMgr.instance:endBlock("playSwitchPageAnim")
	self:refreshUI()
end

function Season123_1_8StoryView:onClose()
	self:saveUnlockState()
...
function Season123_1_8StoryView:onDestroyView()
	self._simageCover:UnLoadImage()
	self._simagePolaroid:UnLoadImage()
end

return Season123_1_8StoryView
