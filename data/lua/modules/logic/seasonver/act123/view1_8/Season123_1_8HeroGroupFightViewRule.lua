-- chunkname: @modules/logic/seasonver/act123/view1_8/Season123_1_8HeroGroupFightViewRule.lua

module("modules.logic.seasonver.act123.view1_8.Season123_1_8HeroGroupFightViewRule", package.seeall)

local Season123_1_8HeroGroupFightViewRule = class("Season123_1_8HeroGroupFightViewRule", BaseView)

function Season123_1_8HeroGroupFightViewRule:onInitView()
...
function Season123_1_8HeroGroupFightViewRule:addEvents()
...
function Season123_1_8HeroGroupFightViewRule:removeEvents()
...
function Season123_1_8HeroGroupFightViewRule:_btncloseruleOnClick()
...
function Season123_1_8HeroGroupFightViewRule:_btnadditionRuleOnClick()
...
function Season123_1_8HeroGroupFightViewRule:_btnenemyOnClick()
...
function Season123_1_8HeroGroupFightViewRule:_btnAdditionRuleDetailOnClick()
...
function Season123_1_8HeroGroupFightViewRule:_editableInitView()
...
function Season123_1_8HeroGroupFightViewRule:onOpen()
	self:addEventCb(HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
	self:_refreshUI()
end

function Season123_1_8HeroGroupFightViewRule:_refreshUI()
	self:_refreshRules()
...
function Season123_1_8HeroGroupFightViewRule:_refreshRules()
...
function Season123_1_8HeroGroupFightViewRule:_refreshAddition()
	local episodeId = HeroGroupModel.instance.episodeId
...
function Season123_1_8HeroGroupFightViewRule:_addRuleItem(ruleCo, targetId)
...
function Season123_1_8HeroGroupFightViewRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season123_1_8HeroGroupFightViewRule:_refreshEnemy()
...
function Season123_1_8HeroGroupFightViewRule:_recommendCareer()
...
function Season123_1_8HeroGroupFightViewRule:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season123_1_8HeroGroupFightViewRule:_onEnemyItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")
...
function Season123_1_8HeroGroupFightViewRule:onClose()
	self:removeEventCb(HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
end

function Season123_1_8HeroGroupFightViewRule:onDestroyView()
	return
end

return Season123_1_8HeroGroupFightViewRule
