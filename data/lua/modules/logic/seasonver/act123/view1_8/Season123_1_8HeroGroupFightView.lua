...
function Season123_1_8HeroGroupFightView:_btnstartseasonOnClick()
	if not self._blockStart then
		...
		UIBlockMgr.instance:startBlock(Season123_1_8HeroGroupFightView.UIBlock_SeasonFight)
	end
end
...
function Season123_1_8HeroGroupFightView:onDestroyView()
	...
	UIBlockMgr.instance:endBlock(Season123_1_8HeroGroupFightView.UIBlock_SeasonFight)
end
