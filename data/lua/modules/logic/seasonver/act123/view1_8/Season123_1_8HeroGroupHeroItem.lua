module("modules.logic.seasonver.act123.view1_8.Season123_1_8HeroGroupHeroItem", package.seeall)

slot0 = class("Season123_1_8HeroGroupHeroItem", LuaCompBase)
...
function slot0.init(slot0, slot1)
	...
	slot0._cardItem1 = Season123_1_8HeroGroupCardItem.New(slot0._gocarditem1, slot0, {
		slot = 1
	})
...
function slot0.onUpdateMO(slot0, slot1, slot2, slot3)
	...
	if slot0._heroMO or slot3 and slot3.heroId and slot3.heroId ~= 0 then
		slot6 = slot4.isReplay and slot4.replay_hero_data[slot0.mo.heroUid] or nil
		slot0._txtlvnum.text, slot8 = HeroConfig.instance:getShowLevel(slot6 and slot6.level or slot0._heroMO.level)

		slot0._simagecharactericon:LoadImage(ResUrl.getHeadIconMiddle(FightConfig.instance:getSkinCO(slot6 and slot6.skin or slot0._heroMO.skin).retangleIcon))
	...
	elseif slot0.trialCO then
		slot6 = HeroConfig.instance:getHeroCO(slot0.trialCO.heroId)
		slot7 = nil

		slot0._commonHeroCard:onUpdateMO((slot0.trialCO.skin <= 0 or SkinConfig.instance:getSkinCo(slot0.trialCO.skin)) and SkinConfig.instance:getSkinCo(slot6.skinId))
		UISpriteSetMgr.instance:setCommonSprite(slot0._imagecareericon, "lssx_" .. tostring(slot6.career))
		...
		for slot13 = 1, 6 do
			gohelper.setActive(slot0._gostars[slot13], slot13 <= CharacterEnum.Star[slot6.rare])
		end
	end
	...
	slot0.isRoleNumLock = HeroGroupModel.instance:getBattleRoleNum() and slot6 < slot0.mo.id
	slot0.isEmpty = slot1:isEmpty()
	slot7 = (slot0._heroMO or slot0._monsterCo or slot0.trialCO or slot3 and slot3.heroId and slot3.heroId ~= 0) and not slot0.isLock and not slot0.isRoleNumLock

	gohelper.setActive(slot0._gohero, slot7)
	gohelper.setActive(slot0._gostarroot, slot7)
	gohelper.setActive(slot0._goherolvLayout, slot7)

	slot8 = not slot0._heroMO and (slot3 == nil or slot3.heroId == nil or slot3.heroId == 0) and not slot0._monsterCo and not slot0.trialCO

	gohelper.setActive(slot0._gonone, slot8 or slot0.isLock or slot0.isAidLock or slot0.isRoleNumLock)
	gohelper.setActive(slot0._goadd, slot8 and not slot0.isLock and not slot0.isAidLock and not slot0.isRoleNumLock)
