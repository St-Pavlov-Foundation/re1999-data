...
local var_0_0 = class("Season123HeroGroupFightView", BaseView)
	...
	if HeroGroupModel.instance.episodeId then
		...
		if FightController.instance:setFightHeroGroup() then
			...
			if arg_48_0._replayMode then
				var_48_0.isReplay = true
				var_48_0.multiplication = Season123HeroGroupModel.instance.multiplication

				Season123HeroGroupController.instance:sendStartAct123Battle(var_48_0.chapterId, var_48_0.episodeId, var_48_0, Season123HeroGroupModel.instance.multiplication, nil, true)
			else
				var_48_0.isReplay = false
				var_48_0.multiplication = 1

				Season123HeroGroupController.instance:sendStartAct123Battle(var_48_0.chapterId, var_48_0.episodeId, var_48_0, 1)
			end
