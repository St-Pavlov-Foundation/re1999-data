-- chunkname: @modules/logic/seasonver/act123/view/Season123EquipHeroView.lua

module("modules.logic.seasonver.act123.view.Season123EquipHeroView", package.seeall)

local Season123EquipHeroView = class("Season123EquipHeroView", BaseView)

function Season123EquipHeroView:onInitView()
...
function Season123EquipHeroView:addEvents()
...
function Season123EquipHeroView:onDestroyView()
...
function Season123EquipHeroView:onOpen()
...
function Season123EquipHeroView:onClose()
	return
end

function Season123EquipHeroView:refreshUI()
...
function Season123EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end
...
function Season123EquipHeroView:refreshSlot(slotIndex)
...
Season123EquipHeroView.MaxUISlot = 2

function Season123EquipHeroView:refreshDescGroup()
	for slot = 1, Season123EquipHeroView.MaxUISlot do
...
function Season123EquipHeroView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season123EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season123EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season123EquipHeroView:getOrCreateSlotIcon(slotItem)
...
function Season123EquipHeroView:getOrCreateDesc(index)
...
function Season123EquipHeroView:onClickSlot(slotIndex)
	if Season123EquipHeroItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123EquipHeroView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123EquipHeroView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123EquipHeroView:handleEquipCardChanged(param)
...
function Season123EquipHeroView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123EquipHeroView:handleSaveSucc()
...
function Season123EquipHeroView:_btnequipOnClick()
...
function Season123EquipHeroView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123EquipHeroView
