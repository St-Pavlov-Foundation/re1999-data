-- chunkname: @modules/logic/seasonver/act123/view/Season123EquipBookView.lua

module("modules.logic.seasonver.act123.view.Season123EquipBookView", package.seeall)

local Season123EquipBookView = class("Season123EquipBookView", BaseView)

function Season123EquipBookView:onInitView()
...
function Season123EquipBookView:addEvents()
...
function Season123EquipBookView:removeEvents()
...
Season123EquipBookView.defaultDescColor = "#cac8c5"

function Season123EquipBookView:_btncomposeOnClick()
...
function Season123EquipBookView:sendComposeRequest()
...
function Season123EquipBookView:_btndecomposeOnClick()
	...
	ViewMgr.instance:openView(ViewName.Season123DecomposeView, param)
end

function Season123EquipBookView:_btnbatchDecomposeOnClick()
...
function Season123EquipBookView:_btnskipEffectOnClick()
...
function Season123EquipBookView:_editableInitView()
	...
	self.colorStr = Season123EquipBookView.defaultDescColor

	self:hideEffect()
	gohelper.setActive(self._btnskipEffect.gameObject, false)
end

function Season123EquipBookView:onOpen()
...
function Season123EquipBookView:onSwitchCardAnim()
	self:refreshUI()
end

function Season123EquipBookView:refreshEquipBook()
	self._scrollcardlist.verticalNormalizedPosition = 1

	self:refreshUI()
end

function Season123EquipBookView:refreshUI()
...
function Season123EquipBookView:refreshCardDesc()
...
function Season123EquipBookView:refreshCardItem(itemConfig)
...
function Season123EquipBookView:cardDescItemShow(obj, data, index)
	obj.name = "desc" .. index
...
function Season123EquipBookView:refreshIcon()
...
function Season123EquipBookView:refreshBtn()
	local equipItemCount = self:getItemCount()
...
function Season123EquipBookView:isMainCardOverCount()
	if self.itemId then
...
function Season123EquipBookView:canCompose()
	if not self.itemId then
		return false
	end
...
function Season123EquipBookView:getItemCount()
	local itemMap = Season123Model.instance:getAllItemMo(self.actId)

	return GameUtil.getTabLen(itemMap)
end

function Season123EquipBookView:onChangeSelectCard()
	self._animatorCard:Play("switch", 0, 0)
	self:hideEffect()
end

function Season123EquipBookView:doDecompose(decomposeList)
...
function Season123EquipBookView:sendDecomposeEquipRequest()
...
function Season123EquipBookView:showDecomposeEffect()
...
function Season123EquipBookView:showComposeEffect()
...
function Season123EquipBookView:hideEffect()
	gohelper.setActive(self._godecomposeEffect, false)
	gohelper.setActive(self._gocomposeEffect, false)
end

function Season123EquipBookView:onClose()
	TaskDispatcher.cancelTask(self.sendComposeRequest, self)
	TaskDispatcher.cancelTask(self.sendDecomposeEquipRequest, self)
...
function Season123EquipBookView:onDestroyView()
