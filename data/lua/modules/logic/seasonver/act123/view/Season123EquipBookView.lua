module("modules.logic.seasonver.act123.view.Season123EquipBookView", package.seeall)

local var_0_0 = class("Season123EquipBookView", BaseView)
...
function var_0_0._btndecomposeOnClick(arg_6_0)
	...
	ViewMgr.instance:openView(ViewName.Season123DecomposeView, var_6_0)
end
...
function var_0_0.refreshIcon(arg_17_0)
	if not arg_17_0._icon then
		...
		arg_17_0._icon = MonoHelper.addNoUpdateLuaComOnceToGo(var_17_0, Season123CelebrityCardEquip)
	end
