...
local var_0_0 = class("Season123SettlementHeroItem", BaseViewExtended)
...
function var_0_0._showHeroIcon(arg_8_0, arg_8_1, arg_8_2)
	...
	if var_8_1 then
		...
		local var_8_3 = FightDataHelper.entityMgr:getById(arg_8_1)

		if var_8_3 then
			local var_8_4 = lua_monster.configDict[var_8_3.modelId]

			if var_8_4 then
				arg_8_2 = arg_8_2 or var_8_4.skinId
				var_8_2 = var_8_4.career
			end
		end
	end

	if arg_8_2 then
		local var_8_5 = FightConfig.instance:getSkinCO(arg_8_2)

		if var_8_5 then
			arg_8_0._simageheroicon:LoadImage(ResUrl.getHeadIconMiddle(var_8_5.retangleIcon))
		end
	else
...
function var_0_0._showEquip123(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4)
	...
	arg_11_0:openSubView(Season123CelebrityCardGetItem, Season123CelebrityCardItem.AssetPath, var_11_0, arg_11_2, nil, arg_11_4)
end
