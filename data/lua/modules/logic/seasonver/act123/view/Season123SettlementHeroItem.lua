-- chunkname: @modules/logic/seasonver/act123/view/Season123SettlementHeroItem.lua

module("modules.logic.seasonver.act123.view.Season123SettlementHeroItem", package.seeall)

local Season123SettlementHeroItem = class("Season123SettlementHeroItem", BaseViewExtended)

function Season123SettlementHeroItem:onInitView()
...
function Season123SettlementHeroItem:addEvents()
	return
end

function Season123SettlementHeroItem:removeEvents()
	return
end

function Season123SettlementHeroItem:onRefreshViewParam(is_replay, hero, equip, equip_104, replay_data, trail)
...
function Season123SettlementHeroItem:onOpen()
...
function Season123SettlementHeroItem:_showNormalData()
	if self._trail then
...
function Season123SettlementHeroItem:_showTrailHeroIcon(trail)
	if not trail then
		return
	end
...
function Season123SettlementHeroItem:_showHeroIcon(heroId, skinId)
...
function Season123SettlementHeroItem:checkAssist(heroUid, heroMO)
	if not heroMO then
...
function Season123SettlementHeroItem:_showEquipIcon(equip_id)
...
function Season123SettlementHeroItem:_showEquip123(index, uid, totalEquipCount, equipId)
	if equipId == 0 then
		return
	end
	...
	self:openSubView(Season123CelebrityCardGetItem, Season123CelebrityCardItem.AssetPath, parentTran, uid, nil, equipId)
end

function Season123SettlementHeroItem:_showReplayData()
...
function Season123SettlementHeroItem:_refreshEquipPos()
	return
end

function Season123SettlementHeroItem:onClose()
	return
end

function Season123SettlementHeroItem:onDestroyView()
	self._simageheroicon:UnLoadImage()
end

return Season123SettlementHeroItem
