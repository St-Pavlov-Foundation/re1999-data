-- chunkname: @modules/logic/seasonver/act123/view/Season123FightRuleView.lua

module("modules.logic.seasonver.act123.view.Season123FightRuleView", package.seeall)

local Season123FightRuleView = class("Season123FightRuleView", BaseView)

function Season123FightRuleView:onInitView()
...
function Season123FightRuleView:addEvents()
	return
end

function Season123FightRuleView:removeEvents()
	return
end

function Season123FightRuleView:_editableInitView()
	gohelper.setActive(self._goItem, false)
end

function Season123FightRuleView:onOpen()
	self:refreshRule()
end

function Season123FightRuleView:refreshRule()
	local dataList = Season123FightRuleView.getRuleList() or {}
...
function Season123FightRuleView:createItem(index)
	local item = {}
...
function Season123FightRuleView:updateItem(item, data)
...
function Season123FightRuleView:destroyItem(item)
	return
end

function Season123FightRuleView.getRuleList()
...
function Season123FightRuleView:setDecorateVisible(isVisible)
...
function Season123FightRuleView:onClose()
	return
end

function Season123FightRuleView:onDestroyView()
