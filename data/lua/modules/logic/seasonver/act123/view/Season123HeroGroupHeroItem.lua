...
local var_0_0 = class("Season123HeroGroupHeroItem", LuaCompBase)
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	arg_2_0._cardItem1 = Season123HeroGroupCardItem.New(arg_2_0._gocarditem1, arg_2_0, {
		slot = 1
	})
...
function var_0_0.onUpdateMO(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if arg_3_0._heroMO or arg_3_3 and arg_3_3.heroId and arg_3_3.heroId ~= 0 then
		local var_3_2 = var_3_0.isReplay and var_3_0.replay_hero_data[arg_3_0.mo.heroUid] or nil
		local var_3_3, var_3_4 = HeroConfig.instance:getShowLevel(var_3_2 and var_3_2.level or arg_3_0._heroMO.level)

		arg_3_0._txtlvnum.text = var_3_3

		local var_3_5 = FightConfig.instance:getSkinCO(var_3_2 and var_3_2.skin or arg_3_0._heroMO.skin)
		...
		for iter_3_0 = 1, 3 do
			gohelper.setActive(arg_3_0._goranks[iter_3_0], iter_3_0 == var_3_4 - 1)
		end
	...
	elseif arg_3_0._monsterCo then
		local var_3_7 = FightConfig.instance:getSkinCO(arg_3_0._monsterCo.skinId)

		arg_3_0._simagecharactericon:LoadImage(ResUrl.getHeadIconMiddle(var_3_7.retangleIcon))
		UISpriteSetMgr.instance:setCommonSprite(arg_3_0._imagecareericon, "lssx_" .. tostring(arg_3_0._monsterCo.career))

		local var_3_8, var_3_9 = HeroConfig.instance:getShowLevel(arg_3_0._monsterCo.level)

		arg_3_0._txtlvnum.text = var_3_8

		for iter_3_2 = 1, 3 do
			gohelper.setActive(arg_3_0._goranks[iter_3_2], iter_3_2 == var_3_9 - 1)
		end

		gohelper.setActive(arg_3_0._gostarroot, false)
	elseif arg_3_0.trialCO then
		local var_3_10 = HeroConfig.instance:getHeroCO(arg_3_0.trialCO.heroId)
		local var_3_11

		if arg_3_0.trialCO.skin > 0 then
			var_3_11 = SkinConfig.instance:getSkinCo(arg_3_0.trialCO.skin)
		else
			var_3_11 = SkinConfig.instance:getSkinCo(var_3_10.skinId)
		end

		arg_3_0._commonHeroCard:onUpdateMO(var_3_11)
		UISpriteSetMgr.instance:setCommonSprite(arg_3_0._imagecareericon, "lssx_" .. tostring(var_3_10.career))

		local var_3_12, var_3_13 = HeroConfig.instance:getShowLevel(arg_3_0.trialCO.level)

		arg_3_0._txtlvnum.text = var_3_12

		for iter_3_3 = 1, 3 do
			gohelper.setActive(arg_3_0._goranks[iter_3_3], iter_3_3 == var_3_13 - 1)
		end

		for iter_3_4 = 1, 6 do
			gohelper.setActive(arg_3_0._gostars[iter_3_4], iter_3_4 <= CharacterEnum.Star[var_3_10.rare])
		end
	end
	...
	local var_3_14 = HeroGroupModel.instance:getBattleRoleNum()

	arg_3_0.isRoleNumLock = var_3_14 and var_3_14 < arg_3_0.mo.id
	arg_3_0.isEmpty = arg_3_1:isEmpty()

	local var_3_15 = (arg_3_0._heroMO or arg_3_0._monsterCo or arg_3_0.trialCO or arg_3_3 and arg_3_3.heroId and arg_3_3.heroId ~= 0) and not arg_3_0.isLock and not arg_3_0.isRoleNumLock

	gohelper.setActive(arg_3_0._gohero, var_3_15)
	gohelper.setActive(arg_3_0._gostarroot, var_3_15)
	gohelper.setActive(arg_3_0._goherolvLayout, var_3_15)

	local var_3_16 = not arg_3_0._heroMO and (arg_3_3 == nil or arg_3_3.heroId == nil or arg_3_3.heroId == 0) and not arg_3_0._monsterCo and not arg_3_0.trialCO
	local var_3_17 = var_3_16 or arg_3_0.isLock or arg_3_0.isAidLock or arg_3_0.isRoleNumLock

	gohelper.setActive(arg_3_0._gonone, var_3_17)

	local var_3_18 = var_3_16 and not arg_3_0.isLock and not arg_3_0.isAidLock and not arg_3_0.isRoleNumLock

	gohelper.setActive(arg_3_0._goadd, var_3_18)
...
function var_0_0._playDragEndAudio(arg_25_0, arg_25_1)
	local var_25_0, var_25_1, var_25_2 = EquipHelper.getSkillBaseDescAndIcon(arg_25_0._equipMO.config.id, arg_25_0._equipMO.refineLv)
