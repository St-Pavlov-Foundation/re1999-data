-- chunkname: @modules/logic/seasonver/act123/view/Season123FightSuccView.lua

module("modules.logic.seasonver.act123.view.Season123FightSuccView", package.seeall)

local Season123FightSuccView = class("Season123FightSuccView", FightSuccView)

function Season123FightSuccView:onInitView()
...
function Season123FightSuccView:addEvents()
...
function Season123FightSuccView:removeEvents()
...
function Season123FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season123FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season123FightSuccView.super._onClickClose(self)
end

function Season123FightSuccView:onOpen()
	Season123FightSuccView.super.onOpen(self)
...
function Season123FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season123FightSuccView:_loadBonusItems()
	return
end

function Season123FightSuccView:_showGetCardView()
...
function Season123FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season123FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season123FightSuccView.super._loadBonusItems(self)
end

function Season123FightSuccView:_onCloseViewFinish(viewName)
...
function Season123FightSuccView:_addItem(material)
	...
	if material.materilType == MaterialEnum.MaterialType.Season123EquipCard then
		...
		local cardItem = Season123CelebrityCardItem.New()
...
function Season123FightSuccView:_setFbName(episodeCO)
	self._txtFbName.text = episodeCO.name
	self._txtFbNameEn.text = episodeCO.name_En
end

function Season123FightSuccView:_showGoal()
	gohelper.setActive(self._goallist, false)
end

function Season123FightSuccView:_checkTypeDetails()
	return
end

function Season123FightSuccView:_hideGoDemand()
	return
end

function Season123FightSuccView:onClose()
	...
	Season123FightSuccView.super.onClose(self)
end

function Season123FightSuccView:onDestroyView()
	Season123FightSuccView.super.onDestroyView(self)
end

return Season123FightSuccView
