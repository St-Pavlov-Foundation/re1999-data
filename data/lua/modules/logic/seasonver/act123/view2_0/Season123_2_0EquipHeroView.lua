-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EquipHeroView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EquipHeroView", package.seeall)

local Season123_2_0EquipHeroView = class("Season123_2_0EquipHeroView", BaseView)

function Season123_2_0EquipHeroView:onInitView()
...
function Season123_2_0EquipHeroView:addEvents()
...
function Season123_2_0EquipHeroView:onDestroyView()
...
function Season123_2_0EquipHeroView:onOpen()
...
function Season123_2_0EquipHeroView:onClose()
	return
end

function Season123_2_0EquipHeroView:refreshUI()
...
function Season123_2_0EquipHeroView:handleEquipUpdate()
	self:refreshDescGroup()
	self:refreshSlots()
end

function Season123_2_0EquipHeroView:refreshSlots()
	for slotIndex = 1, Season123EquipHeroItemListModel.HeroMaxPos do
		self:refreshSlot(slotIndex)
	end
end

function Season123_2_0EquipHeroView:refreshSlot(slotIndex)
...
Season123_2_0EquipHeroView.MaxUISlot = 2

function Season123_2_0EquipHeroView:refreshDescGroup()
	for slot = 1, Season123_2_0EquipHeroView.MaxUISlot do
...
function Season123_2_0EquipHeroView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_2_0EquipHeroView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_2_0EquipHeroView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123_2_0EquipHeroView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_2_0EquipHeroView:getOrCreatePropText(index, descItem)
...
function Season123_2_0EquipHeroView:getOrCreateSkillText(index, descItem)
...
function Season123_2_0EquipHeroView:getOrCreateSlot(slotIndex)
...
function Season123_2_0EquipHeroView:getOrCreateSlotIcon(slotItem)
	...
	if not icon then
		...
		icon = MonoHelper.addNoUpdateLuaComOnceToGo(go, Season123_2_0CelebrityCardEquip)
		slotItem.icon = icon
	end
...
function Season123_2_0EquipHeroView:getOrCreateDesc(index)
...
function Season123_2_0EquipHeroView:onClickSlot(slotIndex)
	if Season123EquipHeroItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_2_0EquipHeroView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_2_0EquipHeroView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_2_0EquipHeroView:handleEquipCardChanged(param)
...
function Season123_2_0EquipHeroView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123_2_0EquipHeroView:handleSaveSucc()
...
function Season123_2_0EquipHeroView:_btnequipOnClick()
...
function Season123_2_0EquipHeroView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_2_0EquipHeroView
