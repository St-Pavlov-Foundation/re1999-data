-- chunkname: @modules/logic/seasonver/act123/view2_0/Season123_2_0EquipView.lua

module("modules.logic.seasonver.act123.view2_0.Season123_2_0EquipView", package.seeall)

local Season123_2_0EquipView = class("Season123_2_0EquipView", BaseView)

function Season123_2_0EquipView:onInitView()
...
function Season123_2_0EquipView:addEvents()
...
function Season123_2_0EquipView:removeEvents()
	self._btnequip:RemoveClickListener()
	self._btnopenhandbook:RemoveClickListener()
end

function Season123_2_0EquipView:_editableInitView()
...
function Season123_2_0EquipView:onDestroyView()
...
function Season123_2_0EquipView:onOpen()
...
function Season123_2_0EquipView:onClose()
	return
end

function Season123_2_0EquipView:refreshUI()
...
function Season123_2_0EquipView:handleEquipUpdate()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_2_0EquipView:refreshSlots()
...
function Season123_2_0EquipView:refreshSlot(slotIndex)
...
Season123_2_0EquipView.MaxUISlot = 2

function Season123_2_0EquipView:refreshDescGroup()
	for slot = 1, Season123_2_0EquipView.MaxUISlot do
...
function Season123_2_0EquipView:refreshDesc(descItem, itemUid, slotIndex)
...
function Season123_2_0EquipView:refreshProps(itemCfg, descItem, colorStr)
	local processedSet = {}
	local isDirty = false
...
function Season123_2_0EquipView:refreshSkills(itemCfg, descItem, colorStr)
...
function Season123_2_0EquipView:setSkillClickCallBack(effId, clickPosition)
...
function Season123_2_0EquipView:getOrCreatePropText(index, descItem)
...
function Season123_2_0EquipView:getOrCreateSkillText(index, descItem)
...
function Season123_2_0EquipView:getOrCreateSlot(slotIndex)
...
function Season123_2_0EquipView:getOrCreateSlotIcon(slotItem)
...
function Season123_2_0EquipView:getOrCreateDesc(index)
...
function Season123_2_0EquipView:onClickSlot(slotIndex)
	if Season123EquipItemListModel.instance.curSelectSlot ~= slotIndex then
...
function Season123_2_0EquipView:handleSaveSucc()
...
function Season123_2_0EquipView:handleSwitchAnimFrame()
	self:refreshSlots()
	self:refreshDescGroup()
end

function Season123_2_0EquipView.handleSlotSwitchAnimFrame(slotItem)
	local mainView = slotItem.mainView

	mainView:refreshDescGroup()
end

function Season123_2_0EquipView:handleEquipCardChanged(param)
...
function Season123_2_0EquipView:handleEquipSlotChanged()
	self._animator:Play("switch", 0, 0)
	self:refreshSlots()
end

function Season123_2_0EquipView:_btnequipOnClick()
...
function Season123_2_0EquipView:_btnhandbookOnClick()
	Season123Controller.instance:openSeasonEquipBookView(self.viewParam.actId)
end

return Season123_2_0EquipView
