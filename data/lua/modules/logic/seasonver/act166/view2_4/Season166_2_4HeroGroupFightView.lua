...
slot0 = class("Season166_2_4HeroGroupFightView", BaseView)
...
function slot0.onInitView(slot0)
	...
	slot0._btntalentInfo = gohelper.findChildButtonWithAudio(slot0.viewGO, "btnContain/#btn_talentTree/#btn_talentInfo")
...
function slot0.addEvents(slot0)
	...
	slot0._btntalentInfo:AddClickListener(slot0._btntalentInfoOnClick, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0._btntalentInfo:RemoveClickListener()
...
function slot0._btntalentInfoOnClick(slot0)
...
function slot0.setFightTalentParam(slot0)
	if not (slot0.baseSpotTalentId or slot0.newTalentId or Season166Model.getPrefsTalent()) then
		return
	end

	gohelper.setActive(slot0._btntalentInfo.gameObject, slot1 and slot1 > 0)
	Season166Model.instance:setFightTalentParam(slot1, Season166Model.instance:getTalentInfo(slot0.actId, slot1) and slot2.skillIds or {}, slot2 and slot2.level or 1)
end
