...
local var_0_0 = class("Season166_2_6InformationAnalyView", BaseView)
...
function var_0_0.onChangeAnalyInfo(arg_5_0, arg_5_1)
	...
	Season166Controller.instance:enterReportItem(arg_5_0.actId, arg_5_0.infoId)
	arg_5_0:refreshUI()
end
...
function var_0_0.onOpen(arg_14_0)
	...
	Season166Controller.instance:enterReportItem(arg_14_0.actId, arg_14_0.infoId)
	arg_14_0:refreshUI()
end
...
function var_0_0.refreshCost(arg_19_0, arg_19_1)
	...
	if ItemModel.instance:getItemQuantity(MaterialEnum.MaterialType.Currency, var_19_0) >= arg_19_1.consume then
		...
		arg_19_0.txtCost.text = string.format("<color=#BF2E11>-%s</color>", arg_19_1.consume)
	end
