...
function var_0_0.setMoList(arg_1_0, arg_1_1)
	...
	if var_1_0 then
		for iter_1_0, iter_1_1 in ipairs(var_1_0) do
			...
			if not var_1_3 then
				var_1_3 = RoomGiftShowBuildingMo.New()
...
function var_0_0._sort(arg_3_0, arg_3_1)
	...
	local var_3_2 = arg_3_0:getBuildingAreaConfig().occupy
	local var_3_3 = arg_3_1:getBuildingAreaConfig().occupy
...
function var_0_0.isHasTheme(arg_4_0, arg_4_1)
	return LuaUtil.tableContains(arg_4_0._themeIds, arg_4_1)
end

function var_0_0.setThemeList(arg_5_0)
	RoomThemeFilterListModel.instance:initThemeData(arg_5_0._themeIds)
end
...
function var_0_0.setThemeMoList(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(var_6_0) do
		if arg_6_0:isHasTheme(iter_6_1) then
			local var_6_2 = {
				themeId = iter_6_1,
				moList = arg_6_0._themeBuilding[iter_6_1]
			}

			table.insert(arg_6_0._themeMoList, var_6_2)
		else
	...
	for iter_6_2, iter_6_3 in ipairs(var_6_1) do
		RoomThemeFilterListModel.instance:setSelectById(iter_6_3, false)
	end
...
function var_0_0._sortThemeBuilding(arg_8_0)
...
function var_0_0.onSelect(arg_11_0, arg_11_1, arg_11_2)
	arg_11_1 = arg_11_0:getById(arg_11_1.id)
