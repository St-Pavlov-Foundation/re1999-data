...
function var_0_0._refreshLevelUpInfo(arg_12_0)
	...
	for iter_12_0, iter_12_1 in ipairs(var_12_1) do
		...
		if not var_12_2 then
			...
			var_12_2.bg = gohelper.findChild(var_12_2.go, "go_bg")
			var_12_2.curNum = gohelper.findChildText(var_12_2.go, "#txt_curNum")
			var_12_2.nextNum = gohelper.findChildText(var_12_2.go, "#txt_nextNum")
