...
function slot0.onInitView(slot0)
	...
	slot0._goreddot = gohelper.findChild(slot0.viewGO, "left/title/layout/#btn_levelup/#go_reddot")
...
function slot0._editableInitView(slot0)
	...
	slot0._expandDetailLineId = nil
	slot0._golevelupeffect = gohelper.findChild(slot0.viewGO, "left/title/layout/#btn_levelup/#go_reddot/#leveup_effect")
end
...
function slot0._initGatherItem(slot0)
	...
	slot1.txtstore = gohelper.findChildText(slot1.go, "go_gatherInfo/collectinfo/num/txt_store")
	slot1.txttime = gohelper.findChildText(slot1.go, "go_gatherInfo/collectinfo/num/txt_expspeed")
	slot1.txtremain = gohelper.findChildText(slot1.go, "go_gatherInfo/collectinfo/go_time/txt_time")
