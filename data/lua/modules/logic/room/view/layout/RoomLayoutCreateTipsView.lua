...
function slot0.onInitView(slot0)
	...
	slot0._goselect = gohelper.findChild(slot0.viewGO, "#btn_select/txt_desc/#go_select")
...
function slot0._refreshInitUI(slot0)
	if slot0.viewParam then
		...
		if slot0.viewParam.titleStr ~= nil then
			slot0._txtdesc.text = slot0.viewParam.titleStr
		end
