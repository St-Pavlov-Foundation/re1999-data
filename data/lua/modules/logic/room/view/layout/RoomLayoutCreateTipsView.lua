...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._goselect = gohelper.findChild(arg_1_0.viewGO, "#btn_select/txt_desc/#go_select")
...
function var_0_0._editableInitView(arg_7_0)
	arg_7_0._txtdesc = gohelper.findChildText(arg_7_0.viewGO, "txt_desc")
...
function var_0_0._refreshInitUI(arg_13_0)
	if arg_13_0.viewParam then
		...
		if arg_13_0.viewParam.titleStr ~= nil then
			arg_13_0._txtdesc.text = arg_13_0.viewParam.titleStr
		end
