...
function var_0_0._playTipsEffect(arg_22_0)
	...
	for iter_22_0 = 1, 5 do
		...
		if not var_22_4 then
			...
			var_22_4._imagerare = gohelper.findChildImage(var_22_5, "rare")
			var_22_4._txtname = gohelper.findChildText(var_22_5, "txt_name")
			var_22_4._txtnum = gohelper.findChildText(var_22_5, "txt_num")
			var_22_4._goicon = gohelper.findChild(var_22_5, "icon")
			var_22_4._gobuildingicon = gohelper.findChild(var_22_5, "building_icon")
