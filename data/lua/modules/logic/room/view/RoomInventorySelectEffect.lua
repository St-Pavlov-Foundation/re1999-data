...
function slot0._playTipsEffect(slot0)
	...
	for slot8 = 1, 5 do
		if not slot0._massifTipEffList[slot8] then
			...
			slot9._imagerare = gohelper.findChildImage(slot10, "rare")
			slot9._txtname = gohelper.findChildText(slot10, "txt_name")
			slot9._txtnum = gohelper.findChildText(slot10, "txt_num")
			slot9._goicon = gohelper.findChild(slot10, "icon")
			slot9._gobuildingicon = gohelper.findChild(slot10, "building_icon")
			slot9.finishTime = 0
