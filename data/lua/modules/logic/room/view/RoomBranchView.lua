...
function var_0_0._refreshDialog(arg_10_0)
	...
	if var_10_0 then
		...
		arg_10_0._txtinfo.text = var_10_2
...
function var_0_0._refreshCritterItem(arg_11_0, arg_11_1)
	if not arg_11_0._critterMO or not arg_11_0._critterItem then
		return
	end

	if arg_11_1 and arg_11_1 ~= 0 then
		arg_11_0._critterItem:fadeIn()
		arg_11_0._critterItem:setEffectByType(arg_11_1)
		arg_11_0._critterItem:setCritterPos(CritterEnum.PosType.Middle, false)
		arg_11_0:_refreshPosition()
	else
		arg_11_0._critterItem:setEffectByType(0)
		arg_11_0._critterItem:hideEffects()
	end
end

function var_0_0._getSpeakerName(arg_12_0, arg_12_1)
	if not string.nilorempty(arg_12_1.speaker) then
		return arg_12_1.speaker
	end

	if arg_12_0._critterMO then
		if arg_12_1.speakerType == RoomEnum.DialogSpeakerType.Hero then
			local var_12_0 = HeroConfig.instance:getHeroCO(arg_12_0._heroId)

			return var_12_0 and var_12_0.name
		elseif arg_12_1.speakerType == RoomEnum.DialogSpeakerType.Critter then
			return arg_12_0._critterMO:getName()
		end
	end
...
function var_0_0._onEscape(arg_13_0)
	return
end

function var_0_0.onOpen(arg_14_0)
	arg_14_0:_refreshUI()
	NavigateMgr.instance:addEscape(ViewName.RoomBranchView, arg_14_0._onEscape, arg_14_0)
	arg_14_0:addEventCb(RoomCharacterController.instance, RoomEvent.UpdateCharacterInteractionUI, arg_14_0._refreshUI, arg_14_0)
end

function var_0_0._addPostionEventCb(arg_15_0)
	if not arg_15_0._isAddPostionEven then
		arg_15_0._isAddPostionEven = true

		arg_15_0:addEventCb(RoomCharacterController.instance, RoomEvent.CharacterPositionChanged, arg_15_0._characterPositionChanged, arg_15_0)
		arg_15_0:addEventCb(RoomMapController.instance, RoomEvent.CameraTransformUpdate, arg_15_0._refreshPosition, arg_15_0)
	end
end

function var_0_0._removePostionEventCb(arg_16_0)
	if arg_16_0._isAddPostionEven then
		arg_16_0._isAddPostionEven = false

		arg_16_0:removeEventCb(RoomCharacterController.instance, RoomEvent.CharacterPositionChanged, arg_16_0._characterPositionChanged, arg_16_0)
		arg_16_0:removeEventCb(RoomMapController.instance, RoomEvent.CameraTransformUpdate, arg_16_0._refreshPosition, arg_16_0)
	end
end

function var_0_0._characterPositionChanged(arg_17_0, arg_17_1)
	if arg_17_0._critterMO and arg_17_0._critterMO.trainInfo.heroId ~= arg_17_1 then
		return
	end

	arg_17_0:_refreshPosition()
end

function var_0_0._refreshPosition(arg_18_0)
	local var_18_0 = arg_18_0:_getCritterEntity()

	if not var_18_0 then
		return
	end

	local var_18_1 = var_18_0.critterspine:getMountheadGOTrs() or var_18_0.goTrs

	if not var_18_1 then
		return
	end

	local var_18_2, var_18_3, var_18_4 = transformhelper.getPos(var_18_1)
	local var_18_5 = RoomBendingHelper.worldToBendingSimple(Vector3(var_18_2, var_18_3, var_18_4))
	local var_18_6 = RoomBendingHelper.worldPosToAnchorPos(var_18_5, arg_18_0._gocontentTrs)

	if var_18_6 then
		recthelper.setAnchor(arg_18_0._gospineTrs, var_18_6.x, var_18_6.y)
	end
end

function var_0_0._getCritterEntity(arg_19_0)
	if arg_19_0._scene.cameraFollow:isFollowing() then
		return arg_19_0._scene.crittermgr:getCritterEntity(arg_19_0._critterUid, SceneTag.RoomCharacter)
	end

	return arg_19_0._scene.crittermgr:getTempCritterEntity()
end
...
function var_0_0.onDestroyView(arg_21_0)
	...
	for iter_21_0, iter_21_1 in ipairs(arg_21_0._selectItemList) do
		iter_21_1.btnclick:RemoveClickListener()
	end

	if arg_21_0._critterItem then
		local var_21_0 = arg_21_0._critterItem

		arg_21_0._critterItem = nil
