-- chunkname: @modules/logic/versionactivity4_0/enter/view/subview/VersionActivity4_0SpLilyaEnterView.lua

module("modules.logic.versionactivity4_0.enter.view.subview.VersionActivity4_0SpLilyaEnterView", package.seeall)

local VersionActivity4_0SpLilyaEnterView = class("VersionActivity4_0SpLilyaEnterView", VersionActivityEnterBaseSubView)

function VersionActivity4_0SpLilyaEnterView:onInitView()
...
function VersionActivity4_0SpLilyaEnterView:addEvents()
...
function VersionActivity4_0SpLilyaEnterView:removeEvents()
...
function VersionActivity4_0SpLilyaEnterView:_btnEnterOnClick()
...
function VersionActivity4_0SpLilyaEnterView:_enterLevelView()
	SpLilyaController.instance:enterEpisodeLevelView()
end

function VersionActivity4_0SpLilyaEnterView:_btnLockOnClick()
...
function VersionActivity4_0SpLilyaEnterView:_btnTrialOnClick()
...
function VersionActivity4_0SpLilyaEnterView:_btnitemOnClick()
	return
end

function VersionActivity4_0SpLilyaEnterView:_editableInitView()
	self._animator = self.viewGO:GetComponent(gohelper.Type_Animator)
end

function VersionActivity4_0SpLilyaEnterView:onOpen()
...
function VersionActivity4_0SpLilyaEnterView:_refreshTime()
...
function VersionActivity4_0SpLilyaEnterView:onClose()
	TaskDispatcher.cancelTask(self._refreshTime, self)
end

function VersionActivity4_0SpLilyaEnterView:onDestroyView()
	return
end

return VersionActivity4_0SpLilyaEnterView
