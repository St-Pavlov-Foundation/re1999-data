...
function slot0._editableInitView(slot0)
	...
	for slot5, slot6 in ipairs((SDKMgr.instance:getChannelId() ~= SDKMgr.ChannelId.QQMobile or {
		"fenxiang_qq",
		"fenxiang_kongjian"
...
function slot0._logoLoaded(slot0)
	...
	slot0._co = coroutine.start(slot0._addLogo, slot0, slot0._texture, slot0._simagelogo.gameObject:GetComponent(typeof(UnityEngine.UI.Image)).sprite.texture, slot0:_getRect(slot0._texture, slot0._simagelogo.gameObject))
end
