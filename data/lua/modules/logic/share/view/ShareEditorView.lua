...
function var_0_0._logoLoaded(arg_8_0)
	...
	local var_8_0 = arg_8_0._simagelogo.gameObject:GetComponent(typeof(UnityEngine.UI.Image)).sprite.texture
	local var_8_1 = arg_8_0:_getRect(arg_8_0._texture, arg_8_0._simagelogo.gameObject)

	arg_8_0._co = coroutine.start(arg_8_0._addLogo, arg_8_0, arg_8_0._texture, var_8_0, var_8_1)
end
