...
slot0 = class("WeekWalk_2ResetView", BaseView)
...
function slot0._btnresetOnClick(slot0)
	...
	GameFacade.showMessageBox(MessageBoxIdDefine.WeekWalkResetLayerBattle, MsgBoxEnum.BoxType.Yes_No, function ()
		Weekwalk_2Rpc.instance:sendWeekwalkVer2ResetLayerRequest(uv0._mapId, uv1, uv0.closeThis, uv0)
...
function slot0._editableInitView(slot0)
	...
	slot0._sceneConfig = slot0._mapInfo.sceneConfig
...
function slot0._showBattleList(slot0)
	...
	for slot5, slot6 in ipairs(slot0._mapInfo.battleInfos) do
		table.insert(slot0._battleItemList, MonoHelper.addLuaComOnceToGo(slot0:getResInst(slot0.viewContainer:getSetting().otherRes[1], slot0._goprogress), WeekWalk_2ResetBattleItem, {
			slot0,
			slot6,
			slot5,
			slot1
