...
local var_0_0 = class("SeasonHeroGroupFightView", BaseView)
local var_0_1 = 1
...
function var_0_0._btnseasonsupercardOnClick(arg_10_0)
	...
	var_10_0.pos = 4
	var_10_0.actId = ActivityEnum.Activity.Season
	var_10_0.slot = 1
...
function var_0_0._groupDropValueChanged(arg_11_0, arg_11_1)
	...
	local var_11_0 = ActivityEnum.Activity.Season
...
function var_0_0._initData(arg_15_0)
	...
	NavigateMgr.instance:addEscape(ViewName.SeasonHeroGroupFightView, arg_15_0._onEscapeBtnClick, arg_15_0)
...
function var_0_0._refreshMainCard(arg_20_0)
	...
	if var_20_0 then
		if var_20_0.isReplay and var_20_0.replay_activity104Equip_data then
			var_20_2 = var_20_0.replay_activity104Equip_data[var_20_1][1].equipId
		end

		if not var_20_0.isReplay and var_20_0.activity104Equips and var_20_0.activity104Equips[4] then
			var_20_2 = Activity104Model.instance:getItemIdByUid(var_20_0.activity104Equips[4].equipUid[1])
		end
	end
	...
	if var_20_2 ~= 0 then
		if not arg_20_0._superCardItem then
			arg_20_0._superCardItem = SeasonCelebrityCardItem.New()

			arg_20_0._superCardItem:init(arg_20_0._gosupercardpos, var_20_2)
		else
			gohelper.setActive(arg_20_0._superCardItem.go, true)
			arg_20_0._superCardItem:reset(var_20_2)
		end
	...
	local var_20_3 = Activity104Model.instance:getAct104CurLayer()
	...
	if var_20_0.isReplay and DungeonModel.instance.curSendEpisodeId and DungeonConfig.instance:getEpisodeCO(DungeonModel.instance.curSendEpisodeId).type == DungeonEnum.EpisodeType.Season then
		var_20_3 = Activity104Model.instance:getBattleFinishLayer()
	end

	local var_20_4 = Activity104Model.instance:getSeasonCurSnapshotSubId()
	local var_20_5 = Activity104Model.instance:isSeasonLayerPosUnlock(nil, var_20_4, var_20_3, 1, 4)

	gohelper.setActive(arg_20_0._gosupercardlock, not var_20_5)
	gohelper.setActive(arg_20_0._gosupercardempty, var_20_5)
end
...
function var_0_0._refreshUI(arg_35_0)
	...
	arg_35_0.viewContainer:setNavigateOverrideClose(arg_35_0.openSeasonMainView, arg_35_0)
end
...
function var_0_0._checkEquipClothSkill(arg_40_0)
	...
	for iter_40_0, iter_40_1 in ipairs(var_40_1) do
		if PlayerClothModel.instance:hasCloth(iter_40_1.id) then
			local var_40_2 = ActivityEnum.Activity.Season
