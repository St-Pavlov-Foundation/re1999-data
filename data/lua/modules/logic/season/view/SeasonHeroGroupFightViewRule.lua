...
slot0 = class("SeasonHeroGroupFightViewRule", BaseView)
...
function slot0._refreshEnemy(slot0)
	...
	if DungeonConfig.instance:getEpisodeCO(DungeonModel.instance.curSendEpisodeId).type == DungeonEnum.EpisodeType.Season then
		slot9 = SeasonConfig.instance:getSeasonEpisodeCo(ActivityEnum.Activity.Season, Activity104Model.instance:getBattleFinishLayer()).level
	elseif slot8.type == DungeonEnum.EpisodeType.SeasonRetail then
		slot9 = SeasonConfig.instance:getSeasonRetailCo(ActivityEnum.Activity.Season, Activity104Model.instance:getRetailStage()).level
	elseif slot8.type == DungeonEnum.EpisodeType.SeasonSpecial then
		slot9 = SeasonConfig.instance:getSeasonSpecialCo(ActivityEnum.Activity.Season, Activity104Model.instance:getBattleFinishLayer()).level
	end
