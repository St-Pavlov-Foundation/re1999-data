-- chunkname: @modules/logic/season/view1_4/Season1_4MainView.lua

module("modules.logic.season.view1_4.Season1_4MainView", package.seeall)

local Season1_4MainView = class("Season1_4MainView", BaseView)

function Season1_4MainView:onInitView()
...
function Season1_4MainView:addEvents()
...
function Season1_4MainView:removeEvents()
...
function Season1_4MainView:hideMask()
...
function Season1_4MainView:activeMask(active)
	gohelper.setActive(self._goMask, active)
end

function Season1_4MainView:_btnletterOnClick()
	Activity104Controller.instance:openSeasonSumView()
end

function Season1_4MainView:_btntrialOnClick()
	local actId = Activity104Model.instance:getCurSeasonId()
	local trialId = Activity104Model.instance:getTrialId(actId)
	local co = SeasonConfig.instance:getTrialConfig(actId, trialId)

	if co then
		Activity104Rpc.instance:sendBeforeStartAct104BattleRequest(actId, trialId, co.episodeId, self.onTrialBattleReply, self)
	end
end

function Season1_4MainView:onTrialBattleReply(cmd, resultCode, msg)
...
function Season1_4MainView:_btndiscountOnClick()
	Activity104Controller.instance:openSeasonSpecialMarketView()
end

function Season1_4MainView:_btndiscountlockOnClick()
	return
end

function Season1_4MainView:_btnretailOnClick()
	Activity104Controller.instance:openSeasonRetailView()
end

function Season1_4MainView:_btnentranceOnClick()
	Activity104Controller.instance:openSeasonMarketView()
end

function Season1_4MainView:_btnreadprocessOnClick()
	Activity104Controller.instance:openSeasonStoreView()
end

function Season1_4MainView:_btntaskOnClick()
	Activity104Controller.instance:openSeasonTaskView()
end

function Season1_4MainView:_btncelebrityOnClick()
	Activity104Controller.instance:openSeasonCardBook()
end

function Season1_4MainView:_btncurrencyiconOnClick()
	local actId = Activity104Model.instance:getCurSeasonId()
...
function Season1_4MainView:_editableInitView()
	self._progressItems = {}
...
function Season1_4MainView:onUpdateParam()
	self:_refreshUI()
	self:checkJump()
end

function Season1_4MainView:onOpen()
...
function Season1_4MainView:checkJump()
...
function Season1_4MainView:_checkShowEquipSelfChoiceView()
	Activity104Controller.instance:checkShowEquipSelfChoiceView()
end

function Season1_4MainView:onLevelUp()
...
function Season1_4MainView:_showPassTips()
...
function Season1_4MainView:_refreshUI()
	self:_refreshMain()
	self:_refreshRetail()
...
function Season1_4MainView:_refreshMain()
	local actId = Activity104Model.instance:getCurSeasonId()
...
function Season1_4MainView:refreshTrial()
	local actId = Activity104Model.instance:getCurSeasonId()
	local trialId = Activity104Model.instance:getTrialId(actId)
	local co = SeasonConfig.instance:getTrialConfig(actId, trialId)
	...
	if co then
		...
		if not self.trialCardItem then
			self.trialCardItem = Season1_4CelebrityCardItem.New()
...
function Season1_4MainView:_refreshRetail()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_4MainView:_showUTTU()
	self:_refreshRetail()
...
function Season1_4MainView:_onRefreshRetail()
	self:_refreshRetail()
end

function Season1_4MainView:_onChangeRetail(changeIds)
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_4MainView:createProgress(index, parentGo)
...
function Season1_4MainView:activeProgress(item, active)
	if not item then
		return
	end
...
function Season1_4MainView:activeProgressLevup(index, active)
...
function Season1_4MainView:activeProgressLight(index, active)
	local item = self._progressItems[index]
...
function Season1_4MainView:updateProgress(item, stage)
	if not item then
		return
	end
...
function Season1_4MainView:onTrialBattle(msg)
	return
end

function Season1_4MainView:onClose()
	return
end

function Season1_4MainView:onDestroyView()
	TaskDispatcher.cancelTask(self._refreshMain, self)
	TaskDispatcher.cancelTask(self.hideMask, self)
