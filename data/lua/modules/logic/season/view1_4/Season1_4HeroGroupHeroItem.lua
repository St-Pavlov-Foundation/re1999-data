...
local var_0_0 = class("Season1_4HeroGroupHeroItem", LuaCompBase)

function var_0_0.ctor(arg_1_0, arg_1_1)
	arg_1_0._Season1_4HeroGroupListView = arg_1_1
end
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	arg_2_0._cardItem1 = Season1_4HeroGroupCardItem.New(arg_2_0._gocarditem1, arg_2_0, {
		slot = 1
	})
	arg_2_0._gocarditem2 = gohelper.findChild(arg_2_1, "heroitemani/equipcard/cardlist/carditem2")
	arg_2_0._cardItem2 = Season1_4HeroGroupCardItem.New(arg_2_0._gocarditem2, arg_2_0, {
		slot = 2
	})
...
function var_0_0.onUpdateMO(arg_3_0, arg_3_1)
	...
	elseif arg_3_0.trialCO then
		...
		arg_3_0._simagecharactericon:LoadImage(ResUrl.getHeadIconMiddle(var_3_10.retangleIcon))
...
function var_0_0._moveToTarget(arg_27_0, arg_27_1)
	for iter_27_0, iter_27_1 in ipairs(arg_27_0._Season1_4HeroGroupListView.heroPosTrList) do
		if arg_27_0._Season1_4HeroGroupListView._heroItemList[iter_27_0] ~= arg_27_0 then
			...
			if math.abs(var_27_1.x) * 2 < recthelper.getWidth(var_27_0) and math.abs(var_27_1.y) * 2 < recthelper.getHeight(var_27_0) then
				return arg_27_0._Season1_4HeroGroupListView._heroItemList[iter_27_0]
			end
		end
	end
...
function var_0_0._setEquipDragEnabled(arg_28_0, arg_28_1)
	for iter_28_0, iter_28_1 in ipairs(arg_28_0._Season1_4HeroGroupListView._heroItemList) do
...
function var_0_0.setGrayFactor(arg_31_0, arg_31_1)
	ZProj.UGUIHelper.SetGrayFactor(arg_31_0._simagecharactericon.gameObject, arg_31_1)
end
...
function var_0_0.getHeroItemList(arg_41_0)
	return arg_41_0._Season1_4HeroGroupListView:getHeroItemList()
end
...
function var_0_0._setHeroItemPressState(arg_44_0, arg_44_1)
	...
	if arg_44_0._imageAdd then
		local var_44_4 = arg_44_1 and HeroGroupHeroItem.PressColor or Color.white

		arg_44_0._imageAdd.color = var_44_4
	end
end
...
function var_0_0.onDestroy(arg_46_0)
	...
	arg_46_0._simagecharactericon:UnLoadImage()
