...
function Season1_4HeroGroupHeroItem:_updateAct104Equips()
	...
	if curGroupMO.isReplay then
		...
		if self.trialCO and self.trialCO.act104EquipId1 > 0 then
			...
			equipUid1 = equips[1]
			equipId1 = Activity104Model.instance:getItemIdByUid(equipUid1)
		end
		...
		if self.trialCO and self.trialCO.act104EquipId2 > 0 then
			...
			equipUid2 = equips[2]
			equipId2 = Activity104Model.instance:getItemIdByUid(equipUid2)
		end
	end
	...
	local targetBlackMaskHeight = hasShowCardSlot and Season1_4HeroGroupHeroItem.NonCardSlotBlackMaskHeight or Season1_4HeroGroupHeroItem.HasCardSlotBlackMashHeight
	...
	local targetSlot1Pos = hasAllSlotUnlock and Season1_4HeroGroupHeroItem.TwoSlotCardItem1Pos or Season1_4HeroGroupHeroItem.SingleSlotCardItem1Pos
