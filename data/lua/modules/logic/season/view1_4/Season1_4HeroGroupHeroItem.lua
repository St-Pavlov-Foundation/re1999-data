...
slot0 = class("Season1_4HeroGroupHeroItem", LuaCompBase)

function slot0.ctor(slot0, slot1)
	slot0._Season1_4HeroGroupListView = slot1
end
...
function slot0.init(slot0, slot1)
	...
	slot0._cardItem1 = Season1_4HeroGroupCardItem.New(slot0._gocarditem1, slot0, {
		slot = 1
	})
	slot0._gocarditem2 = gohelper.findChild(slot1, "heroitemani/equipcard/cardlist/carditem2")
	slot0._cardItem2 = Season1_4HeroGroupCardItem.New(slot0._gocarditem2, slot0, {
		slot = 2
	})
...
function slot0._moveToTarget(slot0, slot1)
	for slot5, slot6 in ipairs(slot0._Season1_4HeroGroupListView.heroPosTrList) do
		if slot0._Season1_4HeroGroupListView._heroItemList[slot5] ~= slot0 then
			slot7 = slot6.parent
			...
			if math.abs(recthelper.screenPosToAnchorPos(slot1, slot7).x) * 2 < recthelper.getWidth(slot7) and math.abs(slot8.y) * 2 < recthelper.getHeight(slot7) then
				return slot0._Season1_4HeroGroupListView._heroItemList[slot5]
			end
		end
	end
...
function slot0._setEquipDragEnabled(slot0, slot1)
	for slot5, slot6 in ipairs(slot0._Season1_4HeroGroupListView._heroItemList) do
		if slot6._drag then
...
function slot0.getHeroItemList(slot0)
	return slot0._Season1_4HeroGroupListView:getHeroItemList()
end
