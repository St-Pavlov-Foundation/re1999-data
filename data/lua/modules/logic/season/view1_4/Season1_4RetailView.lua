-- chunkname: @modules/logic/season/view1_4/Season1_4RetailView.lua

module("modules.logic.season.view1_4.Season1_4RetailView", package.seeall)

local Season1_4RetailView = class("Season1_4RetailView", BaseView)

function Season1_4RetailView:onInitView()
	...
	MainCameraMgr.instance:addView(ViewName.Season1_4RetailView, self.autoInitRetailViewCamera, nil, self)
...
function Season1_4RetailView:addEvents()
...
function Season1_4RetailView:removeEvents()
...
function Season1_4RetailView:_btngo1OnClick()
	self:_enterLevelInfoView(1)
end

function Season1_4RetailView:_btngo2OnClick()
	self:_enterLevelInfoView(2)
end

function Season1_4RetailView:_btngo3OnClick()
	self:_enterLevelInfoView(3)
end

function Season1_4RetailView:_btngo4OnClick()
	self:_enterLevelInfoView(4)
end

function Season1_4RetailView:_btngo5OnClick()
	self:_enterLevelInfoView(5)
end

function Season1_4RetailView:_btngo6OnClick()
	self:_enterLevelInfoView(6)
end

function Season1_4RetailView:_btnruledetailOnClick()
	gohelper.setActive(self._goruletipdetail, true)
end

function Season1_4RetailView:_btncloseruletipOnClick()
	gohelper.setActive(self._goruletipdetail, false)
end

function Season1_4RetailView:_btncurrencyiconOnClick()
...
function Season1_4RetailView:_enterLevelInfoView(index)
...
function Season1_4RetailView:_btnsummonOnClick()
...
function Season1_4RetailView:_editableInitView()
	return
end

function Season1_4RetailView:onUpdateParam()
	return
end

function Season1_4RetailView:onOpen()
...
function Season1_4RetailView:_onRefreshRetailSuccess()
	self._waitRefreshingRetailReply = false
...
function Season1_4RetailView:onSwitchCard()
	self:_refreshLevel()
	self:_refreshTitle()
end

function Season1_4RetailView:_refreshTitle()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_4RetailView:_setStages()
...
function Season1_4RetailView:_refreshLevel()
	self:_refreshTicket()
	self:_showEntrance()
end

function Season1_4RetailView:_refreshTicket()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_4RetailView:_onChangeRetail(changeIds)
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_4RetailView:_showEntrance()
	...
	for _, v in pairs(retails) do
		...
		for i = 1, 3 do
			...
			if not self._rewardCardItems[v.position].celebrityCards[i] then
				self._rewardCardItems[v.position].celebrityCards[i] = Season1_4CelebrityCardItem.New()
...
function Season1_4RetailView:onClose()
...
function Season1_4RetailView:autoInitRetailViewCamera()
	Activity104Controller.instance:dispatchEvent(Activity104Event.ChangeCameraSize, true)
end

function Season1_4RetailView:onDestroyView()
