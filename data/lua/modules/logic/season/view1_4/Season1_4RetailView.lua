...
local var_0_0 = class("Season1_4RetailView", BaseView)
...
function var_0_0.onInitView(arg_1_0)
	...
	MainCameraMgr.instance:addView(ViewName.Season1_4RetailView, arg_1_0.autoInitRetailViewCamera, nil, arg_1_0)
...
function var_0_0._refreshConstTips(arg_19_0)
	...
	if var_19_2 ~= 0 then
		if not arg_19_0._rareCard then
			arg_19_0._rareCard = Season1_4CelebrityCardItem.New()
	...
	for iter_27_0, iter_27_1 in pairs(var_27_0) do
		...
		for iter_27_6 = 1, 3 do
			...
			if not arg_27_0._rewardCardItems[iter_27_1.position].celebrityCards[iter_27_6] then
				arg_27_0._rewardCardItems[iter_27_1.position].celebrityCards[iter_27_6] = Season1_4CelebrityCardItem.New()
