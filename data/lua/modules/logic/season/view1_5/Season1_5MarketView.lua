-- chunkname: @modules/logic/season/view1_5/Season1_5MarketView.lua

module("modules.logic.season.view1_5.Season1_5MarketView", package.seeall)

local Season1_5MarketView = class("Season1_5MarketView", BaseView)

function Season1_5MarketView:onInitView()
...
function Season1_5MarketView:addEvents()
...
function Season1_5MarketView:removeEvents()
...
function Season1_5MarketView:_btnlastOnClick()
...
function Season1_5MarketView:_btnnextOnClick()
...
function Season1_5MarketView:_delayShowInfo()
	self:_showInfo()
	self:_setStages()
	self:updateLeftDesc()
end

function Season1_5MarketView:_btnstartOnClick()
...
function Season1_5MarketView:_btnreplayOnClick()
	local actId = Activity104Model.instance:getCurSeasonId()
...
function Season1_5MarketView:_editableInitView()
...
function Season1_5MarketView:onUpdateParam()
	return
end

function Season1_5MarketView:onOpen()
...
function Season1_5MarketView:resetData()
	self._showLvItems = {}
...
function Season1_5MarketView:_showInfoByOpen()
...
function Season1_5MarketView:_setLevels()
	...
	if self._layer <= 4 then
		for i = 1, 6 do
			...
			self._showLvItems[i] = Season1_5MarketShowLevelItem.New()
...
function Season1_5MarketView:_delayShowItem()
...
function Season1_5MarketView:_setStages()
	local episodeCo = SeasonConfig.instance:getSeasonEpisodeCo(Activity104Model.instance:getCurSeasonId(), self._layer)
...
function Season1_5MarketView:_showInfo()
	self:_setInfo()
	self:_setParts()
end

Season1_5MarketView.NomalStageTagPos = Vector2(46.3, 2.7)
Season1_5MarketView.NewStageTagPos = Vector2(4.37, 2.7)

function Season1_5MarketView:_setInfo()
	local episodeCo = SeasonConfig.instance:getSeasonEpisodeCo(Activity104Model.instance:getCurSeasonId(), self._layer)
	...
	local targetStageTagPos = isNewStage and Season1_5MarketView.NewStageTagPos or Season1_5MarketView.NomalStageTagPos
...
function Season1_5MarketView:refreshEquipCardItem()
	...
	if episodeCo.firstPassEquipId > 0 then
		...
		if not self._rewardItems[1].itemIcon then
			self._rewardItems[1].itemIcon = Season1_5CelebrityCardItem.New()
...
function Season1_5MarketView:createRewardItem(index)
...
function Season1_5MarketView:refreshRewardItem(item, itemInfo)
...
function Season1_5MarketView:_setParts()
	local episodeCo = SeasonConfig.instance:getSeasonEpisodeCo(Activity104Model.instance:getCurSeasonId(), self._layer)
...
Season1_5MarketView.UnLockStageItemAlpha = 1
Season1_5MarketView.LockStageItemAlpha = 0.3

function Season1_5MarketView:_showPartStageItem(stage)
	if stage < 7 then
		...
		for i = 1, 6 do
			...
			self._partStageItems[i].canvasgroup.alpha = i <= stage and Season1_5MarketView.UnLockStageItemAlpha or Season1_5MarketView.LockStageItemAlpha
		end
	else
		for i = 1, 7 do
			if not self._partStageItems[i] then
...
function Season1_5MarketView:updateLeftDesc()
...
function Season1_5MarketView:createLeftDescItem(index)
	local item = self:getUserDataTb_()
...
function Season1_5MarketView:updateLeftDescItem(item, co)
	if not co then
		gohelper.setActive(item.go, false)
...
function Season1_5MarketView:moveToCurDesc()
...
function Season1_5MarketView:onClose()
	TaskDispatcher.cancelTask(self._delayShowInfo, self)
end

function Season1_5MarketView:onDestroyView()
	TaskDispatcher.cancelTask(self._showInfoByOpen, self)
	TaskDispatcher.cancelTask(self.moveToCurDesc, self)
