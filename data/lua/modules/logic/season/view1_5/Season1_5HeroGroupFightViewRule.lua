-- chunkname: @modules/logic/season/view1_5/Season1_5HeroGroupFightViewRule.lua

module("modules.logic.season.view1_5.Season1_5HeroGroupFightViewRule", package.seeall)

local Season1_5HeroGroupFightViewRule = class("Season1_5HeroGroupFightViewRule", BaseView)

function Season1_5HeroGroupFightViewRule:onInitView()
...
function Season1_5HeroGroupFightViewRule:addEvents()
...
function Season1_5HeroGroupFightViewRule:removeEvents()
...
function Season1_5HeroGroupFightViewRule:_btncloseruleOnClick()
...
function Season1_5HeroGroupFightViewRule:_btnadditionRuleOnClick()
	self._ruleItemClick = self._goruledesc.activeSelf

	gohelper.setActive(self._goruledesc, true)
end

function Season1_5HeroGroupFightViewRule:_btnenemyOnClick()
	EnemyInfoController.instance:openEnemyInfoViewByBattleId(HeroGroupModel.instance.battleId)
end

function Season1_5HeroGroupFightViewRule:_btnAdditionRuleDetailOnClick()
...
function Season1_5HeroGroupFightViewRule:_editableInitView()
...
function Season1_5HeroGroupFightViewRule:_refreshTask()
...
function Season1_5HeroGroupFightViewRule:_refreshRules()
...
function Season1_5HeroGroupFightViewRule:_refreshAddition()
	local episodeId = HeroGroupModel.instance.episodeId
...
function Season1_5HeroGroupFightViewRule:_addRuleItem(ruleCo, targetId)
...
function Season1_5HeroGroupFightViewRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season1_5HeroGroupFightViewRule:_refreshEnemy()
...
function Season1_5HeroGroupFightViewRule:_recommendCareer()
...
function Season1_5HeroGroupFightViewRule:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season1_5HeroGroupFightViewRule:_onEnemyItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")
...
function Season1_5HeroGroupFightViewRule:onClose()
	self:removeEventCb(HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
end

function Season1_5HeroGroupFightViewRule:onDestroyView()
	return
end

return Season1_5HeroGroupFightViewRule
