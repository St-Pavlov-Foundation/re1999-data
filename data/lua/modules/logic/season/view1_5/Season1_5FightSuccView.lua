-- chunkname: @modules/logic/season/view1_5/Season1_5FightSuccView.lua

module("modules.logic.season.view1_5.Season1_5FightSuccView", package.seeall)

local Season1_5FightSuccView = class("Season1_5FightSuccView", FightSuccView)

function Season1_5FightSuccView:onInitView()
...
function Season1_5FightSuccView:addEvents()
...
function Season1_5FightSuccView:removeEvents()
...
function Season1_5FightSuccView:_editableInitView()
	self._click = gohelper.getClick(self.viewGO)
end

function Season1_5FightSuccView:_onClickClose()
	if self._showEquipCard then
		return
	end

	Season1_5FightSuccView.super._onClickClose(self)
end

function Season1_5FightSuccView:onOpen()
	Season1_5FightSuccView.super.onOpen(self)
	gohelper.setActive(self._bonusItemContainer, false)
	self:_dealGetCard()
	self:_showGoal()
end

function Season1_5FightSuccView:_dealGetCard()
	local reward_list = {}
...
function Season1_5FightSuccView:_loadBonusItems()
	return
end

function Season1_5FightSuccView:_showGetCardView()
...
function Season1_5FightSuccView:_onTipsClose()
	self:_showRewardPart()
	self:_showPlayerLevelUpView()
end

function Season1_5FightSuccView:_showRewardPart()
	self._showEquipCard = nil

	ViewMgr.instance:unregisterCallback(ViewEvent.OnCloseViewFinish, self._onCloseViewFinish, self)
	gohelper.setActive(self._bonusItemContainer, true)
	Season1_5FightSuccView.super._loadBonusItems(self)
end

function Season1_5FightSuccView:_onCloseViewFinish(viewName)
...
function Season1_5FightSuccView:_showChoiceCardView()
...
function Season1_5FightSuccView:_addItem(material)
...
function Season1_5FightSuccView:_setFbName(episodeCO)
...
function Season1_5FightSuccView:_showGoal()
...
function Season1_5FightSuccView:_checkTypeDetails()
	return
end

function Season1_5FightSuccView:_hideGoDemand()
	return
end

function Season1_5FightSuccView:onClose()
	...
	Season1_5FightSuccView.super.onClose(self)
end

function Season1_5FightSuccView:onDestroyView()
	Season1_5FightSuccView.super.onDestroyView(self)
end

return Season1_5FightSuccView
