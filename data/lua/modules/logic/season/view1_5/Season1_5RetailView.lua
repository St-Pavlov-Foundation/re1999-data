-- chunkname: @modules/logic/season/view1_5/Season1_5RetailView.lua

module("modules.logic.season.view1_5.Season1_5RetailView", package.seeall)

local Season1_5RetailView = class("Season1_5RetailView", BaseView)

function Season1_5RetailView:onInitView()
	...
	MainCameraMgr.instance:addView(ViewName.Season1_5RetailView, self.autoInitRetailViewCamera, nil, self)
...
function Season1_5RetailView:addEvents()
...
function Season1_5RetailView:removeEvents()
...
function Season1_5RetailView:_btngo1OnClick()
	self:_enterLevelInfoView(1)
end

function Season1_5RetailView:_btngo2OnClick()
	self:_enterLevelInfoView(2)
end

function Season1_5RetailView:_btngo3OnClick()
	self:_enterLevelInfoView(3)
end

function Season1_5RetailView:_btngo4OnClick()
	self:_enterLevelInfoView(4)
end

function Season1_5RetailView:_btngo5OnClick()
	self:_enterLevelInfoView(5)
end

function Season1_5RetailView:_btngo6OnClick()
	self:_enterLevelInfoView(6)
end

function Season1_5RetailView:_btnruledetailOnClick()
	gohelper.setActive(self._goruletipdetail, true)
end

function Season1_5RetailView:_btncloseruletipOnClick()
	gohelper.setActive(self._goruletipdetail, false)
end

function Season1_5RetailView:_btncurrencyiconOnClick()
...
function Season1_5RetailView:_enterLevelInfoView(index)
...
function Season1_5RetailView:_btnsummonOnClick()
...
function Season1_5RetailView:_editableInitView()
	return
end

function Season1_5RetailView:onUpdateParam()
	return
end

function Season1_5RetailView:onOpen()
...
function Season1_5RetailView:_onRefreshRetailSuccess()
	self._waitRefreshingRetailReply = false
...
function Season1_5RetailView:onSwitchCard()
	self:_refreshLevel()
	self:_refreshTitle()
end

function Season1_5RetailView:_refreshTitle()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_5RetailView:_setStages()
...
function Season1_5RetailView:_refreshLevel()
	self:_refreshTicket()
	self:_showEntrance()
end

function Season1_5RetailView:_refreshTicket()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_5RetailView:_onChangeRetail(changeIds)
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_5RetailView:_showEntrance()
	...
	for _, v in pairs(retails) do
		...
		for i = 1, 3 do
			...
			if not self._rewardCardItems[v.position].celebrityCards[i] then
				self._rewardCardItems[v.position].celebrityCards[i] = Season1_5CelebrityCardItem.New()
...
function Season1_5RetailView:onClose()
...
function Season1_5RetailView:autoInitRetailViewCamera()
	Activity104Controller.instance:dispatchEvent(Activity104Event.ChangeCameraSize, true)
end

function Season1_5RetailView:onDestroyView()
