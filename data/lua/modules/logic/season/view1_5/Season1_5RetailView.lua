...
slot0 = class("Season1_5RetailView", BaseView)
...
function slot0.onInitView(slot0)
	...
	MainCameraMgr.instance:addView(ViewName.Season1_5RetailView, slot0.autoInitRetailViewCamera, nil, slot0)
...
function slot0._refreshConstTips(slot0)
	...
	if slot3 ~= 0 then
		if not slot0._rareCard then
			slot0._rareCard = Season1_5CelebrityCardItem.New()
	...
	for slot7, slot8 in pairs(Activity104Model.instance:getAct104Retails()) do
		...
		for slot15 = 1, 3 do
			if not slot0._rewardCardItems[slot8.position].celebrityCards[slot15] then
				slot0._rewardCardItems[slot8.position].celebrityCards[slot15] = Season1_5CelebrityCardItem.New()
