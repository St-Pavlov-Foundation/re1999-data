module("modules.logic.season.view3_0.Season3_0FightSuccView", package.seeall)

local var_0_0 = class("Season3_0FightSuccView", FightSuccView)
...
function var_0_0._showChoiceCardView(arg_13_0)
	if arg_13_0._choiceCards and #arg_13_0._choiceCards > 0 then
		...
		if var_13_1 then
			...
			Activity104Controller.instance:openSeasonEquipSelectChoiceView(var_13_2, true)
...
function var_0_0._addItem(arg_14_0, arg_14_1)
	...
	if arg_14_1.materilType == MaterialEnum.MaterialType.EquipCard then
		...
		local var_14_9 = Season3_0CelebrityCardItem.New()
