...
local var_0_0 = class("Season3_0HeroGroupFightViewRule", BaseView)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._btnenemy = gohelper.findChildButtonWithAudio(arg_1_0.viewGO, "#go_container/#scroll_info/infocontain/enemycontain/enemytitle/txten/#btn_enemy")
...
function var_0_0._refreshEnemy(arg_16_0)
	...
	elseif var_16_10.type == DungeonEnum.EpisodeType.SeasonRetail then
		local var_16_13 = SeasonConfig.instance:getSeasonRetailEpisodeCo(Activity104Model.instance:getCurSeasonId(), var_16_9)

		var_16_11 = var_16_13 and var_16_13.level or 0
