-- chunkname: @modules/logic/season/view1_2/Season1_2HeroGroupFightViewRule.lua

module("modules.logic.season.view1_2.Season1_2HeroGroupFightViewRule", package.seeall)

local Season1_2HeroGroupFightViewRule = class("Season1_2HeroGroupFightViewRule", BaseView)

function Season1_2HeroGroupFightViewRule:onInitView()
...
function Season1_2HeroGroupFightViewRule:addEvents()
...
function Season1_2HeroGroupFightViewRule:removeEvents()
...
function Season1_2HeroGroupFightViewRule:_btncloseruleOnClick()
...
function Season1_2HeroGroupFightViewRule:_btnadditionRuleOnClick()
...
function Season1_2HeroGroupFightViewRule:_btnenemyOnClick()
	EnemyInfoController.instance:openEnemyInfoViewByBattleId(HeroGroupModel.instance.battleId)
end

function Season1_2HeroGroupFightViewRule:_btnAdditionRuleDetailOnClick()
...
function Season1_2HeroGroupFightViewRule:_editableInitView()
...
function Season1_2HeroGroupFightViewRule:_refreshRules()
...
function Season1_2HeroGroupFightViewRule:_refreshAddition()
	local episodeId = HeroGroupModel.instance.episodeId
...
function Season1_2HeroGroupFightViewRule:_addRuleItem(ruleCo, targetId)
...
function Season1_2HeroGroupFightViewRule:_setRuleDescItem(ruleCo, targetId)
	local tagColor = {
		"#6680bd",
		"#d05b4c",
		"#c7b376"
...
function Season1_2HeroGroupFightViewRule:_refreshEnemy()
...
function Season1_2HeroGroupFightViewRule:_recommendCareer()
...
function Season1_2HeroGroupFightViewRule:_onRecommendCareerItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")

	UISpriteSetMgr.instance:setHeroGroupSprite(icon, "career_" .. data)
end

function Season1_2HeroGroupFightViewRule:_onEnemyItemShow(obj, data, index)
	local icon = gohelper.findChildImage(obj, "icon")
...
function Season1_2HeroGroupFightViewRule:onClose()
	self:removeEventCb(HeroGroupController.instance, HeroGroupEvent.OnModifyHeroGroup, self._recommendCareer, self)
end

function Season1_2HeroGroupFightViewRule:onDestroyView()
	return
end

return Season1_2HeroGroupFightViewRule
