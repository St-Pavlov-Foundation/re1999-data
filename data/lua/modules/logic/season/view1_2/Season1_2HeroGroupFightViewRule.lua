...
local var_0_0 = class("Season1_2HeroGroupFightViewRule", BaseView)
...
function var_0_0._refreshRules(arg_11_0)
	...
	local var_11_1 = DungeonConfig.instance:getEpisodeCO(var_11_0).type == DungeonEnum.EpisodeType.SeasonRetail
	local var_11_2 = Activity104Model.instance:getEpisodeRetail(var_11_0)
...
function var_0_0._refreshAddition(arg_12_0)
	...
	local var_12_3 = SeasonConfig.instance:filterRule(var_12_2)
...
function var_0_0._setRuleDescItem(arg_14_0, arg_14_1, arg_14_2)
	...
	var_14_5.text = string.format("<color=%s>[%s]</color>%s%s", var_14_10, var_14_9, var_14_7, var_14_8)
end
...
function var_0_0._refreshEnemy(arg_15_0)
	...
	for iter_15_0, iter_15_1 in ipairs(var_15_0.monsterGroupIds) do
		...
		for iter_15_2, iter_15_3 in ipairs(var_15_6) do
			...
			if FightHelper.isBossId(var_15_5, iter_15_3) then
	...
	if var_15_10.type == DungeonEnum.EpisodeType.Season then
		local var_15_12 = Activity104Model.instance:getBattleFinishLayer()

		var_15_11 = SeasonConfig.instance:getSeasonEpisodeCo(Activity104Model.instance:getCurSeasonId(), var_15_12).level
	elseif var_15_10.type == DungeonEnum.EpisodeType.SeasonRetail then
		local var_15_13 = Activity104Model.instance:getRetailStage()

		var_15_11 = SeasonConfig.instance:getSeasonRetailCo(Activity104Model.instance:getCurSeasonId(), var_15_13).level
	elseif var_15_10.type == DungeonEnum.EpisodeType.SeasonSpecial then
		local var_15_14 = Activity104Model.instance:getBattleFinishLayer()

		var_15_11 = SeasonConfig.instance:getSeasonSpecialCo(Activity104Model.instance:getCurSeasonId(), var_15_14).level
	end
