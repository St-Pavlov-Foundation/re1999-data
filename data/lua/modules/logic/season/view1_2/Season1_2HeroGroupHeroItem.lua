...
local var_0_0 = class("Season1_2HeroGroupHeroItem", LuaCompBase)

function var_0_0.ctor(arg_1_0, arg_1_1)
	arg_1_0._Season1_2HeroGroupListView = arg_1_1
end
...
function var_0_0.init(arg_2_0, arg_2_1)
	...
	arg_2_0._aidGO = gohelper.findChild(arg_2_1, "heroitemani/storytag")
	...
	arg_2_0._cardItem1 = Season1_2HeroGroupCardItem.New(arg_2_0._gocarditem1, arg_2_0, {
		slot = 1
	})
	arg_2_0._gocarditem2 = gohelper.findChild(arg_2_1, "heroitemani/equipcard/cardlist/carditem2")
	arg_2_0._cardItem2 = Season1_2HeroGroupCardItem.New(arg_2_0._gocarditem2, arg_2_0, {
		slot = 2
	})
...
function var_0_0.onUpdateMO(arg_3_0, arg_3_1)
	...
	local var_3_9 = HeroGroupModel.instance:getBattleRoleNum()

	arg_3_0.isRoleNumLock = var_3_9 and var_3_9 < arg_3_0.mo.id
	arg_3_0.isEmpty = arg_3_1:isEmpty()

	local var_3_10 = (arg_3_0._heroMO or arg_3_0._monsterCo) and not arg_3_0.isLock and not arg_3_0.isRoleNumLock

	gohelper.setActive(arg_3_0._gohero, var_3_10)
	gohelper.setActive(arg_3_0._gostarroot, var_3_10)
	gohelper.setActive(arg_3_0._goherolvLayout, var_3_10)

	local var_3_11 = not arg_3_0._heroMO and not arg_3_0._monsterCo or arg_3_0.isLock or arg_3_0.isAidLock or arg_3_0.isRoleNumLock

	gohelper.setActive(arg_3_0._gonone, var_3_11)

	local var_3_12 = not arg_3_0._heroMO and not arg_3_0._monsterCo and not arg_3_0.isLock and not arg_3_0.isAidLock and not arg_3_0.isRoleNumLock

	gohelper.setActive(arg_3_0._goadd, var_3_12)
	...
	if arg_3_0.isRoleNumLock and arg_3_0._heroMO ~= nil and arg_3_0._monsterCo == nil then
		...
		local var_3_13 = Activity104Model.instance:getCurSeasonId()
		local var_3_14 = Activity104Model.instance:getSeasonCurSnapshotSubId(var_3_13)
		local var_3_15 = Activity104Model.instance:getSnapshotHeroGroupBySubId(var_3_14)
		local var_3_16 = {
			groupIndex = var_3_14,
			heroGroup = var_3_15
		}

		HeroGroupModel.instance:setHeroGroupSnapshot(ModuleEnum.HeroGroupType.Season, DungeonModel.instance.curSendEpisodeId, true, var_3_16)
	end
...
function var_0_0._updateEquips(arg_10_0)
	...
	if arg_10_0.isLock or arg_10_0.isAid or arg_10_0.isRoleNumLock or not OpenModel.instance:isFunctionUnlock(OpenEnum.UnlockFunc.Equip) then
		...
		gohelper.setActive(arg_10_0._goequip, true)

		if not arg_10_0._equip then
			arg_10_0._equip = arg_10_0:getUserDataTb_()
			arg_10_0._equip.moveParent = gohelper.findChild(arg_10_0._goequip, "moveParent")
			arg_10_0._equip.moveContainer = gohelper.findChild(arg_10_0._equip.moveParent, "moveContainer")
			arg_10_0._equip.moveContainerTrs = arg_10_0._equip.moveContainer.transform
			arg_10_0._equip.equipIcon = gohelper.findChildImage(arg_10_0._equip.moveParent, "moveContainer/equipIcon")
			arg_10_0._equip.equipRare = gohelper.findChildImage(arg_10_0._equip.moveParent, "moveContainer/equiprare")
			arg_10_0._equip.equiptxtlv = gohelper.findChildText(arg_10_0._equip.moveParent, "moveContainer/equiplv/txtequiplv")
			arg_10_0._equip.equipGolv = gohelper.findChild(arg_10_0._equip.moveParent, "moveContainer/equiplv")
...
function var_0_0._updateAct104Equips(arg_11_0)
	...
	local var_11_1 = var_11_0:getAct104PosEquips(arg_11_0.mo.id - 1).equipUid or {}
	...
	if var_11_0.isReplay then
		local var_11_7 = var_11_0.replay_activity104Equip_data[arg_11_0.mo.heroUid]

		var_11_5 = var_11_7 and var_11_7[1] and var_11_7[1].equipId or 0
		var_11_6 = var_11_7 and var_11_7[2] and var_11_7[2].equipId or 0
	else
		var_11_2 = nil
	end
	...
	local var_11_8 = not arg_11_0.isAid and (arg_11_0._cardItem1.slotUnlock or arg_11_0._cardItem2.slotUnlock)
	local var_11_9 = var_11_8 and var_0_0.NonCardSlotBlackMaskHeight or var_0_0.HasCardSlotBlackMashHeight

	recthelper.setHeight(arg_11_0._goblackmask.transform, var_11_9)
	gohelper.setActive(arg_11_0._gocardlist, var_11_8)
	arg_11_0._cardItem1:setActive(var_11_8)
	arg_11_0._cardItem2:setActive(var_11_8)

	local var_11_10 = arg_11_0._cardItem1.slotUnlock and arg_11_0._cardItem2.slotUnlock and var_0_0.TwoSlotCardItem1Pos or var_0_0.SingleSlotCardItem1Pos

	recthelper.setAnchor(arg_11_0._cardItem1.transform, var_11_10.x, var_11_10.y)
end
...
function var_0_0.resetDragTransformOrder(arg_17_0)
	...
	gohelper.addChildPosStay(arg_17_0._equip.moveParent, var_17_0.gameObject)
end
...
function var_0_0.getOrignDragPos(arg_19_0)
	return arg_19_0._equip.moveParent.transform.position
end
...
function var_0_0.onDragEndSuccess(arg_21_0, arg_21_1)
	local var_21_0 = Activity104Model.instance:getRealHeroGroupBySubId()

	EquipTeamListModel.instance:openTeamEquip(arg_21_0.mo.id - 1, arg_21_0._heroMO, var_21_0)
	...
	local var_21_1 = arg_21_0:getDragTransform()
	local var_21_2 = arg_21_1:getDragTransform()

	arg_21_0:_setToPos(var_21_1, Vector2())
	arg_21_0:_setToPos(var_21_2, Vector2())
	...
	local var_21_3 = arg_21_0.mo.id - 1
	local var_21_4 = arg_21_1.mo.id - 1
	...
	local var_21_6 = EquipTeamListModel.instance:getTeamEquip(var_21_4)[1]

	var_21_6 = EquipModel.instance:getEquip(var_21_6) and var_21_6 or nil

	if var_21_6 then
		EquipTeamShowItem.removeEquip(var_21_4, true)
	end

	if var_21_5 then
		EquipTeamShowItem.replaceEquip(var_21_4, var_21_5, true)
	end

	if var_21_6 then
		EquipTeamShowItem.replaceEquip(var_21_3, var_21_6, true)
	end

	HeroGroupController.instance:dispatchEvent(HeroGroupEvent.ChangeEquip)

	local var_21_7 = Activity104Model.instance:getSeasonCurSnapshotSubId()
	local var_21_8 = {
		groupIndex = var_21_7,
		heroGroup = EquipTeamListModel.instance:getCurGroupMo()
	}

	HeroGroupModel.instance:setHeroGroupSnapshot(ModuleEnum.HeroGroupType.Season, DungeonModel.instance.curSendEpisodeId, true, var_21_8)
end
...
function var_0_0._moveToTarget(arg_25_0, arg_25_1)
	for iter_25_0, iter_25_1 in ipairs(arg_25_0._Season1_2HeroGroupListView.heroPosTrList) do
		if arg_25_0._Season1_2HeroGroupListView._heroItemList[iter_25_0] ~= arg_25_0 then
			...
			if math.abs(var_25_1.x) * 2 < recthelper.getWidth(var_25_0) and math.abs(var_25_1.y) * 2 < recthelper.getHeight(var_25_0) then
				return arg_25_0._Season1_2HeroGroupListView._heroItemList[iter_25_0]
			end
		end
	end
...
function var_0_0._setEquipDragEnabled(arg_26_0, arg_26_1)
	for iter_26_0, iter_26_1 in ipairs(arg_26_0._Season1_2HeroGroupListView._heroItemList) do
...
function var_0_0.getHeroItemList(arg_39_0)
	return arg_39_0._Season1_2HeroGroupListView:getHeroItemList()
end
