...
function Season1_2HeroGroupHeroItem:_updateAct104Equips()
	...
	local targetBlackMaskHeight = hasShowCardSlot and Season1_2HeroGroupHeroItem.NonCardSlotBlackMaskHeight or Season1_2HeroGroupHeroItem.HasCardSlotBlackMashHeight
	...
	local targetSlot1Pos = hasAllSlotUnlock and Season1_2HeroGroupHeroItem.TwoSlotCardItem1Pos or Season1_2HeroGroupHeroItem.SingleSlotCardItem1Pos
...
function Season1_2HeroGroupHeroItem:onDragEndSuccess(targetHeroItem)
	...
	local subId = Activity104Model.instance:getSeasonCurSnapshotSubId()
	local extraData = {}
