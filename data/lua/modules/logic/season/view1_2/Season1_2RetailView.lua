-- chunkname: @modules/logic/season/view1_2/Season1_2RetailView.lua

module("modules.logic.season.view1_2.Season1_2RetailView", package.seeall)

local Season1_2RetailView = class("Season1_2RetailView", BaseView)

function Season1_2RetailView:onInitView()
	...
	MainCameraMgr.instance:addView(ViewName.Season1_2RetailView, self.autoInitRetailViewCamera, nil, self)
...
function Season1_2RetailView:addEvents()
...
function Season1_2RetailView:removeEvents()
...
function Season1_2RetailView:_btngo1OnClick()
	self:_enterLevelInfoView(1)
end

function Season1_2RetailView:_btngo2OnClick()
	self:_enterLevelInfoView(2)
end

function Season1_2RetailView:_btngo3OnClick()
	self:_enterLevelInfoView(3)
end

function Season1_2RetailView:_btngo4OnClick()
	self:_enterLevelInfoView(4)
end

function Season1_2RetailView:_btngo5OnClick()
	self:_enterLevelInfoView(5)
end

function Season1_2RetailView:_btngo6OnClick()
	self:_enterLevelInfoView(6)
end

function Season1_2RetailView:_btnruledetailOnClick()
	gohelper.setActive(self._goruletipdetail, true)
end

function Season1_2RetailView:_btncloseruletipOnClick()
	gohelper.setActive(self._goruletipdetail, false)
end

function Season1_2RetailView:_btncurrencyiconOnClick()
...
function Season1_2RetailView:_enterLevelInfoView(index)
...
function Season1_2RetailView:_btnsummonOnClick()
...
function Season1_2RetailView:_editableInitView()
	return
end

function Season1_2RetailView:onUpdateParam()
	return
end

function Season1_2RetailView:onOpen()
...
function Season1_2RetailView:_onRefreshRetailSuccess()
	self._waitRefreshingRetailReply = false
...
function Season1_2RetailView:onSwitchCard()
	self:_refreshLevel()
	self:_refreshTitle()
end

function Season1_2RetailView:_refreshTitle()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_2RetailView:_setStages()
...
function Season1_2RetailView:_refreshLevel()
	self:_refreshTicket()
	self:_showEntrance()
end

function Season1_2RetailView:_refreshTicket()
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_2RetailView:_onChangeRetail(changeIds)
	local actId = Activity104Model.instance:getCurSeasonId()
	local id = SeasonConfig.instance:getRetailTicket(actId)
...
function Season1_2RetailView:_showEntrance()
	...
	for _, v in pairs(retails) do
		...
		for i = 1, 3 do
			...
			if not self._rewardCardItems[v.position].celebrityCards[i] then
				self._rewardCardItems[v.position].celebrityCards[i] = Season1_2CelebrityCardItem.New()
...
function Season1_2RetailView:onClose()
...
function Season1_2RetailView:autoInitRetailViewCamera()
	Activity104Controller.instance:dispatchEvent(Activity104Event.ChangeCameraSize, true)
end

function Season1_2RetailView:onDestroyView()
