...
local var_0_0 = class("Season1_3RetailView", BaseView)
...
function var_0_0.onInitView(arg_1_0)
	...
	MainCameraMgr.instance:addView(ViewName.Season1_3RetailView, arg_1_0.autoInitRetailViewCamera, nil, arg_1_0)
...
function var_0_0._refreshConstTips(arg_19_0)
	...
	if var_19_2 ~= 0 then
		if not arg_19_0._rareCard then
			arg_19_0._rareCard = Season1_3CelebrityCardItem.New()
...
function var_0_0._showEntrance(arg_27_0)
	...
	for iter_27_0, iter_27_1 in pairs(var_27_0) do
		...
		if iter_27_1.advancedId ~= 0 and iter_27_1.advancedRare == 2 then
			...
			gohelper.findChildText(arg_27_0["_gospecialtips" .. iter_27_1.position], "tips").text = string.format(luaLang("season_retail_specialtips"), var_27_5)
		end
		...
		for iter_27_6 = 1, 3 do
			...
			if not arg_27_0._rewardCardItems[iter_27_1.position].celebrityCards[iter_27_6] then
				arg_27_0._rewardCardItems[iter_27_1.position].celebrityCards[iter_27_6] = Season1_3CelebrityCardItem.New()
