...
local var_0_0 = class("Season1_3HeroFightViewLevel", BaseView)

function var_0_0.onInitView(arg_1_0)
	arg_1_0._goTarget = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain")
	arg_1_0._gonormalcondition = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_normalcondition")
	arg_1_0._txtnormalcondition = gohelper.findChildText(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_normalcondition/#txt_normalcondition")
	arg_1_0._gonormalfinish = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_normalcondition/#go_normalfinish")
	arg_1_0._gonormalunfinish = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_normalcondition/#go_normalunfinish")
	arg_1_0._goplatinumcondition = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition")
	arg_1_0._txtplatinumcondition = gohelper.findChildText(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition/#txt_platinumcondition")
	arg_1_0._goplatinumfinish = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition/#go_platinumfinish")
	arg_1_0._goplatinumunfinish = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition/#go_platinumunfinish")
	arg_1_0._goplatinumcondition2 = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition2")
	arg_1_0._txtplatinumcondition2 = gohelper.findChildText(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition2/#txt_platinumcondition")
	arg_1_0._goplatinumfinish2 = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition2/#go_platinumfinish")
	arg_1_0._goplatinumunfinish2 = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_platinumcondition2/#go_platinumunfinish")
	arg_1_0._gotargetlist = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList")
	arg_1_0._goplace = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/targetList/#go_place")
	arg_1_0._gostar3 = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/text/starcontainer/#go_star3")
	arg_1_0._gostar2 = gohelper.findChild(arg_1_0.viewGO, "#go_container/infocontain/targetcontain/text/starcontainer/#go_star2")
