...
slot0 = class("Season1_3HeroGroupFightViewRule", BaseView)
...
function slot0.onInitView(slot0)
	...
	slot0._goTask = gohelper.findChild(slot0.viewGO, "#go_container/infocontain/#go_task")
	slot0._txtTask = gohelper.findChildText(slot0.viewGO, "#go_container/infocontain/#go_task/#go_taskitem/#txt_task")
