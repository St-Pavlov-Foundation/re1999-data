-- chunkname: @modules/logic/versionactivity3_4/dungeon/view/map/VersionActivity3_4DungeonMapNormalInteractView.lua

module("modules.logic.versionactivity3_4.dungeon.view.map.VersionActivity3_4DungeonMapNormalInteractView", package.seeall)

local VersionActivity3_4DungeonMapNormalInteractView = class("VersionActivity3_4DungeonMapNormalInteractView", BaseViewExtended)

function VersionActivity3_4DungeonMapNormalInteractView:onInitView(go)
...
function VersionActivity3_4DungeonMapNormalInteractView:initNoneContainer()
...
function VersionActivity3_4DungeonMapNormalInteractView:initFightContainer()
...
function VersionActivity3_4DungeonMapNormalInteractView:initDialogueContainer()
...
function VersionActivity3_4DungeonMapNormalInteractView:initTalkContainer()
...
function VersionActivity3_4DungeonMapNormalInteractView:addEvents()
...
function VersionActivity3_4DungeonMapNormalInteractView:removeEvents()
...
function VersionActivity3_4DungeonMapNormalInteractView:_editableInitView()
	self._handleTypeMap = {
...
function VersionActivity3_4DungeonMapNormalInteractView:showInteractUI(mapElement)
	if self._show then
		return
	end
...
function VersionActivity3_4DungeonMapNormalInteractView:show()
	if self._show then
		return
	end
...
function VersionActivity3_4DungeonMapNormalInteractView:hide()
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshUI()
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshRewards()
...
function VersionActivity3_4DungeonMapNormalInteractView:createRewardItem()
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshNoneUI()
...
function VersionActivity3_4DungeonMapNormalInteractView:setFinishText()
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshFightUI()
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshDialogueUI()
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshTalkUI()
	self._sectionStack = {}
...
function VersionActivity3_4DungeonMapNormalInteractView:_playSection(sectionId, dialogIndex)
	self:_setSectionData(sectionId, dialogIndex)
	self:_playNextDialog()
end

function VersionActivity3_4DungeonMapNormalInteractView:_setSectionData(sectionId, dialogIndex)
...
function VersionActivity3_4DungeonMapNormalInteractView:_playNextDialog()
...
function VersionActivity3_4DungeonMapNormalInteractView:_showDialog(type, text, speaker, audio)
...
function VersionActivity3_4DungeonMapNormalInteractView:setIsChat(isChat)
	gohelper.setActive(self._godesc, not isChat)
	gohelper.setActive(self._gochat, isChat)
end

function VersionActivity3_4DungeonMapNormalInteractView:_addDialogOption(index, sectionId, text)
...
function VersionActivity3_4DungeonMapNormalInteractView:_onOptionClick(param)
...
function VersionActivity3_4DungeonMapNormalInteractView:_refreshDialogBtnState(showOption, hasNext)
...
function VersionActivity3_4DungeonMapNormalInteractView:_onClickFightBtn()
	self:hide()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
...
function VersionActivity3_4DungeonMapNormalInteractView:finishElement(dialogIds)
...
function VersionActivity3_4DungeonMapNormalInteractView:refreshElement()
	return
end

function VersionActivity3_4DungeonMapNormalInteractView:_btnnextOnClick()
	self:_playNextSectionOrDialog()
	AudioMgr.instance:trigger(AudioEnum.UI.play_ui_checkpoint_continuemesh)
end

function VersionActivity3_4DungeonMapNormalInteractView:_playNextSectionOrDialog()
	if #self._sectionList >= self._dialogIndex then
		self:_playNextDialog()
...
function VersionActivity3_4DungeonMapNormalInteractView:_btnfinishtalkOnClick()
	self:hide()
...
function VersionActivity3_4DungeonMapNormalInteractView:onDialogueInfoChange(dialogueId)
	if dialogueId == self.dialogueId then
		self:refreshDialogueUI()
	end
end

function VersionActivity3_4DungeonMapNormalInteractView:onCloseViewFinishCall(viewName)
	if viewName == ViewName.DialogueView and self.isFinish then
		self:refreshUI()
	end
end

function VersionActivity3_4DungeonMapNormalInteractView:beforeJump()
	self:hide()
end

function VersionActivity3_4DungeonMapNormalInteractView:onClose()
	return
end

function VersionActivity3_4DungeonMapNormalInteractView:onDestroyView()
	self.rootClick:RemoveClickListener()
end

return VersionActivity3_4DungeonMapNormalInteractView
