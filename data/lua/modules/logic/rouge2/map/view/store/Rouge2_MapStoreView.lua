...
function Rouge2_MapStoreView:onInitView()
	...
	self._btnEnterSteal = gohelper.findChildButtonWithAudio(self.viewGO, "#go_Other/#go_Container/#go_NormalBtns/#btn_EnterSteal")
	...
	self._btnSteal = gohelper.findChildButtonWithAudio(self.viewGO, "#go_Other/#go_Container/#go_StealBtns/#btn_Steal")
