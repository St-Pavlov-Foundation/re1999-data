...
local var_0_0 = class("V2a0_WarmUp", BaseView)

function var_0_0.onInitView(arg_1_0)
	arg_1_0._simagefullbgdark = gohelper.findChildSingleImage(arg_1_0.viewGO, "#simage_fullbg_dark")
...
function var_0_0._refreshRightView(arg_15_0)
	...
	if var_15_0 or var_15_1 then
		...
		arg_15_0:_setActive_goWrongChannel(not arg_15_0.viewContainer:checkEyeIsClicked())
	end
...
function var_0_0._refreshTabList(arg_20_0)
	...
	for iter_20_0 = 1, var_20_1 do
		...
		if iter_20_0 > #arg_20_0._itemTabList then
			var_20_4 = arg_20_0:_create_V2a0_WarmUp_radiotaskitem(iter_20_0)
...
function var_0_0._refreshRewards(arg_24_0)
	...
	for iter_24_0 = 1, var_24_2 do
		...
		if iter_24_0 > #arg_24_0._rewardItemList then
			var_24_3 = arg_24_0:_create_V2a0_WarmUp_rewarditem(iter_24_0)
...
function var_0_0.openDesc(arg_25_0, arg_25_1, arg_25_2)
	...
	local var_25_2 = arg_25_0.viewContainer:getEpisodeConfigCur().time
	...
	arg_25_0._tweenId = ZProj.TweenHelper.DOTweenFloat(1, 0, var_25_2, arg_25_0._tweenDescUpdateCb, function()
		arg_25_0:_tweenDescEndCb(var_25_2, var_25_3)
	end, arg_25_0)
end
...
function var_0_0._create_V2a0_WarmUp_radiotaskitem(arg_35_0, arg_35_1)
	local var_35_0 = gohelper.cloneInPlace(arg_35_0._goradiotaskitem)
	local var_35_1 = V2a0_WarmUp_radiotaskitem.New({
		parent = arg_35_0,
...
function var_0_0._create_V2a0_WarmUp_rewarditem(arg_36_0, arg_36_1)
	local var_36_0 = gohelper.cloneInPlace(arg_36_0._gorewarditem)
	local var_36_1 = V2a0_WarmUp_rewarditem.New({
		parent = arg_36_0,
...
function var_0_0.tweenSwitch(arg_39_0, arg_39_1, arg_39_2)
	arg_39_0:_playAnim(var_0_5, arg_39_1, arg_39_2)
end
