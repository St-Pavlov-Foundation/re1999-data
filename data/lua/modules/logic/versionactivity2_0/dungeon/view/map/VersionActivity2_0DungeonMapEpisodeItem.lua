-- chunkname: @modules/logic/versionactivity2_0/dungeon/view/map/VersionActivity2_0DungeonMapEpisodeItem.lua

module("modules.logic.versionactivity2_0.dungeon.view.map.VersionActivity2_0DungeonMapEpisodeItem", package.seeall)

local VersionActivity2_0DungeonMapEpisodeItem = class("VersionActivity2_0DungeonMapEpisodeItem", BaseChildView)

function VersionActivity2_0DungeonMapEpisodeItem:onInitView()
...
function VersionActivity2_0DungeonMapEpisodeItem:addEvents()
...
function VersionActivity2_0DungeonMapEpisodeItem:removeEvents()
...
function VersionActivity2_0DungeonMapEpisodeItem:onClick()
	if self.isLock then
	...
	local viewContainer = ViewMgr.instance:getContainer(ViewName.VersionActivity2_0DungeonMapLevelView)
...
function VersionActivity2_0DungeonMapEpisodeItem:_editableInitView()
...
function VersionActivity2_0DungeonMapEpisodeItem:_showEye()
	...
	local isHard = self._config.chapterId == VersionActivity2_0DungeonEnum.DungeonChapterId.Hard

	gohelper.setActive(self._gonormaleye, not isHard)
	gohelper.setActive(self._gohardeye, isHard)
end

function VersionActivity2_0DungeonMapEpisodeItem:initViewParam()
	self._contentTransform = self.viewParam[1]
	self._layout = self.viewParam[2]
	self._mapSceneView = self.viewContainer.mapScene
end

function VersionActivity2_0DungeonMapEpisodeItem:onUpdateParam()
	self:initViewParam()
	self:_showAllElementTipView()
end

function VersionActivity2_0DungeonMapEpisodeItem:onOpen()
	self:initViewParam()
end

function VersionActivity2_0DungeonMapEpisodeItem:getMapAllElementList()
	local normalElementCoList = VersionActivity2_0DungeonModel.instance:getElementCoList(self._map.id)

	return normalElementCoList
end

function VersionActivity2_0DungeonMapEpisodeItem:_showAllElementTipView()
	...
	local finishElementCoList, mapAllElementList = VersionActivity2_0DungeonModel.instance:getElementCoListWithFinish(self._map.id)
...
function VersionActivity2_0DungeonMapEpisodeItem:_hideAllElementTip()
	gohelper.setActive(self._gotipcontent, false)
end

function VersionActivity2_0DungeonMapEpisodeItem:refresh(config, dungeonMo)
	self._config = config
	...
	self._map = VersionActivity2_0DungeonConfig.instance:getEpisodeMapConfig(self._config.id)
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshUI()
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshLock()
	self.isLock = self:checkLock()

	gohelper.setActive(self.goLock, self:checkLock())
end

function VersionActivity2_0DungeonMapEpisodeItem:initElementIdList()
...
function VersionActivity2_0DungeonMapEpisodeItem:clearElementIdList()
	self.elementIdList = nil
end

function VersionActivity2_0DungeonMapEpisodeItem:checkLock()
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshStar()
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshFlag()
	gohelper.setActive(self._goflag, false)
end

function VersionActivity2_0DungeonMapEpisodeItem:refreshUnlockContent()
	if self.pass then
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshHardModeStar()
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshStoryModeStar()
	local starItem
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshEpisodeStar(starItem, episodeId)
...
function VersionActivity2_0DungeonMapEpisodeItem:refreshFocusStatus()
	gohelper.setActive(self.goSelected, self._config.id == self.activityDungeonMo.episodeId)
end

function VersionActivity2_0DungeonMapEpisodeItem:beginShowRewardView()
	self.beginReward = true
end

function VersionActivity2_0DungeonMapEpisodeItem:endShowRewardView()
...
function VersionActivity2_0DungeonMapEpisodeItem:calculatePosInContent()
	...
	self._maxWidth = math.max(halfWidth * 2, VersionActivity2_0DungeonEnum.EpisodeItemMinWidth) + 30
...
function VersionActivity2_0DungeonMapEpisodeItem:setImage(image, light, episodeId)
	local episodeConfig = DungeonConfig.instance:getEpisodeCO(episodeId)
	local starType = VersionActivity2_0DungeonEnum.EpisodeStarType[episodeConfig.chapterId]
	local lightStateIcon = light and starType.light or starType.empty

	UISpriteSetMgr.instance:setV2a0DungeonSprite(image, lightStateIcon)
end

function VersionActivity2_0DungeonMapEpisodeItem:getMaxWidth()
	return self._maxWidth
end

function VersionActivity2_0DungeonMapEpisodeItem:updateSelectStatus(selectedItem, ignoreAni)
...
function VersionActivity2_0DungeonMapEpisodeItem:onRemoveElement(elementId)
...
function VersionActivity2_0DungeonMapEpisodeItem:playUnLockAnimation()
	local animator = self.goLock:GetComponent(typeof(UnityEngine.Animator))

	animator.enabled = true
end

function VersionActivity2_0DungeonMapEpisodeItem:playAnimation(animationName)
...
function VersionActivity2_0DungeonMapEpisodeItem:getEpisodeId()
	return self._config and self._config.id
end

function VersionActivity2_0DungeonMapEpisodeItem:createStarItem(goStar)
...
function VersionActivity2_0DungeonMapEpisodeItem:onClose()
	TaskDispatcher.cancelTask(self._hideAllElementTip, self)
end

function VersionActivity2_0DungeonMapEpisodeItem:onDestroyView()
	self.goClick:RemoveClickListener()
end

return VersionActivity2_0DungeonMapEpisodeItem
