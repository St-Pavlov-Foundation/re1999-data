...
function VersionActivity2_0DungeonMapEpisodeView:addEvents()
	...
	self:addEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, self.hideUI, self)
	self:addEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_0DungeonMapEpisodeView:removeEvents()
	...
	self:removeEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnClickElement, self.hideUI, self)
	self:removeEventCb(VersionActivity2_0DungeonController.instance, VersionActivity2_0DungeonEvent.OnHideInteractUI, self.showUI, self)
