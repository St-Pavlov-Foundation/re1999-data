...
local var_0_0 = class("VersionActivity2_0DungeonMapLevelView", BaseView)
local var_0_1 = 0.4
local var_0_2 = 2.7
...
function var_0_0.startBattle(arg_11_0)
	...
	if arg_11_0.isSpecialEpisode then
		...
		local var_11_0 = VersionActivity2_0DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
		local var_11_1 = cjson.encode(arg_11_0.lastEpisodeSelectModeDict)

		VersionActivity2_0DungeonController.instance:savePlayerPrefs(var_11_0, var_11_1)
	end
...
function var_0_0.initLocalEpisodeMode(arg_23_0)
	local var_23_0 = VersionActivity2_0DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local var_23_1 = VersionActivity2_0DungeonController.instance:getPlayerPrefs(var_23_0, "")

	arg_23_0.unlockedEpisodeModeDict = VersionActivity2_0DungeonController.instance:loadDictFromStr(var_23_1)

	local var_23_2 = VersionActivity2_0DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
	local var_23_3 = VersionActivity2_0DungeonController.instance:getPlayerPrefs(var_23_2, "")

	arg_23_0.lastEpisodeSelectModeDict = VersionActivity2_0DungeonController.instance:loadDictFromStr(var_23_3)
end
...
function var_0_0.initViewParam(arg_26_0)
	...
	arg_26_0.index = VersionActivity2_0DungeonConfig.instance:getEpisodeIndex(arg_26_0.originEpisodeId)
...
function var_0_0.markSelectEpisode(arg_29_0)
	if arg_29_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act2_0Dungeon then
...
function var_0_0.refreshEpisodeTextInfo(arg_34_0)
	...
	if var_34_0.id == VersionActivity2_0DungeonEnum.DungeonChapterId.Story then
		var_34_1 = arg_34_0.showEpisodeCo
	else
		var_34_1 = VersionActivity2_0DungeonConfig.instance:getStoryEpisodeCo(arg_34_0.showEpisodeCo.id)
	end
	...
	local var_34_3 = FightHelper.getEpisodeRecommendLevel(arg_34_0.showEpisodeCo.id)
...
function var_0_0.setStarImage(arg_38_0, arg_38_1, arg_38_2, arg_38_3)
	...
	local var_38_1 = VersionActivity2_0DungeonEnum.EpisodeStarType[var_38_0.chapterId]

	if arg_38_2 then
		local var_38_2 = var_38_1.light

		UISpriteSetMgr.instance:setV2a0DungeonSprite(arg_38_1, var_38_2)
	else
		local var_38_3 = var_38_1.empty

		UISpriteSetMgr.instance:setV2a0DungeonSprite(arg_38_1, var_38_3)
	end
end
...
function var_0_0.refreshEye(arg_44_0)
	...
	local var_44_0 = arg_44_0.originEpisodeConfig.chapterId == VersionActivity2_0DungeonEnum.DungeonChapterId.Hard
...
function var_0_0.onModeUnlockAnimationPlayDone(arg_47_0)
	...
	local var_47_0 = VersionActivity2_0DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local var_47_1 = cjson.encode(arg_47_0.unlockedEpisodeModeDict)

	VersionActivity2_0DungeonController.instance:savePlayerPrefs(var_47_0, var_47_1)
