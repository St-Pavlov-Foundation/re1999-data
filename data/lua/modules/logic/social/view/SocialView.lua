...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._gorequestreddot = gohelper.findChild(arg_1_0.viewGO, "container/tabbuttons/request/#go_requestreddot")
...
function var_0_0.onOpen(arg_6_0)
	...
	RedDotController.instance:addRedDot(arg_6_0._gorequestreddot, RedDotEnum.DotNode.AddFriendTab)
...
function var_0_0._refreshTabViewInfo(arg_8_0)
	if arg_8_0._selectTabIndex == SocialEnum.TabIndex.Friend then
		...
		recthelper.setAnchor(arg_8_0._gobottom.transform, -340, -473)
	elseif arg_8_0._selectTabIndex == SocialEnum.TabIndex.Black then
		...
		recthelper.setAnchor(arg_8_0._gobottom.transform, -350, -422)
	else
		gohelper.setActive(arg_8_0._gobottom, false)
	end

	local var_8_2 = arg_8_0._selectTabIndex == SocialEnum.TabIndex.Friend and gohelper.findChild(arg_8_0._gofriendselected, "#txt_itemcn2") or gohelper.findChild(arg_8_0._btnfriend.gameObject, "#txt_itemcn1")
	local var_8_3 = arg_8_0._selectTabIndex == SocialEnum.TabIndex.Request and gohelper.findChild(arg_8_0._gorequestselected, "#txt_itemcn2") or gohelper.findChild(arg_8_0._btnrequest.gameObject, "#txt_itemcn1")
	local var_8_4 = 20
	local var_8_5 = -10
	...
	transformhelper.setLocalPosXY(arg_8_0._gorequestreddot.transform, var_8_8 + recthelper.getWidth(var_8_3.transform) + var_8_4, var_8_9 + recthelper.getHeight(var_8_3.transform) / 2 + var_8_5)
end
