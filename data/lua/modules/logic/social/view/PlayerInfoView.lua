...
function slot0.onInitView(slot0)
	...
	slot0._imagebg = gohelper.findChildImage(slot0.viewGO, "scrollview/#simage_bg")
	slot0._goskinbg = gohelper.findChild(slot0.viewGO, "scrollview/#go_skinbg")
	...
	slot0._btnaddfriend = gohelper.findChildButtonWithAudio(slot0.viewGO, "scrollview/viewport/buttonscontainer/#btn_addfriend")
	slot0._btnremovefriend = gohelper.findChildButtonWithAudio(slot0.viewGO, "scrollview/viewport/buttonscontainer/#btn_removefriend")
	slot0._btnroom = gohelper.findChildButtonWithAudio(slot0.viewGO, "scrollview/viewport/buttonscontainer/#btn_room")
	slot0._btnaddblacklist = gohelper.findChildButtonWithAudio(slot0.viewGO, "scrollview/viewport/buttonscontainer/#btn_addblacklist")
	slot0._btnremoveblacklist = gohelper.findChildButtonWithAudio(slot0.viewGO, "scrollview/viewport/buttonscontainer/#btn_removeblacklist")
...
function slot0._editableInitView(slot0)
	...
	UISpriteSetMgr.instance:setSocialSkinSprite(slot0._imagebg, "img_tips_bg", true)
