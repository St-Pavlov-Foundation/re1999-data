...
function slot0.onInitView(slot0)
	...
	slot0._goImageLock = gohelper.findChild(slot0.viewGO, "Map/Path1/#go_NextBtn/Root/Info/#txt_StageName/#image_Lock")
...
function slot0.onSetVisible(slot0, slot1)
	if slot1 then
		slot0:_refreshNodeItemViews()
		slot0:_switchToStage(Va3ChessConfig.instance:getEpisodeCo(VersionActivity1_3Enum.ActivityId.Act304, Activity122Model.instance:getCurEpisodeId()) and slot4.chapterId or 1)
		slot0:_refreshNextChapterView()
	end
end
