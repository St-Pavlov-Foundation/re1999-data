...
function var_0_0.refreshRemainTime(arg_11_0)
	...
	if var_11_1 > 0 then
		arg_11_0._txtremaintime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_11_1, luaLang("time_day"), var_11_3, luaLang("time_hour")))
	else
		local var_11_4 = var_11_2 % TimeUtil.OneHourSecond
		local var_11_5 = Mathf.Floor(var_11_4 / TimeUtil.OneMinuteSecond)

		if var_11_3 > 0 then
			arg_11_0._txtremaintime.text = string.format(luaLang("remain"), string.format("%s%s%s%s", var_11_3, luaLang("time_hour"), var_11_5, luaLang("time_minute2")))
		elseif var_11_5 > 0 then
			arg_11_0._txtremaintime.text = string.format(luaLang("remain"), string.format("%s%s", var_11_5, luaLang("time_minute")))
		else
