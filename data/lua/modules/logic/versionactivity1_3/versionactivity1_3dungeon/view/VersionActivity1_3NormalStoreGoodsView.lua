...
local var_0_0 = class("VersionActivity1_3NormalStoreGoodsView", BaseView)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtremain = gohelper.findChildText(arg_1_0.viewGO, "root/propinfo/info/remain/#txt_remain")
...
function var_0_0.onBuyGoodsSuccess(arg_17_0)
	arg_17_0:closeThis()
end
...
function var_0_0.onDestroyView(arg_19_0)
	arg_19_0._simageleftbg:UnLoadImage()
	arg_19_0._simagerightbg:UnLoadImage()
	arg_19_0._simageicon:UnLoadImage()
	arg_19_0._simagecosticon:UnLoadImage()
end
