-- chunkname: @modules/logic/versionactivity1_3/versionactivity1_3dungeon/view/VersionActivity1_3NormalStoreGoodsView.lua

module("modules.logic.versionactivity1_3.versionactivity1_3dungeon.view.VersionActivity1_3NormalStoreGoodsView", package.seeall)

local VersionActivity1_3NormalStoreGoodsView = class("VersionActivity1_3NormalStoreGoodsView", BaseView)

function VersionActivity1_3NormalStoreGoodsView:onInitView()
	...
	self._txtremain = gohelper.findChildText(self.viewGO, "root/propinfo/info/remain/#txt_remain")
	...
	self._simagecosticon = gohelper.findChildSingleImage(self.viewGO, "root/#go_buy/cost/#simage_costicon")
...
function VersionActivity1_3NormalStoreGoodsView:addEvents()
...
function VersionActivity1_3NormalStoreGoodsView:removeEvents()
...
function VersionActivity1_3NormalStoreGoodsView:_onEndEdit(value)
...
function VersionActivity1_3NormalStoreGoodsView:_btnclickOnClick()
	MaterialTipController.instance:showMaterialInfo(self.itemType, self.itemId)
end

function VersionActivity1_3NormalStoreGoodsView:_btnminOnClick()
	self.currentBuyCount = 1

	self:refreshByCount()
end

function VersionActivity1_3NormalStoreGoodsView:_btnsubOnClick()
...
function VersionActivity1_3NormalStoreGoodsView:_btnaddOnClick()
...
function VersionActivity1_3NormalStoreGoodsView:_btnmaxOnClick()
	self.currentBuyCount = math.max(self.maxBuyCount, 1)

	self:refreshByCount()
end

function VersionActivity1_3NormalStoreGoodsView:_btnbuyOnClick()
	if self.currentBuyCount > self.maxBuyCount then
		GameFacade.showToast(ToastEnum.DiamondBuy, self.costName)
...
function VersionActivity1_3NormalStoreGoodsView:_btncloseOnClick()
	self:closeThis()
end

function VersionActivity1_3NormalStoreGoodsView:_editableInitView()
...
function VersionActivity1_3NormalStoreGoodsView:onUpdateParam()
	return
end

function VersionActivity1_3NormalStoreGoodsView:onOpen()
...
function VersionActivity1_3NormalStoreGoodsView:refreshUI()
...
function VersionActivity1_3NormalStoreGoodsView:refreshByCount()
...
function VersionActivity1_3NormalStoreGoodsView:onBuyGoodsSuccess()
	self:closeThis()
end

function VersionActivity1_3NormalStoreGoodsView:onClose()
	AudioMgr.instance:trigger(AudioEnum.UI.UI_Mail_switch)
end

function VersionActivity1_3NormalStoreGoodsView:onDestroyView()
...
return VersionActivity1_3NormalStoreGoodsView
