...
slot0 = class("VersionActivity1_3DungeonBaseMapLevelView", BaseView)
...
function slot0.initLocalEpisodeMode(slot0)
	slot0.unlockedEpisodeModeDict = slot0:loadDict(VersionActivity1_3EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode))
	slot0.lastEpisodeSelectModeDict = slot0:loadDict(VersionActivity1_3EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode))
end
...
function slot0._showEye(slot0)
	...
	slot2 = slot0.originEpisodeConfig.chapterId == VersionActivity1_3DungeonEnum.DungeonChapterId.LeiMiTeBeiHard
...
function slot0._editableInitView(slot0)
	...
	slot0._simageactivitynormalbg:LoadImage("singlebg/v1a3_dungeon_singlebg/v1a3_dungeon_normaldetailpanelbg.png")
	slot0._simageactivityhardbg:LoadImage("singlebg/v1a3_dungeon_singlebg/v1a3_dungeon_harddetailpanelbg.png")
...
function slot0.initViewParam(slot0)
	...
	slot0.normalConfig = DungeonConfig.instance:getVersionActivityDungeonNormalEpisode(slot0.originEpisodeId, VersionActivity1_3DungeonEnum.DungeonChapterId.LeiMiTeBeiHard, VersionActivity1_3DungeonEnum.DungeonChapterId.LeiMiTeBei)
...
function slot0.markSelectEpisode(slot0)
	if slot0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Act1_3Dungeon or slot0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Boss then
...
function slot0.saveEpisodeUnlockMode(slot0)
	PlayerPrefsHelper.setString(slot0:getKey(VersionActivity1_3EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode)), cjson.encode(slot0.unlockedEpisodeModeDict))
end

function slot0.saveEpisodeLastSelectMode(slot0)
	PlayerPrefsHelper.setString(slot0:getKey(VersionActivity1_3EnterController.GetActivityPrefsKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode)), cjson.encode(slot0.lastEpisodeSelectModeDict))
end
