...
local var_0_0 = class("VersionActivity1_3DungeonBaseChapterLayout", BaseChildView)
...
function var_0_0._onGamepadKeyUp(arg_7_0, arg_7_1)
	...
	if (var_7_1 == ViewName.VersionActivity1_3DungeonMapView or var_7_1 == ViewName.VersionActivity1_3DungeonMapLevelView) and arg_7_0._focusIndex and not DungeonMapModel.instance:getMapInteractiveItemVisible() and (arg_7_1 == GamepadEnum.KeyCode.LB or arg_7_1 == GamepadEnum.KeyCode.RB) then
...
function var_0_0._onOpenView(arg_15_0, arg_15_1)
	if arg_15_1 == ViewName.VersionActivity1_3DungeonMapLevelView then
		arg_15_0._timelineAnimation:Play("timeline_mask")
	end
end

function var_0_0._onCloseView(arg_16_0, arg_16_1)
	if arg_16_1 == ViewName.VersionActivity1_3DungeonMapLevelView then
...
function var_0_0.onClose(arg_22_0)
	for iter_22_0, iter_22_1 in pairs(arg_22_0._episodeContainerItemList) do
