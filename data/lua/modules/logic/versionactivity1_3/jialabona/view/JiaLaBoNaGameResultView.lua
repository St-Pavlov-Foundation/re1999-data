...
function var_0_0.refreshLose(arg_19_0)
	...
	local var_19_1 = JiaLaBoNaEnum.ResultLangResPath[var_19_0] or JiaLaBoNaEnum.ResultLangResPath[Va3ChessEnum.FailReason.None]

	arg_19_0._simageFailtitle:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(var_19_1))
end
