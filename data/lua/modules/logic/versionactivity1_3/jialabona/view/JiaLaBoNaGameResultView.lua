...
function JiaLaBoNaGameResultView:refreshLose()
	...
	local langUrl = JiaLaBoNaEnum.ResultLangResPath[failReason] or JiaLaBoNaEnum.ResultLangResPath[Va3ChessEnum.FailReason.None]

	self._simageFailtitle:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(langUrl))
end
