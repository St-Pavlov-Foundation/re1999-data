...
function slot0.refreshLose(slot0)
	...
	slot0._simageFailtitle:LoadImage(SLFramework.LanguageMgr.Instance:GetLangPathFromAssetPath(JiaLaBoNaEnum.ResultLangResPath[Va3ChessGameModel.instance:getFailReason()] or JiaLaBoNaEnum.ResultLangResPath[Va3ChessEnum.FailReason.None]))
end
