...
slot0 = class("VersionActivity2_1EnterViewContainer", BaseViewContainer)
...
function slot0.buildTabViews(slot0, slot1)
	...
	elseif slot1 == 2 then
		slot2 = {
			[#slot2 + 1] = V2a1_DungeonEnterView.New(),
			[#slot2 + 1] = V2a1_Season123EnterView.New(),
			[#slot2 + 1] = V1a6_BossRush_EnterView.New(),
			[#slot2 + 1] = LanShouPaEnterView.New(),
			[#slot2 + 1] = AergusiEnterView.New(),
			[#slot2 + 1] = V2a1_RougeEnterView.New(),
