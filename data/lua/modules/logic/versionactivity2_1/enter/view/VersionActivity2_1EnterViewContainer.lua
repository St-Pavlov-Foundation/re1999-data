...
local var_0_0 = class("VersionActivity2_1EnterViewContainer", BaseViewContainer)
...
function var_0_0.buildTabViews(arg_2_0, arg_2_1)
	...
	elseif arg_2_1 == 2 then
		...
		var_2_0[#var_2_0 + 1] = V2a1_DungeonEnterView.New()
		var_2_0[#var_2_0 + 1] = V2a1_Season123EnterView.New()
		var_2_0[#var_2_0 + 1] = V1a6_BossRush_EnterView.New()
		var_2_0[#var_2_0 + 1] = LanShouPaEnterView.New()
		var_2_0[#var_2_0 + 1] = AergusiEnterView.New()
		var_2_0[#var_2_0 + 1] = V2a1_RougeEnterView.New()
