-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/maplevel/VersionActivity2_1DungeonMapLevelView.lua

module("modules.logic.versionactivity2_1.dungeon.view.maplevel.VersionActivity2_1DungeonMapLevelView", package.seeall)

local VersionActivity2_1DungeonMapLevelView = class("VersionActivity2_1DungeonMapLevelView", BaseView)
local OPEN_ANIM_TIME = 0.4
local UNLOCK_ANIM_TIME = 2.7

function VersionActivity2_1DungeonMapLevelView:onInitView()
...
function VersionActivity2_1DungeonMapLevelView:addEvents()
...
function VersionActivity2_1DungeonMapLevelView:removeEvents()
...
function VersionActivity2_1DungeonMapLevelView:_onCurrencyChange(changeIds)
...
function VersionActivity2_1DungeonMapLevelView:_btnleftarrowOnClick()
...
function VersionActivity2_1DungeonMapLevelView:_btnrightarrowOnClick()
	local isHardMode = self.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard
...
function VersionActivity2_1DungeonMapLevelView:refreshUIByMode(mode)
...
function VersionActivity2_1DungeonMapLevelView:_btnactivityrewardOnClick()
	DungeonController.instance:openDungeonRewardView(self.showEpisodeCo)
end

function VersionActivity2_1DungeonMapLevelView:_btnnormalStartOnClick()
...
function VersionActivity2_1DungeonMapLevelView:_btnhardStartOnClick()
	self:startBattle()
end

function VersionActivity2_1DungeonMapLevelView:startBattle()
	...
	if self.isSpecialEpisode then
		...
		local prefsKey = VersionActivity2_1DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
		local strLastSelectMode = cjson.encode(self.lastEpisodeSelectModeDict)

		VersionActivity2_1DungeonController.instance:savePlayerPrefs(prefsKey, strLastSelectMode)
	end
...
function VersionActivity2_1DungeonMapLevelView:_playSkipMainStory()
	DungeonRpc.instance:sendStartDungeonRequest(self.showEpisodeCo.chapterId, self.showEpisodeCo.id)
	self:onStoryFinished()
end

function VersionActivity2_1DungeonMapLevelView:_playMainStory()
	DungeonRpc.instance:sendStartDungeonRequest(self.showEpisodeCo.chapterId, self.showEpisodeCo.id)
...
function VersionActivity2_1DungeonMapLevelView:onStoryFinished()
...
function VersionActivity2_1DungeonMapLevelView:_playStoryAndEnterFight(storyId)
...
function VersionActivity2_1DungeonMapLevelView:_enterFight()
	DungeonFightController.instance:enterFight(self.showEpisodeCo.chapterId, self.showEpisodeCo.id, 1)
end

function VersionActivity2_1DungeonMapLevelView:playAfterStory(storyId)
	local param = {}
...
function VersionActivity2_1DungeonMapLevelView:_btnlockStartOnClick()
	local preModeName = self:getPreModeName()

	GameFacade.showToast(ToastEnum.VersionActivityCanFight, preModeName)
end

function VersionActivity2_1DungeonMapLevelView:getPreModeName()
...
function VersionActivity2_1DungeonMapLevelView:_btnreplayStoryOnClick()
...
function VersionActivity2_1DungeonMapLevelView:_editableInitView()
	self.rewardItems = {}
...
function VersionActivity2_1DungeonMapLevelView:initLocalEpisodeMode()
	local unlockModePrefsKey = VersionActivity2_1DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local strLastUnlockModeValue = VersionActivity2_1DungeonController.instance:getPlayerPrefs(unlockModePrefsKey, "")

	self.unlockedEpisodeModeDict = VersionActivity2_1DungeonController.instance:loadDictFromStr(strLastUnlockModeValue)

	local lastSelectModePrefsKey = VersionActivity2_1DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode
	local strLastSelectModeValue = VersionActivity2_1DungeonController.instance:getPlayerPrefs(lastSelectModePrefsKey, "")

	self.lastEpisodeSelectModeDict = VersionActivity2_1DungeonController.instance:loadDictFromStr(strLastSelectModeValue)
end

function VersionActivity2_1DungeonMapLevelView:onUpdateParam()
	self:onOpen()
	self.animator:Play(UIAnimationName.Open, 0, 0)
end

function VersionActivity2_1DungeonMapLevelView:onOpen()
...
function VersionActivity2_1DungeonMapLevelView:initViewParam()
	...
	self.index = VersionActivity2_1DungeonConfig.instance:getEpisodeIndex(self.originEpisodeId)
...
function VersionActivity2_1DungeonMapLevelView:initMode()
...
function VersionActivity2_1DungeonMapLevelView:checkNeedPlayModeUnLockAnimation()
...
function VersionActivity2_1DungeonMapLevelView:markSelectEpisode()
...
function VersionActivity2_1DungeonMapLevelView:refreshStoryIdList()
...
function VersionActivity2_1DungeonMapLevelView:refreshBg()
...
function VersionActivity2_1DungeonMapLevelView:refreshUI()
...
function VersionActivity2_1DungeonMapLevelView:refreshModeCanFight()
...
function VersionActivity2_1DungeonMapLevelView:refreshEpisodeTextInfo()
	local chapterCo = DungeonConfig.instance:getChapterCO(self.showEpisodeCo.chapterId)
	local targetConfig

	if chapterCo.id == VersionActivity2_1DungeonEnum.DungeonChapterId.Story then
		targetConfig = self.showEpisodeCo
	else
		targetConfig = VersionActivity2_1DungeonConfig.instance:getStoryEpisodeCo(self.showEpisodeCo.id)
	end
...
function VersionActivity2_1DungeonMapLevelView:buildEpisodeName(episodeCo)
...
function VersionActivity2_1DungeonMapLevelView:buildColorText(text, color)
	return string.format("<color=%s>%s</color>", color, text)
end

function VersionActivity2_1DungeonMapLevelView:refreshStar()
...
function VersionActivity2_1DungeonMapLevelView:setStarImage(image, light, episodeId)
	local episodeConfig = DungeonConfig.instance:getEpisodeCO(episodeId)
	local starTypeData = VersionActivity2_1DungeonEnum.EpisodeStarType[episodeConfig.chapterId]

	if light then
		local starType = starTypeData.light

		UISpriteSetMgr.instance:setV2a1DungeonSprite(image, starType)
	else
...
function VersionActivity2_1DungeonMapLevelView:refreshMode()
...
function VersionActivity2_1DungeonMapLevelView:refreshArrow()
...
function VersionActivity2_1DungeonMapLevelView:refreshReward()
	local rewardList = {}
...
function VersionActivity2_1DungeonMapLevelView:refreshStartBtn()
	self:refreshCostPower()
...
function VersionActivity2_1DungeonMapLevelView:refreshCostPower()
	local cost = 0
...
function VersionActivity2_1DungeonMapLevelView:refreshEye()
	...
	local isHard = self.originEpisodeConfig.chapterId == VersionActivity2_1DungeonEnum.DungeonChapterId.Hard

	gohelper.setActive(self._gonormaleye, not isHard)
	gohelper.setActive(self._gohardeye, isHard)
end

function VersionActivity2_1DungeonMapLevelView:playModeUnlockAnimation()
	if not self.needPlayUnlockModeAnimation then
		return
	end
	...
	UIBlockMgr.instance:startBlock(VersionActivity2_1DungeonEnum.BlockKey.MapLevelViewPlayUnlockAnim)
	TaskDispatcher.runDelay(self.onModeUnlockAnimationPlayDone, self, UNLOCK_ANIM_TIME)
end

function VersionActivity2_1DungeonMapLevelView:_playModeUnLockAnimation(animationName)
	self.lockTypeAnimator.enabled = true
...
function VersionActivity2_1DungeonMapLevelView:onModeUnlockAnimationPlayDone()
	self:_playModeUnLockAnimation(UIAnimationName.Idle)

	self.unlockedEpisodeModeDict[tostring(self.specialEpisodeId)] = self.mode

	local prefsKey = VersionActivity2_1DungeonEnum.PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode
	local strLastUnlockMode = cjson.encode(self.unlockedEpisodeModeDict)

	VersionActivity2_1DungeonController.instance:savePlayerPrefs(prefsKey, strLastUnlockMode)

	self.needPlayUnlockModeAnimation = false

	self:refreshMode()
	self:refreshStartBtn()
	UIBlockMgr.instance:endBlock(VersionActivity2_1DungeonEnum.BlockKey.MapLevelViewPlayUnlockAnim)
end

function VersionActivity2_1DungeonMapLevelView:onClose()
...
function VersionActivity2_1DungeonMapLevelView:onDestroyView()
	self.rewardItems = nil

	self._simagepower:UnLoadImage()
end

return VersionActivity2_1DungeonMapLevelView
