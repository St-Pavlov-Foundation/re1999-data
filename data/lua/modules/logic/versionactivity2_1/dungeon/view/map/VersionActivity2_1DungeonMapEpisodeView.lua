-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/map/VersionActivity2_1DungeonMapEpisodeView.lua

module("modules.logic.versionactivity2_1.dungeon.view.map.VersionActivity2_1DungeonMapEpisodeView", package.seeall)

local VersionActivity2_1DungeonMapEpisodeView = class("VersionActivity2_1DungeonMapEpisodeView", BaseView)
...
function VersionActivity2_1DungeonMapEpisodeView:onInitView()
...
function VersionActivity2_1DungeonMapEpisodeView:addEvents()
	...
	self:addEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.hideUI, self)
	self:addEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_1DungeonMapEpisodeView:removeEvents()
	...
	self:removeEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnClickElement, self.hideUI, self)
	self:removeEventCb(VersionActivity2_1DungeonController.instance, VersionActivity2_1DungeonEvent.OnHideInteractUI, self.showUI, self)
...
function VersionActivity2_1DungeonMapEpisodeView:_editableInitView()
...
function VersionActivity2_1DungeonMapEpisodeView:onUpdateParam()
	self:refreshModeNode()
	self.chapterLayout:refreshEpisodeNodes()
	self:playOnOpenAnimation()
end

function VersionActivity2_1DungeonMapEpisodeView:onOpen()
	self:initChapterEpisodes()
	self:refreshModeNode()
	TaskDispatcher.runRepeat(self.refreshModeLockText, self, TimeUtil.OneMinuteSecond)
end

function VersionActivity2_1DungeonMapEpisodeView:onOpenFinish()
	self:playUnlockAnimation(true)
end

function VersionActivity2_1DungeonMapEpisodeView:refreshModeNode()
...
function VersionActivity2_1DungeonMapEpisodeView:initChapterEpisodes()
...
function VersionActivity2_1DungeonMapEpisodeView:onLoadLayoutFinish()
...
function VersionActivity2_1DungeonMapEpisodeView:refreshModeLockText()
	local openTimeStamp = VersionActivityConfig.instance:getAct113DungeonChapterOpenTimeStamp(VersionActivity2_1DungeonEnum.DungeonChapterId.Hard)
...
function VersionActivity2_1DungeonMapEpisodeView:onModeChange()
	self:refreshModeNode()
	self.chapterLayout:playAnimation("switch")
	self.chapterLayout:refreshEpisodeNodes()
end

function VersionActivity2_1DungeonMapEpisodeView:showUI()
	self:setLayoutVisible(true)
end

function VersionActivity2_1DungeonMapEpisodeView:hideUI()
	self:setLayoutVisible(false)
end

function VersionActivity2_1DungeonMapEpisodeView:_onRecheckInteractive(isShow)
	if isShow then
		self:showUI()
	else
		self:hideUI()
...
function VersionActivity2_1DungeonMapEpisodeView:setLayoutVisible(isShow)
...
function VersionActivity2_1DungeonMapEpisodeView:_onUpdateDungeonInfo()
...
function VersionActivity2_1DungeonMapEpisodeView:_onCloseViewFinish(viewName)
...
function VersionActivity2_1DungeonMapEpisodeView:dailyRefresh()
	self:refreshModeNode()
	self:playUnlockAnimation()
end

function VersionActivity2_1DungeonMapEpisodeView:btnStoryModeClick()
	self:changeEpisodeMode(VersionActivityDungeonBaseEnum.DungeonMode.Story)
end

function VersionActivity2_1DungeonMapEpisodeView:btnHardModeClick()
...
function VersionActivity2_1DungeonMapEpisodeView:checkHardModeIsOpen()
	local dungeonActId = VersionActivity2_1Enum.ActivityId.Dungeon

	return VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapterAndGetToast(dungeonActId)
end

function VersionActivity2_1DungeonMapEpisodeView:changeEpisodeMode(mode)
...
function VersionActivity2_1DungeonMapEpisodeView:directChangeMode()
	self.activityDungeonMo:changeMode(self.activityDungeonMo.mode)
end

function VersionActivity2_1DungeonMapEpisodeView:_onDragBeginHandler()
	self._audioScroll:onDragBegin()
end

function VersionActivity2_1DungeonMapEpisodeView:_onDragEndHandler()
	self._audioScroll:onDragEnd()
end

function VersionActivity2_1DungeonMapEpisodeView:_onClickDownHandler()
	self._audioScroll:onClickDown()
end

function VersionActivity2_1DungeonMapEpisodeView:playOnOpenAnimation()
...
function VersionActivity2_1DungeonMapEpisodeView:playUnlockAnimation(needDone)
	...
	if isNeedPlayHardModeUnlockAnim then
		local prefsKey = VersionActivity2_1DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim

		VersionActivity2_1DungeonController.instance:savePlayerPrefs(prefsKey, HAVE_PLAYED)
...
function VersionActivity2_1DungeonMapEpisodeView:IsNeedPlayHardModeUnlockAnimation()
	local isNeedPlay = false
	local prefsKey = VersionActivity2_1DungeonEnum.PlayerPrefsKey.HasPlayedUnlockHardModeBtnAnim
	local value = VersionActivity2_1DungeonController.instance:getPlayerPrefs(prefsKey, NOT_PLAYED)
...
function VersionActivity2_1DungeonMapEpisodeView:_unlockAniDone()
	local dungeonActId = VersionActivity2_1Enum.ActivityId.Dungeon
	local isOpen = VersionActivityDungeonBaseController.instance:isOpenActivityHardDungeonChapter(dungeonActId)
...
function VersionActivity2_1DungeonMapEpisodeView:onDestroyView()
...
return VersionActivity2_1DungeonMapEpisodeView
