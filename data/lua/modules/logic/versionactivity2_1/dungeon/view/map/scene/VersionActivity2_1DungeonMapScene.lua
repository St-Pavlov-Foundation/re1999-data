-- chunkname: @modules/logic/versionactivity2_1/dungeon/view/map/scene/VersionActivity2_1DungeonMapScene.lua

module("modules.logic.versionactivity2_1.dungeon.view.map.scene.VersionActivity2_1DungeonMapScene", package.seeall)

local VersionActivity2_1DungeonMapScene = class("VersionActivity2_1DungeonMapScene", BaseView)

function VersionActivity2_1DungeonMapScene:onInitView()
...
function VersionActivity2_1DungeonMapScene:addEvents()
...
function VersionActivity2_1DungeonMapScene:removeEvents()
...
function VersionActivity2_1DungeonMapScene:_onOpenView(viewName)
...
function VersionActivity2_1DungeonMapScene:_onCloseView(viewName)
	if viewName == ViewName.StoryView then
		self:loadMap()
	end
end

function VersionActivity2_1DungeonMapScene:_onScreenResize()
	if self._sceneGo then
		local camera = CameraMgr.instance:getMainCamera()
		local scale = GameUtil.getAdapterScale()

		camera.orthographicSize = VersionActivity2_1DungeonEnum.DungeonMapCameraSize * scale

		self:_initScene()
	end
end

function VersionActivity2_1DungeonMapScene:onModeChange()
	self:refreshMap()
end

function VersionActivity2_1DungeonMapScene:onActivityDungeonMoChange()
	local needTween = VersionActivity2_1DungeonModel.instance:getMapNeedTweenState()

	self:refreshMap(needTween)
end

function VersionActivity2_1DungeonMapScene:onClickElement(elementComp)
...
function VersionActivity2_1DungeonMapScene:focusElementByCo(elementCo)
...
function VersionActivity2_1DungeonMapScene:onFocusElement(elementId, isForce)
...
function VersionActivity2_1DungeonMapScene:changeToElementEpisode(elementId)
...
function VersionActivity2_1DungeonMapScene:manualClickElement(elementId)
	local elementComp = self.mapSceneElementsView:getElementComp(elementId)
...
function VersionActivity2_1DungeonMapScene:_onDragBegin(param, pointerEventData)
...
function VersionActivity2_1DungeonMapScene:_onDrag(param, pointerEventData)
...
function VersionActivity2_1DungeonMapScene:_onDragEnd(param, pointerEventData)
	self._dragBeginPos = nil
end

function VersionActivity2_1DungeonMapScene:getDragWorldPos(pointerEventData)
...
function VersionActivity2_1DungeonMapScene:_editableInitView()
...
function VersionActivity2_1DungeonMapScene:_initMapRootNode()
	self._sceneRoot = UnityEngine.GameObject.New(VersionActivity2_1DungeonEnum.SceneRootName)
...
function VersionActivity2_1DungeonMapScene:onUpdateParam()
	self:refreshMap()
end

function VersionActivity2_1DungeonMapScene:onOpen()
	MainCameraMgr.instance:addView(self.viewName, self._initCamera, nil, self)
	self:refreshMap()
end

function VersionActivity2_1DungeonMapScene:_initCamera()
	local camera = CameraMgr.instance:getMainCamera()
...
function VersionActivity2_1DungeonMapScene:refreshMap(needTween, mapCfg)
	self._mapCfg = mapCfg or VersionActivity2_1DungeonConfig.instance:getEpisodeMapConfig(self.activityDungeonMo.episodeId)
...
function VersionActivity2_1DungeonMapScene:_initElements()
	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnInitElements)
end

function VersionActivity2_1DungeonMapScene:loadMap()
...
function VersionActivity2_1DungeonMapScene:buildLoadRes(allResPath, mapCfg)
...
function VersionActivity2_1DungeonMapScene:_loadSceneFinish()
...
function VersionActivity2_1DungeonMapScene:_initScene()
	...
	local cameraSizeRate = VersionActivity2_1DungeonEnum.DungeonMapCameraSize / uiCameraSize
...
function VersionActivity2_1DungeonMapScene:_setMapPos()
...
function VersionActivity2_1DungeonMapScene:_addMapLight()
...
function VersionActivity2_1DungeonMapScene:_addMapAudio()
...
function VersionActivity2_1DungeonMapScene:_focusUnfinishStoryElement()
	local elementCo = VersionActivity2_1DungeonModel.instance:checkAndGetUnfinishStoryElementCo(self._mapCfg.id)

	if elementCo then
		VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.FocusElement, elementCo.id)
	end
end

function VersionActivity2_1DungeonMapScene:tweenSetScenePos(targetPos, srcPos)
...
function VersionActivity2_1DungeonMapScene:getTargetPos(targetPos)
...
function VersionActivity2_1DungeonMapScene:tweenFrameCallback(value)
...
function VersionActivity2_1DungeonMapScene:tweenFinishCallback()
	self._tempVector:Set(self._tweenTargetPosX, self._tweenTargetPosY, 0)
	self:directSetScenePos(self._tempVector)
end

function VersionActivity2_1DungeonMapScene:directSetScenePos(targetPos)
	...
	VersionActivity2_1DungeonController.instance:dispatchEvent(VersionActivity2_1DungeonEvent.OnMapPosChanged, self._scenePos, self.needTween)
	self:_updateElementArrow()
end

function VersionActivity2_1DungeonMapScene:_updateElementArrow()
	DungeonController.instance:dispatchEvent(DungeonMapElementEvent.OnUpdateElementArrow)
end

function VersionActivity2_1DungeonMapScene:setVisible(isVisible)
...
function VersionActivity2_1DungeonMapScene:killTween()
	if self.tweenId then
		ZProj.TweenHelper.KillById(self.tweenId)
	end
end

function VersionActivity2_1DungeonMapScene:_resetCamera()
	local camera = CameraMgr.instance:getMainCamera()
...
function VersionActivity2_1DungeonMapScene:onDestroyView()
...
function VersionActivity2_1DungeonMapScene:disposeOldMap()
...
function VersionActivity2_1DungeonMapScene:_disposeScene()
	self._oldScenePos = self._scenePos
...
return VersionActivity2_1DungeonMapScene
