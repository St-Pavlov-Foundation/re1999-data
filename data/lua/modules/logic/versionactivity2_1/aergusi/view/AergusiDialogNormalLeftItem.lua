...
function slot0.getHeight(slot0)
	...
	slot0.height = Mathf.Max(AergusiEnum.MinHeight[slot0.type] + AergusiEnum.DialogDoubtOffsetHeight, AergusiEnum.MessageTxtOneLineHeight * slot0._txtContent:GetTextInfo(slot0.stepCo.content).lineCount + AergusiEnum.MessageBgOffsetHeight + AergusiEnum.MessageNameHeight + AergusiEnum.DialogDoubtOffsetHeight)
