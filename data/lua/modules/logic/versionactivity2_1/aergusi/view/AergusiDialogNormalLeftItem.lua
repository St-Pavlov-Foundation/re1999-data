...
function var_0_0.refresh(arg_2_0)
	...
	arg_2_0._txtContent.text = arg_2_0.stepCo.content
...
function var_0_0.getHeight(arg_4_0)
	...
	local var_4_2 = AergusiEnum.MessageTxtOneLineHeight * arg_4_0._txtContent:GetTextInfo(arg_4_0.stepCo.content).lineCount + AergusiEnum.MessageBgOffsetHeight
