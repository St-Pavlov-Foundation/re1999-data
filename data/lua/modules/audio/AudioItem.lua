...
function var_0_0.playAudio(arg_10_0, arg_10_1, arg_10_2)
	...
	local var_10_0 = arg_10_2.volume or 100
	...
	arg_10_0:_play()
	arg_10_0:_fadeIn(var_10_0 * 0.01)
end

function var_0_0.seekPercent(arg_11_0, arg_11_1)
	if arg_11_0._playingId and arg_11_0._emitter then
		arg_11_0._emitter:SeekPercent(arg_11_0._audioId, arg_11_1)
	end
end

function var_0_0.seekMilliSeconds(arg_12_0, arg_12_1)
	if arg_12_0._playingId and arg_12_0._emitter then
		arg_12_0._emitter:SeekMilliSeconds(arg_12_0._audioId, arg_12_1)
	end
end
	...
	if arg_13_0._audioLang then
		if GameConfig:GetCurVoiceShortcut() == LangSettings.shortcutTab[LangSettings.zh] then
			...
			if var_13_4 then
				...
				arg_13_0._emitter:Emitter(arg_13_0._audioId, arg_13_0._audioLang, var_13_3)
		...
		arg_13_0._emitter:Emitter(arg_13_0._audioId, var_13_3)
	end
