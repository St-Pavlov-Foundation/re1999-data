...
function slot0.startCheck(slot0, slot1, slot2)
	...
	elseif not string.nilorempty(SLFramework.GameUpdate.OptionalUpdate.Instance:GetLocalVersion("res-HD")) or not BootVoiceView.instance:isFirstDownloadDone() then
		slot6 = true
