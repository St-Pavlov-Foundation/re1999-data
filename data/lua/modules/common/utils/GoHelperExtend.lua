...
function var_0_0.getUIScreenWidth()
	local var_33_0 = UnityEngine.GameObject.Find("UIRoot/POPUP_TOP")

	if var_33_0 then
		return recthelper.getWidth(var_33_0.transform)
	end

	local var_33_1 = 1080 / UnityEngine.Screen.height

	return (math.floor(UnityEngine.Screen.width * var_33_1 + 0.5))
end
