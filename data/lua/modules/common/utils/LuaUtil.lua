...
function var_0_0.replaceSpace(arg_24_0)
...
function var_0_0.class(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	if isDebugBuild and arg_39_1 then
		if arg_39_3 then
			assert(_G.isTypeOf(arg_39_3, arg_39_1), arg_39_3.__cname .. " is not type of " .. arg_39_1.__cname)
		end

		if arg_39_2 then
			assert(_G.isTypeOf(arg_39_2, arg_39_1), arg_39_2.__cname .. " is not type of " .. arg_39_1.__cname)
		end
	end

	if SettingsModel.instance:isOverseas() then
		return _G.class(arg_39_0, arg_39_2 or arg_39_1)
	else
		return _G.class(arg_39_0, arg_39_3 or arg_39_1)
	end
end
