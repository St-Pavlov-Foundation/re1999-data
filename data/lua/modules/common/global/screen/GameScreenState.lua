...
function var_0_0.setLocalQuality(arg_5_0, arg_5_1, arg_5_2)
	...
	if BootNativeUtil.isWindows() then
		...
		local var_5_8 = UnityEngine.SystemInfo.deviceModel

		if var_5_8:find("Huawei Tablet M5") or var_5_8:find("bah2-w09") then
			UnityEngine.QualitySettings.vSyncCount = 1
		end
	end
	...
	GameResMgr:SetMaxFileLoadingCount(var_5_10)
...
function var_0_0.setTargetFrameRate(arg_7_0, arg_7_1, arg_7_2)
	arg_7_0.targetFrameRate = arg_7_1

	if not arg_7_2 then
		PlayerPrefsHelper.setNumber(PlayerPrefsKey.GMToolViewTargetFrameRate, arg_7_1)
	end

	UnityEngine.Application.targetFrameRate = arg_7_1
end

function var_0_0._onResolutionChange(arg_8_0, arg_8_1, arg_8_2)
	arg_8_0._width = arg_8_1
	arg_8_0._height = arg_8_2

	TaskDispatcher.cancelTask(arg_8_0._delayDispatchResizeEvent, arg_8_0)
	TaskDispatcher.runDelay(arg_8_0._delayDispatchResizeEvent, arg_8_0, 0.01)
	arg_8_0:_setSoftMaskEnable(false)
end

function var_0_0._delayDispatchResizeEvent(arg_9_0)
	arg_9_0:_setSoftMaskEnable(true)
	GameGlobalMgr.instance:dispatchEvent(GameStateEvent.OnScreenResize, arg_9_0._width, arg_9_0._height)
end

function var_0_0._setSoftMaskEnable(arg_10_0, arg_10_1)
	local var_10_0 = ViewMgr.instance:getUIRoot():GetComponentsInChildren(typeof(Coffee.UISoftMask.SoftMask), false)

	for iter_10_0 = 0, var_10_0.Length - 1 do
		var_10_0[iter_10_0].enabled = arg_10_1
	end
end

function var_0_0.getScreenSize(arg_11_0)
	return arg_11_0._width, arg_11_0._height
end
