...
function slot0.refreshHardModeStar(slot0)
	...
	slot0:refreshEpisodeStar(slot4, slot0._config.id, true)
...
function slot0.calculatePosInContent(slot0)
	slot0._maxWidth = math.max(math.max(recthelper.getAnchorX(slot0._txtsectionname.transform) + slot0._txtsectionname.preferredWidth, recthelper.getAnchorX(slot0._txtnameen.transform) + slot0._txtsectionname.preferredWidth) * 2, VersionActivityEnum.EpisodeItemMinWidth) + 30
