...
function var_0_0.calculatePosInContent(arg_19_0)
	...
	local var_19_2 = var_19_0 + arg_19_0._txtsectionname.preferredWidth
	local var_19_3 = var_19_1 + arg_19_0._txtsectionname.preferredWidth
	local var_19_4 = math.max(var_19_2, var_19_3)

	arg_19_0._maxWidth = math.max(var_19_4 * 2, VersionActivityEnum.EpisodeItemMinWidth) + 30
