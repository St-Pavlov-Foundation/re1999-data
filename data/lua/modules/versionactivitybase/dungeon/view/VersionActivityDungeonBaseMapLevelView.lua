...
local var_0_0 = class("VersionActivityDungeonBaseMapLevelView", BaseView)
...
function var_0_0.onInitView(arg_1_0)
	...
	arg_1_0._txtMapChapterIndex = gohelper.findChildText(arg_1_0.viewGO, "anim/versionactivity/right/title/#txt_mapName/#txt_mapChapterIndex")
	arg_1_0._imagestar1 = gohelper.findChildImage(arg_1_0.viewGO, "anim/versionactivity/right/title/stars/starLayout/#image_star1")
	arg_1_0._imagestar2 = gohelper.findChildImage(arg_1_0.viewGO, "anim/versionactivity/right/title/stars/starLayout/#image_star2")
...
function var_0_0.initLocalEpisodeMode(arg_27_0)
	arg_27_0.unlockedEpisodeModeDict = arg_27_0:loadDict(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode)
	arg_27_0.lastEpisodeSelectModeDict = arg_27_0:loadDict(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode)
end
...
function var_0_0._editableInitView(arg_29_0)
	gohelper.setActive(arg_29_0._goactivityrewarditem, false)

	arg_29_0.lockGoType = arg_29_0._gotype0
	arg_29_0.storyGoType = arg_29_0._gotype1
	arg_29_0.story2GoType = arg_29_0._gotype2
	arg_29_0.story3GoType = arg_29_0._gotype3
	arg_29_0.hardGoType = arg_29_0._gotype4
	arg_29_0.rewardItems = {}

	arg_29_0._simageactivitynormalbg:LoadImage(ResUrl.getVersionActivityDungeonIcon("bg002"))
	arg_29_0._simageactivityhardbg:LoadImage(ResUrl.getVersionActivityDungeonIcon("bg003"))

	arg_29_0.goVersionActivity = gohelper.findChild(arg_29_0.viewGO, "anim/versionactivity")
	arg_29_0.animator = arg_29_0.goVersionActivity:GetComponent(typeof(UnityEngine.Animator))
	arg_29_0.animationEventWrap = arg_29_0.goVersionActivity:GetComponent(typeof(ZProj.AnimationEventWrap))

	arg_29_0.animationEventWrap:AddEventListener("refresh", arg_29_0.startRefreshUI, arg_29_0)

	arg_29_0.txtLockType = gohelper.findChildText(arg_29_0.lockGoType, "txt")
	arg_29_0.leftArrowLight = gohelper.findChild(arg_29_0._btnleftarrow.gameObject, "left_arrow")
	arg_29_0.leftArrowDisable = gohelper.findChild(arg_29_0._btnleftarrow.gameObject, "left_arrow_disable")
	arg_29_0.rightArrowLight = gohelper.findChild(arg_29_0._btnrightarrow.gameObject, "right_arrow")
	arg_29_0.rightArrowDisable = gohelper.findChild(arg_29_0._btnrightarrow.gameObject, "right_arrow_disable")
	arg_29_0.userId = PlayerModel.instance:getMyUserId()

	arg_29_0:initLocalEpisodeMode()
	arg_29_0:addEventCb(CurrencyController.instance, CurrencyEvent.CurrencyChange, arg_29_0._onCurrencyChange, arg_29_0)
end

function var_0_0.initViewParam(arg_30_0)
	arg_30_0.originEpisodeId = arg_30_0.viewParam.episodeId
	arg_30_0.originEpisodeConfig = DungeonConfig.instance:getEpisodeCO(arg_30_0.originEpisodeId)
	arg_30_0.normalConfig = DungeonConfig.instance:getVersionActivityDungeonNormalEpisode(arg_30_0.originEpisodeId, VersionActivityEnum.DungeonChapterId.LeiMiTeBeiHard, VersionActivityEnum.DungeonChapterId.LeiMiTeBei)
	arg_30_0.isFromJump = arg_30_0.viewParam.isJump
	arg_30_0.index = arg_30_0:getEpisodeIndex()

	arg_30_0.viewContainer:setOpenedEpisodeId(arg_30_0.originEpisodeId)

	arg_30_0.showEpisodeCo = DungeonConfig.instance:getEpisodeCO(arg_30_0.originEpisodeId)
	arg_30_0.showEpisodeMo = DungeonModel.instance:getEpisodeInfo(arg_30_0.originEpisodeId)
end

function var_0_0.getEpisodeIndex(arg_31_0)
	return DungeonConfig.instance:getEpisodeLevelIndexByEpisodeId(arg_31_0.originEpisodeId)
end

function var_0_0.markSelectEpisode(arg_32_0)
	if arg_32_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Normal or arg_32_0.originEpisodeConfig.type == DungeonEnum.EpisodeType.Boss then
		VersionActivityDungeonBaseController.instance:setChapterIdLastSelectEpisodeId(arg_32_0.originEpisodeConfig.chapterId, arg_32_0.originEpisodeId)
	end
end
...
function var_0_0.onOpen(arg_34_0)
	...
	arg_34_0:initViewParam()
	arg_34_0:initMode()
	arg_34_0:markSelectEpisode()
	arg_34_0:refreshStoryIdList()
	arg_34_0:refreshBg()
	arg_34_0:refreshUI()
	arg_34_0.animator:Play(UIAnimationName.Open, 0, 0)
end

function var_0_0.initMode(arg_35_0)
	arg_35_0.mode = ActivityConfig.instance:getChapterIdMode(arg_35_0.originEpisodeConfig.chapterId)
	arg_35_0.modeIndex = 1

	if arg_35_0.mode ~= VersionActivityDungeonBaseEnum.DungeonMode.Hard then
		arg_35_0.modeList = {
		...
		local var_35_0 = DungeonConfig.instance:getVersionActivityBrotherEpisodeByEpisodeCo(arg_35_0.originEpisodeConfig)

		arg_35_0.mode2EpisodeDict = {}

		for iter_35_0, iter_35_1 in ipairs(var_35_0) do
			arg_35_0.mode2EpisodeDict[ActivityConfig.instance:getChapterIdMode(iter_35_1.chapterId)] = iter_35_1
		end

		arg_35_0.isSpecialEpisode = #var_35_0 > 1
		arg_35_0.specialEpisodeId = var_35_0[1].id

		if arg_35_0.isSpecialEpisode then
			if not arg_35_0.isFromJump then
				local var_35_1

				for iter_35_2 = #var_35_0, 1, -1 do
					local var_35_2 = var_35_0[iter_35_2]

					if DungeonModel.instance:hasPassLevelAndStory(var_35_2.preEpisode) then
						arg_35_0.mode = arg_35_0.modeList[iter_35_2]

						break
					end
				end

				arg_35_0:checkNeedPlayModeUnLockAnimation()

				if not arg_35_0.needPlayUnlockModeAnimation then
					local var_35_3 = arg_35_0.lastEpisodeSelectModeDict[tostring(arg_35_0.specialEpisodeId)] or VersionActivityDungeonBaseEnum.DungeonMode.Story

					if arg_35_0.mode2EpisodeDict[var_35_3] then
						arg_35_0.mode = var_35_3
					else
						arg_35_0:logError(var_35_0, arg_35_0.mode2EpisodeDict, arg_35_0.mode)
					end
				end
			else
				arg_35_0:checkNeedPlayModeUnLockAnimation()
			...
			for iter_35_3, iter_35_4 in ipairs(arg_35_0.modeList) do
				if iter_35_4 == arg_35_0.mode then
					arg_35_0.modeIndex = iter_35_3

					break
				end
			end

			arg_35_0.showEpisodeCo = arg_35_0.mode2EpisodeDict[arg_35_0.mode]
			arg_35_0.showEpisodeMo = DungeonModel.instance:getEpisodeInfo(arg_35_0.showEpisodeCo.id)

			if not arg_35_0.showEpisodeMo then
				arg_35_0.showEpisodeMo = UserDungeonMO.New()

				arg_35_0.showEpisodeMo:initFromManual(arg_35_0.showEpisodeCo.chapterId, arg_35_0.showEpisodeCo.id, 0, 0)
			end
		end
	end
end

function var_0_0.logError(arg_36_0, arg_36_1, arg_36_2, arg_36_3)
	local var_36_0 = string.format("cur mode : %s, episodeList : [", arg_36_3)

	for iter_36_0, iter_36_1 in ipairs(arg_36_1) do
		var_36_0 = var_36_0 .. string.format("%s, ", iter_36_1 and iter_36_1.id or "nil")
	end

	local var_36_1 = var_36_0 .. "], mode2EpisodeDict : ["

	for iter_36_2, iter_36_3 in pairs(arg_36_2) do
		var_36_1 = var_36_1 .. string.format("%s:%s, ", iter_36_2, iter_36_3 and iter_36_3.id or "nil")
	end
...
function var_0_0.refreshEpisodeTextInfo(arg_40_0)
	...
	local var_40_1 = arg_40_0.mode == VersionActivityDungeonBaseEnum.DungeonMode.Hard and "#bc9999" or "#bcbaaa"
...
function var_0_0.refreshStar(arg_41_0)
	...
	arg_41_0:setImage(arg_41_0._imagestar1, var_41_1)
	...
	if string.nilorempty(var_41_2) then
		...
		arg_41_0:setImage(arg_41_0._imagestar2, var_41_1 and arg_41_0.showEpisodeMo.star >= DungeonEnum.StarType.Advanced)
	end
end
...
function var_0_0.setImage(arg_51_0, arg_51_1, arg_51_2)
	if arg_51_2 then
		UISpriteSetMgr.instance:setVersionActivitySprite(arg_51_1, "star_1_3")
	else
		UISpriteSetMgr.instance:setVersionActivitySprite(arg_51_1, "star_1_1")
	end
end
...
function var_0_0.buildEpisodeName(arg_52_0)
	...
	return string.format("<size=112>%s</size>%s", var_52_1, var_52_2)
end
...
function var_0_0.saveEpisodeUnlockMode(arg_57_0)
	PlayerPrefsHelper.setString(arg_57_0:getKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode), cjson.encode(arg_57_0.unlockedEpisodeModeDict))
end

function var_0_0.saveEpisodeLastSelectMode(arg_58_0)
	PlayerPrefsHelper.setString(arg_58_0:getKey(PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode), cjson.encode(arg_58_0.lastEpisodeSelectModeDict))
end
