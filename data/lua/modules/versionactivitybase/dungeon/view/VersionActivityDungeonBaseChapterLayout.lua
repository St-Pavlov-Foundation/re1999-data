...
slot0 = class("VersionActivityDungeonBaseChapterLayout", BaseChildView)
...
function slot0.refreshEpisodeNodes(slot0)
	...
	if DungeonConfig.instance:getChapterEpisodeCOList(slot0.activityDungeonMo.chapterId) then
...
function slot0.isSelectedEpisodeRightEpisode(slot0, slot1)
	if slot0.selectedEpisodeItem and slot0.selectedEpisodeItem._config.id < slot1._config.id then
		return true
	end
