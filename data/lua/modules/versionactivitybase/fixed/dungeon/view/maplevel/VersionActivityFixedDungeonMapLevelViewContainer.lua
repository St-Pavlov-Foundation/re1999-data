...
slot0 = class("VersionActivityFixedDungeonMapLevelViewContainer", BaseViewContainer)
slot1 = 2

function slot0.buildViews(slot0)
	slot0.mapLevelView = VersionActivityFixedHelper.getVersionActivityDungeonMapLevelView().New()
