...
local var_0_0 = class("VersionActivityFixedDungeonMapLevelView", BaseView)
local var_0_1 = 0.4
local var_0_2 = 2.7
...
function var_0_0.onOpen(arg_25_0)
	...
	VersionActivityFixedDungeonController.instance:dispatchEvent(VersionActivityFixedDungeonEvent.OpenFinishMapLevelView, arg_25_0.viewGO)
end
...
function var_0_0.initViewParam(arg_26_0)
	...
	arg_26_0.index = VersionActivityFixedDungeonConfig.instance:getEpisodeIndex(arg_26_0.originEpisodeId)
