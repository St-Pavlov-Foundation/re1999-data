...
slot0 = class("VersionActivityFixedDungeonMapLevelView", BaseView)
slot1 = 0.4
slot2 = 2.7
...
function slot0.startBattle(slot0)
	...
	if slot0.isSpecialEpisode then
		...
		VersionActivityFixedHelper.getVersionActivityDungeonController().instance:savePlayerPrefs(VersionActivityFixedHelper.getVersionActivityDungeonEnum().PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode, cjson.encode(slot0.lastEpisodeSelectModeDict))
	end
...
function slot0.initLocalEpisodeMode(slot0)
	...
	slot0.unlockedEpisodeModeDict = slot2.instance:loadDictFromStr(slot2.instance:getPlayerPrefs(VersionActivityFixedHelper.getVersionActivityDungeonEnum().PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode, ""))
	slot0.lastEpisodeSelectModeDict = slot2.instance:loadDictFromStr(slot2.instance:getPlayerPrefs(VersionActivityFixedHelper.getVersionActivityDungeonEnum().PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastSelectMode, ""))
end
...
function slot0.initViewParam(slot0)
	...
	slot0.index = VersionActivityFixedDungeonConfig.instance:getEpisodeIndex(slot0.originEpisodeId)
...
function slot0.refreshEpisodeTextInfo(slot0)
	slot2 = nil
	slot2 = (DungeonConfig.instance:getChapterCO(slot0.showEpisodeCo.chapterId).id ~= VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonChapterId.Story or slot0.showEpisodeCo) and VersionActivityFixedDungeonConfig.instance:getStoryEpisodeCo(slot0.showEpisodeCo.id)
...
function slot0.setStarImage(slot0, slot1, slot2, slot3)
	if slot2 then
		VersionActivityFixedHelper.setDungeonSprite(slot1, VersionActivityFixedHelper.getVersionActivityDungeonEnum().EpisodeStarType[DungeonConfig.instance:getEpisodeCO(slot3).chapterId].light)
	else
		VersionActivityFixedHelper.setDungeonSprite(slot1, slot5.empty)
	end
end
...
function slot0.refreshEye(slot0)
	...
	slot2 = slot0.originEpisodeConfig.chapterId == VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonChapterId.Hard
...
function slot0.onModeUnlockAnimationPlayDone(slot0)
	...
	VersionActivityFixedHelper.getVersionActivityDungeonController().instance:savePlayerPrefs(VersionActivityFixedHelper.getVersionActivityDungeonEnum().PlayerPrefsKey.ActivityDungeonSpecialEpisodeLastUnLockMode, cjson.encode(slot0.unlockedEpisodeModeDict))
