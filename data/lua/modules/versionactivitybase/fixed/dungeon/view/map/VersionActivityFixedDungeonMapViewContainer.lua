...
slot0 = class("VersionActivityFixedDungeonMapViewContainer", BaseViewContainer)

function slot0.buildViews(slot0)
	slot0.mapScene = VersionActivityFixedHelper.getVersionActivityDungeonMapScene().New()
...
function slot0.onContainerInit(slot0)
	slot0.versionActivityDungeonBaseMo = VersionActivityFixedDungeonMo.New()
	slot4 = slot0.viewParam.chapterId
	slot5 = slot0.viewParam.episodeId

	slot0.versionActivityDungeonBaseMo:init(VersionActivityFixedHelper.getVersionActivityEnum().ActivityId.Dungeon, slot4, slot5)
	slot0.versionActivityDungeonBaseMo:setLayoutClass(VersionActivityFixedHelper.getVersionActivityDungeonMapChapterLayout())
	slot0.versionActivityDungeonBaseMo:setMapEpisodeItemClass(VersionActivityFixedHelper.getVersionActivityDungeonMapEpisodeItem())

	for slot4, slot5 in ipairs(slot0._views) do
		slot5.activityDungeonMo = slot0.versionActivityDungeonBaseMo
	end

	VersionActivityFixedDungeonModel.instance:setDungeonBaseMo(slot0.versionActivityDungeonBaseMo)
