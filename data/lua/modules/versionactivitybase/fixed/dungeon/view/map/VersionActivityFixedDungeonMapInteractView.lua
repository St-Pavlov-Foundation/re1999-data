...
slot0 = class("VersionActivityFixedDungeonMapInteractView", BaseView)
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivityFixedHelper.getVersionActivityDungeonController().instance, VersionActivityFixedDungeonEvent.OnClickElement, slot0.showInteractUI, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivityFixedHelper.getVersionActivityDungeonController().instance, VersionActivityFixedDungeonEvent.OnClickElement, slot0.showInteractUI, slot0)
...
function slot0._onClickFightBtn(slot0)
	...
	VersionActivityFixedDungeonModel.instance:setLastEpisodeId(slot0.activityDungeonMo.episodeId)
...
function slot0.finishElement(slot0, slot1)
	...
	DungeonRpc.instance:sendMapElementRequest(slot2, slot1, slot0.refreshElement, slot0)
end

function slot0.refreshElement(slot0)
end
