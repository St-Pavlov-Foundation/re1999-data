...
slot0 = class("VersionActivityFixedDungeonMapHoleView", DungeonMapHoleView)
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnMapPosChanged, slot0.onMapPosChanged, slot0)
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnAddOneElement, slot0.onAddOneElement, slot0)
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnRemoveElement, slot0.onRemoveElement, slot0)
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnRecycleAllElement, slot0.onRecycleAllElement, slot0)
end
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnMapPosChanged, slot0.onMapPosChanged, slot0)
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnAddOneElement, slot0.onAddOneElement, slot0)
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnRemoveElement, slot0.onRemoveElement, slot0)
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnRecycleAllElement, slot0.onRecycleAllElement, slot0)
end
