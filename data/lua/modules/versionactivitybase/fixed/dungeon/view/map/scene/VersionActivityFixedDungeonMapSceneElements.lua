...
slot0 = class("VersionActivityFixedDungeonMapSceneElements", BaseView)
slot1 = 0.5
slot2 = 0.5
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnClickElement, slot0.onClickElement, slot0)
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnHideInteractUI, slot0.onHideInteractUI, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnClickElement, slot0.onClickElement, slot0)
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.OnHideInteractUI, slot0.onHideInteractUI, slot0)
...
function slot0.onGamepadKeyDown(slot0, slot1)
	...
	for slot9 = 0, UnityEngine.Physics2D.RaycastAll(slot3.origin, slot3.direction).Length - 1 do
		if MonoHelper.getLuaComFromGo(slot4[slot9].transform.parent.gameObject, VersionActivityFixedHelper.getVersionActivityDungeonMapElement()) then
			slot12:_onClickDown()
		end
	end
end
...
function slot0._removeElement(slot0, slot1)
	...
	VersionActivityFixedHelper.getVersionActivityDungeonController().instance:dispatchEvent(VersionActivityFixedDungeonEvent.OnRemoveElement, slot2)
end
...
function slot0.showNewElements(slot0)
	...
	for slot6, slot7 in ipairs(slot1) do
		if VersionActivityFixedDungeonConfig.instance:checkElementBelongMapId(DungeonConfig.instance:getChapterMapElement(slot7), slot0._mapCfg.id) and slot8.showCamera == 1 then
			slot2[#slot2 + 1] = slot7
		end
	end
...
function slot0._doFocusElement(slot0)
	VersionActivityFixedHelper.getVersionActivityDungeonController().instance:dispatchEvent(VersionActivityFixedDungeonEvent.FocusElement, slot0[2], true)
end
...
function slot0._addElement(slot0, slot1)
	...
	if slot0._elementCompPoolDict[slot1.id] then
		...
		slot2 = MonoHelper.addLuaComOnceToGo(slot3, VersionActivityFixedHelper.getVersionActivityDungeonMapElement(), {
			slot1,
			slot0
		})
	end
	...
	VersionActivityFixedHelper.getVersionActivityDungeonController().instance:dispatchEvent(VersionActivityFixedDungeonEvent.OnAddOneElement, slot2)
end
...
function slot0.showElements(slot0)
	...
	for slot8, slot9 in ipairs(VersionActivityFixedDungeonModel.instance:getElementCoList(slot0._mapCfg.id)) do
...
function slot0._arrowClick(slot0, slot1)
	...
	VersionActivityFixedHelper.getVersionActivityDungeonController().instance:dispatchEvent(VersionActivityFixedDungeonEvent.FocusElement, slot1)
end
