...
slot0 = class("VersionActivityFixedDungeonMapElement", LuaCompBase)
slot1 = 1.6
...
function slot0.onClick(slot0)
	VersionActivityFixedHelper.getVersionActivityDungeonController().instance:dispatchEvent(VersionActivityFixedDungeonEvent.OnClickElement, slot0)
end
