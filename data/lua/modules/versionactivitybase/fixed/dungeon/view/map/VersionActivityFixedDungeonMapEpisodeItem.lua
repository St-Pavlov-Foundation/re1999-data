module("modules.versionactivitybase.fixed.dungeon.view.map.VersionActivityFixedDungeonMapEpisodeItem", package.seeall)

slot0 = class("VersionActivityFixedDungeonMapEpisodeItem", BaseChildView)
...
function slot0.onClick(slot0)
	...
	if ViewMgr.instance:getContainer(VersionActivityFixedHelper.getVersionActivityDungeonMapLevelViewName()) then
...
function slot0._showEye(slot0)
	...
	slot2 = slot0._config.chapterId == VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonChapterId.Hard
...
function slot0.getMapAllElementList(slot0)
	return VersionActivityFixedDungeonModel.instance:getElementCoList(slot0._map.id)
end

function slot0._showAllElementTipView(slot0)
	if not slot0._map or slot0._config.chapterId == VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonChapterId.Hard then
	...
	slot1, slot2 = VersionActivityFixedDungeonModel.instance:getElementCoListWithFinish(slot0._map.id)
...
function slot0.refresh(slot0, slot1, slot2)
	...
	slot0._map = VersionActivityFixedDungeonConfig.instance:getEpisodeMapConfig(slot0._config.id)
...
function slot0.setImage(slot0, slot1, slot2, slot3)
	slot5 = VersionActivityFixedHelper.getVersionActivityDungeonEnum().EpisodeStarType[DungeonConfig.instance:getEpisodeCO(slot3).chapterId]

	VersionActivityFixedHelper.setDungeonSprite(slot1, slot2 and slot5.light or slot5.empty)
end
