...
slot0 = class("VersionActivityFixedDungeonMapChapterLayout", BaseChildView)
slot1 = "default"
slot2 = 600
slot3 = 100
slot4 = 0.26
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(VersionActivityFixedHelper.getVersionActivityDungeonController().instance, VersionActivityFixedDungeonEvent.GuideShowElement, slot0._GuideShowElement, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(VersionActivityFixedHelper.getVersionActivityDungeonController().instance, VersionActivityFixedDungeonEvent.GuideShowElement, slot0._GuideShowElement, slot0)
end
...
function slot0._onGamepadKeyUp(slot0, slot1)
	...
	if slot2[#slot2] ~= VersionActivityFixedHelper.getVersionActivityDungeonMapViewName() and slot3 ~= VersionActivityFixedHelper.getVersionActivityDungeonMapLevelViewName() then
		return
	end
...
function slot0._GuideShowElement(slot0, slot1)
	if DungeonConfig.instance:getChapterMapElement(tonumber(slot1)) then
		...
		VersionActivityFixedHelper.getVersionActivityDungeonController().instance:dispatchEvent(VersionActivityFixedDungeonEvent.FocusElement, slot2)
	end
end
