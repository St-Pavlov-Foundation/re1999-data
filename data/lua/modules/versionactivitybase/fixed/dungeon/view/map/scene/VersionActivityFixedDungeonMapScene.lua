...
slot0 = class("VersionActivityFixedDungeonMapScene", BaseView)
...
function slot0.addEvents(slot0)
	...
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.FocusElement, slot0.onFocusElement, slot0)
	slot0:addEventCb(slot1.instance, VersionActivityFixedDungeonEvent.ManualClickElement, slot0.manualClickElement, slot0)
...
function slot0.removeEvents(slot0)
	...
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.FocusElement, slot0.onFocusElement, slot0)
	slot0:removeEventCb(slot1.instance, VersionActivityFixedDungeonEvent.ManualClickElement, slot0.manualClickElement, slot0)
...
function slot0._onScreenResize(slot0)
	if slot0._sceneGo then
		CameraMgr.instance:getMainCamera().orthographicSize = VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonMapCameraSize * GameUtil.getAdapterScale()
...
function slot0.onActivityDungeonMoChange(slot0)
	slot0:refreshMap(VersionActivityFixedDungeonModel.instance:getMapNeedTweenState())
end
...
function slot0._initMapRootNode(slot0)
	slot0._sceneRoot = UnityEngine.GameObject.New(VersionActivityFixedHelper.getVersionActivityDungeonEnum().SceneRootName)
...
function slot0._initCamera(slot0)
	...
	slot1.orthographicSize = VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonMapCameraSize * GameUtil.getAdapterScale()
end
...
function slot0._initScene(slot0)
	...
	slot11 = VersionActivityFixedHelper.getVersionActivityDungeonEnum().DungeonMapCameraSize / (CameraMgr.instance:getUICamera() and slot9.orthographicSize or 5)
