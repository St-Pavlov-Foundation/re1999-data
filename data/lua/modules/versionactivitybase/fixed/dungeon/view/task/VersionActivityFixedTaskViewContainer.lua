...
slot0 = class("VersionActivityFixedTaskViewContainer", BaseViewContainer)
...
function slot0.buildViews(slot0)
	...
	slot1.cellClass = VersionActivityFixedHelper.getVersionActivityTaskItem()
	...
	slot0._taskScrollView = LuaListScrollViewWithAnimator.New(VersionActivityFixedTaskListModel.instance, slot1, {
		[slot6] = (slot6 - 1) * 0.06
	})
