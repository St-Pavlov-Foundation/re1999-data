...
slot0 = class("VersionActivityFixedTaskItem", ListScrollCell)
...
function slot0.addEventListeners(slot0)
	...
	slot0:addEventCb(VersionActivityFixedHelper.getVersionActivityDungeonController().instance, VersionActivityFixedDungeonEvent.OnClickAllTaskFinish, slot0._OnClickAllTaskFinish, slot0)
end
...
function slot0.removeEventListeners(slot0)
	...
	slot0:removeEventCb(VersionActivityFixedHelper.getVersionActivityDungeonController().instance, VersionActivityFixedDungeonEvent.OnClickAllTaskFinish, slot0._OnClickAllTaskFinish, slot0)
end
...
slot0.FinishKey = "VersionActivityFixedTaskItem FinishKey"
...
function slot0.secondAnimationDone(slot0)
	...
	if slot0.taskMo.getAll then
		TaskRpc.instance:sendFinishAllTaskRequest(TaskEnum.TaskType.ActivityDungeon, nil, , , , VersionActivityFixedHelper.getVersionActivityEnum().ActivityId.Dungeon)
	else
