...
slot0 = class("VersionActivityFixedStoreGoodsItem", UserDataDispose)
...
function slot0.updateInfo(slot0, slot1)
	...
	slot2, slot3, slot4 = VersionActivityFixedEnterHelper.getItemTypeIdQuantity(slot0.storeGoodsCo.product)
	...
	VersionActivityFixedHelper.setMainActivitySprite(slot0.imageRare, VersionActivityFixedHelper.getVersionActivityStoreRareIcon() .. slot7)
	...
	slot0.costItemType, slot0.costItemId, slot0.costItemQuantity = VersionActivityFixedEnterHelper.getItemTypeIdQuantity(slot0.storeGoodsCo.cost)
...
function slot0.refreshRemainBuyCount(slot0)
	if slot0.storeGoodsCo.maxBuyCount == 0 then
		...
		slot0.remainBuyCount = slot0.storeGoodsCo.maxBuyCount - ActivityStoreModel.instance:getActivityGoodsBuyCount(VersionActivityFixedHelper.getVersionActivityEnum().ActivityId.DungeonStore, slot0.storeGoodsCo.id)
