...
slot0 = class("VersionActivityFixedStoreItem", UserDataDispose)
slot1 = 424
slot2 = 382.32
slot3 = 300

function slot4(slot0, slot1)
	slot2 = VersionActivityFixedHelper.getVersionActivityEnum().ActivityId.DungeonStore
...
function slot0.refreshGoods(slot0)
	...
	for slot5, slot6 in ipairs(slot0.groupGoodsCoList) do
		if not slot0.goodsItemList[slot5] then
			slot1 = VersionActivityFixedHelper.getVersionActivityStoreGoodsItem().New()
