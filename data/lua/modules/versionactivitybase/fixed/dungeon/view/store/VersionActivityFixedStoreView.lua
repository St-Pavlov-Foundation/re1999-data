...
slot0 = class("VersionActivityFixedStoreView", BaseView)
...
function slot0._editableInitView(slot0)
	...
	slot0.actId = VersionActivityFixedHelper.getVersionActivityEnum().ActivityId.DungeonStore
...
function slot0.refreshTime(slot0)
	slot0._txttime.text = ActivityModel.instance:getActivityInfo()[VersionActivityFixedHelper.getVersionActivityEnum().ActivityId.DungeonStore]:getRemainTimeStr3(false, false)
end
...
function slot0.refreshStoreContent(slot0)
	...
	for slot6 = 1, #slot1 do
		if not slot0.storeItemList[slot6] then
			slot2 = VersionActivityFixedHelper.getVersionActivityStoreItem().New()
