...
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG = protobuf.Descriptor()
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD = protobuf.FieldDescriptor()
...
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG = protobuf.Descriptor()
...
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.name = "payDiamond"
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.full_name = ".GetPayDiamondInfoReply.payDiamond"
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.number = 1
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.index = 0
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.label = 1
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.has_default_value = false
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.default_value = 0
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.type = 3
ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD.cpp_type = 2
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.name = "GetPayDiamondInfoReply"
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.full_name = ".GetPayDiamondInfoReply"
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.nested_types = {}
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.enum_types = {}
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.fields = {
	ChargeModule_pb.GETPAYDIAMONDINFOREPLYPAYDIAMONDFIELD
}
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.is_extendable = false
ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG.extensions = {}
...
ChargeModule_pb.NEWORDERREQUESTSELECTIONINFOSFIELD.number = 2
ChargeModule_pb.NEWORDERREQUESTSELECTIONINFOSFIELD.index = 1
...
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.name = "GetPayDiamondInfoRequest"
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.full_name = ".GetPayDiamondInfoRequest"
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.nested_types = {}
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.enum_types = {}
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.fields = {}
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.is_extendable = false
ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG.extensions = {}
...
ChargeModule_pb.GetPayDiamondInfoReply = protobuf.Message(ChargeModule_pb.GETPAYDIAMONDINFOREPLY_MSG)
ChargeModule_pb.GetPayDiamondInfoRequest = protobuf.Message(ChargeModule_pb.GETPAYDIAMONDINFOREQUEST_MSG)
